 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAgreement#getMerchantAccounts <em>Merchant Accounts</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAgreement()
...
public interface MerchantAgreement extends Agreement {
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getMerchantAgreement <em>Merchant Agreement</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAgreement_MerchantAccounts()
