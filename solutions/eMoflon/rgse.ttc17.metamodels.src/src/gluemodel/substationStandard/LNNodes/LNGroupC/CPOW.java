 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getTmExc <em>Tm Exc</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getStrPOW <em>Str POW</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getOpOpn <em>Op Opn</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getOpCls <em>Op Cls</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getMaxDlTmms <em>Max Dl Tmms</em>}</li>
 * </ul>
 *
 * @see gluemodel.substationStandard.LNNodes.LNGroupC.LNGroupCPackage#getCPOW()
 * @model
 * @generated
 */
public interface CPOW extends GroupC {
	 ...
	 * @see #setTmExc(SPS)
	 * @see gluemodel.substationStandard.LNNodes.LNGroupC.LNGroupCPackage#getCPOW_TmExc()
	 * @model required="true"
	 * @generated
	 */
	SPS getTmExc();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getTmExc <em>Tm Exc</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setStrPOW(SPS)
	 * @see gluemodel.substationStandard.LNNodes.LNGroupC.LNGroupCPackage#getCPOW_StrPOW()
	 * @model required="true"
	 * @generated
	 */
	SPS getStrPOW();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getStrPOW <em>Str POW</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOpOpn(ACT)
	 * @see gluemodel.substationStandard.LNNodes.LNGroupC.LNGroupCPackage#getCPOW_OpOpn()
	 * @model required="true"
	 * @generated
	 */
	ACT getOpOpn();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getOpOpn <em>Op Opn</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOpCls(ACT)
	 * @see gluemodel.substationStandard.LNNodes.LNGroupC.LNGroupCPackage#getCPOW_OpCls()
	 * @model required="true"
	 * @generated
	 */
	ACT getOpCls();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getOpCls <em>Op Cls</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.substationStandard.LNNodes.LNGroupC.LNGroupCPackage#getCPOW_MaxDlTmms()
	 * @model required="true"
	 * @generated
	 */
	ING getMaxDlTmms();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupC.CPOW#getMaxDlTmms <em>Max Dl Tmms</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
