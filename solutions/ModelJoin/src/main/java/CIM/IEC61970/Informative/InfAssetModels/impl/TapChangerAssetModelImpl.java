...
import CIM.IEC61970.Informative.InfAssetModels.TapChangerSwitchingKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getRatedVoltage <em>Rated Voltage</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getHighStep <em>High Step</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getRatedCurrent <em>Rated Current</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getPhaseCount <em>Phase Count</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getTapCount <em>Tap Count</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getTapChangerAssets <em>Tap Changer Assets</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getRatedApparentPower <em>Rated Apparent Power</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getNeutralStep <em>Neutral Step</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getLowStep <em>Low Step</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getInitialDelay <em>Initial Delay</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getStepVoltageIncrement <em>Step Voltage Increment</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getSwitchingKind <em>Switching Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getSubsequentDelay <em>Subsequent Delay</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getStepPhaseIncrement <em>Step Phase Increment</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssetModels.impl.TapChangerAssetModelImpl#getBil <em>Bil</em>}</li>
 * </ul>
 *
 * @generated
 */
