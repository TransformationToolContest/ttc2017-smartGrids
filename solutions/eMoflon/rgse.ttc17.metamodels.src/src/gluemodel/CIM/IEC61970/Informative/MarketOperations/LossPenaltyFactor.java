 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.LossPenaltyFactor#getConnectivityNodes <em>Connectivity Nodes</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.LossPenaltyFactor#getLossFactor <em>Loss Factor</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getLossPenaltyFactor()
...
public interface LossPenaltyFactor extends MarketFactors {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getLossPenaltyFactor_LossFactor()
	 * @model dataType="gluemodel.CIM.PenaltyFactor" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.LossPenaltyFactor#getLossFactor <em>Loss Factor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
