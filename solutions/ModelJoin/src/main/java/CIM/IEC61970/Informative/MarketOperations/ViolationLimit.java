 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#getSeason <em>Season</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#getMeasurement <em>Measurement</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#getOrganisations <em>Organisations</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#getFlowgate <em>Flowgate</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#isEnforced <em>Enforced</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getViolationLimit()
...
public interface ViolationLimit extends Limit {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.LoadModel.Season#getViolationLimits <em>Violation Limits</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getViolationLimit_Season()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#getSeason <em>Season</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.Measurement#getViolationLimits <em>Violation Limits</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getViolationLimit_Measurement()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#getMeasurement <em>Measurement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfERPSupport.ErpOrganisation#getViolationLimits <em>Violation Limits</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getViolationLimit_Organisations()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.Flowgate#getViolationLimits <em>Violation Limits</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getViolationLimit_Flowgate()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#getFlowgate <em>Flowgate</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getViolationLimit_Enforced()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ViolationLimit#isEnforced <em>Enforced</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
