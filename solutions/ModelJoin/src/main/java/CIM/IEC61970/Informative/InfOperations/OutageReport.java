...
import CIM.IEC61970.Informative.InfCustomers.OutageHistory;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getOutageRecord <em>Outage Record</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getCustomerCount <em>Customer Count</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getOutageHistory <em>Outage History</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getOutageDuration <em>Outage Duration</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getAverageCml <em>Average Cml</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getTotalCml <em>Total Cml</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageReport()
...
public interface OutageReport extends Document {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfOperations.OutageRecord#getOutageReport <em>Outage Report</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageReport_OutageRecord()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getOutageRecord <em>Outage Record</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageReport_CustomerCount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getCustomerCount <em>Customer Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfCustomers.OutageHistory#getOutageReports <em>Outage Reports</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageReport_OutageHistory()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getOutageHistory <em>Outage History</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageReport_OutageDuration()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getOutageDuration <em>Outage Duration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageReport_AverageCml()
	 * @model dataType="CIM.IEC61970.Domain.Minutes" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getAverageCml <em>Average Cml</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageReport_TotalCml()
	 * @model dataType="CIM.IEC61970.Domain.Minutes" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageReport#getTotalCml <em>Total Cml</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
