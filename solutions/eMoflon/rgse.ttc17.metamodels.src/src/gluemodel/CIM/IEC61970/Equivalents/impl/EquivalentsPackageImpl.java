...
import gluemodel.CIM.IEC61970.Equivalents.EquivalentsFactory;
...
public class EquivalentsPackageImpl extends EPackageImpl implements EquivalentsPackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.Equivalents.EquivalentsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getEquivalentEquipment() {
		if (equivalentEquipmentEClass == null) {
			equivalentEquipmentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(EquivalentsPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EClass getEquivalentInjection() {
		if (equivalentInjectionEClass == null) {
			equivalentInjectionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(EquivalentsPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EClass getEquivalentShunt() {
		if (equivalentShuntEClass == null) {
			equivalentShuntEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(EquivalentsPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Equivalents." + eClassifier.getName());
