 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#isDemandMultiplierApplied <em>Demand Multiplier Applied</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getTransformerCTRatio <em>Transformer CT Ratio</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getBillingMultiplier <em>Billing Multiplier</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getMeteringFunctionConfiguration <em>Metering Function Configuration</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getCurrentRating <em>Current Rating</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#isTransformerRatiosApplied <em>Transformer Ratios Applied</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getKWMultiplier <em>KW Multiplier</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#isBillingMultiplierApplied <em>Billing Multiplier Applied</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getDemandMultiplier <em>Demand Multiplier</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getKWhMultiplier <em>KWh Multiplier</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getTransformerVTRatio <em>Transformer VT Ratio</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ElectricMeteringFunctionImpl#getVoltageRating <em>Voltage Rating</em>}</li>
 * </ul>
 *
 * @generated
 */
