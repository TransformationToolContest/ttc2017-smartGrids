...
import gluemodel.CIM.IEC61970.Informative.MarketOperations.BilateralTransaction;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.BilateralTransactionImpl#getPurchaseTimeMax <em>Purchase Time Max</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.BilateralTransactionImpl#getPurchaseTimeMin <em>Purchase Time Min</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.BilateralTransactionImpl#getCurtailTimeMax <em>Curtail Time Max</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.BilateralTransactionImpl#getCurtailTimeMin <em>Curtail Time Min</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.BilateralTransactionImpl#getTotalTranChargeMax <em>Total Tran Charge Max</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.BilateralTransactionImpl#getTransactionType <em>Transaction Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.BilateralTransactionImpl#getMarketType <em>Market Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.BilateralTransactionImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
