 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.ProtectedSwitch#getRecloseSequences <em>Reclose Sequences</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Wires.WiresPackage#getProtectedSwitch()
...
public interface ProtectedSwitch extends Switch {
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Protection.RecloseSequence}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Protection.RecloseSequence#getProtectedSwitch <em>Protected Switch</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getProtectedSwitch_RecloseSequences()
