...
import gluemodel.CIM.IEC61970.Informative.InfCustomers.InfCustomersFactory;
 ...
 * @generated
 */
public class InfCustomersPackageImpl extends EPackageImpl implements InfCustomersPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfCustomers.InfCustomersPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InfCustomersPackageImpl() {
		super(eNS_URI, InfCustomersFactory.eINSTANCE);
	}
	...
	public static InfCustomersPackage init() {
		...
		InfCustomersPackageImpl theInfCustomersPackage = (InfCustomersPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InfCustomersPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InfCustomersPackageImpl());
	...
	public EReference getStandardIndustryCode_CustomerAgreements() {
        return (EReference)getStandardIndustryCode().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getStandardIndustryCode_Code() {
        return (EAttribute)getStandardIndustryCode().getEStructuralFeatures().get(1);
	}
	...
	public EClass getCustomerBillingInfo() {
		if (customerBillingInfoEClass == null) {
			customerBillingInfoEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCustomersPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EAttribute getCustomerBillingInfo_DueDate() {
        return (EAttribute)getCustomerBillingInfo().getEStructuralFeatures().get(0);
	}
	...
	public EReference getCustomerBillingInfo_CustomerAccount() {
        return (EReference)getCustomerBillingInfo().getEStructuralFeatures().get(2);
	}
	...
	public EReference getCustomerBillingInfo_ErpInvoiceLineItems() {
        return (EReference)getCustomerBillingInfo().getEStructuralFeatures().get(8);
	}
	...
	public EAttribute getCustomerBillingInfo_Kind() {
        return (EAttribute)getCustomerBillingInfo().getEStructuralFeatures().get(9);
	}
	...
	public EClass getPowerQualityPricing() {
		if (powerQualityPricingEClass == null) {
			powerQualityPricingEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCustomersPackage.eNS_URI).getEClassifiers().get(3);
		}
	 ...
	 * @generated
	 */
	public EReference getPowerQualityPricing_PricingStructure() {
        return (EReference)getPowerQualityPricing().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getPowerQualityPricing_ServiceDeliveryPoints() {
        return (EReference)getPowerQualityPricing().getEStructuralFeatures().get(8);
	}
	...
	public EAttribute getPowerQualityPricing_NormalLowVoltLimit() {
        return (EAttribute)getPowerQualityPricing().getEStructuralFeatures().get(9);
	}
	...
	public EAttribute getPowerQualityPricing_NormalHighVoltLimit() {
        return (EAttribute)getPowerQualityPricing().getEStructuralFeatures().get(10);
	}
	...
	public EClass getOutageHistory() {
		if (outageHistoryEClass == null) {
			outageHistoryEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCustomersPackage.eNS_URI).getEClassifiers().get(4);
		}
	...
	public EClass getWorkBillingInfo() {
		if (workBillingInfoEClass == null) {
			workBillingInfoEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCustomersPackage.eNS_URI).getEClassifiers().get(5);
		}
	...
	public EAttribute getWorkBillingInfo_IssueDateTime() {
        return (EAttribute)getWorkBillingInfo().getEStructuralFeatures().get(3);
	}
	...
	public EReference getWorkBillingInfo_ErpLineItems() {
        return (EReference)getWorkBillingInfo().getEStructuralFeatures().get(4);
	}
	...
	public EAttribute getWorkBillingInfo_DueDateTime() {
        return (EAttribute)getWorkBillingInfo().getEStructuralFeatures().get(5);
	}
	...
	public EReference getWorkBillingInfo_Works() {
        return (EReference)getWorkBillingInfo().getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EReference getSubscribePowerCurve_PricingStructure() {
        return (EReference)getSubscribePowerCurve().getEStructuralFeatures().get(0);
	}
	...
	public EClass getServiceGuarantee() {
		if (serviceGuaranteeEClass == null) {
			serviceGuaranteeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCustomersPackage.eNS_URI).getEClassifiers().get(7);
		}
	...
	public EReference getServiceGuarantee_ApplicationPeriod() {
        return (EReference)getServiceGuarantee().getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getServiceGuarantee_ServiceRequirement() {
        return (EAttribute)getServiceGuarantee().getEStructuralFeatures().get(3);
	}
	...
	public EClass getExternalCustomerAgreement() {
		if (externalCustomerAgreementEClass == null) {
			externalCustomerAgreementEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCustomersPackage.eNS_URI).getEClassifiers().get(8);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.InfCustomers." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //InfCustomersPackageImpl
