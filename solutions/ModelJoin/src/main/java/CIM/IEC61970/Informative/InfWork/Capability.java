 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Capability#getCategory <em>Category</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Capability#getWorkTasks <em>Work Tasks</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Capability#getValidityInterval <em>Validity Interval</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Capability#getCrew <em>Crew</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Capability#getCrafts <em>Crafts</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Capability#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Capability#getPerformanceFactor <em>Performance Factor</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCapability()
...
public interface Capability extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCapability_Category()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Capability#getCategory <em>Category</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.WorkTask#getCapabilities <em>Capabilities</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCapability_WorkTasks()
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCapability_ValidityInterval()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Capability#getValidityInterval <em>Validity Interval</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.Crew#getCapabilities <em>Capabilities</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setCrew(Crew)
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCapability_Crew()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Capability#getCrew <em>Crew</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfCommon.Craft#getCapabilities <em>Capabilities</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCapability_Crafts()
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCapability_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Capability#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCapability_PerformanceFactor()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Capability#getPerformanceFactor <em>Performance Factor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
