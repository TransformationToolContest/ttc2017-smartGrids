...
import CIM.IEC61970.Generation.Production.InflowForecast;
...
import CIM.IEC61970.Generation.Production.SpillwayGateType;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getActiveStorageCapacity <em>Active Storage Capacity</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getUpstreamFromHydroPowerPlants <em>Upstream From Hydro Power Plants</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getSpillsIntoReservoirs <em>Spills Into Reservoirs</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getSpillsFromReservoir <em>Spills From Reservoir</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getLevelVsVolumeCurves <em>Level Vs Volume Curves</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getInflowForecasts <em>Inflow Forecasts</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getSpillTravelDelay <em>Spill Travel Delay</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getRiverOutletWorks <em>River Outlet Works</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getNormalMinOperateLevel <em>Normal Min Operate Level</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getSpillwayCrestLevel <em>Spillway Crest Level</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getFullSupplyLevel <em>Full Supply Level</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getSpillwayCapacity <em>Spillway Capacity</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getTargetLevelSchedule <em>Target Level Schedule</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getSpillWayGateType <em>Spill Way Gate Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getSpillwayCrestLength <em>Spillway Crest Length</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getEnergyStorageRating <em>Energy Storage Rating</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getGrossCapacity <em>Gross Capacity</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.ReservoirImpl#getHydroPowerPlants <em>Hydro Power Plants</em>}</li>
 * </ul>
 *
 * @generated
 */
