...
import gluemodel.CIM.IEC61970.StateVariables.StateVariablesFactory;
...
public class StateVariablesPackageImpl extends EPackageImpl implements StateVariablesPackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.StateVariables.StateVariablesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.StateVariables." + eClassifier.getName());
