 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.CUContractorItem#getActivityCode <em>Activity Code</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.CUContractorItem#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.CUContractorItem#getBidAmount <em>Bid Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.CUContractorItem#getCompatibleUnits <em>Compatible Units</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUContractorItem()
...
public interface CUContractorItem extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUContractorItem_ActivityCode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.CUContractorItem#getActivityCode <em>Activity Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUContractorItem_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.CUContractorItem#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUContractorItem_BidAmount()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.CUContractorItem#getBidAmount <em>Bid Amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.CompatibleUnit#getCUContractorItems <em>CU Contractor Items</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUContractorItem_CompatibleUnits()
