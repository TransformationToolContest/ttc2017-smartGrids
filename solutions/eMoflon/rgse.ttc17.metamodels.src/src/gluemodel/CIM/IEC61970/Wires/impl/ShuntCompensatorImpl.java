...
import gluemodel.CIM.IEC61970.Wires.ShuntCompensator;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getNormalSections <em>Normal Sections</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getMinU <em>Min U</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getB0PerSection <em>B0 Per Section</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getNomQ <em>Nom Q</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getNomU <em>Nom U</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getMaximumSections <em>Maximum Sections</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getSwitchOnCount <em>Switch On Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getMaxU <em>Max U</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getBPerSection <em>BPer Section</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getGPerSection <em>GPer Section</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getSvShuntCompensatorSections <em>Sv Shunt Compensator Sections</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getSwitchOnDate <em>Switch On Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getAVRDelay <em>AVR Delay</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getVoltageSensitivity <em>Voltage Sensitivity</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getG0PerSection <em>G0 Per Section</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.ShuntCompensatorImpl#getReactivePerSection <em>Reactive Per Section</em>}</li>
 * </ul>
 *
 * @generated
 */
