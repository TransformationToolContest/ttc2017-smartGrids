 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61970.Informative.InfCustomers.InfCustomersPackage#getCustomerBillingKind()
 * @model
 * @generated
 */
public enum CustomerBillingKind implements Enumerator {
	 ...
	 * @ordered
	 */
	CONSOLIDATED_ESS(1, "consolidatedEss", "consolidatedEss"),
	 ...
	 * @model name="consolidatedEss"
	 * @generated
	 * @ordered
	 */
	public static final int CONSOLIDATED_ESS_VALUE = 1;
