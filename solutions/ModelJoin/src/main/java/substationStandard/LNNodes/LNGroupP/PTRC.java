 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PTRC#getTr <em>Tr</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PTRC#getOp <em>Op</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PTRC#getStr <em>Str</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PTRC#getTrMod <em>Tr Mod</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PTRC#getTrPlsTmms <em>Tr Pls Tmms</em>}</li>
 * </ul>
 *
 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPTRC()
 * @model
 * @generated
 */
public interface PTRC extends GroupP {
	 ...
	 * @see #setTr(ACT)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPTRC_Tr()
	 * @model required="true"
	 * @generated
	 */
	ACT getTr();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PTRC#getTr <em>Tr</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOp(ACT)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPTRC_Op()
	 * @model required="true"
	 * @generated
	 */
	ACT getOp();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PTRC#getOp <em>Op</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setStr(ACD)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPTRC_Str()
	 * @model required="true"
	 * @generated
	 */
	ACD getStr();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PTRC#getStr <em>Str</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTrMod(ING)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPTRC_TrMod()
	 * @model required="true"
	 * @generated
	 */
	ING getTrMod();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PTRC#getTrMod <em>Tr Mod</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPTRC_TrPlsTmms()
	 * @model required="true"
	 * @generated
	 */
	ING getTrPlsTmms();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PTRC#getTrPlsTmms <em>Tr Pls Tmms</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
