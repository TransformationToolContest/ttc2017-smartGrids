 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.EndDeviceGroup#getDemandResponseProgram <em>Demand Response Program</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.EndDeviceGroup#getGroupAddress <em>Group Address</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.EndDeviceGroup#getEndDeviceAssets <em>End Device Assets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.EndDeviceGroup#getEndDeviceControls <em>End Device Controls</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getEndDeviceGroup()
...
public interface EndDeviceGroup extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.Metering.DemandResponseProgram#getEndDeviceGroups <em>End Device Groups</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getEndDeviceGroup_DemandResponseProgram()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.Metering.EndDeviceGroup#getDemandResponseProgram <em>Demand Response Program</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getEndDeviceGroup_GroupAddress()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.Metering.EndDeviceGroup#getGroupAddress <em>Group Address</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.Metering.EndDeviceAsset#getEndDeviceGroups <em>End Device Groups</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getEndDeviceGroup_EndDeviceAssets()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.Metering.EndDeviceControl#getEndDeviceGroup <em>End Device Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getEndDeviceGroup_EndDeviceControls()
