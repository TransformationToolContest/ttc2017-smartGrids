 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.CurveData#getXvalue <em>Xvalue</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.CurveData#getCurve <em>Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.CurveData#getY2value <em>Y2value</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.CurveData#getY3value <em>Y3value</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.CurveData#getY1value <em>Y1value</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getCurveData()
...
public interface CurveData extends Element {
	 ...
	 * @see #setXvalue(float)
	 * @see CIM.IEC61970.Core.CorePackage#getCurveData_Xvalue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.CurveData#getXvalue <em>Xvalue</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.Curve#getCurveDatas <em>Curve Datas</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setCurve(Curve)
	 * @see CIM.IEC61970.Core.CorePackage#getCurveData_Curve()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.CurveData#getCurve <em>Curve</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurveData_Y2value()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.CurveData#getY2value <em>Y2value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurveData_Y3value()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.CurveData#getY3value <em>Y3value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurveData_Y1value()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.CurveData#getY1value <em>Y1value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
