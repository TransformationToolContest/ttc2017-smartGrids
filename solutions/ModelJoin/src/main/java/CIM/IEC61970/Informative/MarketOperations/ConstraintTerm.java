 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ConstraintTerm#getFactor <em>Factor</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ConstraintTerm#getSecurityConstraintSum <em>Security Constraint Sum</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ConstraintTerm#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getConstraintTerm()
...
public interface ConstraintTerm extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getConstraintTerm_Factor()
	 * @model required="true"
	 * @generated
	 */
	String getFactor();
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ConstraintTerm#getFactor <em>Factor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraintSum#getConstraintTerms <em>Constraint Terms</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getConstraintTerm_SecurityConstraintSum()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ConstraintTerm#getSecurityConstraintSum <em>Security Constraint Sum</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getConstraintTerm_Function()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ConstraintTerm#getFunction <em>Function</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
