 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getInstCVal <em>Inst CVal</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getCVal <em>CVal</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getRange <em>Range</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getQ <em>Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getT <em>T</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#isSubEna <em>Sub Ena</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getSubCVal <em>Sub CVal</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getSubQ <em>Sub Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getSubID <em>Sub ID</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getDb <em>Db</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getZeroDb <em>Zero Db</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getRangeC <em>Range C</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getMagSVC <em>Mag SVC</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getAngSVC <em>Ang SVC</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getAngRef <em>Ang Ref</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.CMVImpl#getSmpRate <em>Smp Rate</em>}</li>
 * </ul>
 *
 * @generated
 */
