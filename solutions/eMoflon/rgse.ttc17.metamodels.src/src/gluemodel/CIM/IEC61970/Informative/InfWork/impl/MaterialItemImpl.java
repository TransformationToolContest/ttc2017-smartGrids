 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getErpPOLineItems <em>Erp PO Line Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getTypeMaterial <em>Type Material</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getErpInventoryCounts <em>Erp Inventory Counts</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getUsages <em>Usages</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getWorkCostDetail <em>Work Cost Detail</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getWorkTask <em>Work Task</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getCostDescription <em>Cost Description</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getCostType <em>Cost Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getExternalRefID <em>External Ref ID</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getErpRecDelvLineItems <em>Erp Rec Delv Line Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getDesignLocation <em>Design Location</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getActualCost <em>Actual Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.MaterialItemImpl#getMaterialCode <em>Material Code</em>}</li>
 * </ul>
 *
 * @generated
 */
