 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getExpirationDate <em>Expiration Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getApplicationNumber <em>Application Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getEffectiveDate <em>Effective Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getPermitID <em>Permit ID</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getPayment <em>Payment</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAccessPermit()
...
public interface AccessPermit extends Document {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAccessPermit_ExpirationDate()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getExpirationDate <em>Expiration Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAccessPermit_ApplicationNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getApplicationNumber <em>Application Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAccessPermit_EffectiveDate()
	 * @model dataType="gluemodel.CIM.IEC61970.Domain.AbsoluteDate" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getEffectiveDate <em>Effective Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAccessPermit_PermitID()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getPermitID <em>Permit ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAccessPermit_Payment()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.AccessPermit#getPayment <em>Payment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
