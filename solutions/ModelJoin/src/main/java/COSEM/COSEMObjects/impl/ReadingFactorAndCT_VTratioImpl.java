 ...
 * </p>
 * <ul>
 *   <li>{@link COSEM.COSEMObjects.impl.ReadingFactorAndCT_VTratioImpl#getReadingfactorforpower <em>Readingfactorforpower</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ReadingFactorAndCT_VTratioImpl#getReadingfactorforenergy <em>Readingfactorforenergy</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ReadingFactorAndCT_VTratioImpl#getTransformerratio_currentzaehler <em>Transformerratio currentzaehler</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ReadingFactorAndCT_VTratioImpl#getTransformerratio_voltagezaehler <em>Transformerratio voltagezaehler</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ReadingFactorAndCT_VTratioImpl#getOveralltransformerratiozaehler <em>Overalltransformerratiozaehler</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ReadingFactorAndCT_VTratioImpl#getTransformerratio_currentnenner <em>Transformerratio currentnenner</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ReadingFactorAndCT_VTratioImpl#getTransformerratio_voltagenenner <em>Transformerratio voltagenenner</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ReadingFactorAndCT_VTratioImpl#getOveralltransformer_rationenner <em>Overalltransformer rationenner</em>}</li>
 * </ul>
 *
 * @generated
 */
