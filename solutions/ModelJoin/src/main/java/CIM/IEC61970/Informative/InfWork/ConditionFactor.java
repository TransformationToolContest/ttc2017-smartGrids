 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getCfValue <em>Cf Value</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getDesignLocations <em>Design Locations</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getDesignLocationCUs <em>Design Location CUs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getKind <em>Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getDesigns <em>Designs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getStatus <em>Status</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getConditionFactor()
...
public interface ConditionFactor extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getConditionFactor_CfValue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getCfValue <em>Cf Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.DesignLocation#getConditionFactors <em>Condition Factors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getConditionFactor_DesignLocations()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.DesignLocationCU#getConditionFactors <em>Condition Factors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getConditionFactor_DesignLocationCUs()
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Informative.InfWork.ConditionFactorKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getConditionFactor_Kind()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.Design#getConditionFactors <em>Condition Factors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getConditionFactor_Designs()
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getConditionFactor_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.ConditionFactor#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
