...
import gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpInvoice;
import gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpInvoiceLineItem;
import gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpInvoiceLineItemKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getErpQuoteLineItem <em>Erp Quote Line Item</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getNetAmount <em>Net Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getErpPayableLineItem <em>Erp Payable Line Item</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getLineAmount <em>Line Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getErpRecLineItem <em>Erp Rec Line Item</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getSettlements <em>Settlements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getPreviousAmount <em>Previous Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getWorkBillingInfos <em>Work Billing Infos</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getMarketFactors <em>Market Factors</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getErpPayments <em>Erp Payments</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getGlDateTime <em>Gl Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getContainerErpInvoiceLineItem <em>Container Erp Invoice Line Item</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getErpRecDelvLineItem <em>Erp Rec Delv Line Item</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getGlAccount <em>Gl Account</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getBillPeriod <em>Bill Period</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getLineNumber <em>Line Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getUserAttributes <em>User Attributes</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getLineVersion <em>Line Version</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getErpInvoice <em>Erp Invoice</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getCustomerBillingInfos <em>Customer Billing Infos</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getComponentErpInvoiceLineItems <em>Component Erp Invoice Line Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceLineItemImpl#getErpJournalEntries <em>Erp Journal Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
