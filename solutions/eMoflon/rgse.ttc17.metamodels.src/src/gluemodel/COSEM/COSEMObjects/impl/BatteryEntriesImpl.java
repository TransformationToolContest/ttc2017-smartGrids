...
import gluemodel.COSEM.COSEMObjects.BatteryEntries;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getBattery_use_time_counter <em>Battery use time counter</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getBattery_charge_display <em>Battery charge display</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getDate_of_next_battery_change <em>Date of next battery change</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getBattery_voltage <em>Battery voltage</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getBattery_initial_capacity <em>Battery initial capacity</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getBattery_installation_date_and_time <em>Battery installation date and time</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getBattery_estimated_remaining_use_time <em>Battery estimated remaining use time</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getAux_supply_use_time_counter <em>Aux supply use time counter</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.BatteryEntriesImpl#getAux_voltage <em>Aux voltage</em>}</li>
 * </ul>
 *
 * @generated
 */
