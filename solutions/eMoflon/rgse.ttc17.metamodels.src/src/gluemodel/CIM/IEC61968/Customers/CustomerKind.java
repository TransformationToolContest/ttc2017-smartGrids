 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61968.Customers.CustomersPackage#getCustomerKind()
 * @model
 * @generated
 */
public enum CustomerKind implements Enumerator {
	 ...
	 * @ordered
	 */
	INTERNAL_USE(1, "internalUse", "internalUse"),
	 ...
	 * @ordered
	 */
	WIND_MACHINE(2, "windMachine", "windMachine"),
	 ...
	 * @ordered
	 */
	COMMERCIAL_INDUSTRIAL(3, "commercialIndustrial", "commercialIndustrial"),
	 ...
	 * @ordered
	 */
	ENERGY_SERVICE_SCHEDULER(4, "energyServiceScheduler", "energyServiceScheduler"),
	 ...
	 * @ordered
	 */
	RESIDENTIAL_STREETLIGHT_OTHERS(5, "residentialStreetlightOthers", "residentialStreetlightOthers"),
	 ...
	 * @ordered
	 */
	ENERGY_SERVICE_SUPPLIER(6, "energyServiceSupplier", "energyServiceSupplier"),
	 ...
	 * @ordered
	 */
	RESIDENTIAL_AND_STREETLIGHT(7, "residentialAndStreetlight", "residentialAndStreetlight"),
	 ...
	 * @ordered
	 */
	RESIDENTIAL_FARM_SERVICE(8, "residentialFarmService", "residentialFarmService"),
	 ...
	 * @ordered
	 */
	PUMPING_LOAD(9, "pumpingLoad", "pumpingLoad"),
	 ...
	 * @ordered
	 */
	RESIDENTIAL_AND_COMMERCIAL(10, "residentialAndCommercial", "residentialAndCommercial"),
	 ...
	 * @ordered
	 */
	public static final int INTERNAL_USE_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int WIND_MACHINE_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int COMMERCIAL_INDUSTRIAL_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int ENERGY_SERVICE_SCHEDULER_VALUE = 4;
	 ...
	 * @ordered
	 */
	public static final int RESIDENTIAL_STREETLIGHT_OTHERS_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int ENERGY_SERVICE_SUPPLIER_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int RESIDENTIAL_AND_STREETLIGHT_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int RESIDENTIAL_FARM_SERVICE_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int PUMPING_LOAD_VALUE = 9;
	 ...
	 * @ordered
	 */
	public static final int RESIDENTIAL_AND_COMMERCIAL_VALUE = 10;
