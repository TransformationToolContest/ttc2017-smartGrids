 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getBankStatements <em>Bank Statements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getMerchantAgreement <em>Merchant Agreement</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getTransactors <em>Transactors</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getProvisionalBalance <em>Provisional Balance</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getCurrentBalance <em>Current Balance</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getVendors <em>Vendors</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getVendorShifts <em>Vendor Shifts</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAccount()
...
public interface MerchantAccount extends Document {
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.BankStatement#getMerchantAccount <em>Merchant Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAccount_BankStatements()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAgreement#getMerchantAccounts <em>Merchant Accounts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAccount_MerchantAgreement()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getMerchantAgreement <em>Merchant Agreement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61968.PaymentMetering.Transactor}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.Transactor#getMerchantAccounts <em>Merchant Accounts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAccount_Transactors()
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAccount_ProvisionalBalance()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getProvisionalBalance <em>Provisional Balance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAccount_CurrentBalance()
	 * @model dataType="gluemodel.CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getCurrentBalance <em>Current Balance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61968.PaymentMetering.Vendor}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.Vendor#getMerchantAccount <em>Merchant Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAccount_Vendors()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getMerchantAccount <em>Merchant Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getMerchantAccount_VendorShifts()
