...
import COSEM.COSEMObjects.COSEMObjectsFactory;
...
public class COSEMObjectsPackageImpl extends EPackageImpl implements COSEMObjectsPackage {
	 ...
	 * @see COSEM.COSEMObjects.COSEMObjectsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("COSEM.COSEMObjects." + eClassifier.getName());
