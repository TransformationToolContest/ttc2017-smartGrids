...
import gluemodel.CIM.IEC61970.Generation.Production.ProductionFactory;
...
public class ProductionPackageImpl extends EPackageImpl implements ProductionPackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.Generation.Production.ProductionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Generation.Production." + eClassifier.getName());
