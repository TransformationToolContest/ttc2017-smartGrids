 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getDesignLocation <em>Design Location</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getWorkTask <em>Work Task</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getCostPerUnit <em>Cost Per Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getWorkCostDetail <em>Work Cost Detail</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getExternalRefID <em>External Ref ID</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.MiscCostItemImpl#getCostType <em>Cost Type</em>}</li>
 * </ul>
 *
 * @generated
 */
