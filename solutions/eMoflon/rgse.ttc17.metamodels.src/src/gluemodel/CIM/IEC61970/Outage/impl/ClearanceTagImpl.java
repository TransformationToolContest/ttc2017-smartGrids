...
import gluemodel.CIM.IEC61970.Outage.ClearanceTagType;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#isGroundReqFlag <em>Ground Req Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#getSafetyDocument <em>Safety Document</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#getTagIssueTime <em>Tag Issue Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#getClearanceTagType <em>Clearance Tag Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#getWorkEndTime <em>Work End Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#getAuthorityName <em>Authority Name</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#getConductingEquipment <em>Conducting Equipment</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#isPhaseCheckReqFlag <em>Phase Check Req Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#isDeenergizeReqFlag <em>Deenergize Req Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#getWorkStartTime <em>Work Start Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Outage.impl.ClearanceTagImpl#getWorkDescription <em>Work Description</em>}</li>
 * </ul>
 *
 * @generated
 */
