 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61970.Generation.GenerationDynamics.GenerationDynamicsPackage#getBoilerControlMode()
 * @model
 * @generated
 */
public enum BoilerControlMode implements Enumerator {
	 ...
	 * @ordered
	 */
	COORDINATED(0, "coordinated", "coordinated"),
	 ...
	 * @ordered
	 */
	public static final int COORDINATED_VALUE = 0;
