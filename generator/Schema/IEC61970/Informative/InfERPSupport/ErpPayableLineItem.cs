...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfERPSupport
{
    ...
    public class ErpPayableLineItem : IdentifiedObject, IErpPayableLineItem, IModelElement
    {
        ...
        public virtual IErpPayable ErpPayable
        {
            ...
            set
            {
                if ((this._erpPayable != value))
                {
                    ...
                    this.OnPropertyChanging("ErpPayable", e);
                    ...
                    this.OnPropertyChanged("ErpPayable", e);
                }
            }
        }
        ...
        private sealed class ErpPayableProxy : ModelPropertyChange<IErpPayableLineItem, IErpPayable>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.ErpPayableChanged += handler;
            }
