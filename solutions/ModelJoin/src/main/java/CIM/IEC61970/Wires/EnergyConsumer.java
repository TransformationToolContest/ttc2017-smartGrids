...
import CIM.IEC61970.LoadModel.LoadResponseCharacteristic;
import CIM.IEC61970.LoadModel.PowerCutZone;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.EnergyConsumer#getServiceDeliveryPoints <em>Service Delivery Points</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.EnergyConsumer#getPowerCutZone <em>Power Cut Zone</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.EnergyConsumer#getPfixed <em>Pfixed</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.EnergyConsumer#getQfixedPct <em>Qfixed Pct</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.EnergyConsumer#getCustomerCount <em>Customer Count</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.EnergyConsumer#getLoadResponse <em>Load Response</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.EnergyConsumer#getPfixedPct <em>Pfixed Pct</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.EnergyConsumer#getQfixed <em>Qfixed</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer()
...
public interface EnergyConsumer extends ConductingEquipment {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.ServiceDeliveryPoint#getEnergyConsumer <em>Energy Consumer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer_ServiceDeliveryPoints()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.LoadModel.PowerCutZone#getEnergyConsumers <em>Energy Consumers</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer_PowerCutZone()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.EnergyConsumer#getPowerCutZone <em>Power Cut Zone</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPfixed(float)
	 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer_Pfixed()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.EnergyConsumer#getPfixed <em>Pfixed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer_QfixedPct()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.EnergyConsumer#getQfixedPct <em>Qfixed Pct</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer_CustomerCount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.EnergyConsumer#getCustomerCount <em>Customer Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.LoadModel.LoadResponseCharacteristic#getEnergyConsumer <em>Energy Consumer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer_LoadResponse()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.EnergyConsumer#getLoadResponse <em>Load Response</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer_PfixedPct()
	 * @model dataType="CIM.IEC61970.Domain.PerCent" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.EnergyConsumer#getPfixedPct <em>Pfixed Pct</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setQfixed(float)
	 * @see CIM.IEC61970.Wires.WiresPackage#getEnergyConsumer_Qfixed()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.EnergyConsumer#getQfixed <em>Qfixed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
