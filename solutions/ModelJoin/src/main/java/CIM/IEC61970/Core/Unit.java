 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.Unit#getControls <em>Controls</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Unit#getProtectionEquipments <em>Protection Equipments</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Unit#getMeasurements <em>Measurements</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getUnit()
...
public interface Unit extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.Control#getUnit <em>Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getUnit_Controls()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Protection.ProtectionEquipment#getUnit <em>Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getUnit_ProtectionEquipments()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.Measurement#getUnit <em>Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getUnit_Measurements()
