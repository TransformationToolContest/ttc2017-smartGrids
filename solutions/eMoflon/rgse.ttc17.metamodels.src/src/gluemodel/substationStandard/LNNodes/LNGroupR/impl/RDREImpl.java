...
import gluemodel.substationStandard.LNNodes.LNGroupR.RDRE;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getOpCntRs <em>Op Cnt Rs</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getRcdTrg <em>Rcd Trg</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getMemRs <em>Mem Rs</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getMemClr <em>Mem Clr</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getRcdMade <em>Rcd Made</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getFltNum <em>Flt Num</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getGriFltNum <em>Gri Flt Num</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getRcdStr <em>Rcd Str</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getMemUsed <em>Mem Used</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getTrgMod <em>Trg Mod</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getLevMod <em>Lev Mod</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getPreTmms <em>Pre Tmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getPstTmms <em>Pst Tmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getMemFull <em>Mem Full</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getMaxNumRcd <em>Max Num Rcd</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getReTrgMod <em>Re Trg Mod</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getPerTrgTms <em>Per Trg Tms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getExclTmms <em>Excl Tmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RDREImpl#getOpMod <em>Op Mod</em>}</li>
 * </ul>
 *
 * @generated
 */
