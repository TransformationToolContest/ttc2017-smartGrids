...
import gluemodel.CIM.IEC61970.Informative.InfTypeAsset.InfTypeAssetFactory;
 ...
 * @generated
 */
public class InfTypeAssetPackageImpl extends EPackageImpl implements InfTypeAssetPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass electricalTypeAssetEClass = null;
	 ...
	 * @generated
	 */
	private EClass typeAssetEClass = null;
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfTypeAsset.InfTypeAssetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InfTypeAssetPackageImpl() {
		super(eNS_URI, InfTypeAssetFactory.eINSTANCE);
	}
	...
	public static InfTypeAssetPackage init() {
		...
		InfTypeAssetPackageImpl theInfTypeAssetPackage = (InfTypeAssetPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InfTypeAssetPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InfTypeAssetPackageImpl());
	 ...
	 * @generated
	 */
	public EClass getElectricalTypeAsset() {
		if (electricalTypeAssetEClass == null) {
			electricalTypeAssetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfTypeAssetPackage.eNS_URI).getEClassifiers().get(1);
		}
		return electricalTypeAssetEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getElectricalTypeAsset_ElectricalInfos() {
        return (EReference)getElectricalTypeAsset().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getTypeAsset() {
		if (typeAssetEClass == null) {
			typeAssetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfTypeAssetPackage.eNS_URI).getEClassifiers().get(2);
		}
		return typeAssetEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getTypeAsset_TypeAssetCatalogue() {
        return (EReference)getTypeAsset().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTypeAsset_ErpBomItemDatas() {
        return (EReference)getTypeAsset().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getTypeAsset_AssetInfo() {
        return (EReference)getTypeAsset().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTypeAsset_StockItem() {
        return (EAttribute)getTypeAsset().getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getTypeAsset_ErpReqLineItems() {
        return (EReference)getTypeAsset().getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getTypeAsset_ErpInventoryIssues() {
        return (EReference)getTypeAsset().getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTypeAsset_EstimatedUnitCost() {
        return (EAttribute)getTypeAsset().getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getTypeAsset_CUWorkEquipmentAsset() {
        return (EReference)getTypeAsset().getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EReference getTypeAsset_AssetModels() {
        return (EReference)getTypeAsset().getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getTypeAsset_CUAsset() {
        return (EReference)getTypeAsset().getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTypeAsset_Quantity() {
        return (EAttribute)getTypeAsset().getEStructuralFeatures().get(10);
	}
	...
	public EClass getGeneratorTypeAsset() {
		if (generatorTypeAssetEClass == null) {
			generatorTypeAssetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfTypeAssetPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.InfTypeAsset." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //InfTypeAssetPackageImpl
