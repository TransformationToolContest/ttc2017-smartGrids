 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.SPC#isCtlVal <em>Ctl Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.SPC#isStVal <em>St Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.SPC#getQ <em>Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.SPC#getT <em>T</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.SPC#isSubVal <em>Sub Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.SPC#getPulseConfig <em>Pulse Config</em>}</li>
 * </ul>
 *
 * @see substationStandard.Dataclasses.DataclassesPackage#getSPC()
 * @model
 * @generated
 */
public interface SPC extends EObject {
	 ...
	 * @see substationStandard.Dataclasses.DataclassesPackage#getSPC_CtlVal()
	 * @model
	 * @generated
	 */
	boolean isCtlVal();
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.SPC#isCtlVal <em>Ctl Val</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see substationStandard.Dataclasses.DataclassesPackage#getSPC_StVal()
	 * @model
	 * @generated
	 */
	boolean isStVal();
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.SPC#isStVal <em>St Val</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setQ(Quality)
	 * @see substationStandard.Dataclasses.DataclassesPackage#getSPC_Q()
	 * @model required="true"
	 * @generated
	 */
	Quality getQ();
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.SPC#getQ <em>Q</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setT(TimeStamp)
	 * @see substationStandard.Dataclasses.DataclassesPackage#getSPC_T()
	 * @model required="true"
	 * @generated
	 */
	TimeStamp getT();
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.SPC#getT <em>T</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see substationStandard.Dataclasses.DataclassesPackage#getSPC_SubVal()
	 * @model
	 * @generated
	 */
	boolean isSubVal();
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.SPC#isSubVal <em>Sub Val</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see substationStandard.Dataclasses.DataclassesPackage#getSPC_PulseConfig()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.SPC#getPulseConfig <em>Pulse Config</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
