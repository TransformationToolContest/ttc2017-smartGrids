...
import gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpAccountKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getTransactionDateTime <em>Transaction Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getErpJounalEntry <em>Erp Jounal Entry</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getErpLedgerEntry <em>Erp Ledger Entry</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getUserAttributes <em>User Attributes</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getSettlements <em>Settlements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getPostedDateTime <em>Posted Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getAccountKind <em>Account Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpLedgerEntryImpl#getErpLedger <em>Erp Ledger</em>}</li>
 * </ul>
 *
 * @generated
 */
