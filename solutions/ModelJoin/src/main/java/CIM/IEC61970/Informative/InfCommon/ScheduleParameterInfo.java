...
import CIM.IEC61970.Informative.InfWork.InspectionDataSet;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getScheduledEvents <em>Scheduled Events</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getRequestedWindow <em>Requested Window</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getForInspectionDataSet <em>For Inspection Data Set</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getEstimatedWindow <em>Estimated Window</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getDocuments <em>Documents</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getStatus <em>Status</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getScheduleParameterInfo()
...
public interface ScheduleParameterInfo extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfCommon.ScheduledEvent#getScheduleParameterInfo <em>Schedule Parameter Info</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getScheduleParameterInfo_ScheduledEvents()
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getScheduleParameterInfo_RequestedWindow()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getRequestedWindow <em>Requested Window</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.InspectionDataSet#getAccordingToSchedules <em>According To Schedules</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getScheduleParameterInfo_ForInspectionDataSet()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getForInspectionDataSet <em>For Inspection Data Set</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getScheduleParameterInfo_EstimatedWindow()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getEstimatedWindow <em>Estimated Window</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Common.Document#getScheduleParameterInfos <em>Schedule Parameter Infos</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getScheduleParameterInfo_Documents()
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getScheduleParameterInfo_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.ScheduleParameterInfo#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
