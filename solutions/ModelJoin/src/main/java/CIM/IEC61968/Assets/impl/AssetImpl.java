 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getAssetPropertyCurves <em>Asset Property Curves</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getSerialNumber <em>Serial Number</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getFinancialInfo <em>Financial Info</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getFromAssetRoles <em>From Asset Roles</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getActivityRecords <em>Activity Records</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getDocumentRoles <em>Document Roles</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getAssetContainer <em>Asset Container</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#isCritical <em>Critical</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getErpInventory <em>Erp Inventory</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getReliabilityInfos <em>Reliability Infos</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getManufacturedDate <em>Manufactured Date</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getWorkTask <em>Work Task</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getLotNumber <em>Lot Number</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getElectronicAddress <em>Electronic Address</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getScheduledEvents <em>Scheduled Events</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getChangeItems <em>Change Items</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getInitialLossOfLife <em>Initial Loss Of Life</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getAssetFunctions <em>Asset Functions</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getInitialCondition <em>Initial Condition</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getUtcNumber <em>Utc Number</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getInstallationDate <em>Installation Date</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getErpOrganisationRoles <em>Erp Organisation Roles</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getRatings <em>Ratings</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getMediums <em>Mediums</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getAssetInfo <em>Asset Info</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getCorporateCode <em>Corporate Code</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getPurchasePrice <em>Purchase Price</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getToAssetRoles <em>To Asset Roles</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getPowerSystemResources <em>Power System Resources</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getErpItemMaster <em>Erp Item Master</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getAcceptanceTest <em>Acceptance Test</em>}</li>
 *   <li>{@link CIM.IEC61968.Assets.impl.AssetImpl#getErpRecDeliveryItems <em>Erp Rec Delivery Items</em>}</li>
 * </ul>
 *
 * @generated
 */
