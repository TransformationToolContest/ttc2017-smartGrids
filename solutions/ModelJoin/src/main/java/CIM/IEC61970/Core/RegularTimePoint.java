 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.RegularTimePoint#getIntervalSchedule <em>Interval Schedule</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.RegularTimePoint#getValue1 <em>Value1</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.RegularTimePoint#getValue2 <em>Value2</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.RegularTimePoint#getSequenceNumber <em>Sequence Number</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getRegularTimePoint()
...
public interface RegularTimePoint extends Element {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.RegularIntervalSchedule#getTimePoints <em>Time Points</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getRegularTimePoint_IntervalSchedule()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.RegularTimePoint#getIntervalSchedule <em>Interval Schedule</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setValue1(float)
	 * @see CIM.IEC61970.Core.CorePackage#getRegularTimePoint_Value1()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.RegularTimePoint#getValue1 <em>Value1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setValue2(float)
	 * @see CIM.IEC61970.Core.CorePackage#getRegularTimePoint_Value2()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.RegularTimePoint#getValue2 <em>Value2</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getRegularTimePoint_SequenceNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.RegularTimePoint#getSequenceNumber <em>Sequence Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
