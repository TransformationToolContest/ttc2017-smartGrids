 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementMethodsImpl#getAlgorithm_for_active_power_measurement <em>Algorithm for active power measurement</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementMethodsImpl#getAlgorithm_for_active_energy_management <em>Algorithm for active energy management</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementMethodsImpl#getAlgorithm_for_reactive_power_measurement <em>Algorithm for reactive power measurement</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementMethodsImpl#getAlgorithm_for_reactive_energy_measurement <em>Algorithm for reactive energy measurement</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementMethodsImpl#getAlgorithm_for_apparent_power_measurement <em>Algorithm for apparent power measurement</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementMethodsImpl#getAlgorithm_for_apparent_energy_measurement <em>Algorithm for apparent energy measurement</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementMethodsImpl#getAlgorithm_for_power_factor_calculation <em>Algorithm for power factor calculation</em>}</li>
 * </ul>
 *
 * @generated
 */
