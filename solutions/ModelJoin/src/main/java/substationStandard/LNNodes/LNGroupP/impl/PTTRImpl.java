...
import substationStandard.LNNodes.LNGroupP.PTTR;
 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getAmp <em>Amp</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getTmp <em>Tmp</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getTmpRl <em>Tmp Rl</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getLodRsvAlm <em>Lod Rsv Alm</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getLodRsvTr <em>Lod Rsv Tr</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getAgeRat <em>Age Rat</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getStr <em>Str</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getOp <em>Op</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getAlmThm <em>Alm Thm</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getTmTmpSt <em>Tm Tmp St</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getTmASt <em>Tm ASt</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getTmTmpCrv <em>Tm Tmp Crv</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getTmACrv <em>Tm ACrv</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getTmpMax <em>Tmp Max</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getStrVal <em>Str Val</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getOpDlTmms <em>Op Dl Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getMinOpTmms <em>Min Op Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getMaxOpTmms <em>Max Op Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getRsDlTmms <em>Rs Dl Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getConsTms <em>Cons Tms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTTRImpl#getAlmVal <em>Alm Val</em>}</li>
 * </ul>
 *
 * @generated
 */
