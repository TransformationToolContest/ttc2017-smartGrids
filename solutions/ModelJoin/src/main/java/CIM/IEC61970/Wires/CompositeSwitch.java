 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.CompositeSwitch#getCompositeSwitchType <em>Composite Switch Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.CompositeSwitch#getSwitches <em>Switches</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Wires.WiresPackage#getCompositeSwitch()
...
public interface CompositeSwitch extends Equipment {
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getCompositeSwitch_CompositeSwitchType()
	 * @model dataType="CIM.IEC61970.Wires.CompositeSwitchType" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.CompositeSwitch#getCompositeSwitchType <em>Composite Switch Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.Switch#getCompositeSwitch <em>Composite Switch</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getCompositeSwitch_Switches()
