 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getCost <em>Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getActivityCode <em>Activity Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getErpPayables <em>Erp Payables</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getWorkCostDetail <em>Work Cost Detail</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getWorkTask <em>Work Task</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getBidAmount <em>Bid Amount</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getContractorItem()
...
public interface ContractorItem extends IdentifiedObject {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getContractorItem_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCost(float)
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getContractorItem_Cost()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getCost <em>Cost</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getContractorItem_ActivityCode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getActivityCode <em>Activity Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpPayable}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpPayable#getContractorItems <em>Contractor Items</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getContractorItem_ErpPayables()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkCostDetail#getContractorItems <em>Contractor Items</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getContractorItem_WorkCostDetail()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getWorkCostDetail <em>Work Cost Detail</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkTask#getContractorItems <em>Contractor Items</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getContractorItem_WorkTask()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getWorkTask <em>Work Task</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getContractorItem_BidAmount()
	 * @model dataType="gluemodel.CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem#getBidAmount <em>Bid Amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
