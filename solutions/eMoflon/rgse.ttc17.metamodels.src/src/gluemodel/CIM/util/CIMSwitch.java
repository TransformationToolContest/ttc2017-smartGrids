/**
 */
package gluemodel.CIM.util;

import gluemodel.CIM.CIMPackage;
import gluemodel.CIM.CIMRoot;
import gluemodel.CIM.CombinedVersion;
import gluemodel.CIM.Element;
import gluemodel.CIM.Stereotype;
...
public class CIMSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CIMPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CIMPackage.CIM_ROOT: {
				CIMRoot cimRoot = (CIMRoot)theEObject;
				T result = caseCIMRoot(cimRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CIMPackage.STEREOTYPE: {
			...
			case CIMPackage.PACKAGE: {
				gluemodel.CIM.Package package_ = (gluemodel.CIM.Package)theEObject;
	 ...
	 * @generated
	 */
	public T caseCIMRoot(CIMRoot object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePackage(gluemodel.CIM.Package object) {
		return null;
	}
