 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupZ.ZCAP#getOpTmh <em>Op Tmh</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupZ.ZCAP#getCapDS <em>Cap DS</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupZ.ZCAP#getDschBlk <em>Dsch Blk</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupZ.ZCAP#getCapControl <em>Cap Control</em>}</li>
 * </ul>
 *
 * @see gluemodel.substationStandard.LNNodes.LNGroupZ.LNGroupZPackage#getZCAP()
 * @model
 * @generated
 */
public interface ZCAP extends GroupZ {
	 ...
	 * @see #setOpTmh(INS)
	 * @see gluemodel.substationStandard.LNNodes.LNGroupZ.LNGroupZPackage#getZCAP_OpTmh()
	 * @model required="true"
	 * @generated
	 */
	INS getOpTmh();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupZ.ZCAP#getOpTmh <em>Op Tmh</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCapDS(SPC)
	 * @see gluemodel.substationStandard.LNNodes.LNGroupZ.LNGroupZPackage#getZCAP_CapDS()
	 * @model required="true"
	 * @generated
	 */
	SPC getCapDS();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupZ.ZCAP#getCapDS <em>Cap DS</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setDschBlk(SPS)
	 * @see gluemodel.substationStandard.LNNodes.LNGroupZ.LNGroupZPackage#getZCAP_DschBlk()
	 * @model required="true"
	 * @generated
	 */
	SPS getDschBlk();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupZ.ZCAP#getDschBlk <em>Dsch Blk</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.substationStandard.LNNodes.LNGroupZ.LNGroupZPackage#getZCAP_CapControl()
	 * @model
	 * @generated
	 */
	ARCO getCapControl();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.LNGroupZ.ZCAP#getCapControl <em>Cap Control</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
