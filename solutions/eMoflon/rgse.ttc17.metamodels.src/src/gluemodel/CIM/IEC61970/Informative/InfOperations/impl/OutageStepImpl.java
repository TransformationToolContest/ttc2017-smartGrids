 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#isInjury <em>Injury</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getOutageCodes <em>Outage Codes</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getCrews <em>Crews</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getSpecialCustomerCount <em>Special Customer Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getEstimatedRestoreDateTime <em>Estimated Restore Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#isFatality <em>Fatality</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getCallerCount <em>Caller Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#isDamage <em>Damage</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getJobPriority <em>Job Priority</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#isShockReported <em>Shock Reported</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getAverageCml <em>Average Cml</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getTotalCml <em>Total Cml</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getTotalCustomerCount <em>Total Customer Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getCriticalCustomerCount <em>Critical Customer Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getNoPowerInterval <em>No Power Interval</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getConductingEquipmentRoles <em>Conducting Equipment Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.OutageStepImpl#getOutageRecord <em>Outage Record</em>}</li>
 * </ul>
 *
 * @generated
 */
