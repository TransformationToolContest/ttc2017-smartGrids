 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Meas.Control#isOperationInProgress <em>Operation In Progress</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Control#getRegulatingCondEq <em>Regulating Cond Eq</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Control#getControlType <em>Control Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Control#getUnit <em>Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Control#getTimeStamp <em>Time Stamp</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Control#getRemoteControl <em>Remote Control</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Meas.MeasPackage#getControl()
...
public interface Control extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getControl_OperationInProgress()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Control#isOperationInProgress <em>Operation In Progress</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.RegulatingCondEq#getControls <em>Controls</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getControl_RegulatingCondEq()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Control#getRegulatingCondEq <em>Regulating Cond Eq</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.ControlType#getControls <em>Controls</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getControl_ControlType()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Control#getControlType <em>Control Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.Unit#getControls <em>Controls</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setUnit(Unit)
	 * @see CIM.IEC61970.Meas.MeasPackage#getControl_Unit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Control#getUnit <em>Unit</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getControl_TimeStamp()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Control#getTimeStamp <em>Time Stamp</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.SCADA.RemoteControl#getControl <em>Control</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getControl_RemoteControl()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Control#getRemoteControl <em>Remote Control</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
