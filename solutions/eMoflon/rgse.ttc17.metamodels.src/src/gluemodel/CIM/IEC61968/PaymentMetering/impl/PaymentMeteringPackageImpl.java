...
import gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringFactory;
...
public class PaymentMeteringPackageImpl extends EPackageImpl implements PaymentMeteringPackage {
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61968.PaymentMetering." + eClassifier.getName());
