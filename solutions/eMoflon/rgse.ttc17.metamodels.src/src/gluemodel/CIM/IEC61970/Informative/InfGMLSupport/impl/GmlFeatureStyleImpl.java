...
import gluemodel.CIM.IEC61970.Informative.InfGMLSupport.GmlFeatureType;
...
import gluemodel.CIM.IEC61970.Informative.InfGMLSupport.QueryGrammarKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getFeatureConstraint <em>Feature Constraint</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getGmlSymbols <em>Gml Symbols</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getSemanticTypeIdentifier <em>Semantic Type Identifier</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getGmlLabelStyles <em>Gml Label Styles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getGmlGeometryStyles <em>Gml Geometry Styles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getFeatureTypeName <em>Feature Type Name</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getQueryGrammar <em>Query Grammar</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getFeatureType <em>Feature Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getBaseType <em>Base Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getGmlFeatureTypes <em>Gml Feature Types</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfGMLSupport.impl.GmlFeatureStyleImpl#getGmlTobologyStyles <em>Gml Tobology Styles</em>}</li>
 * </ul>
 *
 * @generated
 */
