...
import substationStandard.LNNodes.LNGroupR.RREC;
 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getOpCntRs <em>Op Cnt Rs</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getBlkRec <em>Blk Rec</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getChkRec <em>Chk Rec</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getAuto <em>Auto</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getOp <em>Op</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getAutoRecSt <em>Auto Rec St</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getRec1Tmms <em>Rec1 Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getRec2Tmms <em>Rec2 Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getRec3Tmms <em>Rec3 Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getPlsTmms <em>Pls Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupR.impl.RRECImpl#getRclTmms <em>Rcl Tmms</em>}</li>
 * </ul>
 *
 * @generated
 */
