 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.Switch#isRetained <em>Retained</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.Switch#getSwitchOnDate <em>Switch On Date</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.Switch#getLoadMgmtFunctions <em>Load Mgmt Functions</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.Switch#getConnectDisconnectFunctions <em>Connect Disconnect Functions</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.Switch#isNormalOpen <em>Normal Open</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.Switch#getSwitchingOperations <em>Switching Operations</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.Switch#getSwitchSchedules <em>Switch Schedules</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.Switch#getSwitchOnCount <em>Switch On Count</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.Switch#getCompositeSwitch <em>Composite Switch</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch()
...
public interface Switch extends ConductingEquipment {
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_Retained()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.Switch#isRetained <em>Retained</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_SwitchOnDate()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.Switch#getSwitchOnDate <em>Switch On Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Informative.InfLoadControl.LoadMgmtFunction}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfLoadControl.LoadMgmtFunction#getSwitches <em>Switches</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_LoadMgmtFunctions()
	 ...
	 * The list contents are of type {@link CIM.IEC61968.LoadControl.ConnectDisconnectFunction}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.LoadControl.ConnectDisconnectFunction#getSwitches <em>Switches</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_ConnectDisconnectFunctions()
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_NormalOpen()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.Switch#isNormalOpen <em>Normal Open</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Outage.SwitchingOperation#getSwitches <em>Switches</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_SwitchingOperations()
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Wires.SwitchSchedule}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.SwitchSchedule#getSwitch <em>Switch</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_SwitchSchedules()
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_SwitchOnCount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.Switch#getSwitchOnCount <em>Switch On Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.CompositeSwitch#getSwitches <em>Switches</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getSwitch_CompositeSwitch()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.Switch#getCompositeSwitch <em>Composite Switch</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
