 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getSupplierKind()
 * @model
 * @generated
 */
public enum SupplierKind implements Enumerator {
	 ...
	 * @ordered
	 */
	public static final int RETAILER_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int UTILITY_VALUE = 1;
