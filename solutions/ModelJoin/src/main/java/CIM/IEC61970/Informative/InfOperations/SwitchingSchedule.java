 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.SwitchingSchedule#getWorkTask <em>Work Task</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.SwitchingSchedule#getScheduleSteps <em>Schedule Steps</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.SwitchingSchedule#getInterval <em>Interval</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.SwitchingSchedule#getCrews <em>Crews</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.SwitchingSchedule#getReason <em>Reason</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getSwitchingSchedule()
...
public interface SwitchingSchedule extends Document {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.WorkTask#getSwitchingSchedules <em>Switching Schedules</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getSwitchingSchedule_WorkTask()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.SwitchingSchedule#getWorkTask <em>Work Task</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfOperations.SwitchingStep#getSwitchingSchedule <em>Switching Schedule</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getSwitchingSchedule_ScheduleSteps()
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getSwitchingSchedule_Interval()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.SwitchingSchedule#getInterval <em>Interval</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.Crew#getSwitchingSchedules <em>Switching Schedules</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getSwitchingSchedule_Crews()
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getSwitchingSchedule_Reason()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.SwitchingSchedule#getReason <em>Reason</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
