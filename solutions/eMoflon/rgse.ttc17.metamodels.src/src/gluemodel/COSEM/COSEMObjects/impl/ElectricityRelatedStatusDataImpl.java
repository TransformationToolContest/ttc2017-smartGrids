 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityRelatedStatusDataImpl#getStatus_information_missing_voltage <em>Status information missing voltage</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityRelatedStatusDataImpl#getStatus_information_missing_current <em>Status information missing current</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityRelatedStatusDataImpl#getStatus_information_current_without_voltage <em>Status information current without voltage</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityRelatedStatusDataImpl#getStatus_information_auxiliary_power_supply <em>Status information auxiliary power supply</em>}</li>
 * </ul>
 *
 * @generated
 */
