 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.OperationalLimits.ActivePowerLimit#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.OperationalLimits.OperationalLimitsPackage#getActivePowerLimit()
...
public interface ActivePowerLimit extends OperationalLimit {
	 ...
	 * @see #setValue(float)
	 * @see CIM.IEC61970.OperationalLimits.OperationalLimitsPackage#getActivePowerLimit_Value()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.OperationalLimits.ActivePowerLimit#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
