...
namespace TTC2017.SmartGrids.OutageDetectionJointarget
{
    ...
    public partial class PositionPoint : ModelElement, IPositionPoint, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.SmartGrids.OutageDetectionJointarget.PositionPoint.ClassInstance)).Resolve("xPosition")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.SmartGrids.OutageDetectionJointarget.PositionPoint.ClassInstance)).Resolve("yPosition")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.SmartGrids.OutageDetectionJointarget.PositionPoint.ClassInstance)).Resolve("zPosition")));
        }
