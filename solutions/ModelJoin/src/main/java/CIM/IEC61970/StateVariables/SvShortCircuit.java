 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.StateVariables.SvShortCircuit#getR0PerR <em>R0 Per R</em>}</li>
 *   <li>{@link CIM.IEC61970.StateVariables.SvShortCircuit#getSShortCircuit <em>SShort Circuit</em>}</li>
 *   <li>{@link CIM.IEC61970.StateVariables.SvShortCircuit#getXPerR <em>XPer R</em>}</li>
 *   <li>{@link CIM.IEC61970.StateVariables.SvShortCircuit#getTopologicalNode <em>Topological Node</em>}</li>
 *   <li>{@link CIM.IEC61970.StateVariables.SvShortCircuit#getX0PerX <em>X0 Per X</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.StateVariables.StateVariablesPackage#getSvShortCircuit()
...
public interface SvShortCircuit extends StateVariable {
	 ...
	 * @see #setR0PerR(float)
	 * @see CIM.IEC61970.StateVariables.StateVariablesPackage#getSvShortCircuit_R0PerR()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.StateVariables.SvShortCircuit#getR0PerR <em>R0 Per R</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.StateVariables.StateVariablesPackage#getSvShortCircuit_SShortCircuit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.StateVariables.SvShortCircuit#getSShortCircuit <em>SShort Circuit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setXPerR(float)
	 * @see CIM.IEC61970.StateVariables.StateVariablesPackage#getSvShortCircuit_XPerR()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.StateVariables.SvShortCircuit#getXPerR <em>XPer R</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Topology.TopologicalNode#getSvShortCircuit <em>Sv Short Circuit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.StateVariables.StateVariablesPackage#getSvShortCircuit_TopologicalNode()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.StateVariables.SvShortCircuit#getTopologicalNode <em>Topological Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setX0PerX(float)
	 * @see CIM.IEC61970.StateVariables.StateVariablesPackage#getSvShortCircuit_X0PerX()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.StateVariables.SvShortCircuit#getX0PerX <em>X0 Per X</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
