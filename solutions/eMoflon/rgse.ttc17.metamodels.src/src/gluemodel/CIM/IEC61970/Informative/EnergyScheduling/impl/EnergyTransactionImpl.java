 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getEnergyPriceCurves <em>Energy Price Curves</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getEnergyTransId <em>Energy Trans Id</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getState <em>State</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#isFirmInterchangeFlag <em>Firm Interchange Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getEnergyProduct <em>Energy Product</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getDeliveryPointP <em>Delivery Point P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getExport_SubControlArea <em>Export Sub Control Area</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getImport_SubControlArea <em>Import Sub Control Area</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getReceiptPointP <em>Receipt Point P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getCongestChargeMax <em>Congest Charge Max</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getEnergyProfiles <em>Energy Profiles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getCurtailmentProfiles <em>Curtailment Profiles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getLossProfiles <em>Loss Profiles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getEnergyMin <em>Energy Min</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.EnergyTransactionImpl#getReason <em>Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
