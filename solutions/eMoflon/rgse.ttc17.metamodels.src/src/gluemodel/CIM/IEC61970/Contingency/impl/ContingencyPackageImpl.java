...
import gluemodel.CIM.IEC61970.Contingency.ContingencyFactory;
 ...
 * @generated
 */
public class ContingencyPackageImpl extends EPackageImpl implements ContingencyPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gluemodel.CIM.IEC61970.Contingency.ContingencyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ContingencyPackageImpl() {
		super(eNS_URI, ContingencyFactory.eINSTANCE);
	}
	...
	public static ContingencyPackage init() {
		...
		ContingencyPackageImpl theContingencyPackage = (ContingencyPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ContingencyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ContingencyPackageImpl());
	...
	public EClass getContingency() {
		if (contingencyEClass == null) {
			contingencyEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(ContingencyPackage.eNS_URI).getEClassifiers().get(0);
		}
	 ...
	 * @generated
	 */
	public EReference getContingency_ContingencyConstraintLimit() {
        return (EReference)getContingency().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getContingency_MustStudy() {
        return (EAttribute)getContingency().getEStructuralFeatures().get(1);
	}
	...
	public EReference getContingency_ContingencyElement() {
        return (EReference)getContingency().getEStructuralFeatures().get(2);
	}
	...
	public EClass getContingencyEquipment() {
		if (contingencyEquipmentEClass == null) {
			contingencyEquipmentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(ContingencyPackage.eNS_URI).getEClassifiers().get(2);
		}
	...
	public EReference getContingencyEquipment_Equipment() {
        return (EReference)getContingencyEquipment().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getContingencyEquipment_ContingentStatus() {
        return (EAttribute)getContingencyEquipment().getEStructuralFeatures().get(1);
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Contingency." + eClassifier.getName());
