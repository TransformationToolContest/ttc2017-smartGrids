 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getIntervalLength <em>Interval Length</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getDynamicConfiguration <em>Dynamic Configuration</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getDefaultQuality <em>Default Quality</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getRegister <em>Register</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getIntervalBlocks <em>Interval Blocks</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getReadings <em>Readings</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getChannelNumber <em>Channel Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getMultiplier <em>Multiplier</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getDefaultValueDataType <em>Default Value Data Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#isReverseChronology <em>Reverse Chronology</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.impl.ReadingTypeImpl#getPending <em>Pending</em>}</li>
 * </ul>
 *
 * @generated
 */
