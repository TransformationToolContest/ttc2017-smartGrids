...
import gluemodel.CIM.IEC61970.Topology.TopologyFactory;
...
public class TopologyPackageImpl extends EPackageImpl implements TopologyPackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.Topology.TopologyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getTopologicalNode() {
		if (topologicalNodeEClass == null) {
			topologicalNodeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(TopologyPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EClass getBusNameMarker() {
		if (busNameMarkerEClass == null) {
			busNameMarkerEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(TopologyPackage.eNS_URI).getEClassifiers().get(1);
		}
	 ...
	 * @generated
	 */
	public EReference getBusNameMarker_ConnectivityNode() {
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Topology." + eClassifier.getName());
