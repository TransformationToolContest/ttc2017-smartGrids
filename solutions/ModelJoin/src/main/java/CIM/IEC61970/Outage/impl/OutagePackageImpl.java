...
import CIM.IEC61970.Outage.OutageFactory;
...
public class OutagePackageImpl extends EPackageImpl implements OutagePackage {
	 ...
	 * @see CIM.IEC61970.Outage.OutagePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Outage." + eClassifier.getName());
