 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve#getEmissionContent <em>Emission Content</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve#isIsNetGrossP <em>Is Net Gross P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve#getThermalGeneratingUnit <em>Thermal Generating Unit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve#getEmissionType <em>Emission Type</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Generation.Production.ProductionPackage#getEmissionCurve()
...
public interface EmissionCurve extends Curve {
	 ...
	 * @see gluemodel.CIM.IEC61970.Generation.Production.ProductionPackage#getEmissionCurve_EmissionContent()
	 * @model dataType="gluemodel.CIM.IEC61970.Generation.Production.Emission" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve#getEmissionContent <em>Emission Content</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Generation.Production.ProductionPackage#getEmissionCurve_IsNetGrossP()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve#isIsNetGrossP <em>Is Net Gross P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Generation.Production.ThermalGeneratingUnit#getEmissionCurves <em>Emission Curves</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Generation.Production.ProductionPackage#getEmissionCurve_ThermalGeneratingUnit()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve#getThermalGeneratingUnit <em>Thermal Generating Unit</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Generation.Production.ProductionPackage#getEmissionCurve_EmissionType()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve#getEmissionType <em>Emission Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
