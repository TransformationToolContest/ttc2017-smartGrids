 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.TieLineImpl#getDynamicEnergyTransaction <em>Dynamic Energy Transaction</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.TieLineImpl#getCustomerConsumer <em>Customer Consumer</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.TieLineImpl#getSideA_SubControlArea <em>Side ASub Control Area</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.TieLineImpl#getSideB_HostControlArea <em>Side BHost Control Area</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.TieLineImpl#getSideB_SubControlArea <em>Side BSub Control Area</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.TieLineImpl#getSideA_HostControlArea <em>Side AHost Control Area</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.impl.TieLineImpl#getControlAreaOperators <em>Control Area Operators</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TieLineImpl extends ElementImpl implements TieLine {
	 ...
	 * @ordered
	 */
	protected gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic dynamicEnergyTransaction;
	 ...
	 * @generated
	 */
	public gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic getDynamicEnergyTransaction() {
		if (dynamicEnergyTransaction != null && dynamicEnergyTransaction.eIsProxy()) {
			...
			dynamicEnergyTransaction = (gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic)eResolveProxy(oldDynamicEnergyTransaction);
	 ...
	 * @generated
	 */
	public gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic basicGetDynamicEnergyTransaction() {
		return dynamicEnergyTransaction;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDynamicEnergyTransaction(gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic newDynamicEnergyTransaction, NotificationChain msgs) {
		gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic oldDynamicEnergyTransaction = dynamicEnergyTransaction;
	 ...
	 * @generated
	 */
	public void setDynamicEnergyTransaction(gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic newDynamicEnergyTransaction) {
		if (newDynamicEnergyTransaction != dynamicEnergyTransaction) {
			NotificationChain msgs = null;
			if (dynamicEnergyTransaction != null)
				msgs = ((InternalEObject)dynamicEnergyTransaction).eInverseRemove(this, EnergySchedulingPackage.DYNAMIC__TIE_LINES, gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic.class, msgs);
			if (newDynamicEnergyTransaction != null)
				msgs = ((InternalEObject)newDynamicEnergyTransaction).eInverseAdd(this, EnergySchedulingPackage.DYNAMIC__TIE_LINES, gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnergySchedulingPackage.TIE_LINE__DYNAMIC_ENERGY_TRANSACTION:
				if (dynamicEnergyTransaction != null)
					msgs = ((InternalEObject)dynamicEnergyTransaction).eInverseRemove(this, EnergySchedulingPackage.DYNAMIC__TIE_LINES, gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic.class, msgs);
				return basicSetDynamicEnergyTransaction((gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic)otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EnergySchedulingPackage.TIE_LINE__DYNAMIC_ENERGY_TRANSACTION:
				setDynamicEnergyTransaction((gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic)newValue);
				return;
			case EnergySchedulingPackage.TIE_LINE__CUSTOMER_CONSUMER:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case EnergySchedulingPackage.TIE_LINE__DYNAMIC_ENERGY_TRANSACTION:
				setDynamicEnergyTransaction((gluemodel.CIM.IEC61970.Informative.EnergyScheduling.Dynamic)null);
				return;
			case EnergySchedulingPackage.TIE_LINE__CUSTOMER_CONSUMER:
