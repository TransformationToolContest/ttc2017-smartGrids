 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Request#getPriority <em>Priority</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Request#getOrganisation <em>Organisation</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Request#getCorporateCode <em>Corporate Code</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Request#getWorks <em>Works</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Request#getErpQuoteLineItem <em>Erp Quote Line Item</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Request#getProjects <em>Projects</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Request#getActionNeeded <em>Action Needed</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getRequest()
...
public interface Request extends Document {
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getRequest_Priority()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Request#getPriority <em>Priority</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfERPSupport.ErpOrganisation#getRequests <em>Requests</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getRequest_Organisation()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Request#getOrganisation <em>Organisation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getRequest_CorporateCode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Request#getCorporateCode <em>Corporate Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Work.Work#getRequest <em>Request</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getRequest_Works()
	 * @see CIM.IEC61968.Work.Work#getRequest
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfERPSupport.ErpQuoteLineItem#getRequest <em>Request</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getRequest_ErpQuoteLineItem()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Request#getErpQuoteLineItem <em>Erp Quote Line Item</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.Project#getRequests <em>Requests</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getRequest_Projects()
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getRequest_ActionNeeded()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Request#getActionNeeded <em>Action Needed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
