 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getPolePreservativeKind()
 * @model
 * @generated
 */
public enum PolePreservativeKind implements Enumerator {
	 ...
	 * @ordered
	 */
	CHEMONITE(1, "chemonite", "chemonite"),
	 ...
	 * @ordered
	 */
	NAPHTHENA(6, "naphthena", "naphthena");
	 ...
	 * @ordered
	 */
	public static final int CELLON_VALUE = 0;
	 ...
	 * <!-- end-user-doc -->
	 * @see #CHEMONITE
	 * @model name="chemonite"
	 * @generated
	 * @ordered
	 */
	public static final int CHEMONITE_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int CREOSOTE_VALUE = 4;
	 ...
	 * @ordered
	 */
	public static final int PENTA_VALUE = 5;
	 ...
	 * <!-- end-user-doc -->
	 * @see #NAPHTHENA
	 * @model name="naphthena"
	 * @generated
	 * @ordered
	 */
	public static final int NAPHTHENA_VALUE = 6;
