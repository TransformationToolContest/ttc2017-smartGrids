...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Erp Item Master</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpItemMasterImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpItemMasterImpl#getAsset <em>Asset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErpItemMasterImpl extends IdentifiedObjectImpl implements ErpItemMaster {
	/**
		...
		if (status != null && status.eIsProxy()) {
			...
			if (status != oldStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InfERPSupportPackage.ERP_ITEM_MASTER__STATUS, oldStatus, status));
			}
		}
		return status;
	}
	...
	public void setStatus(Status newStatus) {
		...
		status = newStatus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfERPSupportPackage.ERP_ITEM_MASTER__STATUS, oldStatus, status));
	}
	...
	public Asset getAsset() {
		if (asset != null && asset.eIsProxy()) {
			...
			if (asset != oldAsset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InfERPSupportPackage.ERP_ITEM_MASTER__ASSET, oldAsset, asset));
			}
		}
		return asset;
	}
	...
	public NotificationChain basicSetAsset(Asset newAsset, NotificationChain msgs) {
		...
		asset = newAsset;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InfERPSupportPackage.ERP_ITEM_MASTER__ASSET, oldAsset, newAsset);
