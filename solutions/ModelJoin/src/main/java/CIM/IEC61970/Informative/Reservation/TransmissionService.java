...
import CIM.IEC61970.Informative.EnergyScheduling.AvailableTransmissionCapacity;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getOffering <em>Offering</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getOfferedAs <em>Offered As</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getScheduledBy <em>Scheduled By</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getReservedBy_ServiceReservation <em>Reserved By Service Reservation</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getTransContractFor <em>Trans Contract For</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getOffers <em>Offers</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getTransmissionService()
...
public interface TransmissionService extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Reservation.TransmissionPath#getOfferedOn <em>Offered On</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getTransmissionService_Offering()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Financial.TransmissionProduct#getOffers <em>Offers</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getTransmissionService_OfferedAs()
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Informative.EnergyScheduling.AvailableTransmissionCapacity}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.EnergyScheduling.AvailableTransmissionCapacity#getScheduleFor <em>Schedule For</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getTransmissionService_ScheduledBy()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getReserves_TransmissionService <em>Reserves Transmission Service</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getTransmissionService_ReservedBy_ServiceReservation()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Financial.OpenAccessProduct#getProvidedBy_TransmissionService <em>Provided By Transmission Service</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getTransmissionService_TransContractFor()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getTransContractFor <em>Trans Contract For</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Financial.TransmissionProvider#getOfferedBy <em>Offered By</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getTransmissionService_Offers()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getOffers <em>Offers</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
