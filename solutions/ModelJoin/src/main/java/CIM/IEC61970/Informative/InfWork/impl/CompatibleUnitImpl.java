...
import CIM.IEC61970.Informative.InfWork.CUMaterialItem;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getDesignLocationCUs <em>Design Location CUs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getEstCost <em>Est Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getPropertyUnit <em>Property Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getCULaborItems <em>CU Labor Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getCUMaterialItems <em>CU Material Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getCUGroup <em>CU Group</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getCUWorkEquipmentItems <em>CU Work Equipment Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getCostType <em>Cost Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getProcedures <em>Procedures</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getCUAssets <em>CU Assets</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getCUAllowableAction <em>CU Allowable Action</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CompatibleUnitImpl#getCUContractorItems <em>CU Contractor Items</em>}</li>
 * </ul>
 *
 * @generated
 */
