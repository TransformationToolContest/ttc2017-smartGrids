...
import CIM.IEC61970.Wires.WindingTest;
import CIM.IEC61970.Wires.WindingType;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getG0 <em>G0</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getTo_WindingTest <em>To Winding Test</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getRground <em>Rground</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#isGrounded <em>Grounded</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getShortTermS <em>Short Term S</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getG <em>G</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getB <em>B</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getX <em>X</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getPhaseTapChanger <em>Phase Tap Changer</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getR <em>R</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getR0 <em>R0</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getB0 <em>B0</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getPowerTransformer <em>Power Transformer</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getWindingType <em>Winding Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getX0 <em>X0</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getRatedS <em>Rated S</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getRatedU <em>Rated U</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getFrom_WindingTest <em>From Winding Test</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getRatioTapChanger <em>Ratio Tap Changer</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getInsulationU <em>Insulation U</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getEmergencyS <em>Emergency S</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getConnectionType <em>Connection Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.impl.TransformerWindingImpl#getXground <em>Xground</em>}</li>
 * </ul>
 *
 * @generated
 */
