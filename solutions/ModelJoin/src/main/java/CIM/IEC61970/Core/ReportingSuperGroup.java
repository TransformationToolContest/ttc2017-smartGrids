 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.ReportingSuperGroup#getReportingGroup <em>Reporting Group</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getReportingSuperGroup()
...
public interface ReportingSuperGroup extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.ReportingGroup#getReportingSuperGroup <em>Reporting Super Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getReportingSuperGroup_ReportingGroup()
