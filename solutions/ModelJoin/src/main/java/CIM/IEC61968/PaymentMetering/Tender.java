 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Tender#getAmount <em>Amount</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Tender#getChange <em>Change</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Tender#getKind <em>Kind</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Tender#getReceipt <em>Receipt</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Tender#getCheque <em>Cheque</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Tender#getCard <em>Card</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTender()
...
public interface Tender extends IdentifiedObject {
	 ...
	 * @see #setAmount(float)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTender_Amount()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Tender#getAmount <em>Amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setChange(float)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTender_Change()
	 * @model dataType="CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Tender#getChange <em>Change</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTender_Kind()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Tender#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Receipt#getTenders <em>Tenders</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTender_Receipt()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Tender#getReceipt <em>Receipt</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Cheque#getTender <em>Tender</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTender_Cheque()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Tender#getCheque <em>Cheque</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Card#getTender <em>Tender</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setCard(Card)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTender_Card()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Tender#getCard <em>Card</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
