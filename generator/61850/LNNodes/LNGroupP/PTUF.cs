...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupP/PTUF")]
    public class PTUF : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP.GroupP, IPTUF, IModelElement
    {
        ...
        public virtual IACT BlkVal
        {
            ...
            set
            {
                if ((this._blkVal != value))
                {
                    ...
                    this.OnPropertyChanging("BlkVal", e);
                    this._blkVal = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("BlkVal", e);
                }
            }
        }
        ...
        private sealed class BlkValProxy : ModelPropertyChange<IPTUF, IACT>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.BlkValChanged += handler;
            }
