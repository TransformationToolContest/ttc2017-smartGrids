...
import CIM.IEC61970.Informative.InfWork.Assignment;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getWorkTasks <em>Work Tasks</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getAssignments <em>Assignments</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getShiftPatterns <em>Shift Patterns</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getRoute <em>Route</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getTools <em>Tools</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getVehicles <em>Vehicles</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getCrewMembers <em>Crew Members</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getWorkEquipmentAssets <em>Work Equipment Assets</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getLocations <em>Locations</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getOrganisations <em>Organisations</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getSwitchingSchedules <em>Switching Schedules</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.CrewImpl#getOutageSteps <em>Outage Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
