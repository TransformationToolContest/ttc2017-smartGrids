 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.LoadModel.DayType#getSeasonDayTypeSchedules <em>Season Day Type Schedules</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.LoadModel.LoadModelPackage#getDayType()
...
public interface DayType extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.LoadModel.SeasonDayTypeSchedule#getDayType <em>Day Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.LoadModel.LoadModelPackage#getDayType_SeasonDayTypeSchedules()
