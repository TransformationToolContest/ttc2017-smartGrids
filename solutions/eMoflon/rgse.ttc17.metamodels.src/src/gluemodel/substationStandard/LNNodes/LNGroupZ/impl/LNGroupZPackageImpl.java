...
import gluemodel.substationStandard.LNNodes.LNGroupZ.LNGroupZFactory;
...
public class LNGroupZPackageImpl extends EPackageImpl implements LNGroupZPackage {
	 ...
	 * @see gluemodel.substationStandard.LNNodes.LNGroupZ.LNGroupZPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getGroupZ() {
		if (groupZEClass == null) {
			groupZEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(0);
		}
		return groupZEClass;
	}
	...
	public EClass getZAXN() {
		if (zaxnEClass == null) {
			zaxnEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(1);
		}
		return zaxnEClass;
	}
	...
	public EReference getZAXN_OpTmh() {
        return (EReference)getZAXN().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZAXN_Vol() {
        return (EReference)getZAXN().getEStructuralFeatures().get(1);
	}
	...
	public EReference getZAXN_Amp() {
        return (EReference)getZAXN().getEStructuralFeatures().get(2);
	}
	...
	public EClass getZGIL() {
		if (zgilEClass == null) {
			zgilEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(2);
		}
		return zgilEClass;
	}
	...
	public EReference getZGIL_OpTmh() {
        return (EReference)getZGIL().getEStructuralFeatures().get(0);
	}
	...
	public EClass getZBAT() {
		if (zbatEClass == null) {
			zbatEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(3);
		}
		return zbatEClass;
	}
	...
	public EReference getZBAT_OpTmh() {
        return (EReference)getZBAT().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZBAT_Vol() {
        return (EReference)getZBAT().getEStructuralFeatures().get(1);
	}
	...
	public EReference getZBAT_VolChgRte() {
        return (EReference)getZBAT().getEStructuralFeatures().get(2);
	}
	...
	public EReference getZBAT_Amp() {
        return (EReference)getZBAT().getEStructuralFeatures().get(3);
	}
	...
	public EReference getZBAT_BatTest() {
        return (EReference)getZBAT().getEStructuralFeatures().get(4);
	}
	...
	public EReference getZBAT_TestRsl() {
        return (EReference)getZBAT().getEStructuralFeatures().get(5);
	}
	...
	public EReference getZBAT_BatHi() {
        return (EReference)getZBAT().getEStructuralFeatures().get(6);
	}
	...
	public EReference getZBAT_BatLo() {
        return (EReference)getZBAT().getEStructuralFeatures().get(7);
	}
	...
	public EReference getZBAT_LoBatVal() {
        return (EReference)getZBAT().getEStructuralFeatures().get(8);
	}
	...
	public EReference getZBAT_HiBatVal() {
        return (EReference)getZBAT().getEStructuralFeatures().get(9);
	}
	...
	public EClass getZLIN() {
		if (zlinEClass == null) {
			zlinEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(4);
		}
		return zlinEClass;
	}
	...
	public EReference getZLIN_OpTmh() {
        return (EReference)getZLIN().getEStructuralFeatures().get(0);
	}
	...
	public EClass getZMOT() {
		if (zmotEClass == null) {
			zmotEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(5);
		}
		return zmotEClass;
	}
	...
	public EReference getZMOT_OpTmh() {
        return (EReference)getZMOT().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZMOT_DExt() {
        return (EReference)getZMOT().getEStructuralFeatures().get(1);
	}
	...
	public EReference getZMOT_LosOil() {
        return (EReference)getZMOT().getEStructuralFeatures().get(2);
	}
	...
	public EReference getZMOT_LosVac() {
        return (EReference)getZMOT().getEStructuralFeatures().get(3);
	}
	...
	public EReference getZMOT_PresAlm() {
        return (EReference)getZMOT().getEStructuralFeatures().get(4);
	}
	...
	public EClass getZREA() {
		if (zreaEClass == null) {
			zreaEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(6);
		}
		return zreaEClass;
	}
	...
	public EReference getZREA_OpTmh() {
        return (EReference)getZREA().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZREA_ReactorControl() {
        return (EReference)getZREA().getEStructuralFeatures().get(1);
	}
	...
	public EClass getZBSH() {
		if (zbshEClass == null) {
			zbshEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(7);
		}
		return zbshEClass;
	}
	...
	public EReference getZBSH_OpTmh() {
        return (EReference)getZBSH().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZBSH_React() {
        return (EReference)getZBSH().getEStructuralFeatures().get(1);
	}
	...
	public EReference getZBSH_LosFact() {
        return (EReference)getZBSH().getEStructuralFeatures().get(2);
	}
	...
	public EReference getZBSH_Vol() {
        return (EReference)getZBSH().getEStructuralFeatures().get(3);
	}
	...
	public EReference getZBSH_RefReact() {
        return (EReference)getZBSH().getEStructuralFeatures().get(4);
	}
	...
	public EReference getZBSH_RefPF() {
        return (EReference)getZBSH().getEStructuralFeatures().get(5);
	}
	...
	public EReference getZBSH_RefV() {
        return (EReference)getZBSH().getEStructuralFeatures().get(6);
	}
	...
	public EClass getZRRC() {
		if (zrrcEClass == null) {
			zrrcEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(8);
		}
		return zrrcEClass;
	}
	...
	public EReference getZRRC_OpTmh() {
        return (EReference)getZRRC().getEStructuralFeatures().get(0);
	}
	...
	public EClass getZSAR() {
		if (zsarEClass == null) {
			zsarEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(9);
		}
		return zsarEClass;
	}
	...
	public EReference getZSAR_OpCnt() {
        return (EReference)getZSAR().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZSAR_OPSA() {
        return (EReference)getZSAR().getEStructuralFeatures().get(1);
	}
	...
	public EClass getZTCF() {
		if (ztcfEClass == null) {
			ztcfEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(10);
		}
		return ztcfEClass;
	}
	...
	public EReference getZTCF_OpTmh() {
        return (EReference)getZTCF().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZTCF_PwrFrq() {
        return (EReference)getZTCF().getEStructuralFeatures().get(1);
	}
	...
	public EClass getZTCR() {
		if (ztcrEClass == null) {
			ztcrEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(11);
		}
		return ztcrEClass;
	}
	...
	public EReference getZTCR_OpTmh() {
        return (EReference)getZTCR().getEStructuralFeatures().get(0);
	}
	...
	public EClass getZCAB() {
		if (zcabEClass == null) {
			zcabEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(12);
		}
		return zcabEClass;
	}
	...
	public EReference getZCAB_OpTmh() {
        return (EReference)getZCAB().getEStructuralFeatures().get(0);
	}
	...
	public EClass getZCAP() {
		if (zcapEClass == null) {
			zcapEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(13);
		}
		return zcapEClass;
	}
	...
	public EReference getZCAP_OpTmh() {
        return (EReference)getZCAP().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZCAP_CapDS() {
        return (EReference)getZCAP().getEStructuralFeatures().get(1);
	}
	...
	public EReference getZCAP_DschBlk() {
        return (EReference)getZCAP().getEStructuralFeatures().get(2);
	}
	...
	public EReference getZCAP_CapControl() {
        return (EReference)getZCAP().getEStructuralFeatures().get(3);
	}
	...
	public EClass getZCON() {
		if (zconEClass == null) {
			zconEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(14);
		}
		return zconEClass;
	}
	...
	public EReference getZCON_OpTmh() {
        return (EReference)getZCON().getEStructuralFeatures().get(0);
	}
	...
	public EClass getZGEN() {
		if (zgenEClass == null) {
			zgenEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupZPackage.eNS_URI).getEClassifiers().get(15);
		}
		return zgenEClass;
	}
	...
	public EReference getZGEN_OpTmh() {
        return (EReference)getZGEN().getEStructuralFeatures().get(0);
	}
	...
	public EReference getZGEN_GnCtl() {
        return (EReference)getZGEN().getEStructuralFeatures().get(1);
	}
	...
	public EReference getZGEN_DExt() {
        return (EReference)getZGEN().getEStructuralFeatures().get(2);
	}
	...
	public EReference getZGEN_AuxSCO() {
        return (EReference)getZGEN().getEStructuralFeatures().get(3);
	}
	...
	public EReference getZGEN_StopVlv() {
        return (EReference)getZGEN().getEStructuralFeatures().get(4);
	}
	...
	public EReference getZGEN_ReactPwrR() {
        return (EReference)getZGEN().getEStructuralFeatures().get(5);
	}
	...
	public EReference getZGEN_ReactPwrL() {
        return (EReference)getZGEN().getEStructuralFeatures().get(6);
	}
	...
	public EReference getZGEN_GnSpd() {
        return (EReference)getZGEN().getEStructuralFeatures().get(7);
	}
	...
	public EReference getZGEN_OANL() {
        return (EReference)getZGEN().getEStructuralFeatures().get(8);
	}
	...
	public EAttribute getZGEN_GnSt() {
        return (EAttribute)getZGEN().getEStructuralFeatures().get(9);
	}
	...
	public EReference getZGEN_ClkRot() {
        return (EReference)getZGEN().getEStructuralFeatures().get(10);
	}
	...
	public EReference getZGEN_CntClkRot() {
        return (EReference)getZGEN().getEStructuralFeatures().get(11);
	}
	...
	public EReference getZGEN_OpUnExt() {
        return (EReference)getZGEN().getEStructuralFeatures().get(12);
	}
	...
	public EReference getZGEN_OpOvExt() {
        return (EReference)getZGEN().getEStructuralFeatures().get(13);
	}
	...
	public EReference getZGEN_LosOil() {
        return (EReference)getZGEN().getEStructuralFeatures().get(14);
	}
	...
	public EReference getZGEN_LosVac() {
        return (EReference)getZGEN().getEStructuralFeatures().get(15);
	}
	...
	public EReference getZGEN_PresAlm() {
        return (EReference)getZGEN().getEStructuralFeatures().get(16);
	}
	...
	public EReference getZGEN_DmdPwr() {
        return (EReference)getZGEN().getEStructuralFeatures().get(17);
	}
	...
	public EReference getZGEN_PwrRtg() {
        return (EReference)getZGEN().getEStructuralFeatures().get(18);
	}
	...
	public EReference getZGEN_VRtg() {
        return (EReference)getZGEN().getEStructuralFeatures().get(19);
	}
