 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.TransactionSummary#getTransactionKind <em>Transaction Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.TransactionSummary#getLine <em>Line</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.TransactionSummary#getShift <em>Shift</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getTransactionSummary()
...
public interface TransactionSummary extends Element {
	 ...
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getTransactionSummary_TransactionKind()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.TransactionSummary#getTransactionKind <em>Transaction Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getTransactionSummary_Line()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.TransactionSummary#getLine <em>Line</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Shift#getTransactionSummaries <em>Transaction Summaries</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setShift(Shift)
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getTransactionSummary_Shift()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.TransactionSummary#getShift <em>Shift</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
