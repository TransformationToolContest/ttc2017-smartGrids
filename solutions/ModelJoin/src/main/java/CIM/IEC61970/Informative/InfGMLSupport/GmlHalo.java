 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.GmlHalo#getGmlTextSymbols <em>Gml Text Symbols</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.GmlHalo#getOpacity <em>Opacity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.GmlHalo#getRadius <em>Radius</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfGMLSupport.InfGMLSupportPackage#getGmlHalo()
...
public interface GmlHalo extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfGMLSupport.GmlTextSymbol#getGmlHalo <em>Gml Halo</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfGMLSupport.InfGMLSupportPackage#getGmlHalo_GmlTextSymbols()
	 ...
	 * @see CIM.IEC61970.Informative.InfGMLSupport.InfGMLSupportPackage#getGmlHalo_Opacity()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfGMLSupport.GmlHalo#getOpacity <em>Opacity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfGMLSupport.InfGMLSupportPackage#getGmlHalo_Radius()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfGMLSupport.GmlHalo#getRadius <em>Radius</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
