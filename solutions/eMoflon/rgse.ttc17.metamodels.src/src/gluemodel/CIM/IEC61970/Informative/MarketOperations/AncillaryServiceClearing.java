 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getMcp <em>Mcp</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getClearedMW <em>Cleared MW</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getMarketCaseClearing <em>Market Case Clearing</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getCommodityType <em>Commodity Type</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getAncillaryServiceClearing()
...
public interface AncillaryServiceClearing extends MarketFactors {
	 ...
	 * @see #setMcp(float)
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getAncillaryServiceClearing_Mcp()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getMcp <em>Mcp</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getAncillaryServiceClearing_ClearedMW()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getClearedMW <em>Cleared MW</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketCaseClearing#getAncillaryServiceClearing <em>Ancillary Service Clearing</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getAncillaryServiceClearing_MarketCaseClearing()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getMarketCaseClearing <em>Market Case Clearing</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getAncillaryServiceClearing_CommodityType()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getCommodityType <em>Commodity Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
