 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.OperationalLimits.CurrentLimit#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.OperationalLimits.OperationalLimitsPackage#getCurrentLimit()
...
public interface CurrentLimit extends OperationalLimit {
	 ...
	 * @see #setValue(float)
	 * @see gluemodel.CIM.IEC61970.OperationalLimits.OperationalLimitsPackage#getCurrentLimit_Value()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.OperationalLimits.CurrentLimit#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
