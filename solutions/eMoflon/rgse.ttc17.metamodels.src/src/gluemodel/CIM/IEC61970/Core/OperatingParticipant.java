 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.OperatingParticipant#getOperatingShare <em>Operating Share</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Core.CorePackage#getOperatingParticipant()
...
public interface OperatingParticipant extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Core.OperatingShare#getOperatingParticipant <em>Operating Participant</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Core.CorePackage#getOperatingParticipant_OperatingShare()
