 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.impl.ISCImpl#getCtlVal <em>Ctl Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ISCImpl#getValWTr <em>Val WTr</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ISCImpl#getT <em>T</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ISCImpl#getQ <em>Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ISCImpl#getSubVal <em>Sub Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ISCImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ISCImpl#getMaxVal <em>Max Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ISCImpl#getStepSize <em>Step Size</em>}</li>
 * </ul>
 *
 * @generated
 */
