...
import gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringFactory;
 ...
 * @generated
 */
public class InfPaymentMeteringPackageImpl extends EPackageImpl implements InfPaymentMeteringPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass tspAgreementEClass = null;
	 ...
	 * @generated
	 */
	private EClass receiptSummaryEClass = null;
	 ...
	 * @generated
	 */
	private EClass transactionSummaryEClass = null;
	 ...
	 * @generated
	 */
	private EClass bankStatementEClass = null;
	 ...
	 * @generated
	 */
	private EClass sdpAccountingFunctionEClass = null;
	 ...
	 * @generated
	 */
	private EClass creditRegisterEClass = null;
	 ...
	 * @generated
	 */
	private EClass chargeRegisterEClass = null;
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InfPaymentMeteringPackageImpl() {
		super(eNS_URI, InfPaymentMeteringFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link InfPaymentMeteringPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static InfPaymentMeteringPackage init() {
		if (isInited) return (InfPaymentMeteringPackage)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI);

		// Obtain or create and register package
		InfPaymentMeteringPackageImpl theInfPaymentMeteringPackage = (InfPaymentMeteringPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InfPaymentMeteringPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InfPaymentMeteringPackageImpl());
		...
		theInfPaymentMeteringPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(InfPaymentMeteringPackage.eNS_URI, theInfPaymentMeteringPackage);
		return theInfPaymentMeteringPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getTSPAgreement() {
		if (tspAgreementEClass == null) {
			tspAgreementEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(0);
		}
		return tspAgreementEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getReceiptSummary() {
		if (receiptSummaryEClass == null) {
			receiptSummaryEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(1);
		}
		return receiptSummaryEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getReceiptSummary_Line() {
        return (EReference)getReceiptSummary().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getReceiptSummary_TenderKind() {
        return (EAttribute)getReceiptSummary().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getReceiptSummary_Shift() {
        return (EReference)getReceiptSummary().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getTransactionSummary() {
		if (transactionSummaryEClass == null) {
			transactionSummaryEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(2);
		}
		return transactionSummaryEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTransactionSummary_TransactionKind() {
        return (EAttribute)getTransactionSummary().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTransactionSummary_Line() {
        return (EReference)getTransactionSummary().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getTransactionSummary_Shift() {
        return (EReference)getTransactionSummary().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getBankStatement() {
		if (bankStatementEClass == null) {
			bankStatementEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(3);
		}
		return bankStatementEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getBankStatement_MerchantCreditAmount() {
        return (EAttribute)getBankStatement().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getBankStatement_BankAccount() {
        return (EReference)getBankStatement().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getBankStatement_DepositAmount() {
        return (EAttribute)getBankStatement().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getBankStatement_DepositDateTime() {
        return (EAttribute)getBankStatement().getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getBankStatement_MerchantAccount() {
        return (EReference)getBankStatement().getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getBankStatement_Vendor() {
        return (EReference)getBankStatement().getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getBankStatement_Posted() {
        return (EAttribute)getBankStatement().getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EClass getSDPAccountingFunction() {
		if (sdpAccountingFunctionEClass == null) {
			sdpAccountingFunctionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(4);
		}
		return sdpAccountingFunctionEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getSDPAccountingFunction_AvailableCredit() {
        return (EReference)getSDPAccountingFunction().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getSDPAccountingFunction_CreditRegisters() {
        return (EReference)getSDPAccountingFunction().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getSDPAccountingFunction_ChargeRegisters() {
        return (EReference)getSDPAccountingFunction().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getSDPAccountingFunction_LowCreditWarningLevel() {
        return (EReference)getSDPAccountingFunction().getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getSDPAccountingFunction_CreditExpiryLevel() {
        return (EReference)getSDPAccountingFunction().getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getSDPAccountingFunction_ServiceKind() {
        return (EReference)getSDPAccountingFunction().getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EClass getCreditRegister() {
		if (creditRegisterEClass == null) {
			creditRegisterEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(5);
		}
		return creditRegisterEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getCreditRegister_CreditAmount() {
        return (EReference)getCreditRegister().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCreditRegister_CreditKind() {
        return (EAttribute)getCreditRegister().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getCreditRegister_SDPAccountingFunction() {
        return (EReference)getCreditRegister().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getChargeRegister() {
		if (chargeRegisterEClass == null) {
			chargeRegisterEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(6);
		}
		return chargeRegisterEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getChargeRegister_ChargeKind() {
        return (EAttribute)getChargeRegister().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getChargeRegister_SPAccountingFunction() {
        return (EReference)getChargeRegister().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getChargeRegister_ChargeAmount() {
        return (EReference)getChargeRegister().getEStructuralFeatures().get(2);
	}
	...
	public EClass getBank() {
		if (bankEClass == null) {
			bankEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(7);
		}
		return bankEClass;
	}
	...
	public EClass getToken() {
		if (tokenEClass == null) {
			tokenEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfPaymentMeteringPackage.eNS_URI).getEClassifiers().get(8);
		}
		return tokenEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getToken_PointOfSale() {
	 ...
	 * @generated
	 */
	public EAttribute getToken_Comment() {
	 ...
	 * @generated
	 */
	public EAttribute getToken_Code() {
        return (EAttribute)getToken().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public InfPaymentMeteringFactory getInfPaymentMeteringFactory() {
		return (InfPaymentMeteringFactory)getEFactoryInstance();
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.InfPaymentMetering." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //InfPaymentMeteringPackageImpl
