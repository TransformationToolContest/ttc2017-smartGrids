 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Metering.ComFunction#isTwoWay <em>Two Way</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.ComFunction#getAmrAddress <em>Amr Address</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.ComFunction#getAmrRouter <em>Amr Router</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.Metering.MeteringPackage#getComFunction()
...
public interface ComFunction extends DeviceFunction {
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getComFunction_TwoWay()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.ComFunction#isTwoWay <em>Two Way</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getComFunction_AmrAddress()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.ComFunction#getAmrAddress <em>Amr Address</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getComFunction_AmrRouter()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.ComFunction#getAmrRouter <em>Amr Router</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
