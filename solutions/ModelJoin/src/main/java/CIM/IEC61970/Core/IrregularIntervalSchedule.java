 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.IrregularIntervalSchedule#getTimePoints <em>Time Points</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getIrregularIntervalSchedule()
...
public interface IrregularIntervalSchedule extends BasicIntervalSchedule {
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Core.IrregularTimePoint}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.IrregularTimePoint#getIntervalSchedule <em>Interval Schedule</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getIrregularIntervalSchedule_TimePoints()
