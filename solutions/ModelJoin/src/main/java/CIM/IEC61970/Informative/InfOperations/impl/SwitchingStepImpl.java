...
import CIM.IEC61970.Informative.InfOperations.SwitchingStepStatusKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getStatusKind <em>Status Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getErpPersonRole <em>Erp Person Role</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getSwitchingSchedule <em>Switching Schedule</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getSafetyDocument <em>Safety Document</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getRequiredControlAction <em>Required Control Action</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getText <em>Text</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getPowerSystemResources <em>Power System Resources</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getRequiredControlActionInterval <em>Required Control Action Interval</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.SwitchingStepImpl#getDesiredEndState <em>Desired End State</em>}</li>
 * </ul>
 *
 * @generated
 */
