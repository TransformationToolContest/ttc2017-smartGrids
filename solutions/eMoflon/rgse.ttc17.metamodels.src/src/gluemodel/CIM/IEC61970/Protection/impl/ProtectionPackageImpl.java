...
import gluemodel.CIM.IEC61970.Protection.ProtectionFactory;
 ...
 * @generated
 */
public class ProtectionPackageImpl extends EPackageImpl implements ProtectionPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ProtectionPackageImpl() {
		super(eNS_URI, ProtectionFactory.eINSTANCE);
	}
	...
	public static ProtectionPackage init() {
		...
		ProtectionPackageImpl theProtectionPackage = (ProtectionPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ProtectionPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ProtectionPackageImpl());
	...
	public EClass getCurrentRelay() {
		if (currentRelayEClass == null) {
			currentRelayEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(ProtectionPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EClass getRecloseSequence() {
		if (recloseSequenceEClass == null) {
			recloseSequenceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(ProtectionPackage.eNS_URI).getEClassifiers().get(2);
		}
	...
	public EReference getRecloseSequence_ProtectedSwitch() {
        return (EReference)getRecloseSequence().getEStructuralFeatures().get(0);
	}
	...
	public EClass getSurgeProtector() {
		if (surgeProtectorEClass == null) {
			surgeProtectorEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(ProtectionPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	public EClass getProtectionEquipment() {
		if (protectionEquipmentEClass == null) {
			protectionEquipmentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(ProtectionPackage.eNS_URI).getEClassifiers().get(4);
		}
	...
	public EReference getProtectionEquipment_ConductingEquipments() {
        return (EReference)getProtectionEquipment().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getProtectionEquipment_Unit() {
        return (EReference)getProtectionEquipment().getEStructuralFeatures().get(2);
	}
	...
	public EReference getProtectionEquipment_ProtectedSwitches() {
        return (EReference)getProtectionEquipment().getEStructuralFeatures().get(4);
	}
	...
	public EClass getFaultIndicator() {
		if (faultIndicatorEClass == null) {
			faultIndicatorEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(ProtectionPackage.eNS_URI).getEClassifiers().get(5);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Protection." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //ProtectionPackageImpl
