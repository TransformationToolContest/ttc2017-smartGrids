 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getTapChg <em>Tap Chg</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getTapPos <em>Tap Pos</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getParOp <em>Par Op</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLTCBlk <em>LTC Blk</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLTCDragRs <em>LTC Drag Rs</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getVRed1 <em>VRed1</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getVRed2 <em>VRed2</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getCtlV <em>Ctl V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLodA <em>Lod A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getCircA <em>Circ A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getPhAng <em>Ph Ang</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getHiCtlV <em>Hi Ctl V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLoCtlV <em>Lo Ctl V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getHiDmdA <em>Hi Dmd A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getHiTapPos <em>Hi Tap Pos</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLoTapPos <em>Lo Tap Pos</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getBndCtr <em>Bnd Ctr</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getBndWid <em>Bnd Wid</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getCtlDlTmms <em>Ctl Dl Tmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLDCR <em>LDCR</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLDCX <em>LDCX</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getBlkLV <em>Blk LV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getBlkRV <em>Blk RV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getRnbkRV <em>Rnbk RV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLimLodA <em>Lim Lod A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLDC <em>LDC</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getTmDlChr <em>Tm Dl Chr</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getLDCZ <em>LDCZ</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getVRedVal <em>VRed Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getTapBlkR <em>Tap Blk R</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupA.impl.ATCCImpl#getTapBlkL <em>Tap Blk L</em>}</li>
 * </ul>
 *
 * @generated
 */
