...
import CIM.IEC61970.Informative.InfTypeAsset.InfTypeAssetFactory;
...
public class InfTypeAssetPackageImpl extends EPackageImpl implements InfTypeAssetPackage {
	 ...
	 * @see CIM.IEC61970.Informative.InfTypeAsset.InfTypeAssetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfTypeAsset." + eClassifier.getName());
