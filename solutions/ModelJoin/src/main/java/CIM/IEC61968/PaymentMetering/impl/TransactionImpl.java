 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getUserAttributes <em>User Attributes</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getServiceUnitsError <em>Service Units Error</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getReversedId <em>Reversed Id</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getMeterAsset <em>Meter Asset</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getLine <em>Line</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getReceiverReference <em>Receiver Reference</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getDonorReference <em>Donor Reference</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getVendorShift <em>Vendor Shift</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getCashierShift <em>Cashier Shift</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getAuxiliaryAccount <em>Auxiliary Account</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getPricingStructure <em>Pricing Structure</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getServiceUnitsEnergy <em>Service Units Energy</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getCustomerAccount <em>Customer Account</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getReceipt <em>Receipt</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.TransactionImpl#getDiverseReference <em>Diverse Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
