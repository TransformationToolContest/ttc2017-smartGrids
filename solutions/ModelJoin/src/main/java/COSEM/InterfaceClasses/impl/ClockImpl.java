...
import COSEM.InterfaceClasses.Clock;
 ...
 * </p>
 * <ul>
 *   <li>{@link COSEM.InterfaceClasses.impl.ClockImpl#getTime <em>Time</em>}</li>
 *   <li>{@link COSEM.InterfaceClasses.impl.ClockImpl#getTime_zone <em>Time zone</em>}</li>
 *   <li>{@link COSEM.InterfaceClasses.impl.ClockImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link COSEM.InterfaceClasses.impl.ClockImpl#getDaylight_savings_begin <em>Daylight savings begin</em>}</li>
 *   <li>{@link COSEM.InterfaceClasses.impl.ClockImpl#getDaylight_savings_end <em>Daylight savings end</em>}</li>
 *   <li>{@link COSEM.InterfaceClasses.impl.ClockImpl#getDaylight_savings_deviation <em>Daylight savings deviation</em>}</li>
 *   <li>{@link COSEM.InterfaceClasses.impl.ClockImpl#isDaylight_savings_enabled <em>Daylight savings enabled</em>}</li>
 * </ul>
 *
 * @generated
 */
