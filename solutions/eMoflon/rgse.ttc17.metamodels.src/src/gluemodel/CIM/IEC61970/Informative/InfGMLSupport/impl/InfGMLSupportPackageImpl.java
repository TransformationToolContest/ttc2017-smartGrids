...
import gluemodel.CIM.IEC61970.Informative.InfGMLSupport.InfGMLSupportFactory;
...
public class InfGMLSupportPackageImpl extends EPackageImpl implements InfGMLSupportPackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfGMLSupport.InfGMLSupportPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.InfGMLSupport." + eClassifier.getName());
