...
import CIM.IEC61968.Customers.CustomersFactory;
...
public class CustomersPackageImpl extends EPackageImpl implements CustomersPackage {
	 ...
	 * @see CIM.IEC61968.Customers.CustomersPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61968.Customers." + eClassifier.getName());
