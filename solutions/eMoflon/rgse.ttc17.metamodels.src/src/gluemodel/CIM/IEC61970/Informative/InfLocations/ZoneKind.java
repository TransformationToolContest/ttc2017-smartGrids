 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61970.Informative.InfLocations.InfLocationsPackage#getZoneKind()
 * @model
 * @generated
 */
public enum ZoneKind implements Enumerator {
	 ...
	 * @ordered
	 */
	ELECTRICAL_NETWORK(2, "electricalNetwork", "electricalNetwork"),
	 ...
	 * @ordered
	 */
	SPECIAL_RESTRICTION_LAND(3, "specialRestrictionLand", "specialRestrictionLand");
	 ...
	 * @model name="electricalNetwork"
	 * @generated
	 * @ordered
	 */
	public static final int ELECTRICAL_NETWORK_VALUE = 2;
	 ...
	 * @model name="specialRestrictionLand"
	 * @generated
	 * @ordered
	 */
	public static final int SPECIAL_RESTRICTION_LAND_VALUE = 3;
