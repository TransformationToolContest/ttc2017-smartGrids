 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getReportingGroup <em>Reporting Group</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getTopologicalIsland <em>Topological Island</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getSvInjection <em>Sv Injection</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getConnectivityNodeContainer <em>Connectivity Node Container</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getConnectivityNodes <em>Connectivity Nodes</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getBaseVoltage <em>Base Voltage</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getSvVoltage <em>Sv Voltage</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getSvShortCircuit <em>Sv Short Circuit</em>}</li>
 *   <li>{@link CIM.IEC61970.Topology.impl.TopologicalNodeImpl#getAngleRef_TopologicalIsland <em>Angle Ref Topological Island</em>}</li>
 * </ul>
 *
 * @generated
 */
