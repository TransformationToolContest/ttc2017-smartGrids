 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraintsClearing#getMwLimit <em>Mw Limit</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraintsClearing#getMwFlow <em>Mw Flow</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraintsClearing#getShadowPrice <em>Shadow Price</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraintsClearing()
...
public interface SecurityConstraintsClearing extends MarketFactors {
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraintsClearing_MwLimit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraintsClearing#getMwLimit <em>Mw Limit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setMwFlow(float)
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraintsClearing_MwFlow()
	 * @model dataType="CIM.IEC61970.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraintsClearing#getMwFlow <em>Mw Flow</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraintsClearing_ShadowPrice()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraintsClearing#getShadowPrice <em>Shadow Price</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
