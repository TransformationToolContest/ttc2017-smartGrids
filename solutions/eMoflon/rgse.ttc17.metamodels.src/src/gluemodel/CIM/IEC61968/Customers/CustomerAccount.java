 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.Customers.CustomerAccount#getWorkBillingInfos <em>Work Billing Infos</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Customers.CustomerAccount#getPaymentTransactions <em>Payment Transactions</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Customers.CustomerAccount#getCustomerAgreements <em>Customer Agreements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Customers.CustomerAccount#getErpInvoicees <em>Erp Invoicees</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Customers.CustomerAccount#getCustomerBillingInfos <em>Customer Billing Infos</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.Customers.CustomersPackage#getCustomerAccount()
...
public interface CustomerAccount extends Document {
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.WorkBillingInfo#getCustomerAccount <em>Customer Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Customers.CustomersPackage#getCustomerAccount_WorkBillingInfos()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.Transaction#getCustomerAccount <em>Customer Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Customers.CustomersPackage#getCustomerAccount_PaymentTransactions()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.Customers.CustomerAgreement#getCustomerAccount <em>Customer Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Customers.CustomersPackage#getCustomerAccount_CustomerAgreements()
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpInvoice}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpInvoice#getCustomerAccount <em>Customer Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Customers.CustomersPackage#getCustomerAccount_ErpInvoicees()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.CustomerBillingInfo#getCustomerAccount <em>Customer Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Customers.CustomersPackage#getCustomerAccount_CustomerBillingInfos()
