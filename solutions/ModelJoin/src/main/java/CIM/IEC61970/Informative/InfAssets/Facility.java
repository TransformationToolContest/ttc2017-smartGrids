 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.Facility#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getFacility()
...
public interface Facility extends AssetContainer {
	 ...
	 * @see #setKind(String)
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getFacility_Kind()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfAssets.Facility#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
