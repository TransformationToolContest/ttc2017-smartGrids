 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Metering.Register#getLeftDigitCount <em>Left Digit Count</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Register#getReadingType <em>Reading Type</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Register#getDeviceFunction <em>Device Function</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Register#getRightDigitCount <em>Right Digit Count</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.Metering.MeteringPackage#getRegister()
...
public interface Register extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getRegister_LeftDigitCount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Register#getLeftDigitCount <em>Left Digit Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.ReadingType#getRegister <em>Register</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getRegister_ReadingType()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Register#getReadingType <em>Reading Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.DeviceFunction#getRegisters <em>Registers</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getRegister_DeviceFunction()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Register#getDeviceFunction <em>Device Function</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getRegister_RightDigitCount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Register#getRightDigitCount <em>Right Digit Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
