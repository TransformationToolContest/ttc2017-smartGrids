...
import CIM.IEC61970.Informative.InfLoadControl.InfLoadControlFactory;
 ...
 * @generated
 */
public class InfLoadControlPackageImpl extends EPackageImpl implements InfLoadControlPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see CIM.IEC61970.Informative.InfLoadControl.InfLoadControlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InfLoadControlPackageImpl() {
		super(eNS_URI, InfLoadControlFactory.eINSTANCE);
	}
	...
	public static InfLoadControlPackage init() {
		...
		InfLoadControlPackageImpl theInfLoadControlPackage = (InfLoadControlPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InfLoadControlPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InfLoadControlPackageImpl());
	...
	public EClass getLoadMgmtRecord() {
		if (loadMgmtRecordEClass == null) {
			loadMgmtRecordEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfLoadControlPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EAttribute getLoadMgmtRecord_LoadReduction() {
        return (EAttribute)getLoadMgmtRecord().getEStructuralFeatures().get(0);
	}
	...
	public EReference getLoadMgmtRecord_LoadMgmtFunction() {
        return (EReference)getLoadMgmtRecord().getEStructuralFeatures().get(1);
	}
	...
	public EClass getLoadMgmtFunction() {
		if (loadMgmtFunctionEClass == null) {
			loadMgmtFunctionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfLoadControlPackage.eNS_URI).getEClassifiers().get(2);
		}
	...
	public EAttribute getLoadMgmtFunction_LoadStatus() {
        return (EAttribute)getLoadMgmtFunction().getEStructuralFeatures().get(4);
	}
	...
	public EReference getLoadMgmtFunction_Switches() {
        return (EReference)getLoadMgmtFunction().getEStructuralFeatures().get(5);
	}
	...
	public EClass getLoadShedFunction() {
		if (loadShedFunctionEClass == null) {
			loadShedFunctionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfLoadControlPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	public EClass getLoadLimitFunction() {
		if (loadLimitFunctionEClass == null) {
			loadLimitFunctionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfLoadControlPackage.eNS_URI).getEClassifiers().get(5);
		}
	...
	public EEnum getLoadStateKind() {
		if (loadStateKindEEnum == null) {
			loadStateKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(InfLoadControlPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EEnum getLoadMgmtKind() {
		if (loadMgmtKindEEnum == null) {
			loadMgmtKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(InfLoadControlPackage.eNS_URI).getEClassifiers().get(4);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfLoadControl." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //InfLoadControlPackageImpl
