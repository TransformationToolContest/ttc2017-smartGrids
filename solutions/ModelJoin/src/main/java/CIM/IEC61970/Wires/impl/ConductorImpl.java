 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.impl.ConductorImpl#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConductorImpl extends ConductingEquipmentImpl implements Conductor {
	...
	public void setLength(float newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WiresPackage.CONDUCTOR__LENGTH, oldLength, length));
	}
