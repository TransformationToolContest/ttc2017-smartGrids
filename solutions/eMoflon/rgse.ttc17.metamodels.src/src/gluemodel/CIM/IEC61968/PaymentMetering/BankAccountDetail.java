 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getBankName <em>Bank Name</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getAccountNumber <em>Account Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getHolderID <em>Holder ID</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getBranchCode <em>Branch Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getHolderName <em>Holder Name</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getBankAccountDetail()
...
public interface BankAccountDetail extends Element {
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getBankAccountDetail_BankName()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getBankName <em>Bank Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getBankAccountDetail_AccountNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getAccountNumber <em>Account Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getBankAccountDetail_HolderID()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getHolderID <em>Holder ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getBankAccountDetail_BranchCode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getBranchCode <em>Branch Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getBankAccountDetail_HolderName()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.BankAccountDetail#getHolderName <em>Holder Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
