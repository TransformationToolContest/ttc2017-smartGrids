...
import gluemodel.CIM.IEC61970.Informative.InfAssets.RegulationBranchKind;
import gluemodel.CIM.IEC61970.Informative.InfAssets.ShuntCompensatorInfo;
import gluemodel.CIM.IEC61970.Informative.InfAssets.ShuntImpedanceControlKind;
import gluemodel.CIM.IEC61970.Informative.InfAssets.ShuntImpedanceInfo;
import gluemodel.CIM.IEC61970.Informative.InfAssets.ShuntImpedanceLocalControlKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getLowVoltageOverride <em>Low Voltage Override</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getCellSize <em>Cell Size</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getHighVoltageOverride <em>High Voltage Override</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getRegBranchKind <em>Reg Branch Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#isNormalOpen <em>Normal Open</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getShuntCompensatorInfos <em>Shunt Compensator Infos</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getRegBranchEnd <em>Reg Branch End</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#isVRegLineLine <em>VReg Line Line</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getSwitchOperationCycle <em>Switch Operation Cycle</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getLocalOffLevel <em>Local Off Level</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getSensingPhaseCode <em>Sensing Phase Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getLocalControlKind <em>Local Control Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getBranchDirect <em>Branch Direct</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getMaxSwitchOperationCount <em>Max Switch Operation Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#isLocalOverride <em>Local Override</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getLocalOnLevel <em>Local On Level</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getRegBranch <em>Reg Branch</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.ShuntImpedanceInfoImpl#getControlKind <em>Control Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
