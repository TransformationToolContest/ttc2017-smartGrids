 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#isGeneral <em>General</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#getDirGeneral <em>Dir General</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#isPhsA <em>Phs A</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#getDirPhsA <em>Dir Phs A</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#isPhsB <em>Phs B</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#getDirPhsB <em>Dir Phs B</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#isPhsC <em>Phs C</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#getDirPhsC <em>Dir Phs C</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#isNeut <em>Neut</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#getDirNeut <em>Dir Neut</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.ACDImpl#getQ <em>Q</em>}</li>
 * </ul>
 *
 * @generated
 */
