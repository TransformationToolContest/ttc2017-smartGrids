...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Multiplier Kind</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see substationStandard.Enumerations.EnumerationsPackage#getMultiplierKind()
 * @model
 * @generated
 */
public enum MultiplierKind implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>Petra</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #PETRA_VALUE
	 * @generated
	 ...
	 * @ordered
	 */
	public static final int ZEPTO_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int ATTO_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int FEMTO_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int DECI_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int DECA_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int HECTO_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int MEGA_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int GIGA_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int TERA_VALUE = 0;

	/**
	 * The '<em><b>Petra</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Petra</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #PETRA
	 ...
	 * @ordered
	 */
	public static final int PETRA_VALUE = 0;
	 ...
	 * <!-- end-user-doc -->
	 * @see #ZETTA
	 * @model name="zetta" literal=""
	 * @generated
	 * @ordered
	 */
	public static final int ZETTA_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int YOTTA_VALUE = 0;

	/**
	 * An array of all the '<em><b>Multiplier Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final MultiplierKind[] VALUES_ARRAY =
		new MultiplierKind[] {
			YOCTO,
			ZEPTO,
			ATTO,
	...
	/**
	 * A public read-only list of all the '<em><b>Multiplier Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<MultiplierKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Multiplier Kind</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static MultiplierKind get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MultiplierKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Multiplier Kind</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static MultiplierKind getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MultiplierKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Multiplier Kind</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static MultiplierKind get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private MultiplierKind(int value, String name, String literal) {
		this.value = value;
		this.name = name;
