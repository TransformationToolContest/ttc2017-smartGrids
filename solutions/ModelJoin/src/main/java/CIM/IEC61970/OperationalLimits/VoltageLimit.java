 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.OperationalLimits.VoltageLimit#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.OperationalLimits.OperationalLimitsPackage#getVoltageLimit()
...
public interface VoltageLimit extends OperationalLimit {
	 ...
	 * @see #setValue(float)
	 * @see CIM.IEC61970.OperationalLimits.OperationalLimitsPackage#getVoltageLimit_Value()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.OperationalLimits.VoltageLimit#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
