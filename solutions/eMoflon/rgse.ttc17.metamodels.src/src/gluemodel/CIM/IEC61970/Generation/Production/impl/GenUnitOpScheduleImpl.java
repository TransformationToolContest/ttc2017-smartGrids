 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GenUnitOpScheduleImpl#getGeneratingUnit <em>Generating Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenUnitOpScheduleImpl extends RegularIntervalScheduleImpl implements GenUnitOpSchedule {
		...
		if (generatingUnit != null && generatingUnit.eIsProxy()) {
			...
			if (generatingUnit != oldGeneratingUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProductionPackage.GEN_UNIT_OP_SCHEDULE__GENERATING_UNIT, oldGeneratingUnit, generatingUnit));
			}
		}
	...
	public NotificationChain basicSetGeneratingUnit(GeneratingUnit newGeneratingUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProductionPackage.GEN_UNIT_OP_SCHEDULE__GENERATING_UNIT, oldGeneratingUnit, newGeneratingUnit);
	...
	public void setGeneratingUnit(GeneratingUnit newGeneratingUnit) {
		if (newGeneratingUnit != generatingUnit) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ProductionPackage.GEN_UNIT_OP_SCHEDULE__GENERATING_UNIT, newGeneratingUnit, newGeneratingUnit));
	}
