...
import substationStandard.LNNodes.LNGroupP.PTUC;
 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getStr <em>Str</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getOp <em>Op</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getTmASt <em>Tm ASt</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getTmACrv <em>Tm ACrv</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getStrVal <em>Str Val</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getOpDlTmms <em>Op Dl Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getTmMult <em>Tm Mult</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getMinOpTmms <em>Min Op Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getMaxOpTmms <em>Max Op Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getRsDlTmms <em>Rs Dl Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getConsTms <em>Cons Tms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.impl.PTUCImpl#getAlmVal <em>Alm Val</em>}</li>
 * </ul>
 *
 * @generated
 */
