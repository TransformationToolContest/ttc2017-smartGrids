 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getSubdivision <em>Subdivision</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getBlock <em>Block</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getDesignLocations <em>Design Locations</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getOneCallRequest <em>One Call Request</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getLot <em>Lot</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getNearestIntersection <em>Nearest Intersection</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getWorkLocation()
...
public interface WorkLocation extends Location {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getWorkLocation_Subdivision()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getSubdivision <em>Subdivision</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setBlock(String)
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getWorkLocation_Block()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getBlock <em>Block</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfWork.DesignLocation#getWorkLocations <em>Work Locations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getWorkLocation_DesignLocations()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfWork.OneCallRequest#getWorkLocations <em>Work Locations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getWorkLocation_OneCallRequest()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getOneCallRequest <em>One Call Request</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setLot(String)
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getWorkLocation_Lot()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getLot <em>Lot</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getWorkLocation_NearestIntersection()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getNearestIntersection <em>Nearest Intersection</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
