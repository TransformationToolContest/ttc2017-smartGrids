 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getPropertySpecification <em>Property Specification</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getPassThroughBills <em>Pass Through Bills</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getTransaction <em>Transaction</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getRatingAssets <em>Rating Assets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getErpLedgerEntries <em>Erp Ledger Entries</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getPropertyAssets <em>Property Assets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getErpStatementLineItems <em>Erp Statement Line Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getErpInvoiceLineItems <em>Erp Invoice Line Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getProcedureDataSets <em>Procedure Data Sets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getRatingSpecification <em>Rating Specification</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getProcedure <em>Procedure</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getBillDeterminants <em>Bill Determinants</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.UserAttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
