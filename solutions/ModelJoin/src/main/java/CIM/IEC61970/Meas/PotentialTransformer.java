 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Meas.PotentialTransformer#getNominalRatio <em>Nominal Ratio</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.PotentialTransformer#getPtClass <em>Pt Class</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.PotentialTransformer#getAccuracyClass <em>Accuracy Class</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Meas.MeasPackage#getPotentialTransformer()
...
public interface PotentialTransformer extends Equipment {
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getPotentialTransformer_NominalRatio()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.PotentialTransformer#getNominalRatio <em>Nominal Ratio</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getPotentialTransformer_PtClass()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.PotentialTransformer#getPtClass <em>Pt Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getPotentialTransformer_AccuracyClass()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.PotentialTransformer#getAccuracyClass <em>Accuracy Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
