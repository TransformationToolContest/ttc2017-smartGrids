...
import CIM.IEC61970.Topology.TopologyFactory;
...
public class TopologyPackageImpl extends EPackageImpl implements TopologyPackage {
	 ...
	 * @see CIM.IEC61970.Topology.TopologyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Topology." + eClassifier.getName());
