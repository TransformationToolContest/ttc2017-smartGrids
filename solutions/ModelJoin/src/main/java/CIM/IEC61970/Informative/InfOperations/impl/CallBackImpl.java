 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getAdvice <em>Advice</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getErpPersons <em>Erp Persons</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getProblemInfo <em>Problem Info</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getContactDetail <em>Contact Detail</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getAppointments <em>Appointments</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getTroubleTickets <em>Trouble Tickets</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getDateTime <em>Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.CallBackImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
