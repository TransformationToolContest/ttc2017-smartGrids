 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#isIsDelayedDiscon <em>Is Delayed Discon</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#isIsLocalAutoReconOp <em>Is Local Auto Recon Op</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#isIsLocalAutoDisconOp <em>Is Local Auto Discon Op</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#getSwitches <em>Switches</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#isIsConnected <em>Is Connected</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#getRcdInfo <em>Rcd Info</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#isIsRemoteAutoDisconOp <em>Is Remote Auto Discon Op</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#getEventCount <em>Event Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.LoadControl.impl.ConnectDisconnectFunctionImpl#isIsRemoteAutoReconOp <em>Is Remote Auto Recon Op</em>}</li>
 * </ul>
 *
 * @generated
 */
