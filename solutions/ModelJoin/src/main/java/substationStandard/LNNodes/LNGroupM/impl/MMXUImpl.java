 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getTotW <em>Tot W</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getEEHealth <em>EE Health</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getTotVAr <em>Tot VAr</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getTotVA <em>Tot VA</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getTotPF <em>Tot PF</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getHz <em>Hz</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getPPV <em>PPV</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getPhV <em>Ph V</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getA <em>A</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getW <em>W</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getVAr <em>VAr</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getVA <em>VA</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getPF <em>PF</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupM.impl.MMXUImpl#getZ <em>Z</em>}</li>
 * </ul>
 *
 * @generated
 */
