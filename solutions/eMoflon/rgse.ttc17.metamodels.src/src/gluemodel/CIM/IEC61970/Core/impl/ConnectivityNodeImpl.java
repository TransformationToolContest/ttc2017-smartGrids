 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.ConnectivityNodeImpl#getConnectivityNodeContainer <em>Connectivity Node Container</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.ConnectivityNodeImpl#getTopologicalNode <em>Topological Node</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.ConnectivityNodeImpl#getBusNameMarker <em>Bus Name Marker</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.ConnectivityNodeImpl#getLossPenaltyFactors <em>Loss Penalty Factors</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.ConnectivityNodeImpl#getNodeConstraintTerms <em>Node Constraint Terms</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.ConnectivityNodeImpl#getTerminals <em>Terminals</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.ConnectivityNodeImpl#getPnode <em>Pnode</em>}</li>
 * </ul>
 *
 * @generated
 */
