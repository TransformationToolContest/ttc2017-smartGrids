...
import CIM.IEC61968.PaymentMetering.ChargeKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.ChargeRegister#getChargeKind <em>Charge Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.ChargeRegister#getSPAccountingFunction <em>SP Accounting Function</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.ChargeRegister#getChargeAmount <em>Charge Amount</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getChargeRegister()
...
public interface ChargeRegister extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getChargeRegister_ChargeKind()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.ChargeRegister#getChargeKind <em>Charge Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfPaymentMetering.SDPAccountingFunction#getChargeRegisters <em>Charge Registers</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getChargeRegister_SPAccountingFunction()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.ChargeRegister#getSPAccountingFunction <em>SP Accounting Function</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getChargeRegister_ChargeAmount()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.ChargeRegister#getChargeAmount <em>Charge Amount</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
