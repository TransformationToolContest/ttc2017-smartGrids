...
import gluemodel.CIM.IEC61970.Wires.PhaseTapChangerKind;
import gluemodel.CIM.IEC61970.Wires.PhaseVariationCurve;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getTransformerWinding <em>Transformer Winding</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getWindingConnectionAngle <em>Winding Connection Angle</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getWinding <em>Winding</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getPhaseTapChangerType <em>Phase Tap Changer Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getStepPhaseShiftIncrement <em>Step Phase Shift Increment</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getPhaseVariationCurve <em>Phase Variation Curve</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getVoltageStepIncrementOutOfPhase <em>Voltage Step Increment Out Of Phase</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getNominalVoltageOutOfPhase <em>Nominal Voltage Out Of Phase</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getXStepMax <em>XStep Max</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.PhaseTapChangerImpl#getXStepMin <em>XStep Min</em>}</li>
 * </ul>
 *
 * @generated
 */
