	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InfLoadControlPackage.LOAD_MGMT_FUNCTION: {
				...
				if (result == null) result = caseDeviceFunction(loadMgmtFunction);
			...
			case InfLoadControlPackage.LOAD_SHED_FUNCTION: {
				...
				if (result == null) result = caseDeviceFunction(loadShedFunction);
			...
			case InfLoadControlPackage.LOAD_LIMIT_FUNCTION: {
				...
				if (result == null) result = caseDeviceFunction(loadLimitFunction);
