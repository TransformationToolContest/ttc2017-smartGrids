 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Meas.SetPoint#getNormalValue <em>Normal Value</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.SetPoint#getValue <em>Value</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.SetPoint#getAnalog <em>Analog</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.SetPoint#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.SetPoint#getMinValue <em>Min Value</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Meas.MeasPackage#getSetPoint()
...
public interface SetPoint extends Control {
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getSetPoint_NormalValue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.SetPoint#getNormalValue <em>Normal Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setValue(float)
	 * @see CIM.IEC61970.Meas.MeasPackage#getSetPoint_Value()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.SetPoint#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.Analog#getSetPoint <em>Set Point</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getSetPoint_Analog()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.SetPoint#getAnalog <em>Analog</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getSetPoint_MaxValue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.SetPoint#getMaxValue <em>Max Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getSetPoint_MinValue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.SetPoint#getMinValue <em>Min Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
