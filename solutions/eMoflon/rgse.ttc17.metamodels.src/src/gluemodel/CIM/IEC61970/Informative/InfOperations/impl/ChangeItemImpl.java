...
import gluemodel.CIM.IEC61970.Informative.InfOperations.ChangeItemKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getChangeSet <em>Change Set</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getAsset <em>Asset</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getNetworkDataSet <em>Network Data Set</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getGmlSelector <em>Gml Selector</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getOrganisation <em>Organisation</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getGmlObservation <em>Gml Observation</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getPowerSystemResource <em>Power System Resource</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getDocument <em>Document</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfOperations.impl.ChangeItemImpl#getErpPerson <em>Erp Person</em>}</li>
 * </ul>
 *
 * @generated
 */
