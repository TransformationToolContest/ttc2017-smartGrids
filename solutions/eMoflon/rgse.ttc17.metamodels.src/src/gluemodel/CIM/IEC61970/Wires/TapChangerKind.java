 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61970.Wires.WiresPackage#getTapChangerKind()
 * @model
 * @generated
 */
public enum TapChangerKind implements Enumerator {
	 ...
	 * @ordered
	 */
	PHASE_CONTROL(0, "phaseControl", "phaseControl"),
	 ...
	 * @ordered
	 */
	VOLTAGE_AND_PHASE_CONTROL(2, "voltageAndPhaseControl", "voltageAndPhaseControl"),
	 ...
	 * @ordered
	 */
	public static final int PHASE_CONTROL_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int VOLTAGE_AND_PHASE_CONTROL_VALUE = 2;
