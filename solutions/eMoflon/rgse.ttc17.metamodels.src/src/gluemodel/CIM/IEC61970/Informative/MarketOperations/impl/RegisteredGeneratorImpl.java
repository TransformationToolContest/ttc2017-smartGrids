...
import gluemodel.CIM.IEC61970.Informative.MarketOperations.RampRateCurve;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getLowControlLImit <em>Low Control LImit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getLowerControlRate <em>Lower Control Rate</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getRampRateCurves <em>Ramp Rate Curves</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getUnitInitialConditions <em>Unit Initial Conditions</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getStartUpCostCurves <em>Start Up Cost Curves</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getRaiseRampRate <em>Raise Ramp Rate</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getRaiseControlRate <em>Raise Control Rate</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getMaximumAllowableSpinningReserve <em>Maximum Allowable Spinning Reserve</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getGeneratingUnit <em>Generating Unit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getMaximumOperatingMW <em>Maximum Operating MW</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getHighControlLimit <em>High Control Limit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getMinimumOperatingMW <em>Minimum Operating MW</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getLowerRampRate <em>Lower Ramp Rate</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getGeneratingBids <em>Generating Bids</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.RegisteredGeneratorImpl#getSpinReserveRamp <em>Spin Reserve Ramp</em>}</li>
 * </ul>
 *
 * @generated
 */
