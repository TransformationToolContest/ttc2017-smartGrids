 ...
 * <!-- end-user-doc -->
 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getConductorInsulationKind()
 * @model
 * @generated
 */
public enum ConductorInsulationKind implements Enumerator {
	 ...
	 * @ordered
	 */
	CROSSLINKED_POLYETHYLENE(0, "crosslinkedPolyethylene", "crosslinkedPolyethylene"), /**
	 ...
	 * @ordered
	 */
	TREE_RETARDANT_CROSSLINKED_POLYETHYLENE(2, "treeRetardantCrosslinkedPolyethylene", "treeRetardantCrosslinkedPolyethylene"), /**
	 ...
	 * @ordered
	 */
	ASBESTOS_AND_VARNISHED_CAMBRIC(3, "asbestosAndVarnishedCambric", "asbestosAndVarnishedCambric"),
	 ...
	 * @ordered
	 */
	HIGH_PRESSURE_FLUID_FILLED(4, "highPressureFluidFilled", "highPressureFluidFilled"), /**
	 ...
	 * @ordered
	 */
	ETHYLENE_PROPYLENE_RUBBER(5, "ethylenePropyleneRubber", "ethylenePropyleneRubber"),
	 ...
	 * @ordered
	 */
	OZONE_RESISTANT_RUBBER(6, "ozoneResistantRubber", "ozoneResistantRubber"),
	 ...
	 * @ordered
	 */
	VARNISHED_DACRON_GLASS(8, "varnishedDacronGlass", "varnishedDacronGlass"), /**
	 ...
	 * @ordered
	 */
	HIGH_MOLECULAR_WEIGHT_POLYETHYLENE(9, "highMolecularWeightPolyethylene", "highMolecularWeightPolyethylene"),
	 ...
	 * @ordered
	 */
	VARNISHED_CAMBRIC_CLOTH(10, "varnishedCambricCloth", "varnishedCambricCloth"),
	 ...
	 * @ordered
	 */
	TREE_RESISTANT_HIGH_MOLECULAR_WEIGHT_POLYETHYLENE(12, "treeResistantHighMolecularWeightPolyethylene", "treeResistantHighMolecularWeightPolyethylene"),
	 ...
	 * @ordered
	 */
	UNBELTED_PILC(13, "unbeltedPilc", "unbeltedPilc"),
	 ...
	 * @ordered
	 */
	BELTED_PILC(15, "beltedPilc", "beltedPilc"),
	 ...
	 * @ordered
	 */
	LOW_CAPACITANCE_RUBBER(16, "lowCapacitanceRubber", "lowCapacitanceRubber"),
	 ...
	 * @ordered
	 */
	SILICON_RUBBER(17, "siliconRubber", "siliconRubber");
	 ...
	 * @ordered
	 */
	public static final int CROSSLINKED_POLYETHYLENE_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int TREE_RETARDANT_CROSSLINKED_POLYETHYLENE_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int ASBESTOS_AND_VARNISHED_CAMBRIC_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int HIGH_PRESSURE_FLUID_FILLED_VALUE = 4;
	 ...
	 * @ordered
	 */
	public static final int ETHYLENE_PROPYLENE_RUBBER_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int OZONE_RESISTANT_RUBBER_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int OIL_PAPER_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int VARNISHED_DACRON_GLASS_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int HIGH_MOLECULAR_WEIGHT_POLYETHYLENE_VALUE = 9;
	 ...
	 * @ordered
	 */
	public static final int VARNISHED_CAMBRIC_CLOTH_VALUE = 10;
	 ...
	 * @ordered
	 */
	public static final int TREE_RESISTANT_HIGH_MOLECULAR_WEIGHT_POLYETHYLENE_VALUE = 12;
	 ...
	 * @ordered
	 */
	public static final int UNBELTED_PILC_VALUE = 13;
	 ...
	 * @ordered
	 */
	public static final int RUBBER_VALUE = 14;
	 ...
	 * @ordered
	 */
	public static final int BELTED_PILC_VALUE = 15;
	 ...
	 * @ordered
	 */
	public static final int LOW_CAPACITANCE_RUBBER_VALUE = 16;
	 ...
	 * @ordered
	 */
	public static final int SILICON_RUBBER_VALUE = 17;
