 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getCustomerAgreement <em>Customer Agreement</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getAuxCycle <em>Aux Cycle</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getAuxRef <em>Aux Ref</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getSubCategory <em>Sub Category</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getMinAmount <em>Min Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getVendPortion <em>Vend Portion</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getAuxPriorityCode <em>Aux Priority Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getArrearsInterest <em>Arrears Interest</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getFixedAmount <em>Fixed Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getPayCycle <em>Pay Cycle</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getAuxiliaryAccounts <em>Auxiliary Accounts</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.impl.AuxiliaryAgreementImpl#getVendPortionArrear <em>Vend Portion Arrear</em>}</li>
 * </ul>
 *
 * @generated
 */
