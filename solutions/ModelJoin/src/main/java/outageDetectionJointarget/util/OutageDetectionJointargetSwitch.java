 ...
 * @generated
 */
public class OutageDetectionJointargetSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public OutageDetectionJointargetSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OutageDetectionJointargetPackage.ENERGY_CONSUMER: {
				EnergyConsumer energyConsumer = (EnergyConsumer)theEObject;
				T result = caseEnergyConsumer(energyConsumer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OutageDetectionJointargetPackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OutageDetectionJointargetPackage.POSITION_POINT: {
...
} //OutageDetectionJointargetSwitch
