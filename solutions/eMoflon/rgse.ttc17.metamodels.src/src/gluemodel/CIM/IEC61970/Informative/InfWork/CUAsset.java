 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getTypeAssetCode <em>Type Asset Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getTypeAsset <em>Type Asset</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getCompatibleUnits <em>Compatible Units</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUAsset()
...
public interface CUAsset extends IdentifiedObject {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUAsset_TypeAssetCode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getTypeAssetCode <em>Type Asset Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUAsset_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfTypeAsset.TypeAsset#getCUAsset <em>CU Asset</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUAsset_TypeAsset()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getTypeAsset <em>Type Asset</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUAsset_Quantity()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.CUAsset#getQuantity <em>Quantity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfWork.CompatibleUnit#getCUAssets <em>CU Assets</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getCUAsset_CompatibleUnits()
