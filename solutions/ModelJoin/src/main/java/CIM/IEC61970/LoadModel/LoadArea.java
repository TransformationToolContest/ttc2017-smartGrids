 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.LoadModel.LoadArea#getSubLoadAreas <em>Sub Load Areas</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.LoadModel.LoadModelPackage#getLoadArea()
...
public interface LoadArea extends EnergyArea {
	 ...
	 * The list contents are of type {@link CIM.IEC61970.LoadModel.SubLoadArea}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.LoadModel.SubLoadArea#getLoadArea <em>Load Area</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.LoadModel.LoadModelPackage#getLoadArea_SubLoadAreas()
