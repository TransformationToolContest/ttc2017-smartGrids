 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#isRegulationStatus <em>Regulation Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#isRegulationCapability <em>Regulation Capability</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#getMinP <em>Min P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#getMaxP <em>Max P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#getRegulationTarget <em>Regulation Target</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Equivalents.EquivalentsPackage#getEquivalentInjection()
...
public interface EquivalentInjection extends EquivalentEquipment {
	 ...
	 * @see gluemodel.CIM.IEC61970.Equivalents.EquivalentsPackage#getEquivalentInjection_RegulationStatus()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#isRegulationStatus <em>Regulation Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Equivalents.EquivalentsPackage#getEquivalentInjection_RegulationCapability()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#isRegulationCapability <em>Regulation Capability</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setMinP(float)
	 * @see gluemodel.CIM.IEC61970.Equivalents.EquivalentsPackage#getEquivalentInjection_MinP()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#getMinP <em>Min P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setMaxP(float)
	 * @see gluemodel.CIM.IEC61970.Equivalents.EquivalentsPackage#getEquivalentInjection_MaxP()
	 * @model dataType="gluemodel.CIM.IEC61970.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#getMaxP <em>Max P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Equivalents.EquivalentsPackage#getEquivalentInjection_RegulationTarget()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Equivalents.EquivalentInjection#getRegulationTarget <em>Regulation Target</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
