...
import CIM.IEC61968.Customers.RevenueKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getCode <em>Code</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#isTaxExemption <em>Tax Exemption</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getServiceCategory <em>Service Category</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getCustomerAgreements <em>Customer Agreements</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getDailyFloorUsage <em>Daily Floor Usage</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getRevenueKind <em>Revenue Kind</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getPowerQualityPricings <em>Power Quality Pricings</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getTariffs <em>Tariffs</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getServiceDeliveryPoints <em>Service Delivery Points</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getDailyCeilingUsage <em>Daily Ceiling Usage</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getSubscribePowerCurve <em>Subscribe Power Curve</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getDailyEstimatedUsage <em>Daily Estimated Usage</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.PricingStructureImpl#getTransactions <em>Transactions</em>}</li>
 * </ul>
 *
 * @generated
 */
