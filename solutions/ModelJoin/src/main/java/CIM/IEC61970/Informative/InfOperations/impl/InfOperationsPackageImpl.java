...
import CIM.IEC61970.Informative.InfOperations.InfOperationsFactory;
...
public class InfOperationsPackageImpl extends EPackageImpl implements InfOperationsPackage {
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfOperations." + eClassifier.getName());
