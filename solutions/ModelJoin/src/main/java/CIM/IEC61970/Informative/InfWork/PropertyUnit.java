 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getWorkCostDetails <em>Work Cost Details</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getCompatibleUnits <em>Compatible Units</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getPropertyAccount <em>Property Account</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getCUMaterialItems <em>CU Material Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getAccountingUsage <em>Accounting Usage</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getActivityCode <em>Activity Code</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getPropertyUnit()
...
public interface PropertyUnit extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.WorkCostDetail#getPropertyUnits <em>Property Units</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getPropertyUnit_WorkCostDetails()
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getPropertyUnit_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.CompatibleUnit#getPropertyUnit <em>Property Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getPropertyUnit_CompatibleUnits()
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getPropertyUnit_PropertyAccount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getPropertyAccount <em>Property Account</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.CUMaterialItem#getPropertyUnits <em>Property Units</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getPropertyUnit_CUMaterialItems()
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getPropertyUnit_AccountingUsage()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getAccountingUsage <em>Accounting Usage</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getPropertyUnit_ActivityCode()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.PropertyUnit#getActivityCode <em>Activity Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
