 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getServiceSupplier <em>Service Supplier</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getStandardIndustryCode <em>Standard Industry Code</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getBillingCycle <em>Billing Cycle</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getServiceDeliveryPoints <em>Service Delivery Points</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getMeterReadings <em>Meter Readings</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getServiceLocations <em>Service Locations</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getPricingStructures <em>Pricing Structures</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getLoadMgmt <em>Load Mgmt</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getAuxiliaryAgreements <em>Auxiliary Agreements</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getEndDeviceControls <em>End Device Controls</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getBudgetBill <em>Budget Bill</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getServiceCategory <em>Service Category</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getCustomerAccount <em>Customer Account</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getDemandResponseProgram <em>Demand Response Program</em>}</li>
 *   <li>{@link CIM.IEC61968.Customers.impl.CustomerAgreementImpl#getEquipments <em>Equipments</em>}</li>
 * </ul>
 *
 * @generated
 */
