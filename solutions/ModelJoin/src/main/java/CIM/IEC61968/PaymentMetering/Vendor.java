 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Vendor#getPointOfSales <em>Point Of Sales</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Vendor#getCashiers <em>Cashiers</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Vendor#getMerchantAccount <em>Merchant Account</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Vendor#getBankStatements <em>Bank Statements</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Vendor#getVendorShifts <em>Vendor Shifts</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendor()
...
public interface Vendor extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendor_PointOfSales()
	 ...
	 * The list contents are of type {@link CIM.IEC61968.PaymentMetering.Cashier}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Cashier#getVendor <em>Vendor</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendor_Cashiers()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.MerchantAccount#getVendors <em>Vendors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendor_MerchantAccount()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Vendor#getMerchantAccount <em>Merchant Account</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfPaymentMetering.BankStatement#getVendor <em>Vendor</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendor_BankStatements()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.VendorShift#getVendor <em>Vendor</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendor_VendorShifts()
