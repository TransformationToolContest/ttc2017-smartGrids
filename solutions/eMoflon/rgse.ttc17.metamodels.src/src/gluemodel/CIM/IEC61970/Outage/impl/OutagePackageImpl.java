...
import gluemodel.CIM.IEC61970.Outage.OutageFactory;
 ...
 * @generated
 */
public class OutagePackageImpl extends EPackageImpl implements OutagePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gluemodel.CIM.IEC61970.Outage.OutagePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OutagePackageImpl() {
		super(eNS_URI, OutageFactory.eINSTANCE);
	}
	...
	public static OutagePackage init() {
		...
		OutagePackageImpl theOutagePackage = (OutagePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OutagePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OutagePackageImpl());
	...
	public EClass getOutageSchedule() {
		if (outageScheduleEClass == null) {
			outageScheduleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OutagePackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EClass getClearanceTagType() {
		if (clearanceTagTypeEClass == null) {
			clearanceTagTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OutagePackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EClass getClearanceTag() {
		if (clearanceTagEClass == null) {
			clearanceTagEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OutagePackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	public EReference getClearanceTag_SafetyDocument() {
        return (EReference)getClearanceTag().getEStructuralFeatures().get(1);
	}
	...
	public EReference getClearanceTag_ClearanceTagType() {
        return (EReference)getClearanceTag().getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getClearanceTag_WorkEndTime() {
        return (EAttribute)getClearanceTag().getEStructuralFeatures().get(4);
	}
	...
	public EReference getClearanceTag_ConductingEquipment() {
        return (EReference)getClearanceTag().getEStructuralFeatures().get(6);
	}
	...
	public EAttribute getClearanceTag_DeenergizeReqFlag() {
        return (EAttribute)getClearanceTag().getEStructuralFeatures().get(8);
	}
	...
	public EAttribute getClearanceTag_WorkStartTime() {
        return (EAttribute)getClearanceTag().getEStructuralFeatures().get(9);
	}
	...
	public EClass getSwitchingOperation() {
		if (switchingOperationEClass == null) {
			switchingOperationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OutagePackage.eNS_URI).getEClassifiers().get(4);
		}
	...
	public EReference getSwitchingOperation_Switches() {
        return (EReference)getSwitchingOperation().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getSwitchingOperation_OperationTime() {
        return (EAttribute)getSwitchingOperation().getEStructuralFeatures().get(1);
	}
	...
	public EReference getSwitchingOperation_OutageSchedule() {
        return (EReference)getSwitchingOperation().getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getSwitchingOperation_NewState() {
        return (EAttribute)getSwitchingOperation().getEStructuralFeatures().get(3);
	}
	...
	public EEnum getSwitchState() {
		if (switchStateEEnum == null) {
			switchStateEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(OutagePackage.eNS_URI).getEClassifiers().get(2);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Outage." + eClassifier.getName());
