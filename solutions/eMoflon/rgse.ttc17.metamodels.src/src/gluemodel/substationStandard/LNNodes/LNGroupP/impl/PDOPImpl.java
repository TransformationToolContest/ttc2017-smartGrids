...
import gluemodel.substationStandard.LNNodes.LNGroupP.PDOP;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PDOP</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupP.impl.PDOPImpl#getStr <em>Str</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupP.impl.PDOPImpl#getOp <em>Op</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupP.impl.PDOPImpl#getDirMod <em>Dir Mod</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupP.impl.PDOPImpl#getStrVal <em>Str Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupP.impl.PDOPImpl#getOpDlTmms <em>Op Dl Tmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupP.impl.PDOPImpl#getRsDlTmms <em>Rs Dl Tmms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PDOPImpl extends GroupPImpl implements PDOP {
	/**
	...
	protected EClass eStaticClass() {
		return LNGroupPPackage.Literals.PDOP;
	}
		...
		if (str != null && str.eIsProxy()) {
			...
			if (str != oldStr) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LNGroupPPackage.PDOP__STR, oldStr, str));
			}
		}
		return str;
	}
	...
	public void setStr(ACD newStr) {
		...
		str = newStr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LNGroupPPackage.PDOP__STR, oldStr, str));
	}
	...
	public ACT getOp() {
		if (op != null && op.eIsProxy()) {
			...
			if (op != oldOp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LNGroupPPackage.PDOP__OP, oldOp, op));
			}
		}
		return op;
	}
	...
	public void setOp(ACT newOp) {
		...
		op = newOp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LNGroupPPackage.PDOP__OP, oldOp, op));
	}
	...
	public ING getDirMod() {
		if (dirMod != null && dirMod.eIsProxy()) {
			...
			if (dirMod != oldDirMod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LNGroupPPackage.PDOP__DIR_MOD, oldDirMod, dirMod));
			}
		}
		return dirMod;
	}
	...
	public void setDirMod(ING newDirMod) {
		...
		dirMod = newDirMod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LNGroupPPackage.PDOP__DIR_MOD, oldDirMod, dirMod));
	}
	...
	public ASG getStrVal() {
		if (strVal != null && strVal.eIsProxy()) {
			...
			if (strVal != oldStrVal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LNGroupPPackage.PDOP__STR_VAL, oldStrVal, strVal));
			}
		}
		return strVal;
	}
	...
	public void setStrVal(ASG newStrVal) {
		...
		strVal = newStrVal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LNGroupPPackage.PDOP__STR_VAL, oldStrVal, strVal));
	}
	...
	public ING getOpDlTmms() {
		if (opDlTmms != null && opDlTmms.eIsProxy()) {
			...
			if (opDlTmms != oldOpDlTmms) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LNGroupPPackage.PDOP__OP_DL_TMMS, oldOpDlTmms, opDlTmms));
			}
		}
		return opDlTmms;
	}
	...
	public void setOpDlTmms(ING newOpDlTmms) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LNGroupPPackage.PDOP__OP_DL_TMMS, oldOpDlTmms, opDlTmms));
	}
	...
	public ING getRsDlTmms() {
		if (rsDlTmms != null && rsDlTmms.eIsProxy()) {
			...
			if (rsDlTmms != oldRsDlTmms) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LNGroupPPackage.PDOP__RS_DL_TMMS, oldRsDlTmms, rsDlTmms));
			}
		}
		return rsDlTmms;
	}
	...
	public void setRsDlTmms(ING newRsDlTmms) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LNGroupPPackage.PDOP__RS_DL_TMMS, oldRsDlTmms, rsDlTmms));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LNGroupPPackage.PDOP__STR:
				if (resolve) return getStr();
				return basicGetStr();
			case LNGroupPPackage.PDOP__OP:
				if (resolve) return getOp();
				return basicGetOp();
			case LNGroupPPackage.PDOP__DIR_MOD:
				if (resolve) return getDirMod();
				return basicGetDirMod();
			case LNGroupPPackage.PDOP__STR_VAL:
				if (resolve) return getStrVal();
				return basicGetStrVal();
			case LNGroupPPackage.PDOP__OP_DL_TMMS:
				if (resolve) return getOpDlTmms();
				return basicGetOpDlTmms();
			case LNGroupPPackage.PDOP__RS_DL_TMMS:
