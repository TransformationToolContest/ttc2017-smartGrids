...
import gluemodel.CIM.IEC61968.AssetModels.CableConstructionKind;
import gluemodel.CIM.IEC61968.AssetModels.CableInfo;
import gluemodel.CIM.IEC61968.AssetModels.CableOuterJacketKind;
import gluemodel.CIM.IEC61968.AssetModels.CableShieldMaterialKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#isSheathAsNeutral <em>Sheath As Neutral</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#isIsStrandFill <em>Is Strand Fill</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getOuterJacketKind <em>Outer Jacket Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getConstructionKind <em>Construction Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getDiameterOverScreen <em>Diameter Over Screen</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getNominalTemperature <em>Nominal Temperature</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getDiameterOverJacket <em>Diameter Over Jacket</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getDiameterOverCore <em>Diameter Over Core</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getDiameterOverInsulation <em>Diameter Over Insulation</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getShieldMaterial <em>Shield Material</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.CableInfoImpl#getDuctBankInfo <em>Duct Bank Info</em>}</li>
 * </ul>
 *
 * @generated
 */
