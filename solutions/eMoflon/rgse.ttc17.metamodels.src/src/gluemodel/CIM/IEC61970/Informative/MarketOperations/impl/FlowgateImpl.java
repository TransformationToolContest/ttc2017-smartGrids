...
import gluemodel.CIM.IEC61970.Informative.MarketOperations.TransmissionReliabilityMargin;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getTransmissionReliabilityMargin <em>Transmission Reliability Margin</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getAfcUseCode <em>Afc Use Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getIdcOperationalName <em>Idc Operational Name</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getInServiceDate <em>In Service Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getViolationLimits <em>Violation Limits</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getOutOfServiceDate <em>Out Of Service Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getCapacityBenefitMargin <em>Capacity Benefit Margin</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#isCoordinatedFlag <em>Coordinated Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#isAtcFlag <em>Atc Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getDeletionDate <em>Deletion Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#isReciprocalFlag <em>Reciprocal Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getIdcAssignedId <em>Idc Assigned Id</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getPowerTransormers <em>Power Transormers</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getPositiveImpactValue <em>Positive Impact Value</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getFTRs <em>FT Rs</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getLines <em>Lines</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getCounterFlowValue <em>Counter Flow Value</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getCoordinationStudyDate <em>Coordination Study Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getSubControlArea <em>Sub Control Area</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getIdcType <em>Idc Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#isManagingEntityFlag <em>Managing Entity Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.impl.FlowgateImpl#getTransmissionProvider <em>Transmission Provider</em>}</li>
 * </ul>
 *
 * @generated
 */
