 ...
 *   <li>{@link CIM.CombinedVersion#getDate <em>Date</em>}</li>
 * </ul>
 *
 * @see CIM.CIMPackage#getCombinedVersion()
...
public interface CombinedVersion extends Element {
	 ...
	 * @see CIM.CIMPackage#getCombinedVersion_Version()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.CombinedVersion#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setDate(Date)
	 * @see CIM.CIMPackage#getCombinedVersion_Date()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.CombinedVersion#getDate <em>Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
