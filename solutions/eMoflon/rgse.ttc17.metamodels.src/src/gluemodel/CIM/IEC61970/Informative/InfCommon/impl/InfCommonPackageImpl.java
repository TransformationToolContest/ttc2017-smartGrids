...
import gluemodel.CIM.IEC61970.Informative.InfCommon.InfCommonFactory;
 ...
 * @generated
 */
public class InfCommonPackageImpl extends EPackageImpl implements InfCommonPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfCommon.InfCommonPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InfCommonPackageImpl() {
		super(eNS_URI, InfCommonFactory.eINSTANCE);
	}
	...
	public static InfCommonPackage init() {
		...
		InfCommonPackageImpl theInfCommonPackage = (InfCommonPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InfCommonPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InfCommonPackageImpl());
	...
	public EClass getDocDocRole() {
		if (docDocRoleEClass == null) {
			docDocRoleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(2);
		}
	...
	public EClass getScheduleParameterInfo() {
		if (scheduleParameterInfoEClass == null) {
			scheduleParameterInfoEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	public EClass getScheduledEvent() {
		if (scheduledEventEClass == null) {
			scheduledEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(4);
		}
	...
	public EAttribute getScheduledEvent_Duration() {
        return (EAttribute)getScheduledEvent().getEStructuralFeatures().get(2);
	}
	...
	public EClass getBankAccount() {
		if (bankAccountEClass == null) {
			bankAccountEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(5);
		}
	...
	public EAttribute getBankAccount_AccountNumber() {
        return (EAttribute)getBankAccount().getEStructuralFeatures().get(0);
	}
	...
	public EReference getBankAccount_ServiceSupplier() {
        return (EReference)getBankAccount().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getBankAccount_BankStatements() {
        return (EReference)getBankAccount().getEStructuralFeatures().get(3);
	}
	...
	public EClass getDocPsrRole() {
		if (docPsrRoleEClass == null) {
			docPsrRoleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(6);
		}
	...
	public EClass getBusinessRole() {
		if (businessRoleEClass == null) {
			businessRoleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(7);
		}
	...
	public EAttribute getBusinessRole_Category() {
        return (EAttribute)getBusinessRole().getEStructuralFeatures().get(1);
	}
	...
	public EReference getBusinessRole_Organisations() {
        return (EReference)getBusinessRole().getEStructuralFeatures().get(2);
	}
	...
	public EClass getMarketRole() {
		if (marketRoleEClass == null) {
			marketRoleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(8);
		}
	 ...
	 * @generated
	 */
	public EReference getMarketRole_Organisations() {
	...
	public EClass getSkill() {
		if (skillEClass == null) {
			skillEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(9);
		}
		return skillEClass;
	}
	...
	public EReference getSkill_ErpPerson() {
        return (EReference)getSkill().getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getSkill_EffectiveDateTime() {
        return (EAttribute)getSkill().getEStructuralFeatures().get(4);
	}
	...
	public EClass getRole() {
		if (roleEClass == null) {
			roleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(10);
		}
		return roleEClass;
	}
	...
	public EClass getRatio() {
		if (ratioEClass == null) {
			ratioEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(11);
		}
		return ratioEClass;
	}
	...
	public EClass getBusinessPlan() {
		if (businessPlanEClass == null) {
			businessPlanEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(13);
		}
	...
	public EClass getCraft() {
		if (craftEClass == null) {
			craftEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(14);
		}
		return craftEClass;
	}
	...
	public EReference getCraft_Status() {
        return (EReference)getCraft().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getCraft_Category() {
        return (EAttribute)getCraft().getEStructuralFeatures().get(4);
	}
	...
	public EEnum getSkillLevelKind() {
		if (skillLevelKindEEnum == null) {
			skillLevelKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EEnum getMarketRoleKind() {
		if (marketRoleKindEEnum == null) {
			marketRoleKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EEnum getDCPolarityKind() {
		if (dcPolarityKindEEnum == null) {
			dcPolarityKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(InfCommonPackage.eNS_URI).getEClassifiers().get(12);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.InfCommon." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //InfCommonPackageImpl
