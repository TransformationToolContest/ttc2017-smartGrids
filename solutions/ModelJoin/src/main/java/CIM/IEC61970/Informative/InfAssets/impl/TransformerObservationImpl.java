 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getOilIFT <em>Oil IFT</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getHotSpotTemp <em>Hot Spot Temp</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getOilDielectricStrength <em>Oil Dielectric Strength</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getTransformerAsset <em>Transformer Asset</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getTopOilTemp <em>Top Oil Temp</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getPumpVibration <em>Pump Vibration</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getBushingTemp <em>Bushing Temp</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getWaterContent <em>Water Content</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getTransformer <em>Transformer</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getProcedureDataSets <em>Procedure Data Sets</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getFreqResp <em>Freq Resp</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getFurfuralDP <em>Furfural DP</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getBushingInsultationPFs <em>Bushing Insultation PFs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getOilLevel <em>Oil Level</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getOilColor <em>Oil Color</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getWindingInsulationPFs <em>Winding Insulation PFs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getDga <em>Dga</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.TransformerObservationImpl#getOilNeutralizationNumber <em>Oil Neutralization Number</em>}</li>
 * </ul>
 *
 * @generated
 */
