...
import COSEM.COSEMObjects.ParameterChangesObject;
 ...
 * </p>
 * <ul>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getNumberConfigProgramChanges <em>Number Config Program Changes</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateLastConfigChange <em>Date Last Config Change</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateLastSwitchChange <em>Date Last Switch Change</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateLastRippleControlChange <em>Date Last Ripple Control Change</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getStatusSecuritySwitches <em>Status Security Switches</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateLastCalibration <em>Date Last Calibration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateNextConfig <em>Date Next Config</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateActivationPassivCalendar <em>Date Activation Passiv Calendar</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getNumberProtectedConfigChanges <em>Number Protected Config Changes</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateLastProtectedConfigChange <em>Date Last Protected Config Change</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateLastClockSynch <em>Date Last Clock Synch</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.ParameterChangesObjectImpl#getDateLastFirmwareActivation <em>Date Last Firmware Activation</em>}</li>
 * </ul>
 *
 * @generated
 */
