 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getConductingEquipments <em>Conducting Equipments</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getHighLimit <em>High Limit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getUnit <em>Unit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getRelayDelayTime <em>Relay Delay Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getProtectedSwitches <em>Protected Switches</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#isPowerDirectionFlag <em>Power Direction Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getLowLimit <em>Low Limit</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#getProtectionEquipment()
...
public interface ProtectionEquipment extends Equipment {
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61970.Core.ConductingEquipment}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Core.ConductingEquipment#getProtectionEquipments <em>Protection Equipments</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#getProtectionEquipment_ConductingEquipments()
	 ...
	 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#getProtectionEquipment_HighLimit()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getHighLimit <em>High Limit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Core.Unit#getProtectionEquipments <em>Protection Equipments</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setUnit(Unit)
	 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#getProtectionEquipment_Unit()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getUnit <em>Unit</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#getProtectionEquipment_RelayDelayTime()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getRelayDelayTime <em>Relay Delay Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61970.Wires.ProtectedSwitch}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#getProtectionEquipment_ProtectedSwitches()
	 ...
	 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#getProtectionEquipment_PowerDirectionFlag()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#isPowerDirectionFlag <em>Power Direction Flag</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Protection.ProtectionPackage#getProtectionEquipment_LowLimit()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Protection.ProtectionEquipment#getLowLimit <em>Low Limit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
