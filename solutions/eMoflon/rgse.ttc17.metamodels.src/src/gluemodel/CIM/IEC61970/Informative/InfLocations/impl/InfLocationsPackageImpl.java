...
import gluemodel.CIM.IEC61970.Informative.InfLocations.InfLocationsFactory;
...
public class InfLocationsPackageImpl extends EPackageImpl implements InfLocationsPackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfLocations.InfLocationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.InfLocations." + eClassifier.getName());
