...
import gluemodel.substationStandard.LNNodes.LNGroupY.LNGroupYFactory;
...
public class LNGroupYPackageImpl extends EPackageImpl implements LNGroupYPackage {
	 ...
	 * @see gluemodel.substationStandard.LNNodes.LNGroupY.LNGroupYPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getGroupY() {
		if (groupYEClass == null) {
			groupYEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupYPackage.eNS_URI).getEClassifiers().get(0);
		}
		return groupYEClass;
	}
	...
	public EReference getGroupY_EEName() {
        return (EReference)getGroupY().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getGroupY_EEHealth() {
        return (EAttribute)getGroupY().getEStructuralFeatures().get(1);
	}
	...
	public EClass getYEFN() {
		if (yefnEClass == null) {
			yefnEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupYPackage.eNS_URI).getEClassifiers().get(1);
		}
		return yefnEClass;
	}
	...
	public EReference getYEFN_Loc() {
        return (EReference)getYEFN().getEStructuralFeatures().get(0);
	}
	...
	public EReference getYEFN_OpTmh() {
        return (EReference)getYEFN().getEStructuralFeatures().get(1);
	}
	...
	public EReference getYEFN_ECA() {
        return (EReference)getYEFN().getEStructuralFeatures().get(2);
	}
	...
	public EReference getYEFN_ColTapPos() {
        return (EReference)getYEFN().getEStructuralFeatures().get(3);
	}
	...
	public EReference getYEFN_ColPos() {
        return (EReference)getYEFN().getEStructuralFeatures().get(4);
	}
	...
	public EClass getYLTC() {
		if (yltcEClass == null) {
			yltcEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupYPackage.eNS_URI).getEClassifiers().get(2);
		}
		return yltcEClass;
	}
	...
	public EReference getYLTC_OpCnt() {
        return (EReference)getYLTC().getEStructuralFeatures().get(0);
	}
	...
	public EReference getYLTC_Torq() {
        return (EReference)getYLTC().getEStructuralFeatures().get(1);
	}
	...
	public EReference getYLTC_MotDrvA() {
        return (EReference)getYLTC().getEStructuralFeatures().get(2);
	}
	...
	public EReference getYLTC_TapPos() {
        return (EReference)getYLTC().getEStructuralFeatures().get(3);
	}
	...
	public EReference getYLTC_TapChg() {
        return (EReference)getYLTC().getEStructuralFeatures().get(4);
	}
	...
	public EReference getYLTC_EndPosR() {
        return (EReference)getYLTC().getEStructuralFeatures().get(5);
	}
	...
	public EReference getYLTC_EndPosL() {
        return (EReference)getYLTC().getEStructuralFeatures().get(6);
	}
	...
	public EReference getYLTC_OilFil() {
        return (EReference)getYLTC().getEStructuralFeatures().get(7);
	}
	...
	public EClass getYPSH() {
		if (ypshEClass == null) {
			ypshEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupYPackage.eNS_URI).getEClassifiers().get(3);
		}
		return ypshEClass;
	}
	...
	public EReference getYPSH_OpTmh() {
        return (EReference)getYPSH().getEStructuralFeatures().get(0);
	}
	...
	public EReference getYPSH_Pos() {
        return (EReference)getYPSH().getEStructuralFeatures().get(1);
	}
	...
	public EReference getYPSH_BlkOpn() {
        return (EReference)getYPSH().getEStructuralFeatures().get(2);
	}
	...
	public EReference getYPSH_BlkCls() {
        return (EReference)getYPSH().getEStructuralFeatures().get(3);
	}
	...
	public EReference getYPSH_ChaMotEna() {
        return (EReference)getYPSH().getEStructuralFeatures().get(4);
	}
	...
	public EAttribute getYPSH_ShOpCap() {
        return (EAttribute)getYPSH().getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getYPSH_MaxOpCap() {
        return (EAttribute)getYPSH().getEStructuralFeatures().get(6);
	}
	...
	public EClass getYPTR() {
		if (yptrEClass == null) {
			yptrEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupYPackage.eNS_URI).getEClassifiers().get(4);
		}
		return yptrEClass;
	}
	...
	public EReference getYPTR_OpTmh() {
        return (EReference)getYPTR().getEStructuralFeatures().get(0);
	}
	...
	public EReference getYPTR_HPTmp() {
        return (EReference)getYPTR().getEStructuralFeatures().get(1);
	}
	...
	public EReference getYPTR_HPZmpAlm() {
        return (EReference)getYPTR().getEStructuralFeatures().get(2);
	}
	...
	public EReference getYPTR_HPTmpTr() {
        return (EReference)getYPTR().getEStructuralFeatures().get(3);
	}
	...
	public EReference getYPTR_OANL() {
        return (EReference)getYPTR().getEStructuralFeatures().get(4);
	}
	...
	public EReference getYPTR_OpOvA() {
        return (EReference)getYPTR().getEStructuralFeatures().get(5);
	}
	...
	public EReference getYPTR_OpOvV() {
        return (EReference)getYPTR().getEStructuralFeatures().get(6);
	}
	...
	public EReference getYPTR_OpUnV() {
        return (EReference)getYPTR().getEStructuralFeatures().get(7);
	}
	...
	public EReference getYPTR_CGAlm() {
        return (EReference)getYPTR().getEStructuralFeatures().get(8);
	}
	...
	public EReference getYPTR_HiVRtg() {
        return (EReference)getYPTR().getEStructuralFeatures().get(9);
	}
	...
	public EReference getYPTR_LoVRtg() {
        return (EReference)getYPTR().getEStructuralFeatures().get(10);
	}
	...
	public EReference getYPTR_PwrRtg() {
        return (EReference)getYPTR().getEStructuralFeatures().get(11);
	}
	...
	public EReference getYPTR_TransformerControl() {
        return (EReference)getYPTR().getEStructuralFeatures().get(12);
	}
