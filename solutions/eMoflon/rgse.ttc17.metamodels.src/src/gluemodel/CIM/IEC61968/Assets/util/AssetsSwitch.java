...
public class AssetsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AssetsPackage.ACCEPTANCE_TEST: {
				...
				if (result == null) result = caseElement(acceptanceTest);
			...
			case AssetsPackage.COM_MEDIA_ASSET: {
				ComMediaAsset comMediaAsset = (ComMediaAsset)theEObject;
				T result = caseComMediaAsset(comMediaAsset);
				if (result == null) result = caseAsset(comMediaAsset);
				if (result == null) result = caseIdentifiedObject(comMediaAsset);
				if (result == null) result = caseElement(comMediaAsset);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Com Media Asset</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Com Media Asset</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComMediaAsset(ComMediaAsset object) {
		return null;
	}
