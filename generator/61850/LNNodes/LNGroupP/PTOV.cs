...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupP/PTOV")]
    public class PTOV : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP.GroupP, IPTOV, IModelElement
    {
        ...
        public virtual ICSD TmVst
        {
            ...
            set
            {
                if ((this._tmVst != value))
                {
                    ...
                    this.OnPropertyChanging("TmVst", e);
                    this._tmVst = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("TmVst", e);
                }
            }
        }
        ...
        public virtual ICURVE TmVCrv
        {
            ...
            set
            {
                if ((this._tmVCrv != value))
                {
                    ...
                    this.OnPropertyChanging("TmVCrv", e);
                    this._tmVCrv = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("TmVCrv", e);
                }
            }
        }
        ...
        private sealed class TmVstProxy : ModelPropertyChange<IPTOV, ICSD>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.TmVstChanged += handler;
            }
        ...
        private sealed class TmVCrvProxy : ModelPropertyChange<IPTOV, ICURVE>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.TmVCrvChanged += handler;
            }
