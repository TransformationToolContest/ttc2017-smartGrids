...
import gluemodel.CIM.IEC61968.AssetModels.ConcentricNeutralCableInfo;
import gluemodel.CIM.IEC61968.AssetModels.ConductorMaterialKind;
import gluemodel.CIM.IEC61968.AssetModels.WireArrangement;
import gluemodel.CIM.IEC61968.AssetModels.WireType;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getRAC75 <em>RAC75</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getRAC50 <em>RAC50</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getRadius <em>Radius</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getConcentricNeutralCableInfos <em>Concentric Neutral Cable Infos</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getStrandCount <em>Strand Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getCoreRadius <em>Core Radius</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getRAC25 <em>RAC25</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getRDC20 <em>RDC20</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getSizeDescription <em>Size Description</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getCoreStrandCount <em>Core Strand Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getWireArrangements <em>Wire Arrangements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getRatedCurrent <em>Rated Current</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getGmr <em>Gmr</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.impl.WireTypeImpl#getMaterial <em>Material</em>}</li>
 * </ul>
 *
 * @generated
 */
