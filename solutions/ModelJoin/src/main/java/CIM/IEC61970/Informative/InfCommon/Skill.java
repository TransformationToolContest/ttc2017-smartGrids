 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Skill#getCertificationPeriod <em>Certification Period</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Skill#getErpPerson <em>Erp Person</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Skill#getCrafts <em>Crafts</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Skill#getLevel <em>Level</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Skill#getEffectiveDateTime <em>Effective Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Skill#getQualificationRequirements <em>Qualification Requirements</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getSkill()
...
public interface Skill extends Document {
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getSkill_CertificationPeriod()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.Skill#getCertificationPeriod <em>Certification Period</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfERPSupport.ErpPerson#getSkills <em>Skills</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getSkill_ErpPerson()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.Skill#getErpPerson <em>Erp Person</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfCommon.Craft#getSkills <em>Skills</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getSkill_Crafts()
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Informative.InfCommon.SkillLevelKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getSkill_Level()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.Skill#getLevel <em>Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getSkill_EffectiveDateTime()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.Skill#getEffectiveDateTime <em>Effective Date Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.QualificationRequirement#getSkills <em>Skills</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getSkill_QualificationRequirements()
