 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getSecondaryAddress <em>Secondary Address</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getDirections <em>Directions</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getPowerSystemResources <em>Power System Resources</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getPhone2 <em>Phone2</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getPhone1 <em>Phone1</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getLandProperties <em>Land Properties</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getGeoInfoReference <em>Geo Info Reference</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getDimensionsInfo <em>Dimensions Info</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getChangeItems <em>Change Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getErpOrganisations <em>Erp Organisations</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getCoordinateSystems <em>Coordinate Systems</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getAssets <em>Assets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getRoutes <em>Routes</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getHazards <em>Hazards</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getMainAddress <em>Main Address</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getElectronicAddress <em>Electronic Address</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getCorporateCode <em>Corporate Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getRedLines <em>Red Lines</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getCrews <em>Crews</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.LocationImpl#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @generated
 */
