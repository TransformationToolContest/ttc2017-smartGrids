 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see CIM.IEC61970.Informative.InfCore.InfCoreFactory
 * @model kind="package"
 * @generated
 */
public interface InfCorePackage extends EPackage {
	 ...
	 * @generated
	 */
	InfCorePackage eINSTANCE = CIM.IEC61970.Informative.InfCore.impl.InfCorePackageImpl.init();

	/**
	 * The meta object id for the '{@link CIM.IEC61970.Informative.InfCore.impl.ModelingAuthoritySetImpl <em>Modeling Authority Set</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see CIM.IEC61970.Informative.InfCore.impl.ModelingAuthoritySetImpl
	 * @see CIM.IEC61970.Informative.InfCore.impl.InfCorePackageImpl#getModelingAuthoritySet()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link CIM.IEC61970.Informative.InfCore.impl.ModelingAuthorityImpl <em>Modeling Authority</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see CIM.IEC61970.Informative.InfCore.impl.ModelingAuthorityImpl
	 * @see CIM.IEC61970.Informative.InfCore.impl.InfCorePackageImpl#getModelingAuthority()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link CIM.IEC61970.Informative.InfCore.ModelingAuthoritySet <em>Modeling Authority Set</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Modeling Authority Set</em>'.
	 * @see CIM.IEC61970.Informative.InfCore.ModelingAuthoritySet
	 * @generated
	 */
	EClass getModelingAuthoritySet();

	/**
	 * Returns the meta object for the reference list '{@link CIM.IEC61970.Informative.InfCore.ModelingAuthoritySet#getIdentifiedObjects <em>Identified Objects</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link CIM.IEC61970.Informative.InfCore.ModelingAuthoritySet#getModelingAuthority <em>Modeling Authority</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link CIM.IEC61970.Informative.InfCore.ModelingAuthority <em>Modeling Authority</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Modeling Authority</em>'.
	 * @see CIM.IEC61970.Informative.InfCore.ModelingAuthority
	 * @generated
	 */
	EClass getModelingAuthority();

	/**
	 * Returns the meta object for the reference list '{@link CIM.IEC61970.Informative.InfCore.ModelingAuthority#getModelingAuthoritySets <em>Modeling Authority Sets</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Modeling Authority Sets</em>'.
	 * @see CIM.IEC61970.Informative.InfCore.ModelingAuthority#getModelingAuthoritySets()
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link CIM.IEC61970.Informative.InfCore.impl.ModelingAuthoritySetImpl <em>Modeling Authority Set</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see CIM.IEC61970.Informative.InfCore.impl.ModelingAuthoritySetImpl
		 * @see CIM.IEC61970.Informative.InfCore.impl.InfCorePackageImpl#getModelingAuthoritySet()
		...
		/**
		 * The meta object literal for the '{@link CIM.IEC61970.Informative.InfCore.impl.ModelingAuthorityImpl <em>Modeling Authority</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see CIM.IEC61970.Informative.InfCore.impl.ModelingAuthorityImpl
		 * @see CIM.IEC61970.Informative.InfCore.impl.InfCorePackageImpl#getModelingAuthority()
