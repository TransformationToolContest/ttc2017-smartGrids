...
import gluemodel.substationStandard.LNNodes.LNGroupC.LNGroupCFactory;
...
public class LNGroupCPackageImpl extends EPackageImpl implements LNGroupCPackage {
	 ...
	 * @see gluemodel.substationStandard.LNNodes.LNGroupC.LNGroupCPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getGroupC() {
		if (groupCEClass == null) {
			groupCEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupCPackage.eNS_URI).getEClassifiers().get(0);
		}
		return groupCEClass;
	}
	...
	public EClass getCALH() {
		if (calhEClass == null) {
			calhEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupCPackage.eNS_URI).getEClassifiers().get(1);
		}
		return calhEClass;
	}
	...
	public EReference getCALH_GrAlm() {
        return (EReference)getCALH().getEStructuralFeatures().get(0);
	}
	...
	public EReference getCALH_GrWrn() {
        return (EReference)getCALH().getEStructuralFeatures().get(1);
	}
	...
	public EReference getCALH_AlmLstOv() {
        return (EReference)getCALH().getEStructuralFeatures().get(2);
	}
	...
	public EClass getCILO() {
		if (ciloEClass == null) {
			ciloEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupCPackage.eNS_URI).getEClassifiers().get(2);
		}
		return ciloEClass;
	}
	...
	public EReference getCILO_EnaOpn() {
        return (EReference)getCILO().getEStructuralFeatures().get(0);
	}
	...
	public EReference getCILO_EnaCls() {
        return (EReference)getCILO().getEStructuralFeatures().get(1);
	}
	...
	public EClass getCCGR() {
		if (ccgrEClass == null) {
			ccgrEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupCPackage.eNS_URI).getEClassifiers().get(3);
		}
		return ccgrEClass;
	}
	...
	public EReference getCCGR_EEHealth() {
        return (EReference)getCCGR().getEStructuralFeatures().get(0);
	}
	...
	public EReference getCCGR_EEName() {
        return (EReference)getCCGR().getEStructuralFeatures().get(1);
	}
	...
	public EReference getCCGR_OpTmh() {
        return (EReference)getCCGR().getEStructuralFeatures().get(2);
	}
	...
	public EReference getCCGR_EnvTmp() {
        return (EReference)getCCGR().getEStructuralFeatures().get(3);
	}
	...
	public EReference getCCGR_OilTmpIn() {
        return (EReference)getCCGR().getEStructuralFeatures().get(4);
	}
	...
	public EReference getCCGR_OilTmpOut() {
        return (EReference)getCCGR().getEStructuralFeatures().get(5);
	}
	...
	public EReference getCCGR_OilMotA() {
        return (EReference)getCCGR().getEStructuralFeatures().get(6);
	}
	...
	public EReference getCCGR_FanFlw() {
        return (EReference)getCCGR().getEStructuralFeatures().get(7);
	}
	...
	public EReference getCCGR_FanA() {
        return (EReference)getCCGR().getEStructuralFeatures().get(8);
	}
	...
	public EReference getCCGR_CECtl() {
        return (EReference)getCCGR().getEStructuralFeatures().get(9);
	}
	...
	public EReference getCCGR_PmpCtlGen() {
        return (EReference)getCCGR().getEStructuralFeatures().get(10);
	}
	...
	public EReference getCCGR_PmpCtl() {
        return (EReference)getCCGR().getEStructuralFeatures().get(11);
	}
	...
	public EReference getCCGR_FanCtlGen() {
        return (EReference)getCCGR().getEStructuralFeatures().get(12);
	}
	...
	public EReference getCCGR_FanCtl() {
        return (EReference)getCCGR().getEStructuralFeatures().get(13);
	}
	...
	public EReference getCCGR_Auto() {
        return (EReference)getCCGR().getEStructuralFeatures().get(14);
	}
	...
	public EReference getCCGR_FanOvCur() {
        return (EReference)getCCGR().getEStructuralFeatures().get(15);
	}
	...
	public EReference getCCGR_PmpOvCur() {
        return (EReference)getCCGR().getEStructuralFeatures().get(16);
	}
	...
	public EReference getCCGR_PmpAlm() {
        return (EReference)getCCGR().getEStructuralFeatures().get(17);
	}
	...
	public EReference getCCGR_OilTmpSet() {
        return (EReference)getCCGR().getEStructuralFeatures().get(18);
	}
	...
	public EClass getCPOW() {
		if (cpowEClass == null) {
			cpowEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupCPackage.eNS_URI).getEClassifiers().get(4);
		}
		return cpowEClass;
	}
	...
	public EReference getCPOW_TmExc() {
        return (EReference)getCPOW().getEStructuralFeatures().get(0);
	}
	...
	public EReference getCPOW_StrPOW() {
        return (EReference)getCPOW().getEStructuralFeatures().get(1);
	}
	...
	public EReference getCPOW_OpOpn() {
        return (EReference)getCPOW().getEStructuralFeatures().get(2);
	}
	...
	public EReference getCPOW_OpCls() {
        return (EReference)getCPOW().getEStructuralFeatures().get(3);
	}
	...
	public EReference getCPOW_MaxDlTmms() {
        return (EReference)getCPOW().getEStructuralFeatures().get(4);
	}
	...
	public EClass getCSWI() {
		if (cswiEClass == null) {
			cswiEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupCPackage.eNS_URI).getEClassifiers().get(5);
		}
		return cswiEClass;
	}
	...
	public EReference getCSWI_Loc() {
        return (EReference)getCSWI().getEStructuralFeatures().get(0);
	}
	...
	public EReference getCSWI_OpCntRs() {
        return (EReference)getCSWI().getEStructuralFeatures().get(1);
	}
	...
	public EReference getCSWI_Pos() {
        return (EReference)getCSWI().getEStructuralFeatures().get(2);
	}
	...
	public EReference getCSWI_PosA() {
        return (EReference)getCSWI().getEStructuralFeatures().get(3);
	}
	...
	public EReference getCSWI_PosB() {
        return (EReference)getCSWI().getEStructuralFeatures().get(4);
	}
	...
	public EReference getCSWI_PosC() {
        return (EReference)getCSWI().getEStructuralFeatures().get(5);
	}
	...
	public EReference getCSWI_OpOpn() {
        return (EReference)getCSWI().getEStructuralFeatures().get(6);
	}
	...
	public EReference getCSWI_OpCls() {
        return (EReference)getCSWI().getEStructuralFeatures().get(7);
	}
