 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDUP#getStr <em>Str</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDUP#getOp <em>Op</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDUP#getStrVal <em>Str Val</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDUP#getOpDlTmms <em>Op Dl Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDUP#getRsDlTmms <em>Rs Dl Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDUP#getDirMod <em>Dir Mod</em>}</li>
 * </ul>
 *
 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDUP()
 * @model
 * @generated
 */
public interface PDUP extends GroupP {
	 ...
	 * @see #setStr(ACD)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDUP_Str()
	 * @model required="true"
	 * @generated
	 */
	ACD getStr();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDUP#getStr <em>Str</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOp(ACT)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDUP_Op()
	 * @model required="true"
	 * @generated
	 */
	ACT getOp();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDUP#getOp <em>Op</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setStrVal(ASG)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDUP_StrVal()
	 * @model required="true"
	 * @generated
	 */
	ASG getStrVal();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDUP#getStrVal <em>Str Val</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOpDlTmms(ING)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDUP_OpDlTmms()
	 * @model required="true"
	 * @generated
	 */
	ING getOpDlTmms();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDUP#getOpDlTmms <em>Op Dl Tmms</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRsDlTmms(ING)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDUP_RsDlTmms()
	 * @model required="true"
	 * @generated
	 */
	ING getRsDlTmms();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDUP#getRsDlTmms <em>Rs Dl Tmms</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setDirMod(ING)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDUP_DirMod()
	 * @model required="true"
	 * @generated
	 */
	ING getDirMod();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDUP#getDirMod <em>Dir Mod</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
