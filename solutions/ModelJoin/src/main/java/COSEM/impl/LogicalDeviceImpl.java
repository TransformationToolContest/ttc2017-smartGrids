 ...
 * </p>
 * <ul>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getAA <em>AA</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getName <em>Name</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getAutoConnect <em>Auto Connect</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getBillingPeriodValues <em>Billing Period Values</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getElectricityID <em>Electricity ID</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getProgramEntries <em>Program Entries</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getOutputPulse <em>Output Pulse</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getReadingFactor <em>Reading Factor</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getNominalValues <em>Nominal Values</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getInputPulse <em>Input Pulse</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getMeasurementPeriod <em>Measurement Period</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getTimeEntries <em>Time Entries</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getTransformerLineLosses <em>Transformer Line Losses</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getMeasurementAlgorithm <em>Measurement Algorithm</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getMeteringPoint <em>Metering Point</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getElectricityRelatedStatus <em>Electricity Related Status</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getRegisterMonitor <em>Register Monitor</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getElectricityValues <em>Electricity Values</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getMeasurementValueTypes <em>Measurement Value Types</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getHarmonics <em>Harmonics</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getTariffs <em>Tariffs</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getPhaseangles <em>Phaseangles</em>}</li>
 *   <li>{@link COSEM.impl.LogicalDeviceImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
