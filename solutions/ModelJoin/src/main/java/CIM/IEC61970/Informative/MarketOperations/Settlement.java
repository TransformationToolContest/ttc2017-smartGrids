 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.Settlement#getMarket <em>Market</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.Settlement#getTradeDate <em>Trade Date</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.Settlement#getErpLedgerEntries <em>Erp Ledger Entries</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.Settlement#getErpInvoiceLineItems <em>Erp Invoice Line Items</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSettlement()
...
public interface Settlement extends Document {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.Market#getSettlements <em>Settlements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSettlement_Market()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.Settlement#getMarket <em>Market</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSettlement_TradeDate()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.Settlement#getTradeDate <em>Trade Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfERPSupport.ErpLedgerEntry#getSettlements <em>Settlements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSettlement_ErpLedgerEntries()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfERPSupport.ErpInvoiceLineItem#getSettlements <em>Settlements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSettlement_ErpInvoiceLineItems()
