 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.impl.VoltageLevelImpl#getBays <em>Bays</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.VoltageLevelImpl#getLowVoltageLimit <em>Low Voltage Limit</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.VoltageLevelImpl#getHighVoltageLimit <em>High Voltage Limit</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.VoltageLevelImpl#getBaseVoltage <em>Base Voltage</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.VoltageLevelImpl#getSubstation <em>Substation</em>}</li>
 * </ul>
 *
 * @generated
 */
