 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getHolds <em>Holds</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getReserves_TransmissionService <em>Reserves Transmission Service</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getReserves_AncillaryServices <em>Reserves Ancillary Services</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getResells <em>Resells</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getSells <em>Sells</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getServiceReservation()
...
public interface ServiceReservation extends Element {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Financial.Marketer#getHeldBy <em>Held By</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getServiceReservation_Holds()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getHolds <em>Holds</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getReservedBy_ServiceReservation <em>Reserved By Service Reservation</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getServiceReservation_Reserves_TransmissionService()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Reservation.AncillaryService#getReservedBy_ServiceReservation <em>Reserved By Service Reservation</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getServiceReservation_Reserves_AncillaryServices()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Financial.Marketer#getResoldBy <em>Resold By</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getServiceReservation_Resells()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getResells <em>Resells</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Financial.TransmissionProvider#getSoldBy <em>Sold By</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Reservation.ReservationPackage#getServiceReservation_Sells()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.Reservation.ServiceReservation#getSells <em>Sells</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
