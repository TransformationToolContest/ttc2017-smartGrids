...
import CIM.IEC61970.Protection.ProtectionFactory;
...
public class ProtectionPackageImpl extends EPackageImpl implements ProtectionPackage {
	 ...
	 * @see CIM.IEC61970.Protection.ProtectionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Protection." + eClassifier.getName());
