 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#getPowerLimit <em>Power Limit</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#getCustomerVoltageLimit <em>Customer Voltage Limit</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#getEnergyLimit <em>Energy Limit</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#isIsEnergyLimiting <em>Is Energy Limiting</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#getEnergyUsageWarning <em>Energy Usage Warning</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#isNeedsVoltageLimitCheck <em>Needs Voltage Limit Check</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#getEnergyUsageStartDateTime <em>Energy Usage Start Date Time</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#isUsePushbutton <em>Use Pushbutton</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#isIsArmDisconnect <em>Is Arm Disconnect</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#isIsArmConnect <em>Is Arm Connect</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#isNeedsPowerLimitCheck <em>Needs Power Limit Check</em>}</li>
 *   <li>{@link CIM.IEC61968.LoadControl.impl.RemoteConnectDisconnectInfoImpl#getArmedTimeout <em>Armed Timeout</em>}</li>
 * </ul>
 *
 * @generated
 */
