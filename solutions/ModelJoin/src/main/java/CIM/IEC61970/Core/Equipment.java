 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.Equipment#getOperationalLimitSet <em>Operational Limit Set</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Equipment#getContingencyEquipment <em>Contingency Equipment</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Equipment#isNormaIlyInService <em>Norma Ily In Service</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Equipment#getCustomerAgreements <em>Customer Agreements</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Equipment#isAggregate <em>Aggregate</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Equipment#getEquipmentContainer <em>Equipment Container</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getEquipment()
...
public interface Equipment extends PowerSystemResource {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.OperationalLimits.OperationalLimitSet#getEquipment <em>Equipment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getEquipment_OperationalLimitSet()
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Contingency.ContingencyEquipment}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Contingency.ContingencyEquipment#getEquipment <em>Equipment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getEquipment_ContingencyEquipment()
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getEquipment_NormaIlyInService()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Equipment#isNormaIlyInService <em>Norma Ily In Service</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Customers.CustomerAgreement#getEquipments <em>Equipments</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getEquipment_CustomerAgreements()
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getEquipment_Aggregate()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Equipment#isAggregate <em>Aggregate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.EquipmentContainer#getEquipments <em>Equipments</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getEquipment_EquipmentContainer()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Equipment#getEquipmentContainer <em>Equipment Container</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
