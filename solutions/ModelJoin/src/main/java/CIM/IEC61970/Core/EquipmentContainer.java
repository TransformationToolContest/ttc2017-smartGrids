 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.EquipmentContainer#getEquipments <em>Equipments</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getEquipmentContainer()
...
public interface EquipmentContainer extends ConnectivityNodeContainer {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.Equipment#getEquipmentContainer <em>Equipment Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getEquipmentContainer_Equipments()
