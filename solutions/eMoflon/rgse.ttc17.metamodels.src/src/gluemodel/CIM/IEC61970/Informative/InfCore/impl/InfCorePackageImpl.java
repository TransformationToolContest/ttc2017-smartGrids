...
import gluemodel.CIM.IEC61970.Informative.InfCore.InfCoreFactory;
...
public class InfCorePackageImpl extends EPackageImpl implements InfCorePackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfCore.InfCorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.InfCore." + eClassifier.getName());
