/**
 */
package gluemodel.substationStandard.impl;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getLN <em>LN</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getNamePlt <em>Name Plt</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getLPL <em>LPL</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getDPC <em>DPC</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getACT <em>ACT</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getSPS <em>SPS</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getBSC <em>BSC</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getISC <em>ISC</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getSPC <em>SPC</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getMV <em>MV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getINS <em>INS</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getASG <em>ASG</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getWYE <em>WYE</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getDPStatus <em>DP Status</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getAnalogueValue <em>Analogue Value</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getCMV <em>CMV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getValWithTrans <em>Val With Trans</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getBSControl <em>BS Control</em>}</li>
 *   <li>{@link gluemodel.substationStandard.impl.SubstandardImpl#getVector <em>Vector</em>}</li>
 * </ul>
 *
 * @generated
 */
