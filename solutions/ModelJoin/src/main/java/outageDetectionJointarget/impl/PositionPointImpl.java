 ...
 * </p>
 * <ul>
 *   <li>{@link outageDetectionJointarget.impl.PositionPointImpl#getXPosition <em>XPosition</em>}</li>
 *   <li>{@link outageDetectionJointarget.impl.PositionPointImpl#getYPosition <em>YPosition</em>}</li>
 *   <li>{@link outageDetectionJointarget.impl.PositionPointImpl#getZPosition <em>ZPosition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PositionPointImpl extends MinimalEObjectImpl.Container implements PositionPoint {
	...
	protected EClass eStaticClass() {
		return OutageDetectionJointargetPackage.Literals.POSITION_POINT;
	}
	...
	public void setXPosition(String newXPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OutageDetectionJointargetPackage.POSITION_POINT__XPOSITION, oldXPosition, xPosition));
	}
	...
	public void setYPosition(String newYPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OutageDetectionJointargetPackage.POSITION_POINT__YPOSITION, oldYPosition, yPosition));
	}
	...
	public void setZPosition(String newZPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OutageDetectionJointargetPackage.POSITION_POINT__ZPOSITION, oldZPosition, zPosition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OutageDetectionJointargetPackage.POSITION_POINT__XPOSITION:
				return getXPosition();
			case OutageDetectionJointargetPackage.POSITION_POINT__YPOSITION:
				return getYPosition();
			case OutageDetectionJointargetPackage.POSITION_POINT__ZPOSITION:
				return getZPosition();
		}
