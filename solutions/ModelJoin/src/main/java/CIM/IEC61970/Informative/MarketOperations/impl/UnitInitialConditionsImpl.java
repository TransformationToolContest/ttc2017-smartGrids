 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.UnitInitialConditionsImpl#getResourceStatus <em>Resource Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.UnitInitialConditionsImpl#getTimeInStatus <em>Time In Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.UnitInitialConditionsImpl#getResourceMW <em>Resource MW</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.UnitInitialConditionsImpl#getGeneratingUnit <em>Generating Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.UnitInitialConditionsImpl#getCumEnergy <em>Cum Energy</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.UnitInitialConditionsImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.UnitInitialConditionsImpl#getCumStatusChanges <em>Cum Status Changes</em>}</li>
 * </ul>
 *
 * @generated
 */
