...
import CIM.IEC61970.Informative.InfERPSupport.InfERPSupportFactory;
...
public class InfERPSupportPackageImpl extends EPackageImpl implements InfERPSupportPackage {
	 ...
	 * @see CIM.IEC61970.Informative.InfERPSupport.InfERPSupportPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfERPSupport." + eClassifier.getName());
