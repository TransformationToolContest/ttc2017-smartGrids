 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNode#getConnectivityNodeContainer <em>Connectivity Node Container</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNode#getTopologicalNode <em>Topological Node</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNode#getBusNameMarker <em>Bus Name Marker</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNode#getLossPenaltyFactors <em>Loss Penalty Factors</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNode#getNodeConstraintTerms <em>Node Constraint Terms</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNode#getTerminals <em>Terminals</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNode#getPnode <em>Pnode</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNode()
...
public interface ConnectivityNode extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.ConnectivityNodeContainer#getConnectivityNodes <em>Connectivity Nodes</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNode_ConnectivityNodeContainer()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.ConnectivityNode#getConnectivityNodeContainer <em>Connectivity Node Container</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Topology.TopologicalNode#getConnectivityNodes <em>Connectivity Nodes</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNode_TopologicalNode()
	 * @see CIM.IEC61970.Topology.TopologicalNode#getConnectivityNodes
	 * @model opposite="ConnectivityNodes"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.ConnectivityNode#getTopologicalNode <em>Topological Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Topology.BusNameMarker#getConnectivityNode <em>Connectivity Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNode_BusNameMarker()
	 * @see CIM.IEC61970.Topology.BusNameMarker#getConnectivityNode
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.ConnectivityNode#getBusNameMarker <em>Bus Name Marker</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Informative.MarketOperations.LossPenaltyFactor}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.LossPenaltyFactor#getConnectivityNodes <em>Connectivity Nodes</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNode_LossPenaltyFactors()
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Informative.MarketOperations.NodeConstraintTerm}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.NodeConstraintTerm#getConnectivityNode <em>Connectivity Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNode_NodeConstraintTerms()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.Terminal#getConnectivityNode <em>Connectivity Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNode_Terminals()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.Pnode#getConnectivityNode <em>Connectivity Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setPnode(Pnode)
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNode_Pnode()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.ConnectivityNode#getPnode <em>Pnode</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
