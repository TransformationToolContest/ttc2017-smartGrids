 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.PackageDependencies.PackageDependenciesCIMVeresion#getDate <em>Date</em>}</li>
 *   <li>{@link CIM.PackageDependencies.PackageDependenciesCIMVeresion#getVesion <em>Vesion</em>}</li>
 * </ul>
 *
 * @see CIM.PackageDependencies.PackageDependenciesPackage#getPackageDependenciesCIMVeresion()
...
public interface PackageDependenciesCIMVeresion extends Element {
	 ...
	 * @see #setDate(Date)
	 * @see CIM.PackageDependencies.PackageDependenciesPackage#getPackageDependenciesCIMVeresion_Date()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.PackageDependencies.PackageDependenciesCIMVeresion#getDate <em>Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.PackageDependencies.PackageDependenciesPackage#getPackageDependenciesCIMVeresion_Vesion()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.PackageDependencies.PackageDependenciesCIMVeresion#getVesion <em>Vesion</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
