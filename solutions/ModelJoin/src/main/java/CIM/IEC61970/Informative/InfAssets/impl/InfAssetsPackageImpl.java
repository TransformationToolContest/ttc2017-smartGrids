...
import CIM.IEC61970.Informative.InfAssets.InfAssetsFactory;
...
public class InfAssetsPackageImpl extends EPackageImpl implements InfAssetsPackage {
	 ...
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfAssets." + eClassifier.getName());
