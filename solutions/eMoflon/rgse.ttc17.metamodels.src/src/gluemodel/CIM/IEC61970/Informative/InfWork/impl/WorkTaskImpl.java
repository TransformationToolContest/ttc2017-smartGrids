...
import gluemodel.CIM.IEC61970.Informative.InfWork.ContractorItem;
...
import gluemodel.CIM.IEC61970.Informative.InfWork.EquipmentItem;
...
import gluemodel.CIM.IEC61970.Informative.InfWork.OverheadCost;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getCrews <em>Crews</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getSwitchingSchedules <em>Switching Schedules</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getMiscCostItems <em>Misc Cost Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getLaborItems <em>Labor Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getWorkFlowStep <em>Work Flow Step</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getAssets <em>Assets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getSchedOverride <em>Sched Override</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getWork <em>Work</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getDesignLocationCUs <em>Design Location CUs</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getContractorItems <em>Contractor Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getDesign <em>Design</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getEquipmentItems <em>Equipment Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getMaterialItems <em>Material Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getWorkCostDetails <em>Work Cost Details</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getQualificationRequirements <em>Qualification Requirements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getUsages <em>Usages</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkTaskImpl#getOverheadCost <em>Overhead Cost</em>}</li>
 * </ul>
 *
 * @generated
 */
