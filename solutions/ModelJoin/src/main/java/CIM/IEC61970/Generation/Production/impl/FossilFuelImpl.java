 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFuelEffFactor <em>Fuel Eff Factor</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFossilFuelType <em>Fossil Fuel Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFuelMixture <em>Fuel Mixture</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFuelCost <em>Fuel Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getLowBreakpointP <em>Low Breakpoint P</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFuelHandlingCost <em>Fuel Handling Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFuelAllocationSchedules <em>Fuel Allocation Schedules</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFuelSulfur <em>Fuel Sulfur</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getThermalGeneratingUnit <em>Thermal Generating Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFuelHeatContent <em>Fuel Heat Content</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getHighBreakpointP <em>High Breakpoint P</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.FossilFuelImpl#getFuelDispatchCost <em>Fuel Dispatch Cost</em>}</li>
 * </ul>
 *
 * @generated
 */
