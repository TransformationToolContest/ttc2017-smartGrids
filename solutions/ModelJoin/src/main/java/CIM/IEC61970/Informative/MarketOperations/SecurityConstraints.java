 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraints#getMinMW <em>Min MW</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraints#getMaxMW <em>Max MW</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraints#getRTO <em>RTO</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraints#getActualMW <em>Actual MW</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraints()
...
public interface SecurityConstraints extends IdentifiedObject {
	 ...
	 * @see #setMinMW(float)
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraints_MinMW()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraints#getMinMW <em>Min MW</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setMaxMW(float)
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraints_MaxMW()
	 * @model dataType="CIM.IEC61970.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraints#getMaxMW <em>Max MW</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.RTO#getSecurityConstraints <em>Security Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setRTO(RTO)
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraints_RTO()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraints#getRTO <em>RTO</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getSecurityConstraints_ActualMW()
	 * @model dataType="CIM.IEC61970.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraints#getActualMW <em>Actual MW</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
