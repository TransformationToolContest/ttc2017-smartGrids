 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.TimeQuality#isLeapSecondsKnown <em>Leap Seconds Known</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.TimeQuality#isClockFailure <em>Clock Failure</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.TimeQuality#isClockNotSynchronized <em>Clock Not Synchronized</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.TimeQuality#getTimeAccuracy <em>Time Accuracy</em>}</li>
 * </ul>
 *
 * @see substationStandard.Dataclasses.DataclassesPackage#getTimeQuality()
 * @model
 * @generated
 */
public interface TimeQuality extends EObject {
	 ...
	 * @see substationStandard.Dataclasses.DataclassesPackage#getTimeQuality_LeapSecondsKnown()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.TimeQuality#isLeapSecondsKnown <em>Leap Seconds Known</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see substationStandard.Dataclasses.DataclassesPackage#getTimeQuality_ClockFailure()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.TimeQuality#isClockFailure <em>Clock Failure</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see substationStandard.Dataclasses.DataclassesPackage#getTimeQuality_ClockNotSynchronized()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.TimeQuality#isClockNotSynchronized <em>Clock Not Synchronized</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link substationStandard.Enumerations.TimeAccuracyKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see substationStandard.Dataclasses.DataclassesPackage#getTimeQuality_TimeAccuracy()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link substationStandard.Dataclasses.TimeQuality#getTimeAccuracy <em>Time Accuracy</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
