 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getPaymentTransactions <em>Payment Transactions</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getDue <em>Due</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getLastCredit <em>Last Credit</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getPrincipleAmount <em>Principle Amount</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getAuxiliaryAgreement <em>Auxiliary Agreement</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getCharges <em>Charges</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getLastDebit <em>Last Debit</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getBalance <em>Balance</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount()
...
public interface AuxiliaryAccount extends Document {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Transaction#getAuxiliaryAccount <em>Auxiliary Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount_PaymentTransactions()
	 ...
	 * @see #setDue(Due)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount_Due()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getDue <em>Due</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount_LastCredit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getLastCredit <em>Last Credit</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount_PrincipleAmount()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getPrincipleAmount <em>Principle Amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.AuxiliaryAgreement#getAuxiliaryAccounts <em>Auxiliary Accounts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount_AuxiliaryAgreement()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getAuxiliaryAgreement <em>Auxiliary Agreement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Charge#getAuxiliaryAccounts <em>Auxiliary Accounts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount_Charges()
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount_LastDebit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getLastDebit <em>Last Debit</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAuxiliaryAccount_Balance()
	 * @model dataType="CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AuxiliaryAccount#getBalance <em>Balance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
