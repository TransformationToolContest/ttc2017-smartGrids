 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.ConsumerMessage#getConsumer_message_via_local_consumer_information_port <em>Consumer message via local consumer information port</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.ConsumerMessage#getConsumer_message_via_meter_display <em>Consumer message via meter display</em>}</li>
 * </ul>
 *
 * @see gluemodel.COSEM.COSEMObjects.COSEMObjectsPackage#getConsumerMessage()
 * @model
 * @generated
 */
public interface ConsumerMessage extends Data {
	 ...
	 * @see gluemodel.COSEM.COSEMObjects.COSEMObjectsPackage#getConsumerMessage_Consumer_message_via_local_consumer_information_port()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gluemodel.COSEM.COSEMObjects.ConsumerMessage#getConsumer_message_via_local_consumer_information_port <em>Consumer message via local consumer information port</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.COSEM.COSEMObjects.COSEMObjectsPackage#getConsumerMessage_Consumer_message_via_meter_display()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gluemodel.COSEM.COSEMObjects.ConsumerMessage#getConsumer_message_via_meter_display <em>Consumer message via meter display</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
