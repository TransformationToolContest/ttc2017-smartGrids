 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.TransmissionCorridor#getTransmissionRightOfWays <em>Transmission Right Of Ways</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.TransmissionCorridor#getContainedIn <em>Contained In</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getTransmissionCorridor()
...
public interface TransmissionCorridor extends PowerSystemResource {
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Informative.EnergyScheduling.TransmissionRightOfWay}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.EnergyScheduling.TransmissionRightOfWay#getTransmissionCorridor <em>Transmission Corridor</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getTransmissionCorridor_TransmissionRightOfWays()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Reservation.TransmissionPath#getFor <em>For</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getTransmissionCorridor_ContainedIn()
