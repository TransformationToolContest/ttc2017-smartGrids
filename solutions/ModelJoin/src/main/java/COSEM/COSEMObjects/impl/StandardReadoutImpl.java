...
import COSEM.COSEMObjects.StandardReadout;

import COSEM.InterfaceClasses.impl.ProfilegenericImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link COSEM.COSEMObjects.impl.StandardReadoutImpl#getGeneralLocalPortReadout <em>General Local Port Readout</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.StandardReadoutImpl#getGeneralDisplayReadout <em>General Display Readout</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.StandardReadoutImpl#getAlternateDisplayReadout <em>Alternate Display Readout</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.StandardReadoutImpl#getServiceDisplayReadout <em>Service Display Readout</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.StandardReadoutImpl#getListConfigMeterData <em>List Config Meter Data</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.StandardReadoutImpl#getAdditionalReadout <em>Additional Readout</em>}</li>
 * </ul>
 *
 * @generated
 */
