 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityProgramEntriesImpl#getActivefirmwareidentifier <em>Activefirmwareidentifier</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityProgramEntriesImpl#getParameterrecordnumber <em>Parameterrecordnumber</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityProgramEntriesImpl#getTimeswitchprogramnumber <em>Timeswitchprogramnumber</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityProgramEntriesImpl#getRCRprogramnumber <em>RC Rprogramnumber</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityProgramEntriesImpl#getMeterconnectiondiagramID <em>Meterconnectiondiagram ID</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityProgramEntriesImpl#getPassivecalendarname <em>Passivecalendarname</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityProgramEntriesImpl#getActivefirmwaresignature <em>Activefirmwaresignature</em>}</li>
 * </ul>
 *
 * @generated
 */
