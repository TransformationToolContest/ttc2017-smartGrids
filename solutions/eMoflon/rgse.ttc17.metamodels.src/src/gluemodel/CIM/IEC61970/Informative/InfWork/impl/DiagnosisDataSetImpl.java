...
import gluemodel.CIM.IEC61970.Informative.InfWork.DiagnosisDataSet;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getPhaseCode <em>Phase Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getFinalCode <em>Final Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getFailureMode <em>Failure Mode</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getRootOrigin <em>Root Origin</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getFinalCause <em>Final Cause</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getRootRemark <em>Root Remark</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getRootCause <em>Root Cause</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getPreliminaryRemark <em>Preliminary Remark</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getPreliminaryCode <em>Preliminary Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getPreliminaryDateTime <em>Preliminary Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getFinalRemark <em>Final Remark</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DiagnosisDataSetImpl#getFinalOrigin <em>Final Origin</em>}</li>
 * </ul>
 *
 * @generated
 */
