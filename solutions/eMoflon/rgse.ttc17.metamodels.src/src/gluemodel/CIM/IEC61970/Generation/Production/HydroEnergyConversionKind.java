 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61970.Generation.Production.ProductionPackage#getHydroEnergyConversionKind()
 * @model
 * @generated
 */
public enum HydroEnergyConversionKind implements Enumerator {
	 ...
	 * @ordered
	 */
	PUMP_AND_GENERATOR(0, "pumpAndGenerator", "pumpAndGenerator"),
	 ...
	 * @ordered
	 */
	public static final int PUMP_AND_GENERATOR_VALUE = 0;
