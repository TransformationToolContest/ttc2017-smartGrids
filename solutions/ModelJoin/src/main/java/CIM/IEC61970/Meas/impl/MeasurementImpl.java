 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getBy_TiePoint <em>By Tie Point</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getDynamicSchedules <em>Dynamic Schedules</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getLocations <em>Locations</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getAsset <em>Asset</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getViolationLimits <em>Violation Limits</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getDocuments <em>Documents</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getPnode <em>Pnode</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getPowerSystemResource <em>Power System Resource</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getMeasurementType <em>Measurement Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.impl.MeasurementImpl#getFor_TiePoint <em>For Tie Point</em>}</li>
 * </ul>
 *
 * @generated
 */
