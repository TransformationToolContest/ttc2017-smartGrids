...
import CIM.IEC61970.Informative.MarketOperations.MarketStatement;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getCurrentAmount <em>Current Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getPreviousISOAmount <em>Previous ISO Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getQuantityUOM <em>Quantity UOM</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getNetISOAmount <em>Net ISO Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getUserAttributes <em>User Attributes</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getCurrentISOAmount <em>Current ISO Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getPreviousQuantity <em>Previous Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getComponentMarketStatementLineItem <em>Component Market Statement Line Item</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getPreviousAmount <em>Previous Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getNetISOQuantity <em>Net ISO Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getNetPrice <em>Net Price</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getCurrentISOQuantity <em>Current ISO Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getCurrentPrice <em>Current Price</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getPassThroughBill <em>Pass Through Bill</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getPrevisouPrice <em>Previsou Price</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getMarketStatement <em>Market Statement</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getPreviousISOQuantity <em>Previous ISO Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getIntervalDate <em>Interval Date</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getNetQuantity <em>Net Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getNetAmount <em>Net Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getCurrentQuantity <em>Current Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getIntervalNumber <em>Interval Number</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketStatementLineItemImpl#getContainerMarketStatementLineItem <em>Container Market Statement Line Item</em>}</li>
 * </ul>
 *
 * @generated
 */
