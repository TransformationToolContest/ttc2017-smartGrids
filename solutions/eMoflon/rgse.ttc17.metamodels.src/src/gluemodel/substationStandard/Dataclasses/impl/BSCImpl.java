 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#getCtlVal <em>Ctl Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#getValWTr <em>Val WTr</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#getQ <em>Q</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#getT <em>T</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#getSubVal <em>Sub Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#isPersistent <em>Persistent</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#getMaxVal <em>Max Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.BSCImpl#getStepSize <em>Step Size</em>}</li>
 * </ul>
 *
 * @generated
 */
