 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getServiceLocation <em>Service Location</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getPowerQualityPricings <em>Power Quality Pricings</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getPhaseCode <em>Phase Code</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getRatedPower <em>Rated Power</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getCustomerAgreement <em>Customer Agreement</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getEnergyConsumer <em>Energy Consumer</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getServiceCategory <em>Service Category</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#isGrounded <em>Grounded</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getRatedCurrent <em>Rated Current</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getNominalServiceVoltage <em>Nominal Service Voltage</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getEstimatedLoad <em>Estimated Load</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getEndDeviceAssets <em>End Device Assets</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getServiceSupplier <em>Service Supplier</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getPricingStructures <em>Pricing Structures</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getTransformer <em>Transformer</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getServicePriority <em>Service Priority</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getMeterReadings <em>Meter Readings</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getSDPLocations <em>SDP Locations</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getServiceDeliveryRemark <em>Service Delivery Remark</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#isCheckBilling <em>Check Billing</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.ServiceDeliveryPointImpl#getCtptReference <em>Ctpt Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
