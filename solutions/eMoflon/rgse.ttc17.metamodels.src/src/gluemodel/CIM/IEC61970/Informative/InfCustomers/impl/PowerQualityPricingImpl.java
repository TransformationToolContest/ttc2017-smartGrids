 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getPricingStructure <em>Pricing Structure</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getValueUninterruptedServiceEnergy <em>Value Uninterrupted Service Energy</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getVoltImbalanceViolCost <em>Volt Imbalance Viol Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getVoltLimitViolCost <em>Volt Limit Viol Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getEmergencyLowVoltLimit <em>Emergency Low Volt Limit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getValueUninterruptedServiceP <em>Value Uninterrupted Service P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getEmergencyHighVoltLimit <em>Emergency High Volt Limit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getPowerFactorMin <em>Power Factor Min</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getServiceDeliveryPoints <em>Service Delivery Points</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getNormalLowVoltLimit <em>Normal Low Volt Limit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCustomers.impl.PowerQualityPricingImpl#getNormalHighVoltLimit <em>Normal High Volt Limit</em>}</li>
 * </ul>
 *
 * @generated
 */
