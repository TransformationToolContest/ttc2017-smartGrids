 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.PackageDependencies.PackageDependenciesFactory
 * @model kind="package"
...
public interface PackageDependenciesPackage extends EPackage {
	 ...
	 * @generated
	 */
	PackageDependenciesPackage eINSTANCE = gluemodel.CIM.PackageDependencies.impl.PackageDependenciesPackageImpl.init();

	/**
	 * The meta object id for the '{@link gluemodel.CIM.PackageDependencies.impl.PackageDependenciesCIMVeresionImpl <em>CIM Veresion</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see gluemodel.CIM.PackageDependencies.impl.PackageDependenciesCIMVeresionImpl
	 * @see gluemodel.CIM.PackageDependencies.impl.PackageDependenciesPackageImpl#getPackageDependenciesCIMVeresion()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link gluemodel.CIM.PackageDependencies.PackageDependenciesCIMVeresion <em>CIM Veresion</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>CIM Veresion</em>'.
	 * @see gluemodel.CIM.PackageDependencies.PackageDependenciesCIMVeresion
	 * @generated
	 */
	EClass getPackageDependenciesCIMVeresion();

	/**
	 * Returns the meta object for the attribute '{@link gluemodel.CIM.PackageDependencies.PackageDependenciesCIMVeresion#getDate <em>Date</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Date</em>'.
	 * @see gluemodel.CIM.PackageDependencies.PackageDependenciesCIMVeresion#getDate()
	...
	/**
	 * Returns the meta object for the attribute '{@link gluemodel.CIM.PackageDependencies.PackageDependenciesCIMVeresion#getVesion <em>Vesion</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Vesion</em>'.
	 * @see gluemodel.CIM.PackageDependencies.PackageDependenciesCIMVeresion#getVesion()
	 * @see #getPackageDependenciesCIMVeresion()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link gluemodel.CIM.PackageDependencies.impl.PackageDependenciesCIMVeresionImpl <em>CIM Veresion</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see gluemodel.CIM.PackageDependencies.impl.PackageDependenciesCIMVeresionImpl
		 * @see gluemodel.CIM.PackageDependencies.impl.PackageDependenciesPackageImpl#getPackageDependenciesCIMVeresion()
