 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.PSREvent#getPowerSystemResource <em>Power System Resource</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.PSREvent#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getPSREvent()
...
public interface PSREvent extends ActivityRecord {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.PowerSystemResource#getPSREvent <em>PSR Event</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getPSREvent_PowerSystemResource()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.PSREvent#getPowerSystemResource <em>Power System Resource</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Informative.InfOperations.PSREventKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getPSREvent_Kind()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.PSREvent#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
