 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.AssetModels.OverheadConductorInfo#getNeutralInsulationThickness <em>Neutral Insulation Thickness</em>}</li>
 *   <li>{@link CIM.IEC61968.AssetModels.OverheadConductorInfo#getPhaseConductorSpacing <em>Phase Conductor Spacing</em>}</li>
 *   <li>{@link CIM.IEC61968.AssetModels.OverheadConductorInfo#getPhaseConductorCount <em>Phase Conductor Count</em>}</li>
 *   <li>{@link CIM.IEC61968.AssetModels.OverheadConductorInfo#getMountingPoint <em>Mounting Point</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getOverheadConductorInfo()
...
public interface OverheadConductorInfo extends ConductorInfo {
	 ...
	 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getOverheadConductorInfo_NeutralInsulationThickness()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.AssetModels.OverheadConductorInfo#getNeutralInsulationThickness <em>Neutral Insulation Thickness</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getOverheadConductorInfo_PhaseConductorSpacing()
	 * @model dataType="CIM.IEC61970.Domain.Length" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.AssetModels.OverheadConductorInfo#getPhaseConductorSpacing <em>Phase Conductor Spacing</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getOverheadConductorInfo_PhaseConductorCount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.AssetModels.OverheadConductorInfo#getPhaseConductorCount <em>Phase Conductor Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfAssets.MountingPoint#getOverheadConductors <em>Overhead Conductors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getOverheadConductorInfo_MountingPoint()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.AssetModels.OverheadConductorInfo#getMountingPoint <em>Mounting Point</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
