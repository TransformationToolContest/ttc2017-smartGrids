 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.GeographicalRegion#getRegions <em>Regions</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getGeographicalRegion()
...
public interface GeographicalRegion extends IdentifiedObject {
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Core.SubGeographicalRegion}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.SubGeographicalRegion#getRegion <em>Region</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getGeographicalRegion_Regions()
