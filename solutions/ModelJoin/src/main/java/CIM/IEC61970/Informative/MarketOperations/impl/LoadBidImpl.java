...
import CIM.IEC61970.Informative.MarketOperations.LoadBid;
import CIM.IEC61970.Informative.MarketOperations.LoadReductionPriceCurve;
import CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage;
import CIM.IEC61970.Informative.MarketOperations.RegisteredLoad;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getMinLoadReduction <em>Min Load Reduction</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getDropRampRate <em>Drop Ramp Rate</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getMinLoadReductionInterval <em>Min Load Reduction Interval</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getLoadReductionPriceCurve <em>Load Reduction Price Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getMinLoadReductionCost <em>Min Load Reduction Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getPickUpRampRate <em>Pick Up Ramp Rate</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getReqNoticeTime <em>Req Notice Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getMinLoad <em>Min Load</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getRegisteredLoad <em>Registered Load</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getMinTimeBetLoadRed <em>Min Time Bet Load Red</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.LoadBidImpl#getShutdownCost <em>Shutdown Cost</em>}</li>
 * </ul>
 *
 * @generated
 */
