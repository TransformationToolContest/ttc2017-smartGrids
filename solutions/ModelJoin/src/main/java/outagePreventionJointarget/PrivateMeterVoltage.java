 ...
 * @model annotation="edu.kit.ipd.sdq.mdsd.mj.createdBy order='2' operator='thetajoin' condition='CIM.IEC61968.Metering.MeterAsset.mRID = COSEM.PhysicalDevice.ID'"
 * @generated
 */
public interface PrivateMeterVoltage extends Asset, EndDeviceAsset {
	 ...
	 * @model annotation="edu.kit.ipd.sdq.mdsd.mj.createdBy operator='keepattributes'"
	 * @generated
	 */
	String getID();
	 ...
	 * @model annotation="edu.kit.ipd.sdq.mdsd.mj.createdBy operator='keepcalculated' formula='COSEM.PhysicalDevice.ElectricityValues.VoltageL1'"
	 * @generated
	 */
	double getVoltageA();
	 ...
	 * @model annotation="edu.kit.ipd.sdq.mdsd.mj.createdBy operator='keepcalculated' formula='COSEM.PhysicalDevice.ElectricityValues.VoltageL2'"
	 * @generated
	 */
	double getVoltageB();
	 ...
	 * @model annotation="edu.kit.ipd.sdq.mdsd.mj.createdBy operator='keepcalculated' formula='COSEM.PhysicalDevice.ElectricityValues.VoltageL3'"
	 * @generated
	 */
	double getVoltageC();
