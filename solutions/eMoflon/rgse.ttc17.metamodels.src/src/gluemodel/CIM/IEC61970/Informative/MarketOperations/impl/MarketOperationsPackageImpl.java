...
import gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsFactory;
...
public class MarketOperationsPackageImpl extends EPackageImpl implements MarketOperationsPackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.MarketOperations." + eClassifier.getName());
