 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Metering.Pending#getOffset <em>Offset</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Pending#isMultiplyBeforeAdd <em>Multiply Before Add</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Pending#getScalarFloat <em>Scalar Float</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Pending#getReadingType <em>Reading Type</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Pending#getScalarDenominator <em>Scalar Denominator</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Pending#getIntervalBlocks <em>Interval Blocks</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.Pending#getScalarNumerator <em>Scalar Numerator</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.Metering.MeteringPackage#getPending()
...
public interface Pending extends Element {
	 ...
	 * @see #setOffset(int)
	 * @see CIM.IEC61968.Metering.MeteringPackage#getPending_Offset()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Pending#getOffset <em>Offset</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getPending_MultiplyBeforeAdd()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Pending#isMultiplyBeforeAdd <em>Multiply Before Add</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getPending_ScalarFloat()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Pending#getScalarFloat <em>Scalar Float</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.ReadingType#getPending <em>Pending</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getPending_ReadingType()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Pending#getReadingType <em>Reading Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getPending_ScalarDenominator()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Pending#getScalarDenominator <em>Scalar Denominator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.IntervalBlock#getPending <em>Pending</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getPending_IntervalBlocks()
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getPending_ScalarNumerator()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.Pending#getScalarNumerator <em>Scalar Numerator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
