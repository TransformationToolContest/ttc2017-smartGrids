...
import CIM.IEC61970.Generation.GenerationDynamics.BoilerControlMode;
import CIM.IEC61970.Generation.GenerationDynamics.FossilSteamSupply;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getPressureCtrlPG <em>Pressure Ctrl PG</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getSuperHeater1Capacity <em>Super Heater1 Capacity</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getFeedWaterPG <em>Feed Water PG</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getControlTC <em>Control TC</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getMechPowerSensorLag <em>Mech Power Sensor Lag</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getThrottlePressureSP <em>Throttle Pressure SP</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getMaxErrorRateP <em>Max Error Rate P</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getControlIC <em>Control IC</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getMinErrorRateP <em>Min Error Rate P</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getFuelDemandLimit <em>Fuel Demand Limit</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getSuperHeaterPipePD <em>Super Heater Pipe PD</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getPressureCtrlDG <em>Pressure Ctrl DG</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getAuxPowerVersusVoltage <em>Aux Power Versus Voltage</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getControlPC <em>Control PC</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getFeedWaterTC <em>Feed Water TC</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getControlErrorBiasP <em>Control Error Bias P</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getFeedWaterIG <em>Feed Water IG</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getPressureCtrlIG <em>Pressure Ctrl IG</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getFuelSupplyTC <em>Fuel Supply TC</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getAuxPowerVersusFrequency <em>Aux Power Versus Frequency</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getPressureFeedback <em>Pressure Feedback</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getFuelSupplyDelay <em>Fuel Supply Delay</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getBoilerControlMode <em>Boiler Control Mode</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getSuperHeater2Capacity <em>Super Heater2 Capacity</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getControlPEB <em>Control PEB</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.GenerationDynamics.impl.FossilSteamSupplyImpl#getControlPED <em>Control PED</em>}</li>
 * </ul>
 *
 * @generated
 */
