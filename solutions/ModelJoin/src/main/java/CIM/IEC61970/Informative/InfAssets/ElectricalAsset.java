 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.ElectricalAsset#getPhaseCode <em>Phase Code</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.ElectricalAsset#isIsConnected <em>Is Connected</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.ElectricalAsset#getConductingEquipment <em>Conducting Equipment</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.ElectricalAsset#getElectricalInfos <em>Electrical Infos</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getElectricalAsset()
...
public interface ElectricalAsset extends Asset {
	 ...
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getElectricalAsset_PhaseCode()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfAssets.ElectricalAsset#getPhaseCode <em>Phase Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getElectricalAsset_IsConnected()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfAssets.ElectricalAsset#isIsConnected <em>Is Connected</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.ConductingEquipment#getElectricalAssets <em>Electrical Assets</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getElectricalAsset_ConductingEquipment()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfAssets.ElectricalAsset#getConductingEquipment <em>Conducting Equipment</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfAssets.ElectricalInfo#getElectricalAssets <em>Electrical Assets</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getElectricalAsset_ElectricalInfos()
