...
import gluemodel.substationStandard.LNNodes.LNGroupX.LNGroupXFactory;
...
public class LNGroupXPackageImpl extends EPackageImpl implements LNGroupXPackage {
	 ...
	 * @see gluemodel.substationStandard.LNNodes.LNGroupX.LNGroupXPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getGroupX() {
		if (groupXEClass == null) {
			groupXEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupXPackage.eNS_URI).getEClassifiers().get(0);
		}
		return groupXEClass;
	}
	...
	public EReference getGroupX_Loc() {
        return (EReference)getGroupX().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getGroupX_EEHealth() {
        return (EAttribute)getGroupX().getEStructuralFeatures().get(1);
	}
	...
	public EReference getGroupX_EEName() {
        return (EReference)getGroupX().getEStructuralFeatures().get(2);
	}
	...
	public EReference getGroupX_OpCnt() {
        return (EReference)getGroupX().getEStructuralFeatures().get(3);
	}
	...
	public EReference getGroupX_Pos() {
        return (EReference)getGroupX().getEStructuralFeatures().get(4);
	}
	...
	public EReference getGroupX_BlkOpn() {
        return (EReference)getGroupX().getEStructuralFeatures().get(5);
	}
	...
	public EReference getGroupX_BlkCls() {
        return (EReference)getGroupX().getEStructuralFeatures().get(6);
	}
	...
	public EReference getGroupX_ChaMotEna() {
        return (EReference)getGroupX().getEStructuralFeatures().get(7);
	}
	...
	public EClass getXCBR() {
		if (xcbrEClass == null) {
			xcbrEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupXPackage.eNS_URI).getEClassifiers().get(1);
		}
		return xcbrEClass;
	}
	...
	public EReference getXCBR_SumSwARs() {
        return (EReference)getXCBR().getEStructuralFeatures().get(0);
	}
	...
	public EReference getXCBR_CBOpCap() {
        return (EReference)getXCBR().getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getXCBR_POWCap() {
        return (EAttribute)getXCBR().getEStructuralFeatures().get(2);
	}
	...
	public EReference getXCBR_MaxOpCap() {
        return (EReference)getXCBR().getEStructuralFeatures().get(3);
	}
	...
	public EReference getXCBR_SwitchControl() {
        return (EReference)getXCBR().getEStructuralFeatures().get(4);
	}
	...
	public EClass getXSWI() {
		if (xswiEClass == null) {
			xswiEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupXPackage.eNS_URI).getEClassifiers().get(2);
		}
		return xswiEClass;
	}
	...
	public EAttribute getXSWI_SwOpCap() {
        return (EAttribute)getXSWI().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getXSWI_MaxOpCap() {
        return (EAttribute)getXSWI().getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getXSWI_SwTyp() {
        return (EAttribute)getXSWI().getEStructuralFeatures().get(2);
	}
	...
	public EReference getXSWI_SwitchControl() {
        return (EReference)getXSWI().getEStructuralFeatures().get(3);
	}
