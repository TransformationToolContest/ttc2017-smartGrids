...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupP/PMSS")]
    public class PMSS : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP.GroupP, IPMSS, IModelElement
    {
        ...
        public virtual IASG MotStr
        {
            ...
            set
            {
                if ((this._motStr != value))
                {
                    ...
                    this.OnPropertyChanging("MotStr", e);
                    this._motStr = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("MotStr", e);
                }
            }
        }
        ...
        public virtual IING LokRotTms
        {
            ...
            set
            {
                if ((this._lokRotTms != value))
                {
                    ...
                    this.OnPropertyChanging("LokRotTms", e);
                    ...
                    this.OnPropertyChanged("LokRotTms", e);
                }
            }
        }
        ...
        private sealed class MotStrProxy : ModelPropertyChange<IPMSS, IASG>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.MotStrChanged += handler;
            }
        ...
        private sealed class LokRotTmsProxy : ModelPropertyChange<IPMSS, IING>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.LokRotTmsChanged += handler;
            }
