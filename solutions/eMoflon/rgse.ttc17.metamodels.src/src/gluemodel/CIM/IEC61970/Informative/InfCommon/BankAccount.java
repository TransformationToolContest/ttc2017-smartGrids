 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCommon.BankAccount#getAccountNumber <em>Account Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCommon.BankAccount#getBank <em>Bank</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCommon.BankAccount#getServiceSupplier <em>Service Supplier</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfCommon.BankAccount#getBankStatements <em>Bank Statements</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getBankAccount()
...
public interface BankAccount extends Document {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getBankAccount_AccountNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfCommon.BankAccount#getAccountNumber <em>Account Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.Bank#getBankAccounts <em>Bank Accounts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setBank(Bank)
	 * @see gluemodel.CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getBankAccount_Bank()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfCommon.BankAccount#getBank <em>Bank</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.ServiceSupplier#getBankAccounts <em>Bank Accounts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getBankAccount_ServiceSupplier()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfCommon.BankAccount#getServiceSupplier <em>Service Supplier</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.BankStatement#getBankAccount <em>Bank Account</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getBankAccount_BankStatements()
