 ...
 * <ul>
 *   <li>{@link rgse.ttc17.emoflon.tgg.task2.impl.PositionPointToPositionPointImpl#getSource <em>Source</em>}</li>
 *   <li>{@link rgse.ttc17.emoflon.tgg.task2.impl.PositionPointToPositionPointImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PositionPointToPositionPointImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return Task2Package.Literals.POSITION_POINT_TO_POSITION_POINT;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Task2Package.POSITION_POINT_TO_POSITION_POINT__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(PositionPoint newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Task2Package.POSITION_POINT_TO_POSITION_POINT__SOURCE,
					oldSource, source));
	}
	...
	public outagePreventionJointarget.PositionPoint getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Task2Package.POSITION_POINT_TO_POSITION_POINT__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(outagePreventionJointarget.PositionPoint newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Task2Package.POSITION_POINT_TO_POSITION_POINT__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Task2Package.POSITION_POINT_TO_POSITION_POINT__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case Task2Package.POSITION_POINT_TO_POSITION_POINT__TARGET:
			if (resolve)
				return getTarget();
