...
import gluemodel.CIM.IEC61970.Informative.Financial.FinancialFactory;
 ...
 * @generated
 */
public class FinancialPackageImpl extends EPackageImpl implements FinancialPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass financialVersionEClass = null;
	 ...
	 * @generated
	 */
	private EClass marketerEClass = null;
	 ...
	 * @generated
	 */
	private EClass intSchedAgreementEClass = null;
	 ...
	 * @generated
	 */
	private EClass transmissionProviderEClass = null;
	 ...
	 * @generated
	 */
	private EClass transmissionProductEClass = null;
	 ...
	 * @generated
	 */
	private EClass generationProviderEClass = null;
	 ...
	 * @generated
	 */
	private EClass customerConsumerEClass = null;
	 ...
	 * @generated
	 */
	private EClass openAccessProductEClass = null;
	 ...
	 * @generated
	 */
	private EClass controlAreaOperatorEClass = null;
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.Financial.FinancialPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FinancialPackageImpl() {
		super(eNS_URI, FinancialFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link FinancialPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FinancialPackage init() {
		if (isInited) return (FinancialPackage)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI);

		// Obtain or create and register package
		FinancialPackageImpl theFinancialPackage = (FinancialPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FinancialPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FinancialPackageImpl());
		...
		theFinancialPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FinancialPackage.eNS_URI, theFinancialPackage);
		return theFinancialPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getFinancialVersion() {
		if (financialVersionEClass == null) {
			financialVersionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(0);
		}
		return financialVersionEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getFinancialVersion_Version() {
        return (EAttribute)getFinancialVersion().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFinancialVersion_Date() {
        return (EAttribute)getFinancialVersion().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getMarketer() {
		if (marketerEClass == null) {
			marketerEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(1);
		}
		return marketerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getMarketer_Resells_EnergyProduct() {
        return (EReference)getMarketer().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getMarketer_HeldBy() {
        return (EReference)getMarketer().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getMarketer_HoldsTitleTo_EnergyProducts() {
        return (EReference)getMarketer().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getMarketer_ResoldBy() {
        return (EReference)getMarketer().getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EClass getIntSchedAgreement() {
		if (intSchedAgreementEClass == null) {
			intSchedAgreementEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(2);
		}
		return intSchedAgreementEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIntSchedAgreement_Organisations() {
        return (EReference)getIntSchedAgreement().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getIntSchedAgreement_DefaultIntegrationMethod() {
        return (EAttribute)getIntSchedAgreement().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getTransmissionProvider() {
		if (transmissionProviderEClass == null) {
			transmissionProviderEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(3);
		}
		return transmissionProviderEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProvider_ServicePoint() {
        return (EReference)getTransmissionProvider().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProvider_AncillaryServices() {
        return (EReference)getTransmissionProvider().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProvider_For() {
        return (EReference)getTransmissionProvider().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProvider_OfferedBy() {
        return (EReference)getTransmissionProvider().getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProvider_Flowgate() {
        return (EReference)getTransmissionProvider().getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProvider_SoldBy() {
        return (EReference)getTransmissionProvider().getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProvider_TransmissionProducts() {
        return (EReference)getTransmissionProvider().getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EClass getTransmissionProduct() {
		if (transmissionProductEClass == null) {
			transmissionProductEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(4);
		}
		return transmissionProductEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTransmissionProduct_TransmissionProductType() {
        return (EAttribute)getTransmissionProduct().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProduct_LocationFor() {
        return (EReference)getTransmissionProduct().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProduct_TransmissionProvider() {
        return (EReference)getTransmissionProduct().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getTransmissionProduct_Offers() {
        return (EReference)getTransmissionProduct().getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EClass getGenerationProvider() {
		if (generationProviderEClass == null) {
			generationProviderEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(5);
		}
		return generationProviderEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getGenerationProvider_ServicePoint() {
        return (EReference)getGenerationProvider().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getGenerationProvider_GeneratingUnits() {
        return (EReference)getGenerationProvider().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getGenerationProvider_EnergyProducts() {
        return (EReference)getGenerationProvider().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getCustomerConsumer() {
		if (customerConsumerEClass == null) {
			customerConsumerEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(6);
		}
		return customerConsumerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getCustomerConsumer_TieLines() {
        return (EReference)getCustomerConsumer().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCustomerConsumer_ServicePoint() {
        return (EReference)getCustomerConsumer().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getOpenAccessProduct() {
		if (openAccessProductEClass == null) {
			openAccessProductEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(7);
		}
		return openAccessProductEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getOpenAccessProduct_ProvidedBy_TransmissionService() {
        return (EReference)getOpenAccessProduct().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getOpenAccessProduct_AncillaryServices() {
        return (EReference)getOpenAccessProduct().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getControlAreaOperator() {
		if (controlAreaOperatorEClass == null) {
			controlAreaOperatorEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(FinancialPackage.eNS_URI).getEClassifiers().get(8);
		}
		return controlAreaOperatorEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getControlAreaOperator_AncillaryService() {
        return (EReference)getControlAreaOperator().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getControlAreaOperator_TieLines() {
        return (EReference)getControlAreaOperator().getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getControlAreaOperator_ControlledBy() {
        return (EReference)getControlAreaOperator().getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public FinancialFactory getFinancialFactory() {
		return (FinancialFactory)getEFactoryInstance();
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.Financial." + eClassifier.getName());
