 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingPoint#getXCoord <em>XCoord</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingPoint#getOverheadConductors <em>Overhead Conductors</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingPoint#getConnections <em>Connections</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingPoint#getPhaseCode <em>Phase Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingPoint#getYCoord <em>YCoord</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getMountingPoint()
...
public interface MountingPoint extends IdentifiedObject {
	 ...
	 * @see #setXCoord(int)
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getMountingPoint_XCoord()
	 * @model required="true"
	 * @generated
	 */
	int getXCoord();
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingPoint#getXCoord <em>XCoord</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61968.AssetModels.OverheadConductorInfo}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.AssetModels.OverheadConductorInfo#getMountingPoint <em>Mounting Point</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getMountingPoint_OverheadConductors()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingConnection#getMountingPoints <em>Mounting Points</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getMountingPoint_Connections()
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getMountingPoint_PhaseCode()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingPoint#getPhaseCode <em>Phase Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setYCoord(int)
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getMountingPoint_YCoord()
	 * @model required="true"
	 * @generated
	 */
	int getYCoord();
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.MountingPoint#getYCoord <em>YCoord</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
