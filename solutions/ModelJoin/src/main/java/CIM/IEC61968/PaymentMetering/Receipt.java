 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Receipt#getTransactions <em>Transactions</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Receipt#getCashierShift <em>Cashier Shift</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Receipt#getTenders <em>Tenders</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Receipt#getVendorShift <em>Vendor Shift</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Receipt#isIsBankable <em>Is Bankable</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Receipt#getLine <em>Line</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getReceipt()
...
public interface Receipt extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Transaction#getReceipt <em>Receipt</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getReceipt_Transactions()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.CashierShift#getReceipts <em>Receipts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getReceipt_CashierShift()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Receipt#getCashierShift <em>Cashier Shift</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61968.PaymentMetering.Tender}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Tender#getReceipt <em>Receipt</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getReceipt_Tenders()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.VendorShift#getReceipts <em>Receipts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getReceipt_VendorShift()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Receipt#getVendorShift <em>Vendor Shift</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getReceipt_IsBankable()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Receipt#isIsBankable <em>Is Bankable</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getReceipt_Line()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Receipt#getLine <em>Line</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
