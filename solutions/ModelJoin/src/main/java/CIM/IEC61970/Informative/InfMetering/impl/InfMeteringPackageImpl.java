...
import CIM.IEC61970.Informative.InfMetering.InfMeteringFactory;
...
public class InfMeteringPackageImpl extends EPackageImpl implements InfMeteringPackage {
	 ...
	 * @see CIM.IEC61970.Informative.InfMetering.InfMeteringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfMetering." + eClassifier.getName());
