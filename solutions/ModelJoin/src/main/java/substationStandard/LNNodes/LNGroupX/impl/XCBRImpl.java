...
import substationStandard.LNNodes.LNGroupX.XCBR;
 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupX.impl.XCBRImpl#getSumSwARs <em>Sum Sw ARs</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupX.impl.XCBRImpl#getCBOpCap <em>CB Op Cap</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupX.impl.XCBRImpl#getPOWCap <em>POW Cap</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupX.impl.XCBRImpl#getMaxOpCap <em>Max Op Cap</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupX.impl.XCBRImpl#getSwitchControl <em>Switch Control</em>}</li>
 * </ul>
 *
 * @generated
 */
