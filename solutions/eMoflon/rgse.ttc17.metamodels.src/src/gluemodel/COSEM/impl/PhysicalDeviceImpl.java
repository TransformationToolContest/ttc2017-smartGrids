...
import gluemodel.COSEM.ManagementLogicalDevice;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getManagementLogicalDevice <em>Management Logical Device</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getID <em>ID</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getLogicalDevice <em>Logical Device</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getElectricityRelatedStatus <em>Electricity Related Status</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getAA <em>AA</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getAutoConnect <em>Auto Connect</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getBillingPeriodValues <em>Billing Period Values</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getElectricityID <em>Electricity ID</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getProgramEntries <em>Program Entries</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getOutputPulse <em>Output Pulse</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getReadingFactor <em>Reading Factor</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getNominalValues <em>Nominal Values</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getInputPulse <em>Input Pulse</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getMeasurementPeriod <em>Measurement Period</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getTimeEntries <em>Time Entries</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getTransformerLineLosses <em>Transformer Line Losses</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getMeasurementAlgorithm <em>Measurement Algorithm</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getMeteringPoint <em>Metering Point</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getRegisterMonitor <em>Register Monitor</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getElectricityValues <em>Electricity Values</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getMeasurementValueTypes <em>Measurement Value Types</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getHarmonics <em>Harmonics</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getTariffs <em>Tariffs</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.PhysicalDeviceImpl#getPhaseangles <em>Phaseangles</em>}</li>
 * </ul>
 *
 * @generated
 */
