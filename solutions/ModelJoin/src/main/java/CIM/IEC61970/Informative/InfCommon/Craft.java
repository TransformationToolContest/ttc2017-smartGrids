 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Craft#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Craft#getErpPersons <em>Erp Persons</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Craft#getSkills <em>Skills</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Craft#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCommon.Craft#getCategory <em>Category</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getCraft()
...
public interface Craft extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getCraft_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.Craft#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfERPSupport.ErpPerson#getCrafts <em>Crafts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getCraft_ErpPersons()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfCommon.Skill#getCrafts <em>Crafts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getCraft_Skills()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.Capability#getCrafts <em>Crafts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getCraft_Capabilities()
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#getCraft_Category()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfCommon.Craft#getCategory <em>Category</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
