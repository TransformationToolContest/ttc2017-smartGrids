 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getDesigns <em>Designs</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getRemovalDate <em>Removal Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getConditionFactors <em>Condition Factors</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getCompatibleUnits <em>Compatible Units</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getCuQuantity <em>Cu Quantity</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getCuAccount <em>Cu Account</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getWorkTasks <em>Work Tasks</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getDesignLocation <em>Design Location</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getCuAction <em>Cu Action</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#isEnergizationFlag <em>Energization Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getCUGroups <em>CU Groups</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.DesignLocationCUImpl#getCuUsage <em>Cu Usage</em>}</li>
 * </ul>
 *
 * @generated
 */
