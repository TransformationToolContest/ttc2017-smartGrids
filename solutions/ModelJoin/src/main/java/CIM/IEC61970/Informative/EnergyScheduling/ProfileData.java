 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getCapacityLevel <em>Capacity Level</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getStartDateTime <em>Start Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getProfile <em>Profile</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getStopDateTime <em>Stop Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getEnergyLevel <em>Energy Level</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getProfileData()
...
public interface ProfileData extends Element {
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getProfileData_CapacityLevel()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getCapacityLevel <em>Capacity Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getProfileData_StartDateTime()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getStartDateTime <em>Start Date Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getProfileData_SequenceNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getSequenceNumber <em>Sequence Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Informative.EnergyScheduling.Profile}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.EnergyScheduling.Profile#getProfileDatas <em>Profile Datas</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getProfileData_Profile()
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getProfileData_StopDateTime()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getStopDateTime <em>Stop Date Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getProfileData_EnergyLevel()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.ProfileData#getEnergyLevel <em>Energy Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
