...
import CIM.IEC61970.Informative.MarketOperations.BaseCaseConstraintLimit;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Base Case Constraint Limit</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.BaseCaseConstraintLimitImpl#getSecurityConstraintSum <em>Security Constraint Sum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaseCaseConstraintLimitImpl extends CurveImpl implements BaseCaseConstraintLimit {
	/**
	 ...
	 * @generated
	 */
	protected BaseCaseConstraintLimitImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MarketOperationsPackage.Literals.BASE_CASE_CONSTRAINT_LIMIT;
	}
		...
		if (securityConstraintSum != null && securityConstraintSum.eIsProxy()) {
			...
			if (securityConstraintSum != oldSecurityConstraintSum) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MarketOperationsPackage.BASE_CASE_CONSTRAINT_LIMIT__SECURITY_CONSTRAINT_SUM, oldSecurityConstraintSum, securityConstraintSum));
			}
		}
	...
	public NotificationChain basicSetSecurityConstraintSum(SecurityConstraintSum newSecurityConstraintSum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MarketOperationsPackage.BASE_CASE_CONSTRAINT_LIMIT__SECURITY_CONSTRAINT_SUM, oldSecurityConstraintSum, newSecurityConstraintSum);
	...
	public void setSecurityConstraintSum(SecurityConstraintSum newSecurityConstraintSum) {
		if (newSecurityConstraintSum != securityConstraintSum) {
			...
			if (securityConstraintSum != null)
				msgs = ((InternalEObject)securityConstraintSum).eInverseRemove(this, MarketOperationsPackage.SECURITY_CONSTRAINT_SUM__BASE_CASE_CONSTRAINT_LIMIT, SecurityConstraintSum.class, msgs);
			if (newSecurityConstraintSum != null)
				msgs = ((InternalEObject)newSecurityConstraintSum).eInverseAdd(this, MarketOperationsPackage.SECURITY_CONSTRAINT_SUM__BASE_CASE_CONSTRAINT_LIMIT, SecurityConstraintSum.class, msgs);
			msgs = basicSetSecurityConstraintSum(newSecurityConstraintSum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MarketOperationsPackage.BASE_CASE_CONSTRAINT_LIMIT__SECURITY_CONSTRAINT_SUM, newSecurityConstraintSum, newSecurityConstraintSum));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MarketOperationsPackage.BASE_CASE_CONSTRAINT_LIMIT__SECURITY_CONSTRAINT_SUM:
				if (securityConstraintSum != null)
					msgs = ((InternalEObject)securityConstraintSum).eInverseRemove(this, MarketOperationsPackage.SECURITY_CONSTRAINT_SUM__BASE_CASE_CONSTRAINT_LIMIT, SecurityConstraintSum.class, msgs);
