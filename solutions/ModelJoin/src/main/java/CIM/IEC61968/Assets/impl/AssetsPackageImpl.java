...
import CIM.IEC61968.Assets.AssetsFactory;
...
public class AssetsPackageImpl extends EPackageImpl implements AssetsPackage {
	 ...
	 * @see CIM.IEC61968.Assets.AssetsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61968.Assets." + eClassifier.getName());
