 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getInstMag <em>Inst Mag</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getMag <em>Mag</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getRange <em>Range</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getQ <em>Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getT <em>T</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#isSubEna <em>Sub Ena</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getSubMag <em>Sub Mag</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getSubQ <em>Sub Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getSubID <em>Sub ID</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getDb <em>Db</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getZeroDb <em>Zero Db</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getSVC <em>SVC</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getRangeC <em>Range C</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.MVImpl#getSmpRate <em>Smp Rate</em>}</li>
 * </ul>
 *
 * @generated
 */
