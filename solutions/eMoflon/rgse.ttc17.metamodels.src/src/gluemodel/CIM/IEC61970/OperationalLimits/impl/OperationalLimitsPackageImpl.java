...
import gluemodel.CIM.IEC61970.OperationalLimits.OperationalLimitsFactory;
...
public class OperationalLimitsPackageImpl extends EPackageImpl implements OperationalLimitsPackage {
	 ...
	 * @see gluemodel.CIM.IEC61970.OperationalLimits.OperationalLimitsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getBranchGroupTerminal() {
		if (branchGroupTerminalEClass == null) {
			branchGroupTerminalEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EClass getOperationalLimit() {
		if (operationalLimitEClass == null) {
			operationalLimitEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EAttribute getOperationalLimit_Type() {
        return (EAttribute)getOperationalLimit().getEStructuralFeatures().get(0);
	}
	...
	public EReference getOperationalLimit_OperationalLimitType() {
        return (EReference)getOperationalLimit().getEStructuralFeatures().get(2);
	}
	...
	public EClass getBranchGroup() {
		if (branchGroupEClass == null) {
			branchGroupEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(2);
		}
	...
	public EReference getBranchGroup_BranchGroupTerminal() {
        return (EReference)getBranchGroup().getEStructuralFeatures().get(2);
	}
	...
	public EClass getVoltageLimit() {
		if (voltageLimitEClass == null) {
			voltageLimitEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	public EClass getApparentPowerLimit() {
		if (apparentPowerLimitEClass == null) {
			apparentPowerLimitEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(4);
		}
	...
	public EClass getCurrentLimit() {
		if (currentLimitEClass == null) {
			currentLimitEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(6);
		}
	...
	public EClass getOperationalLimitSet() {
		if (operationalLimitSetEClass == null) {
			operationalLimitSetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(7);
		}
	...
	public EClass getActivePowerLimit() {
		if (activePowerLimitEClass == null) {
			activePowerLimitEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(8);
		}
	...
	public EClass getOperationalLimitType() {
		if (operationalLimitTypeEClass == null) {
			operationalLimitTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(9);
		}
	...
	public EEnum getOperationalLimitDirectionKind() {
		if (operationalLimitDirectionKindEEnum == null) {
			operationalLimitDirectionKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(OperationalLimitsPackage.eNS_URI).getEClassifiers().get(5);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.OperationalLimits." + eClassifier.getName());
