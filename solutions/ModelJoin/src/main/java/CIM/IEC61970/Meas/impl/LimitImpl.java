 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Meas.impl.LimitImpl#getProcedures <em>Procedures</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LimitImpl extends IdentifiedObjectImpl implements Limit {
	...
	public EList<Procedure> getProcedures() {
		if (procedures == null) {
			procedures = new EObjectWithInverseResolvingEList.ManyInverse<Procedure>(Procedure.class, this, MeasPackage.LIMIT__PROCEDURES, InfAssetsPackage.PROCEDURE__LIMITS);
		}
		return procedures;
	}
