...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.Reservation
{
    ...
    public class ServiceReservation : Element, IServiceReservation, IModelElement
    {
        ...
        public virtual IMarketer Holds
        {
            ...
            set
            {
                if ((this._holds != value))
                {
                    ...
                    this.OnPropertyChanging("Holds", e);
                    this._holds = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("Holds", e);
                }
            }
        }
        ...
        public virtual IMarketer Resells
        {
            ...
            set
            {
                if ((this._resells != value))
                {
                    ...
                    this.OnPropertyChanging("Resells", e);
                    this._resells = value;
                    if ((old != null))
                    {
                        old.ResoldBy = null;
                    ...
                    this.OnPropertyChanged("Resells", e);
                }
            }
        }
        ...
        public virtual ITransmissionProvider Sells
        {
            ...
            set
            {
                if ((this._sells != value))
                {
                    ...
                    this.OnPropertyChanging("Sells", e);
                    this._sells = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("Sells", e);
                }
            }
        }
        ...
        {
            this.OnCollectionChanging("Reserves_TransmissionService", e);
        }
        ...
        {
            this.OnCollectionChanged("Reserves_TransmissionService", e);
        }
        ...
        {
            this.OnCollectionChanging("Reserves_AncillaryServices", e);
        }
        ...
        {
            this.OnCollectionChanged("Reserves_AncillaryServices", e);
        }
        ...
        private sealed class HoldsProxy : ModelPropertyChange<IServiceReservation, IMarketer>
        {
            ...
            {
                this.ModelElement.HoldsChanged += handler;
            }
        ...
        private sealed class ResellsProxy : ModelPropertyChange<IServiceReservation, IMarketer>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.ResellsChanged += handler;
            }
        ...
        private sealed class SellsProxy : ModelPropertyChange<IServiceReservation, ITransmissionProvider>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.SellsChanged += handler;
            }
