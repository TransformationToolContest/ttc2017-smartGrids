 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.RatioTapChanger#getRatioVariationCurve <em>Ratio Variation Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.RatioTapChanger#getTransformerWinding <em>Transformer Winding</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.RatioTapChanger#getWinding <em>Winding</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.RatioTapChanger#getTculControlMode <em>Tcul Control Mode</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Wires.WiresPackage#getRatioTapChanger()
...
public interface RatioTapChanger extends TapChanger {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.RatioVariationCurve#getRatioTapChanger <em>Ratio Tap Changer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRatioTapChanger_RatioVariationCurve()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.RatioTapChanger#getRatioVariationCurve <em>Ratio Variation Curve</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.TransformerWinding#getRatioTapChanger <em>Ratio Tap Changer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRatioTapChanger_TransformerWinding()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.RatioTapChanger#getTransformerWinding <em>Transformer Winding</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.WiresExt.DistributionTransformerWinding#getRatioTapChanger <em>Ratio Tap Changer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRatioTapChanger_Winding()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.RatioTapChanger#getWinding <em>Winding</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Wires.TransformerControlMode}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRatioTapChanger_TculControlMode()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.RatioTapChanger#getTculControlMode <em>Tcul Control Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
