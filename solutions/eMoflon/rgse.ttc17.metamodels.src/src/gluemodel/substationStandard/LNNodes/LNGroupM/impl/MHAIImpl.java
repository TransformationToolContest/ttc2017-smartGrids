...
import gluemodel.substationStandard.LNNodes.LNGroupM.MHAI;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getEEName <em>EE Name</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHz <em>Hz</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHA <em>HA</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHPhV <em>HPh V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHPPV <em>HPPV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHW <em>HW</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHVAr <em>HV Ar</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHVA <em>HVA</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHRmsA <em>HRms A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHRmsPhV <em>HRms Ph V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHRmsPPV <em>HRms PPV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHTuW <em>HTu W</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHTsW <em>HTs W</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHATm <em>HA Tm</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHKf <em>HKf</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHTdf <em>HTdf</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdA <em>Thd A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdOddA <em>Thd Odd A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdEvnA <em>Thd Evn A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdPhV <em>Thd Ph V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdOddPhV <em>Thd Odd Ph V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdEvnV <em>Thd Evn V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdPPV <em>Thd PPV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdOddPPV <em>Thd Odd PPV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdEvnPPV <em>Thd Evn PPV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHCfPhV <em>HCf Ph V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHCfPPV <em>HCf PPV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHCfA <em>HCf A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHTif <em>HTif</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getHzSet <em>Hz Set</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getEvTmms <em>Ev Tmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getNumCyc <em>Num Cyc</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdAVal <em>Thd AVal</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdVVal <em>Thd VVal</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdATmms <em>Thd ATmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getThdVTmms <em>Thd VTmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getNomA <em>Nom A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MHAIImpl#getEEHealth <em>EE Health</em>}</li>
 * </ul>
 *
 * @generated
 */
