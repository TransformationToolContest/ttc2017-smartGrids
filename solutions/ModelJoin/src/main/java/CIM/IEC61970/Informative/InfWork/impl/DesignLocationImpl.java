 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getSpanLength <em>Span Length</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getConditionFactors <em>Condition Factors</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getMaterialItems <em>Material Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getDiagrams <em>Diagrams</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getWorkLocations <em>Work Locations</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getDesignLocationCUs <em>Design Location CUs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getDesigns <em>Designs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getErpBomItemDatas <em>Erp Bom Item Datas</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.DesignLocationImpl#getMiscCostItems <em>Misc Cost Items</em>}</li>
 * </ul>
 *
 * @generated
 */
