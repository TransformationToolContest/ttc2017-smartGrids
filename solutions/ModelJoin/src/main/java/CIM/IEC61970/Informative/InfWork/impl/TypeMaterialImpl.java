 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.TypeMaterialImpl#getErpIssueInventories <em>Erp Issue Inventories</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.TypeMaterialImpl#isStockItem <em>Stock Item</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.TypeMaterialImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.TypeMaterialImpl#getErpReqLineItems <em>Erp Req Line Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.TypeMaterialImpl#getMaterialItems <em>Material Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.TypeMaterialImpl#getCostType <em>Cost Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.TypeMaterialImpl#getEstUnitCost <em>Est Unit Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.impl.TypeMaterialImpl#getCUMaterialItems <em>CU Material Items</em>}</li>
 * </ul>
 *
 * @generated
 */
