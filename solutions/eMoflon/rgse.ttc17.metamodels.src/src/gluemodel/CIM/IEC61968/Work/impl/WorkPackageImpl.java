...
import gluemodel.CIM.IEC61968.Work.WorkFactory;
...
public class WorkPackageImpl extends EPackageImpl implements WorkPackage {
	 ...
	 * @see gluemodel.CIM.IEC61968.Work.WorkPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getWork() {
		if (workEClass == null) {
			workEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(WorkPackage.eNS_URI).getEClassifiers().get(1);
		}
		return workEClass;
	}
	...
	public EAttribute getWork_Priority() {
        return (EAttribute)getWork().getEStructuralFeatures().get(4);
	}
	...
	public EReference getWork_ErpProjectAccounting() {
        return (EReference)getWork().getEStructuralFeatures().get(6);
	}
	...
	public EAttribute getWork_RequestDateTime() {
        return (EAttribute)getWork().getEStructuralFeatures().get(10);
	}
	...
	public EAttribute getWork_Kind() {
        return (EAttribute)getWork().getEStructuralFeatures().get(11);
	}
	...
	public EEnum getWorkKind() {
		if (workKindEEnum == null) {
			workKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(WorkPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61968.Work." + eClassifier.getName());
