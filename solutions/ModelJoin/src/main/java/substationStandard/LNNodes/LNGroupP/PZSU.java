 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PZSU#getStr <em>Str</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PZSU#getOp <em>Op</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PZSU#getStrVal <em>Str Val</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PZSU#getOpDlTmms <em>Op Dl Tmms</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PZSU#getRsDlTmms <em>Rs Dl Tmms</em>}</li>
 * </ul>
 *
 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPZSU()
 * @model
 * @generated
 */
public interface PZSU extends GroupP {
	 ...
	 * @see #setStr(ACD)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPZSU_Str()
	 * @model required="true"
	 * @generated
	 */
	ACD getStr();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PZSU#getStr <em>Str</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOp(ACT)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPZSU_Op()
	 * @model required="true"
	 * @generated
	 */
	ACT getOp();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PZSU#getOp <em>Op</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setStrVal(ASG)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPZSU_StrVal()
	 * @model required="true"
	 * @generated
	 */
	ASG getStrVal();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PZSU#getStrVal <em>Str Val</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOpDlTmms(ING)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPZSU_OpDlTmms()
	 * @model required="true"
	 * @generated
	 */
	ING getOpDlTmms();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PZSU#getOpDlTmms <em>Op Dl Tmms</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRsDlTmms(ING)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPZSU_RsDlTmms()
	 * @model required="true"
	 * @generated
	 */
	ING getRsDlTmms();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PZSU#getRsDlTmms <em>Rs Dl Tmms</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
