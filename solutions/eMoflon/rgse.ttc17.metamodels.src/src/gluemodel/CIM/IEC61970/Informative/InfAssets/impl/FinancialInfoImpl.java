 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getCostType <em>Cost Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getCostDescription <em>Cost Description</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getPlantTransferDateTime <em>Plant Transfer Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getWarrantyEndDateTime <em>Warranty End Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getActualPurchaseCost <em>Actual Purchase Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getPurchaseDateTime <em>Purchase Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getPurchaseOrderNumber <em>Purchase Order Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getFinancialValue <em>Financial Value</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getValueDateTime <em>Value Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.impl.FinancialInfoImpl#getAsset <em>Asset</em>}</li>
 * </ul>
 *
 * @generated
 */
