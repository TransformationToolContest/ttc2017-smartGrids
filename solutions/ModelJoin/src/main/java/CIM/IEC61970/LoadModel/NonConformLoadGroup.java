 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.LoadModel.NonConformLoadGroup#getNonConformLoadSchedules <em>Non Conform Load Schedules</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.NonConformLoadGroup#getEnergyConsumers <em>Energy Consumers</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.LoadModel.LoadModelPackage#getNonConformLoadGroup()
...
public interface NonConformLoadGroup extends LoadGroup {
	 ...
	 * The list contents are of type {@link CIM.IEC61970.LoadModel.NonConformLoadSchedule}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.LoadModel.NonConformLoadSchedule#getNonConformLoadGroup <em>Non Conform Load Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.LoadModel.LoadModelPackage#getNonConformLoadGroup_NonConformLoadSchedules()
	 ...
	 * The list contents are of type {@link CIM.IEC61970.LoadModel.NonConformLoad}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.LoadModel.NonConformLoad#getLoadGroup <em>Load Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.LoadModel.LoadModelPackage#getNonConformLoadGroup_EnergyConsumers()
