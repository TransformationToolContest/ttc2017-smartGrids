 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.ErpProjectAccounting#getProjects <em>Projects</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.ErpProjectAccounting#getWorkCostDetails <em>Work Cost Details</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.ErpProjectAccounting#getErpTimeEntries <em>Erp Time Entries</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.ErpProjectAccounting#getWorks <em>Works</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfERPSupport.InfERPSupportPackage#getErpProjectAccounting()
...
public interface ErpProjectAccounting extends Document {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.Project#getErpProjectAccounting <em>Erp Project Accounting</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfERPSupport.InfERPSupportPackage#getErpProjectAccounting_Projects()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.WorkCostDetail#getErpProjectAccounting <em>Erp Project Accounting</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfERPSupport.InfERPSupportPackage#getErpProjectAccounting_WorkCostDetails()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfERPSupport.ErpTimeEntry#getErpProjectAccounting <em>Erp Project Accounting</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfERPSupport.InfERPSupportPackage#getErpProjectAccounting_ErpTimeEntries()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Work.Work#getErpProjectAccounting <em>Erp Project Accounting</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfERPSupport.InfERPSupportPackage#getErpProjectAccounting_Works()
