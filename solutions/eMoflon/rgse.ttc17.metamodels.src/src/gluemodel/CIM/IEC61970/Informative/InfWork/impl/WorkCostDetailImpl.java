 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getCostType <em>Cost Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getContractorItems <em>Contractor Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getMaterialItems <em>Material Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getTransactionDateTime <em>Transaction Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getEquipmentItems <em>Equipment Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getPropertyUnits <em>Property Units</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getDesign <em>Design</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getMiscCostItems <em>Misc Cost Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getWorkCostSummary <em>Work Cost Summary</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getWorkTask <em>Work Task</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#isIsDebit <em>Is Debit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getType <em>Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getOverheadCost <em>Overhead Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getWorks <em>Works</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getLaborItems <em>Labor Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.impl.WorkCostDetailImpl#getErpProjectAccounting <em>Erp Project Accounting</em>}</li>
 * </ul>
 *
 * @generated
 */
