 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDIR#getStr <em>Str</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDIR#getOp <em>Op</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupP.PDIR#getRsDiTmms <em>Rs Di Tmms</em>}</li>
 * </ul>
 *
 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDIR()
 * @model
 * @generated
 */
public interface PDIR extends GroupP {
	 ...
	 * @see #setStr(ACD)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDIR_Str()
	 * @model required="true"
	 * @generated
	 */
	ACD getStr();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDIR#getStr <em>Str</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOp(ACT)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDIR_Op()
	 * @model required="true"
	 * @generated
	 */
	ACT getOp();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDIR#getOp <em>Op</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRsDiTmms(ING)
	 * @see substationStandard.LNNodes.LNGroupP.LNGroupPPackage#getPDIR_RsDiTmms()
	 * @model required="true"
	 * @generated
	 */
	ING getRsDiTmms();
	...
	/**
	 * Sets the value of the '{@link substationStandard.LNNodes.LNGroupP.PDIR#getRsDiTmms <em>Rs Di Tmms</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
