 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getReceiptTransactionBids <em>Receipt Transaction Bids</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getRTO <em>RTO</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getRegisteredResources <em>Registered Resources</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getBeginPeriod <em>Begin Period</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getPnodeClearing <em>Pnode Clearing</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getType <em>Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getDeliveryTransactionBids <em>Delivery Transaction Bids</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#isIsPublic <em>Is Public</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getConnectivityNode <em>Connectivity Node</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getFTRs <em>FT Rs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getEndPeriod <em>End Period</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PnodeImpl#getUsage <em>Usage</em>}</li>
 * </ul>
 *
 * @generated
 */
