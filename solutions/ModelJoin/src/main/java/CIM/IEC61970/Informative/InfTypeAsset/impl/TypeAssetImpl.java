...
import CIM.IEC61970.Informative.InfTypeAsset.TypeAssetCatalogue;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getTypeAssetCatalogue <em>Type Asset Catalogue</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getErpBomItemDatas <em>Erp Bom Item Datas</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getAssetInfo <em>Asset Info</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#isStockItem <em>Stock Item</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getErpReqLineItems <em>Erp Req Line Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getErpInventoryIssues <em>Erp Inventory Issues</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getEstimatedUnitCost <em>Estimated Unit Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getCUWorkEquipmentAsset <em>CU Work Equipment Asset</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getAssetModels <em>Asset Models</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getCUAsset <em>CU Asset</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfTypeAsset.impl.TypeAssetImpl#getQuantity <em>Quantity</em>}</li>
 * </ul>
 *
 * @generated
 */
