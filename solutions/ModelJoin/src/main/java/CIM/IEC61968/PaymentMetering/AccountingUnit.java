...
import CIM.IEC61970.Domain.Currency;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AccountingUnit#getMonetaryUnit <em>Monetary Unit</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AccountingUnit#getEnergyUnit <em>Energy Unit</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AccountingUnit#getValue <em>Value</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AccountingUnit#getMultiplier <em>Multiplier</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountingUnit()
...
public interface AccountingUnit extends Element {
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Domain.Currency}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountingUnit_MonetaryUnit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AccountingUnit#getMonetaryUnit <em>Monetary Unit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountingUnit_EnergyUnit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AccountingUnit#getEnergyUnit <em>Energy Unit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setValue(float)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountingUnit_Value()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AccountingUnit#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountingUnit_Multiplier()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AccountingUnit#getMultiplier <em>Multiplier</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
