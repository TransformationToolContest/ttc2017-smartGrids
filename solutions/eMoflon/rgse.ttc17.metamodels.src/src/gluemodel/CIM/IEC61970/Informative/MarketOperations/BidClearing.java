 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.BidClearing#getStartUpCost <em>Start Up Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.BidClearing#getBid <em>Bid</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.BidClearing#getNoLoadCost <em>No Load Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.BidClearing#getLostOpCost <em>Lost Op Cost</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getBidClearing()
...
public interface BidClearing extends Element {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getBidClearing_StartUpCost()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.BidClearing#getStartUpCost <em>Start Up Cost</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.Bid#getBidClearing <em>Bid Clearing</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setBid(Bid)
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getBidClearing_Bid()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.BidClearing#getBid <em>Bid</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getBidClearing_NoLoadCost()
	 * @model dataType="gluemodel.CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.BidClearing#getNoLoadCost <em>No Load Cost</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getBidClearing_LostOpCost()
	 * @model dataType="gluemodel.CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.BidClearing#getLostOpCost <em>Lost Op Cost</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
