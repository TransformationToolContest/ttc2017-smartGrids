...
import CIM.IEC61968.WiresExt.DistributionTapChanger;
import CIM.IEC61968.WiresExt.WiresExtPackage;

import CIM.IEC61970.Core.PhaseCode;

import CIM.IEC61970.Wires.impl.RatioTapChangerImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getPtRatio <em>Pt Ratio</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getLimitVoltage <em>Limit Voltage</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getReverseLineDropR <em>Reverse Line Drop R</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getReverseLineDropX <em>Reverse Line Drop X</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getCtRating <em>Ct Rating</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getLineDropR <em>Line Drop R</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getBandVoltage <em>Band Voltage</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getLineDropX <em>Line Drop X</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getCtRatio <em>Ct Ratio</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#isLineDropCompensation <em>Line Drop Compensation</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getMonitoredPhase <em>Monitored Phase</em>}</li>
 *   <li>{@link CIM.IEC61968.WiresExt.impl.DistributionTapChangerImpl#getTargetVoltage <em>Target Voltage</em>}</li>
 * </ul>
 *
 * @generated
 */
