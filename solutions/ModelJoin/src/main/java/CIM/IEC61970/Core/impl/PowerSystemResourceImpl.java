 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getReportingGroup <em>Reporting Group</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getNetworkDataSets <em>Network Data Sets</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getOutageSchedule <em>Outage Schedule</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getPSREvent <em>PSR Event</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getSafetyDocuments <em>Safety Documents</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getErpOrganisationRoles <em>Erp Organisation Roles</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getCircuitSections <em>Circuit Sections</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getAssets <em>Assets</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getScheduleSteps <em>Schedule Steps</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getPSRType <em>PSR Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getPsrLists <em>Psr Lists</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getOperatingShare <em>Operating Share</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getChangeItems <em>Change Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.PowerSystemResourceImpl#getDocumentRoles <em>Document Roles</em>}</li>
 * </ul>
 *
 * @generated
 */
