 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Card#getCvNumber <em>Cv Number</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Card#getExpiryDate <em>Expiry Date</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Card#getPan <em>Pan</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Card#getAccountHolderName <em>Account Holder Name</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Card#getTender <em>Tender</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCard()
...
public interface Card extends Element {
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCard_CvNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Card#getCvNumber <em>Cv Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCard_ExpiryDate()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Card#getExpiryDate <em>Expiry Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPan(String)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCard_Pan()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Card#getPan <em>Pan</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCard_AccountHolderName()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Card#getAccountHolderName <em>Account Holder Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Tender#getCard <em>Card</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCard_Tender()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Card#getTender <em>Tender</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
