 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.IdentifiedObject#getMRID <em>MRID</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.IdentifiedObject#getName <em>Name</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.IdentifiedObject#getDescription <em>Description</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.IdentifiedObject#getPathName <em>Path Name</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.IdentifiedObject#getModelingAuthoritySet <em>Modeling Authority Set</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.IdentifiedObject#getLocalName <em>Local Name</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.IdentifiedObject#getAliasName <em>Alias Name</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getIdentifiedObject()
...
public interface IdentifiedObject extends Element {
	 ...
	 * @see #setMRID(String)
	 * @see CIM.IEC61970.Core.CorePackage#getIdentifiedObject_MRID()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.IdentifiedObject#getMRID <em>MRID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see CIM.IEC61970.Core.CorePackage#getIdentifiedObject_Name()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.IdentifiedObject#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getIdentifiedObject_Description()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.IdentifiedObject#getDescription <em>Description</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getIdentifiedObject_PathName()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.IdentifiedObject#getPathName <em>Path Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfCore.ModelingAuthoritySet#getIdentifiedObjects <em>Identified Objects</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getIdentifiedObject_ModelingAuthoritySet()
	 * @see CIM.IEC61970.Informative.InfCore.ModelingAuthoritySet#getIdentifiedObjects
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.IdentifiedObject#getModelingAuthoritySet <em>Modeling Authority Set</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getIdentifiedObject_LocalName()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.IdentifiedObject#getLocalName <em>Local Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getIdentifiedObject_AliasName()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.IdentifiedObject#getAliasName <em>Alias Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
