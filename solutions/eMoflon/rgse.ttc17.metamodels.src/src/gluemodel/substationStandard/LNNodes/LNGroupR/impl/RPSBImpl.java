...
import gluemodel.substationStandard.LNNodes.LNGroupR.RPSB;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getOpCntRs <em>Op Cnt Rs</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getStr <em>Str</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getOp <em>Op</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getBlkZn <em>Blk Zn</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getZeroEna <em>Zero Ena</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getNgEna <em>Ng Ena</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getMaxEna <em>Max Ena</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getSwgVal <em>Swg Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getSwgRis <em>Swg Ris</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getSwgReact <em>Swg React</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getSwgTmms <em>Swg Tmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getUnBlkTmms <em>Un Blk Tmms</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getMaxNumSlp <em>Max Num Slp</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupR.impl.RPSBImpl#getEvTmms <em>Ev Tmms</em>}</li>
 * </ul>
 *
 * @generated
 */
