 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.ReliabilityInfo#getMomFailureRate <em>Mom Failure Rate</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.ReliabilityInfo#getAssets <em>Assets</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.ReliabilityInfo#getMTTR <em>MTTR</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.ReliabilityInfo#getSpecification <em>Specification</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getReliabilityInfo()
...
public interface ReliabilityInfo extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getReliabilityInfo_MomFailureRate()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfAssets.ReliabilityInfo#getMomFailureRate <em>Mom Failure Rate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Assets.Asset#getReliabilityInfos <em>Reliability Infos</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getReliabilityInfo_Assets()
	 ...
	 * @see #setMTTR(float)
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getReliabilityInfo_MTTR()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfAssets.ReliabilityInfo#getMTTR <em>MTTR</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfAssets.Specification#getReliabilityInfos <em>Reliability Infos</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getReliabilityInfo_Specification()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfAssets.ReliabilityInfo#getSpecification <em>Specification</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
