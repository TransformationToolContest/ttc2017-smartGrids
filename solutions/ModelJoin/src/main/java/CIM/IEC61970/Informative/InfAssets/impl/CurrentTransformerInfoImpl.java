...
import CIM.IEC61970.Informative.InfAssets.CurrentTransformerInfo;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getAccuracyClass <em>Accuracy Class</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getCtClass <em>Ct Class</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getMaxRatio <em>Max Ratio</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getPrimaryRatio <em>Primary Ratio</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getCoreBurden <em>Core Burden</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getPrimaryFlsRating <em>Primary Fls Rating</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getAccuracyLimit <em>Accuracy Limit</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getKneePointCurrent <em>Knee Point Current</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getTertiaryRatio <em>Tertiary Ratio</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getNominalRatio <em>Nominal Ratio</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getUsage <em>Usage</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getSecondaryFlsRating <em>Secondary Fls Rating</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getTertiaryFlsRating <em>Tertiary Fls Rating</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getCoreCount <em>Core Count</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getKneePointVoltage <em>Knee Point Voltage</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.CurrentTransformerInfoImpl#getSecondaryRatio <em>Secondary Ratio</em>}</li>
 * </ul>
 *
 * @generated
 */
