...
import gluemodel.substationStandard.SubstationStandardFactory;
...
public class SubstationStandardPackageImpl extends EPackageImpl implements SubstationStandardPackage {
	 ...
	 * @see gluemodel.substationStandard.SubstationStandardPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getSubstandard() {
		if (substandardEClass == null) {
			substandardEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(SubstationStandardPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EReference getSubstandard_LN() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(0);
	}
	...
	public EReference getSubstandard_NamePlt() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(1);
	}
	...
	public EReference getSubstandard_LPL() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(2);
	}
	...
	public EReference getSubstandard_DPC() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(3);
	}
	...
	public EReference getSubstandard_ACT() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(4);
	}
	...
	public EReference getSubstandard_SPS() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(5);
	}
	...
	public EReference getSubstandard_BSC() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(6);
	}
	...
	public EReference getSubstandard_ISC() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(7);
	}
	...
	public EReference getSubstandard_SPC() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(8);
	}
	...
	public EReference getSubstandard_MV() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(9);
	}
	...
	public EReference getSubstandard_INS() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(10);
	}
	...
	public EReference getSubstandard_ASG() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(11);
	}
	...
	public EReference getSubstandard_WYE() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(12);
	}
	...
	public EReference getSubstandard_DPStatus() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(13);
	}
	...
	public EReference getSubstandard_AnalogueValue() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(14);
	}
	...
	public EReference getSubstandard_CMV() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(15);
	}
	...
	public EReference getSubstandard_ValWithTrans() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(16);
	}
	...
	public EReference getSubstandard_BSControl() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(17);
	}
	...
	public EReference getSubstandard_Vector() {
        return (EReference)getSubstandard().getEStructuralFeatures().get(18);
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.substationStandard." + eClassifier.getName());
