 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getBilling_period_average <em>Billing period average</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getCumulative_minimum <em>Cumulative minimum</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getCumulative_maximum <em>Cumulative maximum</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getCurrent_average <em>Current average</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getLast_average <em>Last average</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getInstantaneous_value <em>Instantaneous value</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getTime_integral <em>Time integral</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getUnder_limit_threshold <em>Under limit threshold</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getUnder_limit_occurrence_counter <em>Under limit occurrence counter</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getUnder_limit_duration <em>Under limit duration</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getUnder_limit_magnitude <em>Under limit magnitude</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getOver_limit_threshold <em>Over limit threshold</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getOver_limit_occurrence_counter <em>Over limit occurrence counter</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getOver_limit_duration <em>Over limit duration</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getOver_limit_magnitude <em>Over limit magnitude</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#isMissing_threshold <em>Missing threshold</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#isMissing_occurrence_counter <em>Missing occurrence counter</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#isMissing_duration <em>Missing duration</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#isMissing_magnitude <em>Missing magnitude</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getTime_threshold_for_under_limit <em>Time threshold for under limit</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getTime_threshold_for_over_limit <em>Time threshold for over limit</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getTime_threshold_for_missing_magnitude <em>Time threshold for missing magnitude</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getContracted_value <em>Contracted value</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getMinimum_for_recording_interval <em>Minimum for recording interval</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getMaximum_for_recording_interval <em>Maximum for recording interval</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getTest_average <em>Test average</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.MeasurementValuesImpl#getCalculations <em>Calculations</em>}</li>
 * </ul>
 *
 * @generated
 */
