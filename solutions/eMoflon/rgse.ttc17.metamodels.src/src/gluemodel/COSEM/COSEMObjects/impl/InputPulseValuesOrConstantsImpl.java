 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getActiveEnergy <em>Active Energy</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getReactive_energy <em>Reactive energy</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getApparent_energy <em>Apparent energy</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getVolt_squared_hours <em>Volt squared hours</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getAmpere_squared_hours <em>Ampere squared hours</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getUnitless_quantities <em>Unitless quantities</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getActive_energy_export <em>Active energy export</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getReactive_energy_export <em>Reactive energy export</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.InputPulseValuesOrConstantsImpl#getApparent_energy_export <em>Apparent energy export</em>}</li>
 * </ul>
 *
 * @generated
 */
