 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getQ <em>Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getT <em>T</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getPhsABHar <em>Phs AB Har</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getPhsBCHar <em>Phs BC Har</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getPhsCAHar <em>Phs CA Har</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getNumHar <em>Num Har</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getNumCyc <em>Num Cyc</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getEvalTm <em>Eval Tm</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getAngRef <em>Ang Ref</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getSmpRate <em>Smp Rate</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getHvRef <em>Hv Ref</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HDELImpl#getRmsCyc <em>Rms Cyc</em>}</li>
 * </ul>
 *
 * @generated
 */
