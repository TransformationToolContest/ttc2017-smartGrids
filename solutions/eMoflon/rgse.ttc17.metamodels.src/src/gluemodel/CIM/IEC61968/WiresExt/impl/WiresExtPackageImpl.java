...
import gluemodel.CIM.IEC61968.WiresExt.WiresExtFactory;
...
public class WiresExtPackageImpl extends EPackageImpl implements WiresExtPackage {
	 ...
	 * @see gluemodel.CIM.IEC61968.WiresExt.WiresExtPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61968.WiresExt." + eClassifier.getName());
