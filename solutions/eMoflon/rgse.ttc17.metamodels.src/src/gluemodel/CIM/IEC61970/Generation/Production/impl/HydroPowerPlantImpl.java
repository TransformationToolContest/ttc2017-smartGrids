...
import gluemodel.CIM.IEC61970.Generation.Production.HydroPlantType;
...
import gluemodel.CIM.IEC61970.Generation.Production.PenstockType;
...
import gluemodel.CIM.IEC61970.Generation.Production.SurgeTankCode;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getGenRatedP <em>Gen Rated P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getGenSourcePumpDischargeReservoir <em>Gen Source Pump Discharge Reservoir</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getHydroGeneratingUnits <em>Hydro Generating Units</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getSurgeTankCrestLevel <em>Surge Tank Crest Level</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getDischargeTravelDelay <em>Discharge Travel Delay</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getPumpRatedP <em>Pump Rated P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getPenstockType <em>Penstock Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getHydroPlantType <em>Hydro Plant Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getHydroPumps <em>Hydro Pumps</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getPlantRatedHead <em>Plant Rated Head</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getReservoir <em>Reservoir</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getSurgeTankCode <em>Surge Tank Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.HydroPowerPlantImpl#getPlantDischargeCapacity <em>Plant Discharge Capacity</em>}</li>
 * </ul>
 *
 * @generated
 */
