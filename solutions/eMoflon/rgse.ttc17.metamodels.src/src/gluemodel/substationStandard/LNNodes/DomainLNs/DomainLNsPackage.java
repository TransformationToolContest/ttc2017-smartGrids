 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLNsFactory
 * @model kind="package"
 * @generated
 */
public interface DomainLNsPackage extends EPackage {
	 ...
	 * @generated
	 */
	DomainLNsPackage eINSTANCE = gluemodel.substationStandard.LNNodes.DomainLNs.impl.DomainLNsPackageImpl.init();

	/**
	 * The meta object id for the '{@link gluemodel.substationStandard.LNNodes.DomainLNs.impl.DomainLNImpl <em>Domain LN</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.impl.DomainLNImpl
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.impl.DomainLNsPackageImpl#getDomainLN()
	 * @generated
	 */
	int DOMAIN_LN = 0;
	...
	/**
	 * Returns the meta object for class '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN <em>Domain LN</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getMode <em>Mode</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Mode</em>'.
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getMode()
	 * @see #getDomainLN()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getBehaviour <em>Behaviour</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Behaviour</em>'.
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getBehaviour()
	 * @see #getDomainLN()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getHealth <em>Health</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Health</em>'.
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getHealth()
	 * @see #getDomainLN()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getNamePlt <em>Name Plt</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Name Plt</em>'.
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getNamePlt()
	 * @see #getDomainLN()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link gluemodel.substationStandard.LNNodes.DomainLNs.impl.DomainLNImpl <em>Domain LN</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see gluemodel.substationStandard.LNNodes.DomainLNs.impl.DomainLNImpl
		 * @see gluemodel.substationStandard.LNNodes.DomainLNs.impl.DomainLNsPackageImpl#getDomainLN()
