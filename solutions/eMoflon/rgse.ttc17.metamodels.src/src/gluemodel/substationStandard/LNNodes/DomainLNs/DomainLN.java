 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getMode <em>Mode</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getBehaviour <em>Behaviour</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getHealth <em>Health</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getNamePlt <em>Name Plt</em>}</li>
 * </ul>
 *
 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLNsPackage#getDomainLN()
 * @model
 * @generated
 */
public interface DomainLN extends EObject {
	 ...
	 * @see #setMode(INC)
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLNsPackage#getDomainLN_Mode()
	 * @model required="true"
	 * @generated
	 */
	INC getMode();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getMode <em>Mode</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLNsPackage#getDomainLN_Behaviour()
	 * @model required="true"
	 * @generated
	 */
	INS getBehaviour();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getBehaviour <em>Behaviour</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setHealth(INS)
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLNsPackage#getDomainLN_Health()
	 * @model required="true"
	 * @generated
	 */
	INS getHealth();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getHealth <em>Health</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setNamePlt(LPL)
	 * @see gluemodel.substationStandard.LNNodes.DomainLNs.DomainLNsPackage#getDomainLN_NamePlt()
	 * @model required="true"
	 * @generated
	 */
	LPL getNamePlt();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.LNNodes.DomainLNs.DomainLN#getNamePlt <em>Name Plt</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
