 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.Reservation.impl.TransmissionPathImpl#getDeliveryPointFor <em>Delivery Point For</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.Reservation.impl.TransmissionPathImpl#getOfferedOn <em>Offered On</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.Reservation.impl.TransmissionPathImpl#getPointOfReceiptFor <em>Point Of Receipt For</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.Reservation.impl.TransmissionPathImpl#getFor <em>For</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.Reservation.impl.TransmissionPathImpl#getAvailTransferCapability <em>Avail Transfer Capability</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.Reservation.impl.TransmissionPathImpl#isParallelPathFlag <em>Parallel Path Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.Reservation.impl.TransmissionPathImpl#getLocatedOn <em>Located On</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.Reservation.impl.TransmissionPathImpl#getTotalTransferCapability <em>Total Transfer Capability</em>}</li>
 * </ul>
 *
 * @generated
 */
