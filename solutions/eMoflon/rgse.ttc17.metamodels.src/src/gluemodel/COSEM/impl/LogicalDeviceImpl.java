 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getAA <em>AA</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getName <em>Name</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getAutoConnect <em>Auto Connect</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getBillingPeriodValues <em>Billing Period Values</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getElectricityID <em>Electricity ID</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getProgramEntries <em>Program Entries</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getOutputPulse <em>Output Pulse</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getReadingFactor <em>Reading Factor</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getNominalValues <em>Nominal Values</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getInputPulse <em>Input Pulse</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getMeasurementPeriod <em>Measurement Period</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getTimeEntries <em>Time Entries</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getTransformerLineLosses <em>Transformer Line Losses</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getMeasurementAlgorithm <em>Measurement Algorithm</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getMeteringPoint <em>Metering Point</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getElectricityRelatedStatus <em>Electricity Related Status</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getRegisterMonitor <em>Register Monitor</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getElectricityValues <em>Electricity Values</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getMeasurementValueTypes <em>Measurement Value Types</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getHarmonics <em>Harmonics</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getTariffs <em>Tariffs</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getPhaseangles <em>Phaseangles</em>}</li>
 *   <li>{@link gluemodel.COSEM.impl.LogicalDeviceImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalDeviceImpl extends MinimalEObjectImpl.Container implements LogicalDevice {
	/**
	 ...
	 * @ordered
	 */
	protected LogicalDeviceName name;
	...
	protected EClass eStaticClass() {
		return COSEMPackage.Literals.LOGICAL_DEVICE;
	}
	...
	public NotificationChain basicSetAA(CurrentAssociation newAA, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__AA, oldAA, newAA);
	...
	public void setAA(CurrentAssociation newAA) {
		if (newAA != aa) {
			...
			if (aa != null)
				msgs = ((InternalEObject)aa).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__AA, null, msgs);
			if (newAA != null)
				msgs = ((InternalEObject)newAA).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__AA, null, msgs);
			msgs = basicSetAA(newAA, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__AA, newAA, newAA));
	}
	 ...
	 * @generated
	 */
	public LogicalDeviceName getName() {
		return name;
	}
	 ...
	 * @generated
	 */
	public void setName(LogicalDeviceName newName) {
		if (newName != name) {
			NotificationChain msgs = null;
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__NAME, null, msgs);
			if (newName != null)
				msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__NAME, null, msgs);
			msgs = basicSetName(newName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__NAME, newName, newName));
	}
	...
	public NotificationChain basicSetAutoConnect(AutoConnectObject newAutoConnect, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__AUTO_CONNECT, oldAutoConnect, newAutoConnect);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAutoConnect(AutoConnectObject newAutoConnect) {
		if (newAutoConnect != autoConnect) {
			NotificationChain msgs = null;
			if (autoConnect != null)
				msgs = ((InternalEObject)autoConnect).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__AUTO_CONNECT, null, msgs);
			if (newAutoConnect != null)
				msgs = ((InternalEObject)newAutoConnect).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__AUTO_CONNECT, null, msgs);
			msgs = basicSetAutoConnect(newAutoConnect, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__AUTO_CONNECT, newAutoConnect, newAutoConnect));
	}
	...
	public NotificationChain basicSetBillingPeriodValues(BillingPeriodValues newBillingPeriodValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__BILLING_PERIOD_VALUES, oldBillingPeriodValues, newBillingPeriodValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBillingPeriodValues(BillingPeriodValues newBillingPeriodValues) {
		if (newBillingPeriodValues != billingPeriodValues) {
			...
			if (billingPeriodValues != null)
				msgs = ((InternalEObject)billingPeriodValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__BILLING_PERIOD_VALUES, null, msgs);
			if (newBillingPeriodValues != null)
				msgs = ((InternalEObject)newBillingPeriodValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__BILLING_PERIOD_VALUES, null, msgs);
			msgs = basicSetBillingPeriodValues(newBillingPeriodValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__BILLING_PERIOD_VALUES, newBillingPeriodValues, newBillingPeriodValues));
	}
	...
	public NotificationChain basicSetElectricityID(ElectricityID newElectricityID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_ID, oldElectricityID, newElectricityID);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElectricityID(ElectricityID newElectricityID) {
		if (newElectricityID != electricityID) {
			...
			if (electricityID != null)
				msgs = ((InternalEObject)electricityID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_ID, null, msgs);
			if (newElectricityID != null)
				msgs = ((InternalEObject)newElectricityID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_ID, null, msgs);
			msgs = basicSetElectricityID(newElectricityID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_ID, newElectricityID, newElectricityID));
	}
	...
	public void setProgramEntries(ElectricityProgramEntries newProgramEntries) {
		if (newProgramEntries != programEntries) {
			...
			if (programEntries != null)
				msgs = ((InternalEObject)programEntries).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__PROGRAM_ENTRIES, null, msgs);
			if (newProgramEntries != null)
				msgs = ((InternalEObject)newProgramEntries).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__PROGRAM_ENTRIES, null, msgs);
			msgs = basicSetProgramEntries(newProgramEntries, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__PROGRAM_ENTRIES, newProgramEntries, newProgramEntries));
	}
	...
	public NotificationChain basicSetOutputPulse(OutputPulseValues_constants newOutputPulse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__OUTPUT_PULSE, oldOutputPulse, newOutputPulse);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOutputPulse(OutputPulseValues_constants newOutputPulse) {
		if (newOutputPulse != outputPulse) {
			NotificationChain msgs = null;
			if (outputPulse != null)
				msgs = ((InternalEObject)outputPulse).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__OUTPUT_PULSE, null, msgs);
			if (newOutputPulse != null)
				msgs = ((InternalEObject)newOutputPulse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__OUTPUT_PULSE, null, msgs);
			msgs = basicSetOutputPulse(newOutputPulse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__OUTPUT_PULSE, newOutputPulse, newOutputPulse));
	}
	...
	public NotificationChain basicSetReadingFactor(ReadingFactorAndCT_VTratio newReadingFactor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__READING_FACTOR, oldReadingFactor, newReadingFactor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReadingFactor(ReadingFactorAndCT_VTratio newReadingFactor) {
		if (newReadingFactor != readingFactor) {
			...
			if (readingFactor != null)
				msgs = ((InternalEObject)readingFactor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__READING_FACTOR, null, msgs);
			if (newReadingFactor != null)
				msgs = ((InternalEObject)newReadingFactor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__READING_FACTOR, null, msgs);
			msgs = basicSetReadingFactor(newReadingFactor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__READING_FACTOR, newReadingFactor, newReadingFactor));
	}
	...
	public NotificationChain basicSetNominalValues(ElectricityNominalValues newNominalValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__NOMINAL_VALUES, oldNominalValues, newNominalValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNominalValues(ElectricityNominalValues newNominalValues) {
		if (newNominalValues != nominalValues) {
			...
			if (nominalValues != null)
				msgs = ((InternalEObject)nominalValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__NOMINAL_VALUES, null, msgs);
			if (newNominalValues != null)
				msgs = ((InternalEObject)newNominalValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__NOMINAL_VALUES, null, msgs);
			msgs = basicSetNominalValues(newNominalValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__NOMINAL_VALUES, newNominalValues, newNominalValues));
	}
	...
	public NotificationChain basicSetInputPulse(InputPulseValuesOrConstants newInputPulse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__INPUT_PULSE, oldInputPulse, newInputPulse);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInputPulse(InputPulseValuesOrConstants newInputPulse) {
		if (newInputPulse != inputPulse) {
			NotificationChain msgs = null;
			if (inputPulse != null)
				msgs = ((InternalEObject)inputPulse).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__INPUT_PULSE, null, msgs);
			if (newInputPulse != null)
				msgs = ((InternalEObject)newInputPulse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__INPUT_PULSE, null, msgs);
			msgs = basicSetInputPulse(newInputPulse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__INPUT_PULSE, newInputPulse, newInputPulse));
	}
	...
	public NotificationChain basicSetMeasurementPeriod(MeasurementPeriod_recordingInterval_billingPeriodDuration newMeasurementPeriod, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_PERIOD, oldMeasurementPeriod, newMeasurementPeriod);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasurementPeriod(MeasurementPeriod_recordingInterval_billingPeriodDuration newMeasurementPeriod) {
		if (newMeasurementPeriod != measurementPeriod) {
			...
			if (measurementPeriod != null)
				msgs = ((InternalEObject)measurementPeriod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_PERIOD, null, msgs);
			if (newMeasurementPeriod != null)
				msgs = ((InternalEObject)newMeasurementPeriod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_PERIOD, null, msgs);
			msgs = basicSetMeasurementPeriod(newMeasurementPeriod, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_PERIOD, newMeasurementPeriod, newMeasurementPeriod));
	}
	...
	public NotificationChain basicSetTimeEntries(TimeEntries newTimeEntries, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__TIME_ENTRIES, oldTimeEntries, newTimeEntries);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTimeEntries(TimeEntries newTimeEntries) {
		if (newTimeEntries != timeEntries) {
			NotificationChain msgs = null;
			if (timeEntries != null)
				msgs = ((InternalEObject)timeEntries).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__TIME_ENTRIES, null, msgs);
			if (newTimeEntries != null)
				msgs = ((InternalEObject)newTimeEntries).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__TIME_ENTRIES, null, msgs);
			msgs = basicSetTimeEntries(newTimeEntries, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__TIME_ENTRIES, newTimeEntries, newTimeEntries));
	}
	...
	public NotificationChain basicSetTransformerLineLosses(TransformerAndLineLosses newTransformerLineLosses, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__TRANSFORMER_LINE_LOSSES, oldTransformerLineLosses, newTransformerLineLosses);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTransformerLineLosses(TransformerAndLineLosses newTransformerLineLosses) {
		if (newTransformerLineLosses != transformerLineLosses) {
			...
			if (transformerLineLosses != null)
				msgs = ((InternalEObject)transformerLineLosses).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__TRANSFORMER_LINE_LOSSES, null, msgs);
			if (newTransformerLineLosses != null)
				msgs = ((InternalEObject)newTransformerLineLosses).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__TRANSFORMER_LINE_LOSSES, null, msgs);
			msgs = basicSetTransformerLineLosses(newTransformerLineLosses, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__TRANSFORMER_LINE_LOSSES, newTransformerLineLosses, newTransformerLineLosses));
	}
	...
	public NotificationChain basicSetMeasurementAlgorithm(MeasurementMethods newMeasurementAlgorithm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_ALGORITHM, oldMeasurementAlgorithm, newMeasurementAlgorithm);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasurementAlgorithm(MeasurementMethods newMeasurementAlgorithm) {
		if (newMeasurementAlgorithm != measurementAlgorithm) {
			...
			if (measurementAlgorithm != null)
				msgs = ((InternalEObject)measurementAlgorithm).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_ALGORITHM, null, msgs);
			if (newMeasurementAlgorithm != null)
				msgs = ((InternalEObject)newMeasurementAlgorithm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_ALGORITHM, null, msgs);
			msgs = basicSetMeasurementAlgorithm(newMeasurementAlgorithm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_ALGORITHM, newMeasurementAlgorithm, newMeasurementAlgorithm));
	}
	...
	public NotificationChain basicSetMeteringPoint(MeteringPointID newMeteringPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__METERING_POINT, oldMeteringPoint, newMeteringPoint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeteringPoint(MeteringPointID newMeteringPoint) {
		if (newMeteringPoint != meteringPoint) {
			...
			if (meteringPoint != null)
				msgs = ((InternalEObject)meteringPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__METERING_POINT, null, msgs);
			if (newMeteringPoint != null)
				msgs = ((InternalEObject)newMeteringPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__METERING_POINT, null, msgs);
			msgs = basicSetMeteringPoint(newMeteringPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__METERING_POINT, newMeteringPoint, newMeteringPoint));
	}
	...
	public NotificationChain basicSetElectricityRelatedStatus(ElectricityRelatedStatusData newElectricityRelatedStatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_RELATED_STATUS, oldElectricityRelatedStatus, newElectricityRelatedStatus);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElectricityRelatedStatus(ElectricityRelatedStatusData newElectricityRelatedStatus) {
		if (newElectricityRelatedStatus != electricityRelatedStatus) {
			...
			if (electricityRelatedStatus != null)
				msgs = ((InternalEObject)electricityRelatedStatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_RELATED_STATUS, null, msgs);
			if (newElectricityRelatedStatus != null)
				msgs = ((InternalEObject)newElectricityRelatedStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_RELATED_STATUS, null, msgs);
			msgs = basicSetElectricityRelatedStatus(newElectricityRelatedStatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_RELATED_STATUS, newElectricityRelatedStatus, newElectricityRelatedStatus));
	}
	...
	public NotificationChain basicSetRegisterMonitor(RegisterMonitorObject newRegisterMonitor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__REGISTER_MONITOR, oldRegisterMonitor, newRegisterMonitor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRegisterMonitor(RegisterMonitorObject newRegisterMonitor) {
		if (newRegisterMonitor != registerMonitor) {
			...
			if (registerMonitor != null)
				msgs = ((InternalEObject)registerMonitor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__REGISTER_MONITOR, null, msgs);
			if (newRegisterMonitor != null)
				msgs = ((InternalEObject)newRegisterMonitor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__REGISTER_MONITOR, null, msgs);
			msgs = basicSetRegisterMonitor(newRegisterMonitor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__REGISTER_MONITOR, newRegisterMonitor, newRegisterMonitor));
	}
	...
	public NotificationChain basicSetElectricityValues(ElectricityValues newElectricityValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_VALUES, oldElectricityValues, newElectricityValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElectricityValues(ElectricityValues newElectricityValues) {
		if (newElectricityValues != electricityValues) {
			...
			if (electricityValues != null)
				msgs = ((InternalEObject)electricityValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_VALUES, null, msgs);
			if (newElectricityValues != null)
				msgs = ((InternalEObject)newElectricityValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_VALUES, null, msgs);
			msgs = basicSetElectricityValues(newElectricityValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_VALUES, newElectricityValues, newElectricityValues));
	}
	...
	public NotificationChain basicSetMeasurementValueTypes(MeasurementValues newMeasurementValueTypes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_VALUE_TYPES, oldMeasurementValueTypes, newMeasurementValueTypes);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasurementValueTypes(MeasurementValues newMeasurementValueTypes) {
		if (newMeasurementValueTypes != measurementValueTypes) {
			...
			if (measurementValueTypes != null)
				msgs = ((InternalEObject)measurementValueTypes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_VALUE_TYPES, null, msgs);
			if (newMeasurementValueTypes != null)
				msgs = ((InternalEObject)newMeasurementValueTypes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_VALUE_TYPES, null, msgs);
			msgs = basicSetMeasurementValueTypes(newMeasurementValueTypes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_VALUE_TYPES, newMeasurementValueTypes, newMeasurementValueTypes));
	}
	...
	public NotificationChain basicSetHarmonics(ElectricityHarmonics newHarmonics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__HARMONICS, oldHarmonics, newHarmonics);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHarmonics(ElectricityHarmonics newHarmonics) {
		if (newHarmonics != harmonics) {
			NotificationChain msgs = null;
			if (harmonics != null)
				msgs = ((InternalEObject)harmonics).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__HARMONICS, null, msgs);
			if (newHarmonics != null)
				msgs = ((InternalEObject)newHarmonics).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__HARMONICS, null, msgs);
			msgs = basicSetHarmonics(newHarmonics, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__HARMONICS, newHarmonics, newHarmonics));
	}
	...
	public NotificationChain basicSetTariffs(CurrentlyActiveTariff newTariffs, NotificationChain msgs) {
		...
		tariffs = newTariffs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__TARIFFS, oldTariffs, newTariffs);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTariffs(CurrentlyActiveTariff newTariffs) {
		if (newTariffs != tariffs) {
			NotificationChain msgs = null;
			if (tariffs != null)
				msgs = ((InternalEObject)tariffs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__TARIFFS, null, msgs);
			if (newTariffs != null)
				msgs = ((InternalEObject)newTariffs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__TARIFFS, null, msgs);
			msgs = basicSetTariffs(newTariffs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__TARIFFS, newTariffs, newTariffs));
	}
	...
	public NotificationChain basicSetPhaseangles(ExtendedPhaseAngleMeasurement newPhaseangles, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__PHASEANGLES, oldPhaseangles, newPhaseangles);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPhaseangles(ExtendedPhaseAngleMeasurement newPhaseangles) {
		if (newPhaseangles != phaseangles) {
			NotificationChain msgs = null;
			if (phaseangles != null)
				msgs = ((InternalEObject)phaseangles).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__PHASEANGLES, null, msgs);
			if (newPhaseangles != null)
				msgs = ((InternalEObject)newPhaseangles).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - COSEMPackage.LOGICAL_DEVICE__PHASEANGLES, null, msgs);
			msgs = basicSetPhaseangles(newPhaseangles, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__PHASEANGLES, newPhaseangles, newPhaseangles));
	}
	...
	public void setID(String newID) {
		...
		id = newID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, COSEMPackage.LOGICAL_DEVICE__ID, oldID, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case COSEMPackage.LOGICAL_DEVICE__AA:
				return basicSetAA(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__NAME:
				return basicSetName(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__AUTO_CONNECT:
				return basicSetAutoConnect(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__BILLING_PERIOD_VALUES:
				return basicSetBillingPeriodValues(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_ID:
				return basicSetElectricityID(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__PROGRAM_ENTRIES:
				return basicSetProgramEntries(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__OUTPUT_PULSE:
				return basicSetOutputPulse(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__READING_FACTOR:
				return basicSetReadingFactor(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__NOMINAL_VALUES:
				return basicSetNominalValues(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__INPUT_PULSE:
				return basicSetInputPulse(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_PERIOD:
				return basicSetMeasurementPeriod(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__TIME_ENTRIES:
				return basicSetTimeEntries(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__TRANSFORMER_LINE_LOSSES:
				return basicSetTransformerLineLosses(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_ALGORITHM:
				return basicSetMeasurementAlgorithm(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__METERING_POINT:
				return basicSetMeteringPoint(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_RELATED_STATUS:
				return basicSetElectricityRelatedStatus(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__REGISTER_MONITOR:
				return basicSetRegisterMonitor(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__ELECTRICITY_VALUES:
				return basicSetElectricityValues(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__MEASUREMENT_VALUE_TYPES:
				return basicSetMeasurementValueTypes(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__HARMONICS:
				return basicSetHarmonics(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__TARIFFS:
				return basicSetTariffs(null, msgs);
			case COSEMPackage.LOGICAL_DEVICE__PHASEANGLES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case COSEMPackage.LOGICAL_DEVICE__ID:
				return getID();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case COSEMPackage.LOGICAL_DEVICE__AA:
				...
				return;
			case COSEMPackage.LOGICAL_DEVICE__NAME:
				setName((LogicalDeviceName)newValue);
				return;
			case COSEMPackage.LOGICAL_DEVICE__AUTO_CONNECT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case COSEMPackage.LOGICAL_DEVICE__AA:
				...
				return;
			case COSEMPackage.LOGICAL_DEVICE__NAME:
				setName((LogicalDeviceName)null);
				return;
			case COSEMPackage.LOGICAL_DEVICE__AUTO_CONNECT:
