 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getKind <em>Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getLimits <em>Limits</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getCompatibleUnits <em>Compatible Units</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getProcedureDataSets <em>Procedure Data Sets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getProcedureValues <em>Procedure Values</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getCorporateCode <em>Corporate Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getInstruction <em>Instruction</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure()
...
public interface Procedure extends Document {
	 ...
	 * The literals are from the enumeration {@link gluemodel.CIM.IEC61970.Informative.InfAssets.ProcedureKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure_Kind()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure_SequenceNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getSequenceNumber <em>Sequence Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61970.Meas.Limit}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Meas.Limit#getProcedures <em>Procedures</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure_Limits()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfWork.CompatibleUnit#getProcedures <em>Procedures</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure_CompatibleUnits()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.ProcedureDataSet#getProcedure <em>Procedure</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure_ProcedureDataSets()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.Common.UserAttribute#getProcedure <em>Procedure</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure_ProcedureValues()
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure_CorporateCode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getCorporateCode <em>Corporate Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getProcedure_Instruction()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.Procedure#getInstruction <em>Instruction</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
