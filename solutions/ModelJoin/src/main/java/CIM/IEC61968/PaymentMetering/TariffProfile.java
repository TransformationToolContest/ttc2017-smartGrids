 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.TariffProfile#getTariffCycle <em>Tariff Cycle</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.TariffProfile#getTimeTariffIntervals <em>Time Tariff Intervals</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.TariffProfile#getTariffs <em>Tariffs</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.TariffProfile#getConsumptionTariffIntervals <em>Consumption Tariff Intervals</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTariffProfile()
...
public interface TariffProfile extends Document {
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTariffProfile_TariffCycle()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.TariffProfile#getTariffCycle <em>Tariff Cycle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.TimeTariffInterval#getTariffProfiles <em>Tariff Profiles</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTariffProfile_TimeTariffIntervals()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Customers.Tariff#getTariffProfiles <em>Tariff Profiles</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTariffProfile_Tariffs()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.ConsumptionTariffInterval#getTariffProfiles <em>Tariff Profiles</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getTariffProfile_ConsumptionTariffIntervals()
