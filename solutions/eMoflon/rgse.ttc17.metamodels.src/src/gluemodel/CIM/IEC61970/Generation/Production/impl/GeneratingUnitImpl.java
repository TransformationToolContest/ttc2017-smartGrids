...
import gluemodel.CIM.IEC61970.Generation.Production.GenUnitOpCostCurve;
import gluemodel.CIM.IEC61970.Generation.Production.GenUnitOpSchedule;
import gluemodel.CIM.IEC61970.Generation.Production.GeneratingUnit;
import gluemodel.CIM.IEC61970.Generation.Production.GeneratorControlMode;
import gluemodel.CIM.IEC61970.Generation.Production.GeneratorControlSource;
import gluemodel.CIM.IEC61970.Generation.Production.GeneratorOperatingMode;
import gluemodel.CIM.IEC61970.Generation.Production.GrossToNetActivePowerCurve;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getHighControlLimit <em>High Control Limit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getOperatedBy_GenerationProvider <em>Operated By Generation Provider</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getRaiseRampRate <em>Raise Ramp Rate</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getGenOperatingMode <em>Gen Operating Mode</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getAutoCntrlMarginP <em>Auto Cntrl Margin P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getControlPulseLow <em>Control Pulse Low</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getGovernorMPL <em>Governor MPL</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getRatedGrossMaxP <em>Rated Gross Max P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getAllocSpinResP <em>Alloc Spin Res P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getGenUnitOpSchedule <em>Gen Unit Op Schedule</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getStepChange <em>Step Change</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getStartupCost <em>Startup Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getSpinReserveRamp <em>Spin Reserve Ramp</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getNominalP <em>Nominal P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getGovernorSCD <em>Governor SCD</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getPenaltyFactor <em>Penalty Factor</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getControlPulseHigh <em>Control Pulse High</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getEnergyMinP <em>Energy Min P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getStartupTime <em>Startup Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getTieLinePF <em>Tie Line PF</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getLowerRampRate <em>Lower Ramp Rate</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getInitialP <em>Initial P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getControlResponseRate <em>Control Response Rate</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getMinEconomicP <em>Min Economic P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getModelDetail <em>Model Detail</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getControlAreaGeneratingUnit <em>Control Area Generating Unit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getFuelPriority <em>Fuel Priority</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getGrossToNetActivePowerCurves <em>Gross To Net Active Power Curves</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getGenUnitOpCostCurves <em>Gen Unit Op Cost Curves</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getMaxEconomicP <em>Max Economic P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getGenControlSource <em>Gen Control Source</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getRatedGrossMinP <em>Rated Gross Min P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getVariableCost <em>Variable Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getMinOperatingP <em>Min Operating P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getBaseP <em>Base P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getShortPF <em>Short PF</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getSynchronousMachines <em>Synchronous Machines</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getLowControlLimit <em>Low Control Limit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getLongPF <em>Long PF</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getRegisteredGenerator <em>Registered Generator</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getSubControlArea <em>Sub Control Area</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getMaxOperatingP <em>Max Operating P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#isFastStartFlag <em>Fast Start Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getGenControlMode <em>Gen Control Mode</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getRatedNetMaxP <em>Rated Net Max P</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getEfficiency <em>Efficiency</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getMinimumOffTime <em>Minimum Off Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#isDispReserveFlag <em>Disp Reserve Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getMaximumAllowableSpinningReserve <em>Maximum Allowable Spinning Reserve</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getControlDeadband <em>Control Deadband</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.GeneratingUnitImpl#getNormalPF <em>Normal PF</em>}</li>
 * </ul>
 *
 * @generated
 */
