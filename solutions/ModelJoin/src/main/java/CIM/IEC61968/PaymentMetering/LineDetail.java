 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.LineDetail#getRounding <em>Rounding</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.LineDetail#getAmount <em>Amount</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.LineDetail#getDateTime <em>Date Time</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.LineDetail#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getLineDetail()
...
public interface LineDetail extends Element {
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getLineDetail_Rounding()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.LineDetail#getRounding <em>Rounding</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAmount(float)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getLineDetail_Amount()
	 * @model dataType="CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.LineDetail#getAmount <em>Amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getLineDetail_DateTime()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.LineDetail#getDateTime <em>Date Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setNote(String)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getLineDetail_Note()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.LineDetail#getNote <em>Note</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
