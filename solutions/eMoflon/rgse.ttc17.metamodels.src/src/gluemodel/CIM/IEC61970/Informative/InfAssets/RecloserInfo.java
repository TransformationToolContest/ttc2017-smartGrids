 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#getPhaseTripRating <em>Phase Trip Rating</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#isGroundTripNormalEnabled <em>Ground Trip Normal Enabled</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#getGroundTripRating <em>Ground Trip Rating</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#getRecloseLockoutCount <em>Reclose Lockout Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#isGroundTripCapable <em>Ground Trip Capable</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getRecloserInfo()
...
public interface RecloserInfo extends SwitchInfo {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getRecloserInfo_PhaseTripRating()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#getPhaseTripRating <em>Phase Trip Rating</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getRecloserInfo_GroundTripNormalEnabled()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#isGroundTripNormalEnabled <em>Ground Trip Normal Enabled</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getRecloserInfo_GroundTripRating()
	 * @model dataType="gluemodel.CIM.IEC61970.Domain.CurrentFlow" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#getGroundTripRating <em>Ground Trip Rating</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getRecloserInfo_RecloseLockoutCount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#getRecloseLockoutCount <em>Reclose Lockout Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getRecloserInfo_GroundTripCapable()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.RecloserInfo#isGroundTripCapable <em>Ground Trip Capable</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
