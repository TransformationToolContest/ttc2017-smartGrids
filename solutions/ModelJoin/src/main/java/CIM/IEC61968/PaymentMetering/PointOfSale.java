 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.PointOfSale#getTokens <em>Tokens</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.PointOfSale#getLocation <em>Location</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.PointOfSale#getCashierShifts <em>Cashier Shifts</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.PointOfSale#getVendor <em>Vendor</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getPointOfSale()
...
public interface PointOfSale extends IdentifiedObject {
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Informative.InfPaymentMetering.Token}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfPaymentMetering.Token#getPointOfSale <em>Point Of Sale</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getPointOfSale_Tokens()
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getPointOfSale_Location()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.PointOfSale#getLocation <em>Location</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.CashierShift#getPointOfSale <em>Point Of Sale</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getPointOfSale_CashierShifts()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Vendor#getPointOfSales <em>Point Of Sales</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getPointOfSale_Vendor()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.PointOfSale#getVendor <em>Vendor</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
