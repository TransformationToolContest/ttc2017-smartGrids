...
import gluemodel.CIM.IEC61968.LoadControl.LoadControlFactory;
 ...
 * @generated
 */
public class LoadControlPackageImpl extends EPackageImpl implements LoadControlPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gluemodel.CIM.IEC61968.LoadControl.LoadControlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LoadControlPackageImpl() {
		super(eNS_URI, LoadControlFactory.eINSTANCE);
	}
	...
	public static LoadControlPackage init() {
		...
		LoadControlPackageImpl theLoadControlPackage = (LoadControlPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LoadControlPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new LoadControlPackageImpl());
	...
	public EClass getRemoteConnectDisconnectInfo() {
		if (remoteConnectDisconnectInfoEClass == null) {
			remoteConnectDisconnectInfoEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LoadControlPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EClass getConnectDisconnectFunction() {
		if (connectDisconnectFunctionEClass == null) {
			connectDisconnectFunctionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LoadControlPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EReference getConnectDisconnectFunction_Switches() {
        return (EReference)getConnectDisconnectFunction().getEStructuralFeatures().get(3);
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61968.LoadControl." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //LoadControlPackageImpl
