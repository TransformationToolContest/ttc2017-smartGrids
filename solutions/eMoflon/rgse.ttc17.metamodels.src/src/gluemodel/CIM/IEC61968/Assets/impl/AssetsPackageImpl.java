...
import gluemodel.CIM.IEC61968.Assets.AssetsFactory;
...
public class AssetsPackageImpl extends EPackageImpl implements AssetsPackage {
	 ...
	 * @generated
	 */
	private EClass comMediaAssetEClass = null;
	 ...
	 * @see gluemodel.CIM.IEC61968.Assets.AssetsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AssetsPackageImpl() {
		super(eNS_URI, AssetsFactory.eINSTANCE);
	}
	...
	public static AssetsPackage init() {
		...
		AssetsPackageImpl theAssetsPackage = (AssetsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AssetsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AssetsPackageImpl());
	...
	public EClass getAcceptanceTest() {
		if (acceptanceTestEClass == null) {
			acceptanceTestEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(AssetsPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EClass getSeal() {
		if (sealEClass == null) {
			sealEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(AssetsPackage.eNS_URI).getEClassifiers().get(2);
		}
		return sealEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getComMediaAsset() {
		if (comMediaAssetEClass == null) {
			comMediaAssetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(AssetsPackage.eNS_URI).getEClassifiers().get(4);
		}
		return comMediaAssetEClass;
	}
	...
	public EClass getAssetFunction() {
		if (assetFunctionEClass == null) {
			assetFunctionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(AssetsPackage.eNS_URI).getEClassifiers().get(5);
		}
	...
	public EReference getAssetFunction_Asset() {
        return (EReference)getAssetFunction().getEStructuralFeatures().get(3);
	}
	...
	public EClass getAsset() {
		if (assetEClass == null) {
			assetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(AssetsPackage.eNS_URI).getEClassifiers().get(6);
		}
		return assetEClass;
	}
	...
	public EAttribute getAsset_Critical() {
        return (EAttribute)getAsset().getEStructuralFeatures().get(8);
	}
	...
	public EAttribute getAsset_ManufacturedDate() {
        return (EAttribute)getAsset().getEStructuralFeatures().get(11);
	}
	...
	public EAttribute getAsset_LotNumber() {
        return (EAttribute)getAsset().getEStructuralFeatures().get(13);
	}
	...
	public EAttribute getAsset_InitialLossOfLife() {
        return (EAttribute)getAsset().getEStructuralFeatures().get(17);
	}
	...
	public EAttribute getAsset_UtcNumber() {
        return (EAttribute)getAsset().getEStructuralFeatures().get(21);
	}
	...
	public EReference getAsset_Properties() {
        return (EReference)getAsset().getEStructuralFeatures().get(26);
	}
	...
	public EReference getAsset_ToAssetRoles() {
        return (EReference)getAsset().getEStructuralFeatures().get(30);
	}
	...
	public EReference getAsset_ErpRecDeliveryItems() {
        return (EReference)getAsset().getEStructuralFeatures().get(37);
	}
	...
	public EClass getAssetContainer() {
		if (assetContainerEClass == null) {
			assetContainerEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(AssetsPackage.eNS_URI).getEClassifiers().get(7);
		}
	...
	public EEnum getSealConditionKind() {
		if (sealConditionKindEEnum == null) {
			sealConditionKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(AssetsPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EEnum getSealKind() {
		if (sealKindEEnum == null) {
			sealKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(AssetsPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61968.Assets." + eClassifier.getName());
