...
import CIM.IEC61970.Informative.EnergyScheduling.AreaControlMode;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getSubControlAreas <em>Sub Control Areas</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getFrequencyBiasFactor <em>Frequency Bias Factor</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getSideA_TieLines <em>Side ATie Lines</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getFreqSetPoint <em>Freq Set Point</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getControls <em>Controls</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getInadvertentAccounts <em>Inadvertent Accounts</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getSideB_TieLines <em>Side BTie Lines</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getReceive_DynamicSchedules <em>Receive Dynamic Schedules</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getAreaReserveSpec <em>Area Reserve Spec</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getAreaControlMode <em>Area Control Mode</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.HostControlAreaImpl#getSend_DynamicSchedules <em>Send Dynamic Schedules</em>}</li>
 * </ul>
 *
 * @generated
 */
