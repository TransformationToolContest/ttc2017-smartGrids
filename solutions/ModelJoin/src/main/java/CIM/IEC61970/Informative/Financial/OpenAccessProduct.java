 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.Financial.OpenAccessProduct#getProvidedBy_TransmissionService <em>Provided By Transmission Service</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Financial.OpenAccessProduct#getAncillaryServices <em>Ancillary Services</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.Financial.FinancialPackage#getOpenAccessProduct()
...
public interface OpenAccessProduct extends Agreement {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Reservation.TransmissionService#getTransContractFor <em>Trans Contract For</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Financial.FinancialPackage#getOpenAccessProduct_ProvidedBy_TransmissionService()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Reservation.AncillaryService#getOpenAccessProduct <em>Open Access Product</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Financial.FinancialPackage#getOpenAccessProduct_AncillaryServices()
