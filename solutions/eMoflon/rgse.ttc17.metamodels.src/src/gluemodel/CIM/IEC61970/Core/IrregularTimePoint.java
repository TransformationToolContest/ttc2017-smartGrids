 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.IrregularTimePoint#getValue1 <em>Value1</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.IrregularTimePoint#getValue2 <em>Value2</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.IrregularTimePoint#getIntervalSchedule <em>Interval Schedule</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.IrregularTimePoint#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Core.CorePackage#getIrregularTimePoint()
...
public interface IrregularTimePoint extends Element {
	 ...
	 * @see #setValue1(float)
	 * @see gluemodel.CIM.IEC61970.Core.CorePackage#getIrregularTimePoint_Value1()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Core.IrregularTimePoint#getValue1 <em>Value1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setValue2(float)
	 * @see gluemodel.CIM.IEC61970.Core.CorePackage#getIrregularTimePoint_Value2()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Core.IrregularTimePoint#getValue2 <em>Value2</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Core.IrregularIntervalSchedule#getTimePoints <em>Time Points</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Core.CorePackage#getIrregularTimePoint_IntervalSchedule()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Core.IrregularTimePoint#getIntervalSchedule <em>Interval Schedule</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTime(float)
	 * @see gluemodel.CIM.IEC61970.Core.CorePackage#getIrregularTimePoint_Time()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Core.IrregularTimePoint#getTime <em>Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
