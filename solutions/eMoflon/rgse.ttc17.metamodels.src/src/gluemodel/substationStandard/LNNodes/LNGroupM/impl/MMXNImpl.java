...
import gluemodel.substationStandard.LNNodes.LNGroupM.MMXN;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getEEName <em>EE Name</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getEEHealth <em>EE Health</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getAmp <em>Amp</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getVol <em>Vol</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getWatt <em>Watt</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getVolAmpr <em>Vol Ampr</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getVolAmp <em>Vol Amp</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getPwrFact <em>Pwr Fact</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getImp <em>Imp</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MMXNImpl#getHz <em>Hz</em>}</li>
 * </ul>
 *
 * @generated
 */
