 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfLoadControl.LoadLimitFunction#isIsAutoReconOp <em>Is Auto Recon Op</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfLoadControl.LoadLimitFunction#getMaximumLoad <em>Maximum Load</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfLoadControl.LoadLimitFunction#getReconnectTimeDelay <em>Reconnect Time Delay</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfLoadControl.LoadLimitFunction#getDisconnectTimeDelay <em>Disconnect Time Delay</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfLoadControl.InfLoadControlPackage#getLoadLimitFunction()
...
public interface LoadLimitFunction extends LoadMgmtFunction {
	 ...
	 * @see CIM.IEC61970.Informative.InfLoadControl.InfLoadControlPackage#getLoadLimitFunction_IsAutoReconOp()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfLoadControl.LoadLimitFunction#isIsAutoReconOp <em>Is Auto Recon Op</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfLoadControl.InfLoadControlPackage#getLoadLimitFunction_MaximumLoad()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfLoadControl.LoadLimitFunction#getMaximumLoad <em>Maximum Load</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfLoadControl.InfLoadControlPackage#getLoadLimitFunction_ReconnectTimeDelay()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfLoadControl.LoadLimitFunction#getReconnectTimeDelay <em>Reconnect Time Delay</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfLoadControl.InfLoadControlPackage#getLoadLimitFunction_DisconnectTimeDelay()
	 * @model dataType="CIM.IEC61970.Domain.Seconds" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfLoadControl.LoadLimitFunction#getDisconnectTimeDelay <em>Disconnect Time Delay</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
