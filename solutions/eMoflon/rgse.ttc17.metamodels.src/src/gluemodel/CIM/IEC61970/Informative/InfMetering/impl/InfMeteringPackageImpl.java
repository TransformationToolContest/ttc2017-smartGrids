...
import gluemodel.CIM.IEC61970.Informative.InfMetering.InfMeteringFactory;
 ...
 * @generated
 */
public class InfMeteringPackageImpl extends EPackageImpl implements InfMeteringPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass meteringFunctionConfigurationEClass = null;
	 ...
	 * @generated
	 */
	private EClass comPortEClass = null;
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfMetering.InfMeteringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InfMeteringPackageImpl() {
		super(eNS_URI, InfMeteringFactory.eINSTANCE);
	}
	...
	public static InfMeteringPackage init() {
		...
		InfMeteringPackageImpl theInfMeteringPackage = (InfMeteringPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InfMeteringPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InfMeteringPackageImpl());
	...
	public EClass getWaterMeteringFunction() {
		if (waterMeteringFunctionEClass == null) {
			waterMeteringFunctionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfMeteringPackage.eNS_URI).getEClassifiers().get(0);
		}
	...
	public EClass getGasMeteringFunction() {
		if (gasMeteringFunctionEClass == null) {
			gasMeteringFunctionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfMeteringPackage.eNS_URI).getEClassifiers().get(1);
		}
	 ...
	 * @generated
	 */
	public EClass getMeteringFunctionConfiguration() {
		if (meteringFunctionConfigurationEClass == null) {
			meteringFunctionConfigurationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfMeteringPackage.eNS_URI).getEClassifiers().get(2);
		}
		return meteringFunctionConfigurationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getMeteringFunctionConfiguration_ElectricMeteringFunctions() {
        return (EReference)getMeteringFunctionConfiguration().getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getComPort() {
		if (comPortEClass == null) {
			comPortEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(InfMeteringPackage.eNS_URI).getEClassifiers().get(3);
		}
		return comPortEClass;
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.Informative.InfMetering." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //InfMeteringPackageImpl
