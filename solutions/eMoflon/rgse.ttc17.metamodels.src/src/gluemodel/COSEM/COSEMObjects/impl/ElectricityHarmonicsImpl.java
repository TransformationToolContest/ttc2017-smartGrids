 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityHarmonicsImpl#getTotal <em>Total</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityHarmonicsImpl#getFundamental_harmonic <em>Fundamental harmonic</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityHarmonicsImpl#getHarmonic <em>Harmonic</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityHarmonicsImpl#getTotal_Harmoni_Distortion <em>Total Harmoni Distortion</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityHarmonicsImpl#getTotal_Demand_Distortion <em>Total Demand Distortion</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityHarmonicsImpl#getAll_harmonics <em>All harmonics</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityHarmonicsImpl#getAll_harmonics_to_nominal_value_ratio <em>All harmonics to nominal value ratio</em>}</li>
 * </ul>
 *
 * @generated
 */
