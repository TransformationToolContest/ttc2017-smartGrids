...
namespace TTC2017.SmartGrids.CIM.IEC61968.PaymentMetering
{
    ...
    public class Tender : IdentifiedObject, ITender, IModelElement
    {
        ...
        public virtual float Change
        {
            ...
            set
            {
                if ((this._change != value))
                {
                    ...
                    this.OnPropertyChanging("Change", e);
                    this._change = value;
                    this.OnChangeChanged(e);
                    this.OnPropertyChanged("Change", e);
                }
            }
        }
        ...
        public virtual ICheque Cheque
        {
            ...
            set
            {
                if ((this._cheque != value))
                {
                    ...
                    this.OnPropertyChanging("Cheque", e);
                    this._cheque = value;
                    if ((old != null))
                    {
                        old.Tender = null;
                    ...
                    this.OnPropertyChanged("Cheque", e);
                }
            }
        }
        ...
        public virtual ICard Card
        {
            ...
            set
            {
                if ((this._card != value))
                {
                    ...
                    this.OnPropertyChanging("Card", e);
                    this._card = value;
                    if ((old != null))
                    {
                        old.Tender = null;
        ...
        private sealed class ChangeProxy : ModelPropertyChange<ITender, float>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.ChangeChanged += handler;
            }
        ...
        private sealed class ChequeProxy : ModelPropertyChange<ITender, ICheque>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.ChequeChanged += handler;
            }
        ...
        private sealed class CardProxy : ModelPropertyChange<ITender, ICard>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.CardChanged += handler;
            }
