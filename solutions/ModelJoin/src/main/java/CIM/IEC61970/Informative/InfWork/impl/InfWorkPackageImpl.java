...
import CIM.IEC61970.Informative.InfWork.InfWorkFactory;
...
public class InfWorkPackageImpl extends EPackageImpl implements InfWorkPackage {
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfWork." + eClassifier.getName());
