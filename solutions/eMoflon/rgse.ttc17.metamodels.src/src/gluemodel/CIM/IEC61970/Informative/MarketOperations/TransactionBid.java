 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.TransactionBid#getEnergyTransId <em>Energy Trans Id</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.TransactionBid#getEnergyProfiles <em>Energy Profiles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.TransactionBid#getDelivery_Pnode <em>Delivery Pnode</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.TransactionBid#getReceipt_Pnode <em>Receipt Pnode</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransactionBid()
...
public interface TransactionBid extends Bid {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransactionBid_EnergyTransId()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.TransactionBid#getEnergyTransId <em>Energy Trans Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.EnergyScheduling.EnergyProfile#getTransactionBid <em>Transaction Bid</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransactionBid_EnergyProfiles()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.Pnode#getDeliveryTransactionBids <em>Delivery Transaction Bids</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransactionBid_Delivery_Pnode()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.TransactionBid#getDelivery_Pnode <em>Delivery Pnode</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.Pnode#getReceiptTransactionBids <em>Receipt Transaction Bids</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransactionBid_Receipt_Pnode()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.TransactionBid#getReceipt_Pnode <em>Receipt Pnode</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
