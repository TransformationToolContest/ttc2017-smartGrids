 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.Bay#isBayEnergyMeasFlag <em>Bay Energy Meas Flag</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Bay#getBusBarConfiguration <em>Bus Bar Configuration</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Bay#isBayPowerMeasFlag <em>Bay Power Meas Flag</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Bay#getVoltageLevel <em>Voltage Level</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Bay#getBreakerConfiguration <em>Breaker Configuration</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Bay#getSubstation <em>Substation</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getBay()
...
public interface Bay extends EquipmentContainer {
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getBay_BayEnergyMeasFlag()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Bay#isBayEnergyMeasFlag <em>Bay Energy Meas Flag</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Core.BusbarConfiguration}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getBay_BusBarConfiguration()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Bay#getBusBarConfiguration <em>Bus Bar Configuration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getBay_BayPowerMeasFlag()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Bay#isBayPowerMeasFlag <em>Bay Power Meas Flag</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.VoltageLevel#getBays <em>Bays</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getBay_VoltageLevel()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Bay#getVoltageLevel <em>Voltage Level</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Core.BreakerConfiguration}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getBay_BreakerConfiguration()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Bay#getBreakerConfiguration <em>Breaker Configuration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.Substation#getBays <em>Bays</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getBay_Substation()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Bay#getSubstation <em>Substation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
