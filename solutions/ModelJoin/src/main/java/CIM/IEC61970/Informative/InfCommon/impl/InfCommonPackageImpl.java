...
import CIM.IEC61970.Informative.InfCommon.InfCommonFactory;
...
public class InfCommonPackageImpl extends EPackageImpl implements InfCommonPackage {
	 ...
	 * @see CIM.IEC61970.Informative.InfCommon.InfCommonPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfCommon." + eClassifier.getName());
