 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketCaseClearing#getAncillaryServiceClearing <em>Ancillary Service Clearing</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketCaseClearing#getPostedDate <em>Posted Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketCaseClearing#getCaseType <em>Case Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketCaseClearing#getModifiedDate <em>Modified Date</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getMarketCaseClearing()
...
public interface MarketCaseClearing extends MarketFactors {
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.AncillaryServiceClearing#getMarketCaseClearing <em>Market Case Clearing</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getMarketCaseClearing_AncillaryServiceClearing()
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getMarketCaseClearing_PostedDate()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketCaseClearing#getPostedDate <em>Posted Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getMarketCaseClearing_CaseType()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketCaseClearing#getCaseType <em>Case Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getMarketCaseClearing_ModifiedDate()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketCaseClearing#getModifiedDate <em>Modified Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
