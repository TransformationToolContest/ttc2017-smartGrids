...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Fc Kind</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see gluemodel.substationStandard.Enumerations.EnumerationsPackage#getFcKind()
 * @model
 * @generated
 */
public enum FcKind implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int MX_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int CF_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int XX_VALUE = 0;

	/**
	 * An array of all the '<em><b>Fc Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FcKind[] VALUES_ARRAY =
		new FcKind[] {
			ST,
			MX,
			CO,
	...
	/**
	 * A public read-only list of all the '<em><b>Fc Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FcKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Fc Kind</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FcKind get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FcKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Fc Kind</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static FcKind getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FcKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Fc Kind</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FcKind get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FcKind(int value, String name, String literal) {
		this.value = value;
		this.name = name;
