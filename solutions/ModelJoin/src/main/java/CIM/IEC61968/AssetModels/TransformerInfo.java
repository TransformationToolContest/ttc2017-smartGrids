 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.AssetModels.TransformerInfo#getTransformers <em>Transformers</em>}</li>
 *   <li>{@link CIM.IEC61968.AssetModels.TransformerInfo#getWindingInfos <em>Winding Infos</em>}</li>
 *   <li>{@link CIM.IEC61968.AssetModels.TransformerInfo#getTransformerAssetModels <em>Transformer Asset Models</em>}</li>
 *   <li>{@link CIM.IEC61968.AssetModels.TransformerInfo#getTransformerAssets <em>Transformer Assets</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getTransformerInfo()
...
public interface TransformerInfo extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.WiresExt.DistributionTransformer#getTransformerInfo <em>Transformer Info</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getTransformerInfo_Transformers()
	 ...
	 * The list contents are of type {@link CIM.IEC61968.AssetModels.WindingInfo}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.AssetModels.WindingInfo#getTransformerInfo <em>Transformer Info</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getTransformerInfo_WindingInfos()
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Informative.InfAssetModels.TransformerAssetModel}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfAssetModels.TransformerAssetModel#getTransformerInfo <em>Transformer Info</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getTransformerInfo_TransformerAssetModels()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfAssets.TransformerAsset#getTransformerInfo <em>Transformer Info</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.AssetModels.AssetModelsPackage#getTransformerInfo_TransformerAssets()
