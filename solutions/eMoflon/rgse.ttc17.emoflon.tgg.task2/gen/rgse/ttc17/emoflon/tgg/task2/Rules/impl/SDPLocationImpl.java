...
public class SDPLocationImpl extends AbstractRuleImpl implements SDPLocation {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = SDPLocationImpl.pattern_SDPLocation_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
				trgLocation, srcLocation, asset, consumer, assetToPMU, pair, locationCorr);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : SDPLocationImpl.pattern_SDPLocation_2_2_corematch_blackBBFFBB(srcLocation, asset,
				pair, match)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, MeterAsset asset, PMUVoltageMeter consumer,
			MeterAssetToPMUVoltageMeter assetToPMU, MeterAssetMMXUPair pair) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_21(EMoflonEdge _edge_Location) {
		// prepare return value
		Object[] result1_bindingAndBlack = SDPLocationImpl
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SDP_LOCATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_SDPLOCATION_METERASSET_PMUVOLTAGEMETER_METERASSETTOPMUVOLTAGEMETER_METERASSETMMXUPAIR:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(gluemodel.CIM.IEC61968.Metering.SDPLocation) arguments.get(1), (MeterAsset) arguments.get(2),
					(PMUVoltageMeter) arguments.get(3), (MeterAssetToPMUVoltageMeter) arguments.get(4),
		...
		case RulesPackage.SDP_LOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_21__EMOFLONEDGE:
	...
	public static final Object[] pattern_SDPLocation_1_1_performtransformation_blackBBBBBFBB(
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, MeterAsset asset, PMUVoltageMeter consumer,
			MeterAssetToPMUVoltageMeter assetToPMU, MeterAssetMMXUPair pair, SDPLocation _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_SDPLocation_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_SDPLocation_1_1_performtransformation_binding != null) {
			...
			PMUVoltageMeter consumer = (PMUVoltageMeter) result_pattern_SDPLocation_1_1_performtransformation_binding[2];
			MeterAssetToPMUVoltageMeter assetToPMU = (MeterAssetToPMUVoltageMeter) result_pattern_SDPLocation_1_1_performtransformation_binding[3];
			MeterAssetMMXUPair pair = (MeterAssetMMXUPair) result_pattern_SDPLocation_1_1_performtransformation_binding[4];
	...
	public static final Iterable<Object[]> pattern_SDPLocation_2_2_corematch_blackBBFFBB(
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, MeterAsset asset, MeterAssetMMXUPair pair,
			Match match) {
	...
	public static final Object[] pattern_SDPLocation_2_4_solveCSP_bindingAndBlackFBBBBBBB(SDPLocation _this,
		...
		Object[] result_pattern_SDPLocation_2_4_solveCSP_binding = pattern_SDPLocation_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, srcLocation, asset, consumer, assetToPMU, pair);
