 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.impl.BankStatementImpl#getMerchantCreditAmount <em>Merchant Credit Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.impl.BankStatementImpl#getBankAccount <em>Bank Account</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.impl.BankStatementImpl#getDepositAmount <em>Deposit Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.impl.BankStatementImpl#getDepositDateTime <em>Deposit Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.impl.BankStatementImpl#getMerchantAccount <em>Merchant Account</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.impl.BankStatementImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfPaymentMetering.impl.BankStatementImpl#isPosted <em>Posted</em>}</li>
 * </ul>
 *
 * @generated
 */
