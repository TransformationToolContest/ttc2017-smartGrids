 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#isExponentModel <em>Exponent Model</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getPConstantCurrent <em>PConstant Current</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getQConstantImpedance <em>QConstant Impedance</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getQFrequencyExponent <em>QFrequency Exponent</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getPFrequencyExponent <em>PFrequency Exponent</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getPConstantImpedance <em>PConstant Impedance</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getQVoltageExponent <em>QVoltage Exponent</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getPVoltageExponent <em>PVoltage Exponent</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getEnergyConsumer <em>Energy Consumer</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getQConstantCurrent <em>QConstant Current</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getPConstantPower <em>PConstant Power</em>}</li>
 *   <li>{@link CIM.IEC61970.LoadModel.impl.LoadResponseCharacteristicImpl#getQConstantPower <em>QConstant Power</em>}</li>
 * </ul>
 *
 * @generated
 */
