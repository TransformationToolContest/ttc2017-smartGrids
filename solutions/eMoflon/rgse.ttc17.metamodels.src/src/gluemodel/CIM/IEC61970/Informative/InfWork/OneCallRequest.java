 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.OneCallRequest#getMarkingInstruction <em>Marking Instruction</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.OneCallRequest#isExplosivesUsed <em>Explosives Used</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.OneCallRequest#getWorkLocations <em>Work Locations</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfWork.OneCallRequest#isMarkedIndicator <em>Marked Indicator</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getOneCallRequest()
...
public interface OneCallRequest extends Document {
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getOneCallRequest_MarkingInstruction()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.OneCallRequest#getMarkingInstruction <em>Marking Instruction</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getOneCallRequest_ExplosivesUsed()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.OneCallRequest#isExplosivesUsed <em>Explosives Used</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfWork.WorkLocation#getOneCallRequest <em>One Call Request</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getOneCallRequest_WorkLocations()
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfWork.InfWorkPackage#getOneCallRequest_MarkedIndicator()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfWork.OneCallRequest#isMarkedIndicator <em>Marked Indicator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
