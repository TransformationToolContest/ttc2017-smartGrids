 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.PnodeClearing#getCongestLMP <em>Congest LMP</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.PnodeClearing#getCostLMP <em>Cost LMP</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.PnodeClearing#getLossLMP <em>Loss LMP</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.PnodeClearing#getPnode <em>Pnode</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getPnodeClearing()
...
public interface PnodeClearing extends MarketFactors {
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getPnodeClearing_CongestLMP()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.PnodeClearing#getCongestLMP <em>Congest LMP</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getPnodeClearing_CostLMP()
	 * @model dataType="CIM.IEC61970.Domain.CostPerEnergyUnit" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.PnodeClearing#getCostLMP <em>Cost LMP</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getPnodeClearing_LossLMP()
	 * @model dataType="CIM.IEC61970.Domain.CostPerEnergyUnit" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.PnodeClearing#getLossLMP <em>Loss LMP</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.Pnode#getPnodeClearing <em>Pnode Clearing</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setPnode(Pnode)
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getPnodeClearing_Pnode()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.PnodeClearing#getPnode <em>Pnode</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
