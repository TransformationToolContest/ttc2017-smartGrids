...
import CIM.IEC61970.Informative.MarketOperations.BidSet;
...
import CIM.IEC61970.Informative.MarketOperations.StartUpTimeCurve;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getUpTimeMin <em>Up Time Min</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getRegisteredGenerator <em>Registered Generator</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getMaximumEconomicMW <em>Maximum Economic MW</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getBidSet <em>Bid Set</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getStartUpTimeCurve <em>Start Up Time Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getUpTimeMax <em>Up Time Max</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getStartUpType <em>Start Up Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getNotificationTime <em>Notification Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getNotificationTimeCurve <em>Notification Time Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getMaxEmergencyMW <em>Max Emergency MW</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getStartupTime <em>Startup Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getStartUpCostCurve <em>Start Up Cost Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getMinimumEconomicMW <em>Minimum Economic MW</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getMinEmergencyMW <em>Min Emergency MW</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getNoLoadCost <em>No Load Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getMinimumDownTime <em>Minimum Down Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getDownTimeMax <em>Down Time Max</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getStartUpRampRate <em>Start Up Ramp Rate</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.GeneratingBidImpl#getOperatingMode <em>Operating Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
