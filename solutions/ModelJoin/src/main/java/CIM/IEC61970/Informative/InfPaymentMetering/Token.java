 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.Token#getPointOfSale <em>Point Of Sale</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.Token#getComment <em>Comment</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfPaymentMetering.Token#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getToken()
...
public interface Token extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.PointOfSale#getTokens <em>Tokens</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getToken_PointOfSale()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.Token#getPointOfSale <em>Point Of Sale</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getToken_Comment()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.Token#getComment <em>Comment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCode(String)
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#getToken_Code()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfPaymentMetering.Token#getCode <em>Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
