...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupM
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupM/MMXN")]
    public class MMXN : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupM.GroupM, IMMXN, IModelElement
    {
        ...
        public virtual IMV Watt
        {
            ...
            set
            {
                if ((this._watt != value))
                {
                    ...
                    this.OnPropertyChanging("Watt", e);
                    this._watt = value;
                    if ((old != null))
                    {
        ...
        public virtual IMV VolAmpr
        {
            ...
            set
            {
                if ((this._volAmpr != value))
                {
                    ...
                    this.OnPropertyChanging("VolAmpr", e);
                    this._volAmpr = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("VolAmpr", e);
                }
            }
        }
        ...
        public virtual IMV VolAmp
        {
            ...
            set
            {
                if ((this._volAmp != value))
                {
                    ...
                    this.OnPropertyChanging("VolAmp", e);
                    this._volAmp = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("VolAmp", e);
                }
            }
        }
        ...
        public virtual IMV PwrFact
        {
            ...
            set
            {
                if ((this._pwrFact != value))
                {
                    ...
                    this.OnPropertyChanging("PwrFact", e);
                    this._pwrFact = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("PwrFact", e);
                }
            }
        }
        ...
        private sealed class WattProxy : ModelPropertyChange<IMMXN, IMV>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.WattChanged += handler;
            }
        ...
        private sealed class VolAmprProxy : ModelPropertyChange<IMMXN, IMV>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.VolAmprChanged += handler;
            }
        ...
        private sealed class VolAmpProxy : ModelPropertyChange<IMMXN, IMV>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.VolAmpChanged += handler;
            }
        ...
        private sealed class PwrFactProxy : ModelPropertyChange<IMMXN, IMV>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.PwrFactChanged += handler;
            }
        ...
        private sealed class ImpProxy : ModelPropertyChange<IMMXN, ICMV>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.ImpChanged += handler;
            }
