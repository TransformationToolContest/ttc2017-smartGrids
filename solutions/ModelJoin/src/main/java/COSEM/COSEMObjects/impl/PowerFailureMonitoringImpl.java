...
import COSEM.COSEMObjects.PowerFailureMonitoring;
 ...
 * </p>
 * <ul>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getFailuresAllPhases <em>Failures All Phases</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getFailuresL1 <em>Failures L1</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getFailuresL2 <em>Failures L2</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getFailuresL3 <em>Failures L3</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getFailuresAny <em>Failures Any</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getAuxiliarysupply <em>Auxiliarysupply</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getLongFailsAll <em>Long Fails All</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getLongFailsL1 <em>Long Fails L1</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getLongFailsL2 <em>Long Fails L2</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getLongFailsL3 <em>Long Fails L3</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getLongFailsAny <em>Long Fails Any</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getTimeAll <em>Time All</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getTimeL1 <em>Time L1</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getTimeL2 <em>Time L2</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getTimeL3 <em>Time L3</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getTimeAny <em>Time Any</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getDurationAll <em>Duration All</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getDurationL1 <em>Duration L1</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getDurationL2 <em>Duration L2</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getDurationL3 <em>Duration L3</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getDurationAny <em>Duration Any</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.PowerFailureMonitoringImpl#getTime_threshold_long_powerfailure <em>Time threshold long powerfailure</em>}</li>
 * </ul>
 *
 * @generated
 */
