	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CommonPackage.POSTAL_ADDRESS: {
				...
				if (result == null) result = caseElement(postalAddress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CommonPackage.TELEPHONE_NUMBER: {
				...
				if (result == null) result = caseElement(telephoneNumber);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.STREET_ADDRESS: {
				...
				if (result == null) result = caseElement(streetAddress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CommonPackage.STREET_DETAIL: {
				...
				if (result == null) result = caseElement(streetDetail);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CommonPackage.ELECTRONIC_ADDRESS: {
				...
				if (result == null) result = caseElement(electronicAddress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CommonPackage.TOWN_DETAIL: {
				...
				if (result == null) result = caseElement(townDetail);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
