 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getReceipts <em>Receipts</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getMerchantDebitAmount <em>Merchant Debit Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getVendor <em>Vendor</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getTransactions <em>Transactions</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getMerchantAccount <em>Merchant Account</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#isPosted <em>Posted</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendorShift()
...
public interface VendorShift extends Shift {
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61968.PaymentMetering.Receipt}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.Receipt#getVendorShift <em>Vendor Shift</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendorShift_Receipts()
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendorShift_MerchantDebitAmount()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getMerchantDebitAmount <em>Merchant Debit Amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.Vendor#getVendorShifts <em>Vendor Shifts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendorShift_Vendor()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getVendor <em>Vendor</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.Transaction#getVendorShift <em>Vendor Shift</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendorShift_Transactions()
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.MerchantAccount#getVendorShifts <em>Vendor Shifts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendorShift_MerchantAccount()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#getMerchantAccount <em>Merchant Account</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getVendorShift_Posted()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.VendorShift#isPosted <em>Posted</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
