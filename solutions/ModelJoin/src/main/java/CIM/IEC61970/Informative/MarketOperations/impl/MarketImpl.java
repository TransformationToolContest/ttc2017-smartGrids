 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getType <em>Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getMarketFactors <em>Market Factors</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getStart <em>Start</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getMarketProducts <em>Market Products</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getRTO <em>RTO</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getRampIntervalNonSpinRes <em>Ramp Interval Non Spin Res</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getEnd <em>End</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getTimeIntervalLength <em>Time Interval Length</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getSettlements <em>Settlements</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getBids <em>Bids</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getRampIntervalReg <em>Ramp Interval Reg</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getRegisteredResources <em>Registered Resources</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getRampIntervalSpinRes <em>Ramp Interval Spin Res</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#isDst <em>Dst</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getRampIntervalEnergy <em>Ramp Interval Energy</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.MarketImpl#getLocalTimeZone <em>Local Time Zone</em>}</li>
 * </ul>
 *
 * @generated
 */
