 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Metering.MeterReading#getEndDeviceEvents <em>End Device Events</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.MeterReading#getServiceDeliveryPoint <em>Service Delivery Point</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.MeterReading#getCustomerAgreement <em>Customer Agreement</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.MeterReading#getMeterAsset <em>Meter Asset</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.MeterReading#getValuesInterval <em>Values Interval</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.MeterReading#getReadings <em>Readings</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.MeterReading#getIntervalBlocks <em>Interval Blocks</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.Metering.MeteringPackage#getMeterReading()
...
public interface MeterReading extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.EndDeviceEvent#getMeterReading <em>Meter Reading</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getMeterReading_EndDeviceEvents()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.ServiceDeliveryPoint#getMeterReadings <em>Meter Readings</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getMeterReading_ServiceDeliveryPoint()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.MeterReading#getServiceDeliveryPoint <em>Service Delivery Point</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Customers.CustomerAgreement#getMeterReadings <em>Meter Readings</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getMeterReading_CustomerAgreement()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.MeterReading#getCustomerAgreement <em>Customer Agreement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.MeterAsset#getMeterReadings <em>Meter Readings</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getMeterReading_MeterAsset()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.MeterReading#getMeterAsset <em>Meter Asset</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getMeterReading_ValuesInterval()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.MeterReading#getValuesInterval <em>Values Interval</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.Reading#getMeterReadings <em>Meter Readings</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getMeterReading_Readings()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.IntervalBlock#getMeterReading <em>Meter Reading</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getMeterReading_IntervalBlocks()
