 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.DPS#getStVal <em>St Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.DPS#getQ <em>Q</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.DPS#isSubEna <em>Sub Ena</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.DPS#getSubVal <em>Sub Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.DPS#getSubQ <em>Sub Q</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.DPS#getSubID <em>Sub ID</em>}</li>
 * </ul>
 *
 * @see gluemodel.substationStandard.Dataclasses.DataclassesPackage#getDPS()
 * @model
 * @generated
 */
public interface DPS extends EObject {
	 ...
	 * @see gluemodel.substationStandard.Dataclasses.DataclassesPackage#getDPS_StVal()
	 * @model required="true"
	 * @generated
	 */
	DPStatus getStVal();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.Dataclasses.DPS#getStVal <em>St Val</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setQ(Quality)
	 * @see gluemodel.substationStandard.Dataclasses.DataclassesPackage#getDPS_Q()
	 * @model required="true"
	 * @generated
	 */
	Quality getQ();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.Dataclasses.DPS#getQ <em>Q</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.substationStandard.Dataclasses.DataclassesPackage#getDPS_SubEna()
	 * @model
	 * @generated
	 */
	boolean isSubEna();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.Dataclasses.DPS#isSubEna <em>Sub Ena</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.substationStandard.Dataclasses.DataclassesPackage#getDPS_SubVal()
	 * @model required="true"
	 * @generated
	 */
	DPStatus getSubVal();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.Dataclasses.DPS#getSubVal <em>Sub Val</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setSubQ(Quality)
	 * @see gluemodel.substationStandard.Dataclasses.DataclassesPackage#getDPS_SubQ()
	 * @model required="true"
	 * @generated
	 */
	Quality getSubQ();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.Dataclasses.DPS#getSubQ <em>Sub Q</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setSubID(String)
	 * @see gluemodel.substationStandard.Dataclasses.DataclassesPackage#getDPS_SubID()
	 * @model
	 * @generated
	 */
	String getSubID();
	...
	/**
	 * Sets the value of the '{@link gluemodel.substationStandard.Dataclasses.DPS#getSubID <em>Sub ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
