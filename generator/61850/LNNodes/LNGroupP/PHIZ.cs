...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupP/PHIZ")]
    public class PHIZ : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP.GroupP, IPHIZ, IModelElement
    {
        ...
        public virtual IASG AStr
        {
            ...
            set
            {
                if ((this._aStr != value))
                {
                    ...
                    this.OnPropertyChanging("AStr", e);
                    this._aStr = value;
                    if ((old != null))
                    {
        ...
        public virtual IASG VStr
        {
            ...
            set
            {
                if ((this._vStr != value))
                {
                    ...
                    this.OnPropertyChanging("VStr", e);
                    this._vStr = value;
                    if ((old != null))
                    {
        ...
        public virtual IASG HVStr
        {
            ...
            set
            {
                if ((this._hVStr != value))
                {
                    ...
                    this.OnPropertyChanging("HVStr", e);
                    this._hVStr = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("HVStr", e);
                }
            }
        }
        ...
        private sealed class AStrProxy : ModelPropertyChange<IPHIZ, IASG>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.AStrChanged += handler;
            }
        ...
        private sealed class VStrProxy : ModelPropertyChange<IPHIZ, IASG>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.VStrChanged += handler;
            }
        ...
        private sealed class HVStrProxy : ModelPropertyChange<IPHIZ, IASG>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.HVStrChanged += handler;
            }
