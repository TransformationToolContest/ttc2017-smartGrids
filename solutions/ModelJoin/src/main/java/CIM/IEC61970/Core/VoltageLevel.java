 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.VoltageLevel#getBays <em>Bays</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.VoltageLevel#getLowVoltageLimit <em>Low Voltage Limit</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.VoltageLevel#getHighVoltageLimit <em>High Voltage Limit</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.VoltageLevel#getBaseVoltage <em>Base Voltage</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.VoltageLevel#getSubstation <em>Substation</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getVoltageLevel()
...
public interface VoltageLevel extends EquipmentContainer {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.Bay#getVoltageLevel <em>Voltage Level</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getVoltageLevel_Bays()
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getVoltageLevel_LowVoltageLimit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.VoltageLevel#getLowVoltageLimit <em>Low Voltage Limit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getVoltageLevel_HighVoltageLimit()
	 * @model dataType="CIM.IEC61970.Domain.Voltage" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.VoltageLevel#getHighVoltageLimit <em>High Voltage Limit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.BaseVoltage#getVoltageLevel <em>Voltage Level</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getVoltageLevel_BaseVoltage()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.VoltageLevel#getBaseVoltage <em>Base Voltage</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.Substation#getVoltageLevels <em>Voltage Levels</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getVoltageLevel_Substation()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.VoltageLevel#getSubstation <em>Substation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
