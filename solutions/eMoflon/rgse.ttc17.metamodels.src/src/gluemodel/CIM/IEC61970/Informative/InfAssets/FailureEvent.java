 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureEvent#getFailureIsolationMethod <em>Failure Isolation Method</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureEvent#getCorporateCode <em>Corporate Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureEvent#getFaultLocatingMethod <em>Fault Locating Method</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureEvent#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getFailureEvent()
...
public interface FailureEvent extends ActivityRecord {
	 ...
	 * The literals are from the enumeration {@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureIsolationMethodKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getFailureEvent_FailureIsolationMethod()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureEvent#getFailureIsolationMethod <em>Failure Isolation Method</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getFailureEvent_CorporateCode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureEvent#getCorporateCode <em>Corporate Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getFailureEvent_FaultLocatingMethod()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureEvent#getFaultLocatingMethod <em>Fault Locating Method</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getFailureEvent_Location()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.Informative.InfAssets.FailureEvent#getLocation <em>Location</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
