...
import CIM.IEC61970.Generation.Production.StartIgnFuelCurve;
import CIM.IEC61970.Generation.Production.StartMainFuelCurve;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getStartIgnFuelCurve <em>Start Ign Fuel Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getFixedMaintCost <em>Fixed Maint Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getRiskFactorCost <em>Risk Factor Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getStbyAuxP <em>Stby Aux P</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getStartupDate <em>Startup Date</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getStartRampCurve <em>Start Ramp Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getMinimumDownTime <em>Minimum Down Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getMinimumRunTime <em>Minimum Run Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getStartMainFuelCurve <em>Start Main Fuel Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getStartupPriority <em>Startup Priority</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getStartupCost <em>Startup Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getHotStandbyHeat <em>Hot Standby Heat</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getThermalGeneratingUnit <em>Thermal Generating Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.impl.StartupModelImpl#getIncrementalMaintCost <em>Incremental Maint Cost</em>}</li>
 * </ul>
 *
 * @generated
 */
