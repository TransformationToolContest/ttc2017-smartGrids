 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ContingencyConstraintLimit#getSecurityConstraintSum <em>Security Constraint Sum</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ContingencyConstraintLimit#getMWLimitSchedules <em>MW Limit Schedules</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.ContingencyConstraintLimit#getContingency <em>Contingency</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getContingencyConstraintLimit()
...
public interface ContingencyConstraintLimit extends Curve {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.SecurityConstraintSum#getContingencyConstraintLimits <em>Contingency Constraint Limits</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getContingencyConstraintLimit_SecurityConstraintSum()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ContingencyConstraintLimit#getSecurityConstraintSum <em>Security Constraint Sum</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.MWLimitSchedule#getSecurityConstraintLimit <em>Security Constraint Limit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getContingencyConstraintLimit_MWLimitSchedules()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ContingencyConstraintLimit#getMWLimitSchedules <em>MW Limit Schedules</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Contingency.Contingency#getContingencyConstraintLimit <em>Contingency Constraint Limit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getContingencyConstraintLimit_Contingency()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.ContingencyConstraintLimit#getContingency <em>Contingency</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
