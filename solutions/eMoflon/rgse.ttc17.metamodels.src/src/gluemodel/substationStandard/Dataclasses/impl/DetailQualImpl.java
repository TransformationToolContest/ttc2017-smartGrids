 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.DetailQualImpl#isOverflow <em>Overflow</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.DetailQualImpl#isOutOfRange <em>Out Of Range</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.DetailQualImpl#isBadReference <em>Bad Reference</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.DetailQualImpl#isOscillatory <em>Oscillatory</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.DetailQualImpl#isFailure <em>Failure</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.DetailQualImpl#isOldData <em>Old Data</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.DetailQualImpl#isInconsistent <em>Inconsistent</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.DetailQualImpl#isInaccurate <em>Inaccurate</em>}</li>
 * </ul>
 *
 * @generated
 */
