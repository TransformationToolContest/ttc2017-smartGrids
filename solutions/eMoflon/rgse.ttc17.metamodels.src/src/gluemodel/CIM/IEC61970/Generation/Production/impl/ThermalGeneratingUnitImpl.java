...
import gluemodel.CIM.IEC61970.Generation.Production.CogenerationPlant;
import gluemodel.CIM.IEC61970.Generation.Production.CombinedCyclePlant;
import gluemodel.CIM.IEC61970.Generation.Production.EmissionAccount;
import gluemodel.CIM.IEC61970.Generation.Production.EmissionCurve;
...
import gluemodel.CIM.IEC61970.Generation.Production.IncrementalHeatRateCurve;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getCombinedCyclePlant <em>Combined Cycle Plant</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getCAESPlant <em>CAES Plant</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getEmissionCurves <em>Emission Curves</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getHeatInputCurve <em>Heat Input Curve</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getShutdownCurve <em>Shutdown Curve</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getHeatRateCurve <em>Heat Rate Curve</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getIncrementalHeatRateCurve <em>Incremental Heat Rate Curve</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getOMCost <em>OM Cost</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getCogenerationPlant <em>Cogeneration Plant</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getFossilFuels <em>Fossil Fuels</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getStartupModel <em>Startup Model</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getFuelAllocationSchedules <em>Fuel Allocation Schedules</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.ThermalGeneratingUnitImpl#getEmmissionAccounts <em>Emmission Accounts</em>}</li>
 * </ul>
 *
 * @generated
 */
