 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ASGImpl#getSetMag <em>Set Mag</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ASGImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ASGImpl#getSVC <em>SVC</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ASGImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ASGImpl#getMaxVal <em>Max Val</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ASGImpl#getStepSize <em>Step Size</em>}</li>
 * </ul>
 *
 * @generated
 */
