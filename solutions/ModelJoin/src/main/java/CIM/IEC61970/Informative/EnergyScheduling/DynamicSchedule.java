 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#getDynSchedStatus <em>Dyn Sched Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#getReceive_HostControlArea <em>Receive Host Control Area</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#getMeasurement <em>Measurement</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#getSend_HostControlArea <em>Send Host Control Area</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#isDynSchedSignRev <em>Dyn Sched Sign Rev</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getDynamicSchedule()
...
public interface DynamicSchedule extends RegularIntervalSchedule {
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getDynamicSchedule_DynSchedStatus()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#getDynSchedStatus <em>Dyn Sched Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.EnergyScheduling.HostControlArea#getReceive_DynamicSchedules <em>Receive Dynamic Schedules</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getDynamicSchedule_Receive_HostControlArea()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#getReceive_HostControlArea <em>Receive Host Control Area</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.Measurement#getDynamicSchedules <em>Dynamic Schedules</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getDynamicSchedule_Measurement()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#getMeasurement <em>Measurement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.EnergyScheduling.HostControlArea#getSend_DynamicSchedules <em>Send Dynamic Schedules</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getDynamicSchedule_Send_HostControlArea()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#getSend_HostControlArea <em>Send Host Control Area</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.EnergyScheduling.EnergySchedulingPackage#getDynamicSchedule_DynSchedSignRev()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.EnergyScheduling.DynamicSchedule#isDynSchedSignRev <em>Dyn Sched Sign Rev</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
