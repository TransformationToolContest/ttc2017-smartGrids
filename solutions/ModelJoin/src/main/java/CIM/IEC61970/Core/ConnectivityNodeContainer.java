 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNodeContainer#getConnectivityNodes <em>Connectivity Nodes</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.ConnectivityNodeContainer#getTopologicalNode <em>Topological Node</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNodeContainer()
...
public interface ConnectivityNodeContainer extends PowerSystemResource {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.ConnectivityNode#getConnectivityNodeContainer <em>Connectivity Node Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNodeContainer_ConnectivityNodes()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Topology.TopologicalNode#getConnectivityNodeContainer <em>Connectivity Node Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getConnectivityNodeContainer_TopologicalNode()
