 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.Curve#getY2Unit <em>Y2 Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getXMultiplier <em>XMultiplier</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getY3Multiplier <em>Y3 Multiplier</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getY1Unit <em>Y1 Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getCurveStyle <em>Curve Style</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getY3Unit <em>Y3 Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getXUnit <em>XUnit</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getCurveDatas <em>Curve Datas</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getY2Multiplier <em>Y2 Multiplier</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.Curve#getY1Multiplier <em>Y1 Multiplier</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getCurve()
...
public interface Curve extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_Y2Unit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getY2Unit <em>Y2 Unit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_XMultiplier()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getXMultiplier <em>XMultiplier</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_Y3Multiplier()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getY3Multiplier <em>Y3 Multiplier</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_Y1Unit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getY1Unit <em>Y1 Unit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Core.CurveStyle}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_CurveStyle()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getCurveStyle <em>Curve Style</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_Y3Unit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getY3Unit <em>Y3 Unit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_XUnit()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getXUnit <em>XUnit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Core.CurveData}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.CurveData#getCurve <em>Curve</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_CurveDatas()
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_Y2Multiplier()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getY2Multiplier <em>Y2 Multiplier</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getCurve_Y1Multiplier()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.Curve#getY1Multiplier <em>Y1 Multiplier</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
