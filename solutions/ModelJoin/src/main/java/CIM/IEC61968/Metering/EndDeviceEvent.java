 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Metering.EndDeviceEvent#getUserID <em>User ID</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.EndDeviceEvent#getMeterReading <em>Meter Reading</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.EndDeviceEvent#getDeviceFunction <em>Device Function</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.Metering.MeteringPackage#getEndDeviceEvent()
...
public interface EndDeviceEvent extends ActivityRecord {
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getEndDeviceEvent_UserID()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.EndDeviceEvent#getUserID <em>User ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.MeterReading#getEndDeviceEvents <em>End Device Events</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getEndDeviceEvent_MeterReading()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.EndDeviceEvent#getMeterReading <em>Meter Reading</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.DeviceFunction#getEndDeviceEvents <em>End Device Events</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.Metering.MeteringPackage#getEndDeviceEvent_DeviceFunction()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.Metering.EndDeviceEvent#getDeviceFunction <em>Device Function</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
