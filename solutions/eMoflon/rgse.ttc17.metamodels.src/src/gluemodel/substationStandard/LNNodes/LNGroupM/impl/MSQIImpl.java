...
import gluemodel.substationStandard.LNNodes.LNGroupM.MSQI;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getEEName <em>EE Name</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getEEHealth <em>EE Health</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getSeqA <em>Seq A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getSeqV <em>Seq V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getDQ0Seq <em>DQ0 Seq</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getImbA <em>Imb A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getImbNgA <em>Imb Ng A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getImbNgV <em>Imb Ng V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getImbPPV <em>Imb PPV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getImbV <em>Imb V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getImbZroA <em>Imb Zro A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getImbZroV <em>Imb Zro V</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getMaxImbA <em>Max Imb A</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getMaxImbPPV <em>Max Imb PPV</em>}</li>
 *   <li>{@link gluemodel.substationStandard.LNNodes.LNGroupM.impl.MSQIImpl#getMaxImbV <em>Max Imb V</em>}</li>
 * </ul>
 *
 * @generated
 */
