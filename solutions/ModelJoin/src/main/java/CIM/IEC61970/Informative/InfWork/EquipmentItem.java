 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getCode <em>Code</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getCost <em>Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getWorkCostDetail <em>Work Cost Detail</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getWorkTask <em>Work Task</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getEquipmentItem()
...
public interface EquipmentItem extends IdentifiedObject {
	 ...
	 * @see #setCode(String)
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getEquipmentItem_Code()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getCode <em>Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCost(float)
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getEquipmentItem_Cost()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getCost <em>Cost</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getEquipmentItem_Status()
	 * @model
	 * @generated
	 */
	Status getStatus();
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getStatus <em>Status</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.WorkCostDetail#getEquipmentItems <em>Equipment Items</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getEquipmentItem_WorkCostDetail()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getWorkCostDetail <em>Work Cost Detail</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfWork.WorkTask#getEquipmentItems <em>Equipment Items</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getEquipmentItem_WorkTask()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.EquipmentItem#getWorkTask <em>Work Task</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
