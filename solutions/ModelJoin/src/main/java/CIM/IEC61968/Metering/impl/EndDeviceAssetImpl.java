...
import CIM.IEC61968.Assets.impl.AssetContainerImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isDisconnect <em>Disconnect</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isRelayCapable <em>Relay Capable</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getReadings <em>Readings</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getServiceDeliveryPoint <em>Service Delivery Point</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isMetrology <em>Metrology</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getRatedVoltage <em>Rated Voltage</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getRatedCurrent <em>Rated Current</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getTimeZoneOffset <em>Time Zone Offset</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getServiceLocation <em>Service Location</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getEndDeviceControls <em>End Device Controls</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getEndDeviceModel <em>End Device Model</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isReadRequest <em>Read Request</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isDstEnabled <em>Dst Enabled</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getPhaseCount <em>Phase Count</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getDeviceFunctions <em>Device Functions</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isReverseFlowHandling <em>Reverse Flow Handling</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isDemandResponse <em>Demand Response</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getAmrSystem <em>Amr System</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isLoadControl <em>Load Control</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#isOutageReport <em>Outage Report</em>}</li>
 *   <li>{@link CIM.IEC61968.Metering.impl.EndDeviceAssetImpl#getEndDeviceGroups <em>End Device Groups</em>}</li>
 * </ul>
 *
 * @generated
 */
