...
import CIM.IEC61970.Informative.InfAssets.PoleBaseKind;
import CIM.IEC61970.Informative.InfAssets.PoleInfo;
import CIM.IEC61970.Informative.InfAssets.PolePreservativeKind;
import CIM.IEC61970.Informative.InfAssets.PoleTreatmentKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getTreatedDateTime <em>Treated Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#isBreastBlock <em>Breast Block</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getClassification <em>Classification</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getPreservativeKind <em>Preservative Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getJpaReference <em>Jpa Reference</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getBaseKind <em>Base Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getDiameter <em>Diameter</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getStreetlights <em>Streetlights</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getTreatmentKind <em>Treatment Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getConstruction <em>Construction</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getLength <em>Length</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfAssets.impl.PoleInfoImpl#getSpeciesType <em>Species Type</em>}</li>
 * </ul>
 *
 * @generated
 */
