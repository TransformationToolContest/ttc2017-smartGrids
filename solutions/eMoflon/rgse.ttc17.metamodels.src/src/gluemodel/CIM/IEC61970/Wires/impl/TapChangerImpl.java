...
import gluemodel.CIM.IEC61970.Wires.ImpedanceVariationCurve;
import gluemodel.CIM.IEC61970.Wires.RegulatingControl;
import gluemodel.CIM.IEC61970.Wires.TapChanger;
import gluemodel.CIM.IEC61970.Wires.TapSchedule;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getInitialDelay <em>Initial Delay</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getSubsequentDelay <em>Subsequent Delay</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getTapSchedules <em>Tap Schedules</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#isLtcFlag <em>Ltc Flag</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#isRegulationStatus <em>Regulation Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getRegulatingControl <em>Regulating Control</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getNeutralStep <em>Neutral Step</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getNeutralU <em>Neutral U</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getLowStep <em>Low Step</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getHighStep <em>High Step</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getStepVoltageIncrement <em>Step Voltage Increment</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getImpedanceVariationCurve <em>Impedance Variation Curve</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getSvTapStep <em>Sv Tap Step</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.TapChangerImpl#getNormalStep <em>Normal Step</em>}</li>
 * </ul>
 *
 * @generated
 */
