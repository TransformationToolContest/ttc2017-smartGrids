...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupY
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupY/YLTC")]
    public class YLTC : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupY.GroupY, IYLTC, IModelElement
    {
        ...
        public virtual IMV Torq
        {
            ...
            set
            {
                if ((this._torq != value))
                {
                    ...
                    this.OnPropertyChanging("Torq", e);
                    this._torq = value;
                    if ((old != null))
                    {
        ...
        public virtual IMV MotDrvA
        {
            ...
            set
            {
                if ((this._motDrvA != value))
                {
                    ...
                    this.OnPropertyChanging("MotDrvA", e);
                    this._motDrvA = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("MotDrvA", e);
                }
            }
        }
        ...
        public virtual ISPS EndPosR
        {
            ...
            set
            {
                if ((this._endPosR != value))
                {
                    ...
                    this.OnPropertyChanging("EndPosR", e);
                    this._endPosR = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("EndPosR", e);
                }
            }
        }
        ...
        public virtual ISPS EndPosL
        {
            ...
            set
            {
                if ((this._endPosL != value))
                {
                    ...
                    this.OnPropertyChanging("EndPosL", e);
                    this._endPosL = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("EndPosL", e);
                }
            }
        }
        ...
        public virtual ISPS OilFil
        {
            ...
            set
            {
                if ((this._oilFil != value))
                {
                    ...
                    this.OnPropertyChanging("OilFil", e);
                    this._oilFil = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("OilFil", e);
                }
            }
        }
        ...
        private sealed class TorqProxy : ModelPropertyChange<IYLTC, IMV>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.TorqChanged += handler;
            }
        ...
        private sealed class MotDrvAProxy : ModelPropertyChange<IYLTC, IMV>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.MotDrvAChanged += handler;
            }
        ...
        private sealed class EndPosRProxy : ModelPropertyChange<IYLTC, ISPS>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.EndPosRChanged += handler;
            }
        ...
        private sealed class EndPosLProxy : ModelPropertyChange<IYLTC, ISPS>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.EndPosLChanged += handler;
            }
        ...
        private sealed class OilFilProxy : ModelPropertyChange<IYLTC, ISPS>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.OilFilChanged += handler;
            }
