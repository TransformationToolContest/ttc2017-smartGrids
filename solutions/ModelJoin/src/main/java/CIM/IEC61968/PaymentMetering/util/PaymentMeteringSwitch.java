	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PaymentMeteringPackage.DUE: {
				...
				if (result == null) result = caseElement(due);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentMeteringPackage.BANK_ACCOUNT_DETAIL: {
				...
				if (result == null) result = caseElement(bankAccountDetail);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PaymentMeteringPackage.LINE_DETAIL: {
				...
				if (result == null) result = caseElement(lineDetail);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PaymentMeteringPackage.ACCOUNT_MOVEMENT: {
				...
				if (result == null) result = caseElement(accountMovement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PaymentMeteringPackage.ACCOUNTING_UNIT: {
				...
				if (result == null) result = caseElement(accountingUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
