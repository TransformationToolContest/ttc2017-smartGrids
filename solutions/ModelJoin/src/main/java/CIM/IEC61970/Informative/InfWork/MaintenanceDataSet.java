 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.MaintenanceDataSet#getMaintCode <em>Maint Code</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.MaintenanceDataSet#getConditionBefore <em>Condition Before</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.MaintenanceDataSet#getConditionAfter <em>Condition After</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getMaintenanceDataSet()
...
public interface MaintenanceDataSet extends ProcedureDataSet {
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getMaintenanceDataSet_MaintCode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.MaintenanceDataSet#getMaintCode <em>Maint Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getMaintenanceDataSet_ConditionBefore()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.MaintenanceDataSet#getConditionBefore <em>Condition Before</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getMaintenanceDataSet_ConditionAfter()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.MaintenanceDataSet#getConditionAfter <em>Condition After</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
