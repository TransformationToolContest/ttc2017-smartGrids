...
import gluemodel.CIM.IEC61970.SCADA.SCADAFactory;
 ...
 * @generated
 */
public class SCADAPackageImpl extends EPackageImpl implements SCADAPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gluemodel.CIM.IEC61970.SCADA.SCADAPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SCADAPackageImpl() {
		super(eNS_URI, SCADAFactory.eINSTANCE);
	}
	...
	public static SCADAPackage init() {
		...
		SCADAPackageImpl theSCADAPackage = (SCADAPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SCADAPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SCADAPackageImpl());
	...
	public EClass getCommunicationLink() {
		if (communicationLinkEClass == null) {
			communicationLinkEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(SCADAPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EClass getRemotePoint() {
		if (remotePointEClass == null) {
			remotePointEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(SCADAPackage.eNS_URI).getEClassifiers().get(2);
		}
	...
	public EClass getRemoteUnit() {
		if (remoteUnitEClass == null) {
			remoteUnitEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(SCADAPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	public EReference getRemoteUnit_RemotePoints() {
        return (EReference)getRemoteUnit().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getRemoteUnit_RemoteUnitType() {
        return (EAttribute)getRemoteUnit().getEStructuralFeatures().get(1);
	}
	...
	public EClass getRemoteControl() {
		if (remoteControlEClass == null) {
			remoteControlEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(SCADAPackage.eNS_URI).getEClassifiers().get(5);
		}
	...
	public EClass getRemoteSource() {
		if (remoteSourceEClass == null) {
			remoteSourceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(SCADAPackage.eNS_URI).getEClassifiers().get(6);
		}
	...
	public EReference getRemoteSource_MeasurementValue() {
        return (EReference)getRemoteSource().getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getRemoteSource_SensorMaximum() {
        return (EAttribute)getRemoteSource().getEStructuralFeatures().get(4);
	}
	...
	public EEnum getSource() {
		if (sourceEEnum == null) {
			sourceEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(SCADAPackage.eNS_URI).getEClassifiers().get(0);
		}
		return sourceEEnum;
	}
	...
	public EEnum getRemoteUnitType() {
		if (remoteUnitTypeEEnum == null) {
			remoteUnitTypeEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(SCADAPackage.eNS_URI).getEClassifiers().get(4);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.CIM.IEC61970.SCADA." + eClassifier.getName());
