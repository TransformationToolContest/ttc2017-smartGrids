 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getCrews <em>Crews</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getRequests <em>Requests</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#isOptOut <em>Opt Out</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getRegisteredResources <em>Registered Resources</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getPowerSystemResourceRoles <em>Power System Resource Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#isIsProfitCenter <em>Is Profit Center</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#isIsCostCenter <em>Is Cost Center</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getDocumentRoles <em>Document Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getAssetRoles <em>Asset Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getViolationLimits <em>Violation Limits</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getParentOrganisationRoles <em>Parent Organisation Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getLandPropertyRoles <em>Land Property Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getErpPersonRoles <em>Erp Person Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getChildOrganisationRoles <em>Child Organisation Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getIndustryID <em>Industry ID</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getChangeItems <em>Change Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getLocations <em>Locations</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getIntSchedAgreement <em>Int Sched Agreement</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getActivityRecords <em>Activity Records</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpOrganisationImpl#getGovernmentID <em>Government ID</em>}</li>
 * </ul>
 *
 * @generated
 */
