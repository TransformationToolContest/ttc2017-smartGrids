 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.ShiftImpl#getTransactionsGrandTotal <em>Transactions Grand Total</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.ShiftImpl#getActivityInterval <em>Activity Interval</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.ShiftImpl#getTransactionSummaries <em>Transaction Summaries</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.ShiftImpl#getReceiptsGrandTotalRounding <em>Receipts Grand Total Rounding</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.ShiftImpl#getTransactionsGrandTotalRounding <em>Transactions Grand Total Rounding</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.ShiftImpl#getReceiptsGrandTotalNonBankable <em>Receipts Grand Total Non Bankable</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.ShiftImpl#getReceiptsGrandTotalBankable <em>Receipts Grand Total Bankable</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.impl.ShiftImpl#getReceiptSummaries <em>Receipt Summaries</em>}</li>
 * </ul>
 *
 * @generated
 */
