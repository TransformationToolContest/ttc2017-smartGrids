 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getQ <em>Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getT <em>T</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getPhsAHar <em>Phs AHar</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getPhsBHar <em>Phs BHar</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getPhsCHar <em>Phs CHar</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getNeutHar <em>Neut Har</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getNetHar <em>Net Har</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getResHar <em>Res Har</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getNumHar <em>Num Har</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getNumCyc <em>Num Cyc</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getEvalTm <em>Eval Tm</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getAngRef <em>Ang Ref</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getSmpRate <em>Smp Rate</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getHvRef <em>Hv Ref</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.HYWEImpl#getRmsCyc <em>Rms Cyc</em>}</li>
 * </ul>
 *
 * @generated
 */
