...
import CIM.IEC61970.OperationalLimits.OperationalLimitsFactory;
...
public class OperationalLimitsPackageImpl extends EPackageImpl implements OperationalLimitsPackage {
	 ...
	 * @see CIM.IEC61970.OperationalLimits.OperationalLimitsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.OperationalLimits." + eClassifier.getName());
