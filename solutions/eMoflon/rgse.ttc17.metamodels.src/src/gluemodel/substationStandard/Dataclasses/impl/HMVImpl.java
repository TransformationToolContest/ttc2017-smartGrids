 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getQ <em>Q</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getT <em>T</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getHar <em>Har</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getNumHar <em>Num Har</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getNumCyc <em>Num Cyc</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getEvalTm <em>Eval Tm</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getSmpRate <em>Smp Rate</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getHvRef <em>Hv Ref</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.HMVImpl#getRmsCyc <em>Rms Cyc</em>}</li>
 * </ul>
 *
 * @generated
 */
