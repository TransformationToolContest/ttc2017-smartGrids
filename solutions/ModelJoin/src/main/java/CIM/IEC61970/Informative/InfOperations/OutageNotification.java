 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageNotification#getExpectedInterruptionCount <em>Expected Interruption Count</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageNotification#getDuration <em>Duration</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageNotification#getCustomerDatas <em>Customer Datas</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.OutageNotification#getReason <em>Reason</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageNotification()
...
public interface OutageNotification extends Document {
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageNotification_ExpectedInterruptionCount()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageNotification#getExpectedInterruptionCount <em>Expected Interruption Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageNotification_Duration()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageNotification#getDuration <em>Duration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Customers.Customer#getOutageNotifications <em>Outage Notifications</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageNotification_CustomerDatas()
	 ...
	 * @see CIM.IEC61970.Informative.InfOperations.InfOperationsPackage#getOutageNotification_Reason()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfOperations.OutageNotification#getReason <em>Reason</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
