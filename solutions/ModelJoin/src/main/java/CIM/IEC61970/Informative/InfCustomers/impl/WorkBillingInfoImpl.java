 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getCustomerAccount <em>Customer Account</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getReceivedDateTime <em>Received Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getDiscount <em>Discount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getIssueDateTime <em>Issue Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getErpLineItems <em>Erp Line Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getDueDateTime <em>Due Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getDeposit <em>Deposit</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getWorks <em>Works</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getWorkPrice <em>Work Price</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfCustomers.impl.WorkBillingInfoImpl#getCostEstimate <em>Cost Estimate</em>}</li>
 * </ul>
 *
 * @generated
 */
