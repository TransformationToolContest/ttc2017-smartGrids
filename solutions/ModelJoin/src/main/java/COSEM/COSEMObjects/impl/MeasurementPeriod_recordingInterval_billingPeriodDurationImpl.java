 ...
 * </p>
 * <ul>
 *   <li>{@link COSEM.COSEMObjects.impl.MeasurementPeriod_recordingInterval_billingPeriodDurationImpl#getMeasurement_period_1_for_averaging_scheme_1 <em>Measurement period 1for averaging scheme 1</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeasurementPeriod_recordingInterval_billingPeriodDurationImpl#getMeasurement_period_2_for_averagingscheme_2 <em>Measurement period 2for averagingscheme 2</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeasurementPeriod_recordingInterval_billingPeriodDurationImpl#getMeasurement_period_3_for_instantaneous_value <em>Measurement period 3for instantaneous value</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeasurementPeriod_recordingInterval_billingPeriodDurationImpl#getMeasurement_period_4_for_test_value <em>Measurement period 4for test value</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeasurementPeriod_recordingInterval_billingPeriodDurationImpl#getRecording_interval_1_for_loadprofile <em>Recording interval 1for loadprofile</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeasurementPeriod_recordingInterval_billingPeriodDurationImpl#getRecording_interval_2_for_loadprofile <em>Recording interval 2for loadprofile</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeasurementPeriod_recordingInterval_billingPeriodDurationImpl#getBillingperiod <em>Billingperiod</em>}</li>
 * </ul>
 *
 * @generated
 */
