 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Appointment#getRemark <em>Remark</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Appointment#getAddress <em>Address</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Appointment#getCallBack <em>Call Back</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Appointment#getMeetingInterval <em>Meeting Interval</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Appointment#getErpPersons <em>Erp Persons</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfWork.Appointment#isCallAhead <em>Call Ahead</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAppointment()
...
public interface Appointment extends ScheduledEvent {
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAppointment_Remark()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Appointment#getRemark <em>Remark</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAppointment_Address()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Appointment#getAddress <em>Address</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfOperations.CallBack#getAppointments <em>Appointments</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAppointment_CallBack()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Appointment#getCallBack <em>Call Back</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAppointment_MeetingInterval()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Appointment#getMeetingInterval <em>Meeting Interval</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAppointment_ErpPersons()
	 ...
	 * @see CIM.IEC61970.Informative.InfWork.InfWorkPackage#getAppointment_CallAhead()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.InfWork.Appointment#isCallAhead <em>Call Ahead</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
