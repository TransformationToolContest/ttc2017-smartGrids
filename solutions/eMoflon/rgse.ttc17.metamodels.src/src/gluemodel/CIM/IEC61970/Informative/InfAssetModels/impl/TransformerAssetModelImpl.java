...
import gluemodel.CIM.IEC61970.Informative.InfAssetModels.OilPreservationKind;
import gluemodel.CIM.IEC61970.Informative.InfAssetModels.TransformerAssetModel;
import gluemodel.CIM.IEC61970.Informative.InfAssetModels.TransformerConstructionKind;
import gluemodel.CIM.IEC61970.Informative.InfAssetModels.TransformerCoreKind;
import gluemodel.CIM.IEC61970.Informative.InfAssetModels.TransformerFunctionKind;
import gluemodel.CIM.IEC61970.Informative.InfAssetModels.WindingInsulationKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getHourOverLoadRating <em>Hour Over Load Rating</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getOilPreservationKind <em>Oil Preservation Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getCoreCoilsWeight <em>Core Coils Weight</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getWindingInsulationKind <em>Winding Insulation Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getAltSecondaryNomVoltage <em>Alt Secondary Nom Voltage</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getTransformerInfo <em>Transformer Info</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getSolidInsulationWeight <em>Solid Insulation Weight</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getNeutralBIL <em>Neutral BIL</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getCoreKind <em>Core Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getDayOverLoadRating <em>Day Over Load Rating</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getConstructionKind <em>Construction Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#isAutoTransformer <em>Auto Transformer</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getTransformerAssets <em>Transformer Assets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#getAltPrimaryNomVoltage <em>Alt Primary Nom Voltage</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.TransformerAssetModelImpl#isReconfigWinding <em>Reconfig Winding</em>}</li>
 * </ul>
 *
 * @generated
 */
