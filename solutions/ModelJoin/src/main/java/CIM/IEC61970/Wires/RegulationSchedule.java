 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.RegulationSchedule#getLineDropR <em>Line Drop R</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.RegulationSchedule#getLineDropX <em>Line Drop X</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.RegulationSchedule#isLineDropCompensation <em>Line Drop Compensation</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.RegulationSchedule#getRegulatingControl <em>Regulating Control</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.RegulationSchedule#getVoltageControlZones <em>Voltage Control Zones</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Wires.WiresPackage#getRegulationSchedule()
...
public interface RegulationSchedule extends SeasonDayTypeSchedule {
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRegulationSchedule_LineDropR()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.RegulationSchedule#getLineDropR <em>Line Drop R</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRegulationSchedule_LineDropX()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.RegulationSchedule#getLineDropX <em>Line Drop X</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRegulationSchedule_LineDropCompensation()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.RegulationSchedule#isLineDropCompensation <em>Line Drop Compensation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.RegulatingControl#getRegulationSchedule <em>Regulation Schedule</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRegulationSchedule_RegulatingControl()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.RegulationSchedule#getRegulatingControl <em>Regulating Control</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Wires.VoltageControlZone}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.VoltageControlZone#getRegulationSchedule <em>Regulation Schedule</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getRegulationSchedule_VoltageControlZones()
