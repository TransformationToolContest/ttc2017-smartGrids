 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.TransmissionReliabilityMargin#getTrmType <em>Trm Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.TransmissionReliabilityMargin#getFlowgate <em>Flowgate</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.TransmissionReliabilityMargin#getValueUnit <em>Value Unit</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.TransmissionReliabilityMargin#getTrmValue <em>Trm Value</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransmissionReliabilityMargin()
...
public interface TransmissionReliabilityMargin extends IdentifiedObject {
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransmissionReliabilityMargin_TrmType()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.TransmissionReliabilityMargin#getTrmType <em>Trm Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.Flowgate#getTransmissionReliabilityMargin <em>Transmission Reliability Margin</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransmissionReliabilityMargin_Flowgate()
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransmissionReliabilityMargin_ValueUnit()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.TransmissionReliabilityMargin#getValueUnit <em>Value Unit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getTransmissionReliabilityMargin_TrmValue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Informative.MarketOperations.TransmissionReliabilityMargin#getTrmValue <em>Trm Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
