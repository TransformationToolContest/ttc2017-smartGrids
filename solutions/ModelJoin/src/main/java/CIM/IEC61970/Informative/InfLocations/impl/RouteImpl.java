 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfLocations.impl.RouteImpl#getLocations <em>Locations</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfLocations.impl.RouteImpl#getCrews <em>Crews</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfLocations.impl.RouteImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfLocations.impl.RouteImpl#getCategory <em>Category</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RouteImpl extends IdentifiedObjectImpl implements Route {
	/**
	...
	public EList<Location> getLocations() {
		if (locations == null) {
			locations = new EObjectWithInverseResolvingEList.ManyInverse<Location>(Location.class, this, InfLocationsPackage.ROUTE__LOCATIONS, CommonPackage.LOCATION__ROUTES);
		}
		return locations;
	}
	...
	public EList<Crew> getCrews() {
		if (crews == null) {
			crews = new EObjectWithInverseResolvingEList<Crew>(Crew.class, this, InfLocationsPackage.ROUTE__CREWS, InfWorkPackage.CREW__ROUTE);
		}
		return crews;
	}
		...
		if (status != null && status.eIsProxy()) {
			...
			if (status != oldStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InfLocationsPackage.ROUTE__STATUS, oldStatus, status));
			}
		}
		return status;
	}
	...
	public void setStatus(Status newStatus) {
		...
		status = newStatus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfLocationsPackage.ROUTE__STATUS, oldStatus, status));
	}
	...
	public void setCategory(String newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfLocationsPackage.ROUTE__CATEGORY, oldCategory, category));
	}
