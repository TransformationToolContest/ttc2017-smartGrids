...
import CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringFactory;
...
public class InfPaymentMeteringPackageImpl extends EPackageImpl implements InfPaymentMeteringPackage {
	 ...
	 * @see CIM.IEC61970.Informative.InfPaymentMetering.InfPaymentMeteringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Informative.InfPaymentMetering." + eClassifier.getName());
