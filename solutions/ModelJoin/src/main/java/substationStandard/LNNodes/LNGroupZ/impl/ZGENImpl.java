...
import substationStandard.LNNodes.LNGroupZ.ZGEN;
 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getOpTmh <em>Op Tmh</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getGnCtl <em>Gn Ctl</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getDExt <em>DExt</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getAuxSCO <em>Aux SCO</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getStopVlv <em>Stop Vlv</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getReactPwrR <em>React Pwr R</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getReactPwrL <em>React Pwr L</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getGnSpd <em>Gn Spd</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getOANL <em>OANL</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getGnSt <em>Gn St</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getClkRot <em>Clk Rot</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getCntClkRot <em>Cnt Clk Rot</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getOpUnExt <em>Op Un Ext</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getOpOvExt <em>Op Ov Ext</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getLosOil <em>Los Oil</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getLosVac <em>Los Vac</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getPresAlm <em>Pres Alm</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getDmdPwr <em>Dmd Pwr</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getPwrRtg <em>Pwr Rtg</em>}</li>
 *   <li>{@link substationStandard.LNNodes.LNGroupZ.impl.ZGENImpl#getVRtg <em>VRtg</em>}</li>
 * </ul>
 *
 * @generated
 */
