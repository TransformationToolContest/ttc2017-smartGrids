 ...
 * <!-- end-user-doc -->
 * @see gluemodel.CIM.IEC61970.Informative.InfAssets.InfAssetsPackage#getCoolingKind()
 * @model
 * @generated
 */
public enum CoolingKind implements Enumerator {
	 ...
	 * @ordered
	 */
	SELF_COOLING(0, "selfCooling", "selfCooling"),
	 ...
	 * @ordered
	 */
	FORCED_OIL_AND_AIR(1, "forcedOilAndAir", "forcedOilAndAir"),
	 ...
	 * @ordered
	 */
	FORCED_AIR(2, "forcedAir", "forcedAir"),
	 ...
	 * <!-- end-user-doc -->
	 * @see #SELF_COOLING
	 * @model name="selfCooling"
	 * @generated
	 * @ordered
	 */
	public static final int SELF_COOLING_VALUE = 0;
	 ...
	 * @model name="forcedOilAndAir"
	 * @generated
	 * @ordered
	 */
	public static final int FORCED_OIL_AND_AIR_VALUE = 1;
	 ...
	 * <!-- end-user-doc -->
	 * @see #FORCED_AIR
	 * @model name="forcedAir"
	 * @generated
	 * @ordered
	 */
	public static final int FORCED_AIR_VALUE = 2;
