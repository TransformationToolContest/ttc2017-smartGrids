 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Meas.Discrete#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Discrete#getValueAliasSet <em>Value Alias Set</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Discrete#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Discrete#getNormalValue <em>Normal Value</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Discrete#getCommand <em>Command</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.Discrete#getDiscreteValues <em>Discrete Values</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Meas.MeasPackage#getDiscrete()
...
public interface Discrete extends Measurement {
	 ...
	 * @see #setMinValue(int)
	 * @see CIM.IEC61970.Meas.MeasPackage#getDiscrete_MinValue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Discrete#getMinValue <em>Min Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.ValueAliasSet#getDiscretes <em>Discretes</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getDiscrete_ValueAliasSet()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Discrete#getValueAliasSet <em>Value Alias Set</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setMaxValue(int)
	 * @see CIM.IEC61970.Meas.MeasPackage#getDiscrete_MaxValue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Discrete#getMaxValue <em>Max Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getDiscrete_NormalValue()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Discrete#getNormalValue <em>Normal Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.Command#getDiscrete <em>Discrete</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getDiscrete_Command()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Meas.Discrete#getCommand <em>Command</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Meas.DiscreteValue}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.DiscreteValue#getDiscrete <em>Discrete</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getDiscrete_DiscreteValues()
