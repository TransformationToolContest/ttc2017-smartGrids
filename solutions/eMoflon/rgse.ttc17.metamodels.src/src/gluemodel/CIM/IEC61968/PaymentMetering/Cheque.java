 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getMicrNumber <em>Micr Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getDate <em>Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getChequeNumber <em>Cheque Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getKind <em>Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getBankAccountDetail <em>Bank Account Detail</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getTender <em>Tender</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCheque()
...
public interface Cheque extends Element {
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCheque_MicrNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getMicrNumber <em>Micr Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setDate(String)
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCheque_Date()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getDate <em>Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCheque_ChequeNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getChequeNumber <em>Cheque Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link gluemodel.CIM.IEC61968.PaymentMetering.ChequeKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCheque_Kind()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCheque_BankAccountDetail()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getBankAccountDetail <em>Bank Account Detail</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.Tender#getCheque <em>Cheque</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getCheque_Tender()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.PaymentMetering.Cheque#getTender <em>Tender</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
