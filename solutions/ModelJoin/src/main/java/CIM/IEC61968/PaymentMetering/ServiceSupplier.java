 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ServiceSupplier#getServiceDeliveryPoints <em>Service Delivery Points</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ServiceSupplier#getBankAccounts <em>Bank Accounts</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ServiceSupplier#getIssuerIdentificationNumber <em>Issuer Identification Number</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ServiceSupplier#getKind <em>Kind</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ServiceSupplier#getCustomerAgreements <em>Customer Agreements</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getServiceSupplier()
...
public interface ServiceSupplier extends Organisation {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Metering.ServiceDeliveryPoint#getServiceSupplier <em>Service Supplier</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getServiceSupplier_ServiceDeliveryPoints()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.InfCommon.BankAccount#getServiceSupplier <em>Service Supplier</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getServiceSupplier_BankAccounts()
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getServiceSupplier_IssuerIdentificationNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.ServiceSupplier#getIssuerIdentificationNumber <em>Issuer Identification Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61968.PaymentMetering.SupplierKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getServiceSupplier_Kind()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.ServiceSupplier#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.Customers.CustomerAgreement#getServiceSupplier <em>Service Supplier</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getServiceSupplier_CustomerAgreements()
