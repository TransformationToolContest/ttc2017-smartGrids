...
import gluemodel.COSEM.Datatypes.DatatypesFactory;
...
public class DatatypesPackageImpl extends EPackageImpl implements DatatypesPackage {
	 ...
	 * @see gluemodel.COSEM.Datatypes.DatatypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.COSEM.Datatypes." + eClassifier.getName());
