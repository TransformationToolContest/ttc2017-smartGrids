 ...
 * </p>
 * <ul>
 *   <li>{@link outagePreventionJointarget.impl.TieFlowImpl#getControlArea <em>Control Area</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TieFlowImpl extends MinimalEObjectImpl.Container implements TieFlow {
	/**
	...
	protected EClass eStaticClass() {
		return OutagePreventionJointargetPackage.Literals.TIE_FLOW;
	}
		...
		if (controlArea != null && controlArea.eIsProxy()) {
			...
			if (controlArea != oldControlArea) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OutagePreventionJointargetPackage.TIE_FLOW__CONTROL_AREA, oldControlArea, controlArea));
			}
		}
		return controlArea;
	}
	...
	public void setControlArea(ControlArea newControlArea) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OutagePreventionJointargetPackage.TIE_FLOW__CONTROL_AREA, oldControlArea, controlArea));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OutagePreventionJointargetPackage.TIE_FLOW__CONTROL_AREA:
