 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getDeadband <em>Deadband</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getSensorMinimum <em>Sensor Minimum</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getMeasurementValue <em>Measurement Value</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getScanInterval <em>Scan Interval</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getSensorMaximum <em>Sensor Maximum</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.SCADA.SCADAPackage#getRemoteSource()
...
public interface RemoteSource extends RemotePoint {
	 ...
	 * @see gluemodel.CIM.IEC61970.SCADA.SCADAPackage#getRemoteSource_Deadband()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getDeadband <em>Deadband</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.SCADA.SCADAPackage#getRemoteSource_SensorMinimum()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getSensorMinimum <em>Sensor Minimum</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Meas.MeasurementValue#getRemoteSource <em>Remote Source</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.SCADA.SCADAPackage#getRemoteSource_MeasurementValue()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getMeasurementValue <em>Measurement Value</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.SCADA.SCADAPackage#getRemoteSource_ScanInterval()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getScanInterval <em>Scan Interval</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61970.SCADA.SCADAPackage#getRemoteSource_SensorMaximum()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61970.SCADA.RemoteSource#getSensorMaximum <em>Sensor Maximum</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
