...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupP/PTRC")]
    public class PTRC : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP.GroupP, IPTRC, IModelElement
    {
        ...
        public virtual IING TrMod
        {
            ...
            set
            {
                if ((this._trMod != value))
                {
                    ...
                    this.OnPropertyChanging("TrMod", e);
                    this._trMod = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("TrMod", e);
                }
            }
        }
        ...
        public virtual IING TrPlsTmms
        {
            ...
            set
            {
                if ((this._trPlsTmms != value))
                {
                    ...
                    this.OnPropertyChanging("TrPlsTmms", e);
                    ...
                    this.OnPropertyChanged("TrPlsTmms", e);
                }
            }
        }
        ...
        private sealed class TrProxy : ModelPropertyChange<IPTRC, IACT>
        {
            ...
            {
                this.ModelElement.TrChanged += handler;
            }
        ...
        private sealed class TrModProxy : ModelPropertyChange<IPTRC, IING>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.TrModChanged += handler;
            }
        ...
        private sealed class TrPlsTmmsProxy : ModelPropertyChange<IPTRC, IING>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.TrPlsTmmsChanged += handler;
            }
