 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#getKH <em>KH</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#isIntervalDataMeter <em>Interval Data Meter</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#getMaxRegisterCount <em>Max Register Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#getMeterAssets <em>Meter Assets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#isKVAhMeter <em>KV Ah Meter</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#getWireCount <em>Wire Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#isTimeOfUseMeter <em>Time Of Use Meter</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#isDemandMeter <em>Demand Meter</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#isReactiveMeter <em>Reactive Meter</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#getForm <em>Form</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#getRegisterRatio <em>Register Ratio</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#isKwhMeter <em>Kwh Meter</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#isQMeter <em>QMeter</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.impl.MeterAssetModelImpl#isLoadProfileMeter <em>Load Profile Meter</em>}</li>
 * </ul>
 *
 * @generated
 */
