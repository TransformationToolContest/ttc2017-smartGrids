 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Meas.ValueAliasSet#getValues <em>Values</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.ValueAliasSet#getCommands <em>Commands</em>}</li>
 *   <li>{@link CIM.IEC61970.Meas.ValueAliasSet#getDiscretes <em>Discretes</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Meas.MeasPackage#getValueAliasSet()
...
public interface ValueAliasSet extends IdentifiedObject {
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Meas.ValueToAlias}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.ValueToAlias#getValueAliasSet <em>Value Alias Set</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getValueAliasSet_Values()
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Meas.Command}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.Command#getValueAliasSet <em>Value Alias Set</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getValueAliasSet_Commands()
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Meas.Discrete}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Meas.Discrete#getValueAliasSet <em>Value Alias Set</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Meas.MeasPackage#getValueAliasSet_Discretes()
