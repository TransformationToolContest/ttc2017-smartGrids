 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getEnergyConversionCapability <em>Energy Conversion Capability</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getTailbayLossCurve <em>Tailbay Loss Curve</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getHydroPowerPlant <em>Hydro Power Plant</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getHydroGeneratingEfficiencyCurves <em>Hydro Generating Efficiency Curves</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getHydroUnitWaterCost <em>Hydro Unit Water Cost</em>}</li>
 *   <li>{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getPenstockLossCurve <em>Penstock Loss Curve</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Generation.Production.ProductionPackage#getHydroGeneratingUnit()
...
public interface HydroGeneratingUnit extends GeneratingUnit {
	 ...
	 * The literals are from the enumeration {@link CIM.IEC61970.Generation.Production.HydroEnergyConversionKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Generation.Production.ProductionPackage#getHydroGeneratingUnit_EnergyConversionCapability()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getEnergyConversionCapability <em>Energy Conversion Capability</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Generation.Production.TailbayLossCurve}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Generation.Production.TailbayLossCurve#getHydroGeneratingUnit <em>Hydro Generating Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Generation.Production.ProductionPackage#getHydroGeneratingUnit_TailbayLossCurve()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Generation.Production.HydroPowerPlant#getHydroGeneratingUnits <em>Hydro Generating Units</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Generation.Production.ProductionPackage#getHydroGeneratingUnit_HydroPowerPlant()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getHydroPowerPlant <em>Hydro Power Plant</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Generation.Production.HydroGeneratingEfficiencyCurve}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Generation.Production.HydroGeneratingEfficiencyCurve#getHydroGeneratingUnit <em>Hydro Generating Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Generation.Production.ProductionPackage#getHydroGeneratingUnit_HydroGeneratingEfficiencyCurves()
	 ...
	 * @see CIM.IEC61970.Generation.Production.ProductionPackage#getHydroGeneratingUnit_HydroUnitWaterCost()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getHydroUnitWaterCost <em>Hydro Unit Water Cost</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Generation.Production.PenstockLossCurve#getHydroGeneratingUnit <em>Hydro Generating Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Generation.Production.ProductionPackage#getHydroGeneratingUnit_PenstockLossCurve()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Generation.Production.HydroGeneratingUnit#getPenstockLossCurve <em>Penstock Loss Curve</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
