 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getMeterAssetModel <em>Meter Asset Model</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getVendingTransactions <em>Vending Transactions</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getKR <em>KR</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getMeterServiceWorks <em>Meter Service Works</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getKH <em>KH</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getFormNumber <em>Form Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getMeterReadings <em>Meter Readings</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getMeterReplacementWorks <em>Meter Replacement Works</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset()
...
public interface MeterAsset extends EndDeviceAsset {
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.InfAssetModels.MeterAssetModel#getMeterAssets <em>Meter Assets</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset_MeterAssetModel()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getMeterAssetModel <em>Meter Asset Model</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.PaymentMetering.Transaction#getMeterAsset <em>Meter Asset</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset_VendingTransactions()
	 ...
	 * @see #setKR(float)
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset_KR()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getKR <em>KR</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61968.Metering.MeterServiceWork}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.Metering.MeterServiceWork#getMeterAsset <em>Meter Asset</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset_MeterServiceWorks()
	 ...
	 * @see #setKH(float)
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset_KH()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getKH <em>KH</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset_FormNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.Metering.MeterAsset#getFormNumber <em>Form Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.Metering.MeterReading#getMeterAsset <em>Meter Asset</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset_MeterReadings()
	 ...
	 * The list contents are of type {@link gluemodel.CIM.IEC61968.Metering.MeterServiceWork}.
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.Metering.MeterServiceWork#getOldMeterAsset <em>Old Meter Asset</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.Metering.MeteringPackage#getMeterAsset_MeterReplacementWorks()
