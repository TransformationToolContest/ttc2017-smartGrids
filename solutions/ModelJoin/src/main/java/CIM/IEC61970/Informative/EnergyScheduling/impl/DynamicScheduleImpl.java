 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.DynamicScheduleImpl#getDynSchedStatus <em>Dyn Sched Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.DynamicScheduleImpl#getReceive_HostControlArea <em>Receive Host Control Area</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.DynamicScheduleImpl#getMeasurement <em>Measurement</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.DynamicScheduleImpl#getSend_HostControlArea <em>Send Host Control Area</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.EnergyScheduling.impl.DynamicScheduleImpl#isDynSchedSignRev <em>Dyn Sched Sign Rev</em>}</li>
 * </ul>
 *
 * @generated
 */
