...
import gluemodel.CIM.IEC61970.Informative.InfERPSupport.BillMediaKind;
import gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpInvoice;
import gluemodel.CIM.IEC61970.Informative.InfERPSupport.ErpInvoiceKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getTransactionDateTime <em>Transaction Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getReferenceNumber <em>Reference Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getDueDate <em>Due Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getMailedDate <em>Mailed Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getTransferType <em>Transfer Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getCustomerAccount <em>Customer Account</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#isProForma <em>Pro Forma</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getBillMediaKind <em>Bill Media Kind</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.InfERPSupport.impl.ErpInvoiceImpl#getErpInvoiceLineItems <em>Erp Invoice Line Items</em>}</li>
 * </ul>
 *
 * @generated
 */
