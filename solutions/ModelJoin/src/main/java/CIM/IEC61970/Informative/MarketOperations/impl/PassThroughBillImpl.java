...
import CIM.IEC61970.Informative.MarketOperations.ChargeProfile;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getBillEnd <em>Bill End</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getEffectiveDate <em>Effective Date</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getServiceEnd <em>Service End</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#isIsProfiled <em>Is Profiled</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getPreviousEnd <em>Previous End</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getTimeZone <em>Time Zone</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getBilledTo <em>Billed To</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#isIsDisputed <em>Is Disputed</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getProvidedBy <em>Provided By</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getMarketStatementLineItem <em>Market Statement Line Item</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getBillStart <em>Bill Start</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getPreviousStart <em>Previous Start</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getServiceStart <em>Service Start</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getProductCode <em>Product Code</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getBillRunType <em>Bill Run Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getTransactionType <em>Transaction Type</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getUserAttributes <em>User Attributes</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getChargeProfiles <em>Charge Profiles</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getTradeDate <em>Trade Date</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getPrice <em>Price</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getTaxAmount <em>Tax Amount</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getSoldTo <em>Sold To</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getTransactionDate <em>Transaction Date</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getPaidTo <em>Paid To</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.impl.PassThroughBillImpl#getQuantity <em>Quantity</em>}</li>
 * </ul>
 *
 * @generated
 */
