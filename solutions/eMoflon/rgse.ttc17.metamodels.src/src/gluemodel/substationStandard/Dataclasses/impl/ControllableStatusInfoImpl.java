...
import gluemodel.substationStandard.Dataclasses.ControllableStatusInfo;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getOperTm <em>Oper Tm</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getCtlNum <em>Ctl Num</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#isStSeld <em>St Seld</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#isSubEna <em>Sub Ena</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getSubQ <em>Sub Q</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getSubID <em>Sub ID</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getCtlModel <em>Ctl Model</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getSboTimeout <em>Sbo Timeout</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getSboClass <em>Sbo Class</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getD <em>D</em>}</li>
 *   <li>{@link gluemodel.substationStandard.Dataclasses.impl.ControllableStatusInfoImpl#getDU <em>DU</em>}</li>
 * </ul>
 *
 * @generated
 */
