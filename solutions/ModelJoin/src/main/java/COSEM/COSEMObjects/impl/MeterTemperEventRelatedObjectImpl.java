...
import COSEM.COSEMObjects.MeterTemperEventRelatedObject;
 ...
 * </p>
 * <ul>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getMeter_open_event_counter <em>Meter open event counter</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getMeter_open_event_timestamp <em>Meter open event timestamp</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getMeter_open_event_duration <em>Meter open event duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getMeter_open_event_cumulative_duration <em>Meter open event cumulative duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getTerminal_cover_open_event_counter <em>Terminal cover open event counter</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getTerminal_cover_open_event_time <em>Terminal cover open event time</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getTerminal_cover_open_event_duration <em>Terminal cover open event duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getTerminal_cover_open_event_cumulative_duration <em>Terminal cover open event cumulative duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getTilt_event_counter <em>Tilt event counter</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getTilt_event_time <em>Tilt event time</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getTilt_event_duration <em>Tilt event duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getTilt_event_cumulative_duration <em>Tilt event cumulative duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getStrong_DC_magnetic_field_event_counter <em>Strong DC magnetic field event counter</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getStrong_DC_magnetic_field_event_time <em>Strong DC magnetic field event time</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getStrong_DC_magnetic_field_event_duration <em>Strong DC magnetic field event duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getStrong_DC_magnetic_field_event_cumulative_duration <em>Strong DC magnetic field event cumulative duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getSupply_control_switch_event_counter <em>Supply control switch event counter</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getSupply_control_switch_event_time <em>Supply control switch event time</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getSupply_control_switch_event_duration <em>Supply control switch event duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getSupply_control_switch_event_cumulative_duration <em>Supply control switch event cumulative duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getMetrology_tamper_event_counter <em>Metrology tamper event counter</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getMetrology_tamper_event_time <em>Metrology tamper event time</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getMetrology_tamper_event_duration <em>Metrology tamper event duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getMetrology_tamper_event_cumulative_duration <em>Metrology tamper event cumulative duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getCommunication_tamper_event_counter <em>Communication tamper event counter</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getCommunication_tamper_event_time <em>Communication tamper event time</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getCommunication_tamper_event_duration <em>Communication tamper event duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getCommunication_tamper_event_cumulative_duration <em>Communication tamper event cumulative duration</em>}</li>
 *   <li>{@link COSEM.COSEMObjects.impl.MeterTemperEventRelatedObjectImpl#getManufacturer_specific <em>Manufacturer specific</em>}</li>
 * </ul>
 *
 * @generated
 */
