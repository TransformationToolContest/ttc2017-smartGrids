 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityNominalValuesImpl#getVoltage <em>Voltage</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityNominalValuesImpl#getNominalcurrent <em>Nominalcurrent</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityNominalValuesImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityNominalValuesImpl#getMaximumcurrent <em>Maximumcurrent</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityNominalValuesImpl#getReference_voltage_for_power_quality_measurement <em>Reference voltage for power quality measurement</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityNominalValuesImpl#getReference_voltage_for_aux_power_supply <em>Reference voltage for aux power supply</em>}</li>
 * </ul>
 *
 * @generated
 */
