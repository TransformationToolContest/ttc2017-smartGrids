 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getWireType <em>Wire Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getConductorInfo <em>Conductor Info</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getMountingPointX <em>Mounting Point X</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getMountingPointY <em>Mounting Point Y</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61968.AssetModels.AssetModelsPackage#getWireArrangement()
...
public interface WireArrangement extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.AssetModels.WireType#getWireArrangements <em>Wire Arrangements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.AssetModels.AssetModelsPackage#getWireArrangement_WireType()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getWireType <em>Wire Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61968.AssetModels.ConductorInfo#getWireArrangements <em>Wire Arrangements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61968.AssetModels.AssetModelsPackage#getWireArrangement_ConductorInfo()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getConductorInfo <em>Conductor Info</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.AssetModels.AssetModelsPackage#getWireArrangement_MountingPointX()
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getMountingPointX <em>Mounting Point X</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gluemodel.CIM.IEC61968.AssetModels.AssetModelsPackage#getWireArrangement_MountingPointY()
	 * @model dataType="gluemodel.CIM.IEC61970.Domain.Length" required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getMountingPointY <em>Mounting Point Y</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPosition(int)
	 * @see gluemodel.CIM.IEC61968.AssetModels.AssetModelsPackage#getWireArrangement_Position()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link gluemodel.CIM.IEC61968.AssetModels.WireArrangement#getPosition <em>Position</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
