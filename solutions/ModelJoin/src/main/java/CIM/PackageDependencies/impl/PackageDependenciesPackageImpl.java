/**
 */
package CIM.PackageDependencies.impl;
...
import CIM.PackageDependencies.PackageDependenciesFactory;
 ...
 * @generated
 */
public class PackageDependenciesPackageImpl extends EPackageImpl implements PackageDependenciesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see CIM.PackageDependencies.PackageDependenciesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PackageDependenciesPackageImpl() {
		super(eNS_URI, PackageDependenciesFactory.eINSTANCE);
	}
	...
	public static PackageDependenciesPackage init() {
		...
		PackageDependenciesPackageImpl thePackageDependenciesPackage = (PackageDependenciesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PackageDependenciesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PackageDependenciesPackageImpl());
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.PackageDependencies." + eClassifier.getName());
			setGeneratedClassName(eClassifier);
		}
	}

} //PackageDependenciesPackageImpl
