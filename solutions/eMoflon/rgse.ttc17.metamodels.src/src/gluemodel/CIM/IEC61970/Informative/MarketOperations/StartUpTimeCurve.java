 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.StartUpTimeCurve#getGeneratingBids <em>Generating Bids</em>}</li>
 * </ul>
 *
 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getStartUpTimeCurve()
...
public interface StartUpTimeCurve extends Curve {
	 ...
	 * It is bidirectional and its opposite is '{@link gluemodel.CIM.IEC61970.Informative.MarketOperations.GeneratingBid#getStartUpTimeCurve <em>Start Up Time Curve</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gluemodel.CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getStartUpTimeCurve_GeneratingBids()
