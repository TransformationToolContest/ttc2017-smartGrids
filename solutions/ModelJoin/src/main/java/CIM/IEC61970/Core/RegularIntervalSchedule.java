 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.RegularIntervalSchedule#getEndTime <em>End Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.RegularIntervalSchedule#getTimePoints <em>Time Points</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.RegularIntervalSchedule#getTimeStep <em>Time Step</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Core.CorePackage#getRegularIntervalSchedule()
...
public interface RegularIntervalSchedule extends BasicIntervalSchedule {
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getRegularIntervalSchedule_EndTime()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.RegularIntervalSchedule#getEndTime <em>End Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Core.RegularTimePoint}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Core.RegularTimePoint#getIntervalSchedule <em>Interval Schedule</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getRegularIntervalSchedule_TimePoints()
	 ...
	 * @see CIM.IEC61970.Core.CorePackage#getRegularIntervalSchedule_TimeStep()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Core.RegularIntervalSchedule#getTimeStep <em>Time Step</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
