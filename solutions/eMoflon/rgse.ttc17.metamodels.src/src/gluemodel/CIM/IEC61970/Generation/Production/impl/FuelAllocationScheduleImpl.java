 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.FuelAllocationScheduleImpl#getFuelType <em>Fuel Type</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.FuelAllocationScheduleImpl#getMaxFuelAllocation <em>Max Fuel Allocation</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.FuelAllocationScheduleImpl#getFuelAllocationStartDate <em>Fuel Allocation Start Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.FuelAllocationScheduleImpl#getFossilFuel <em>Fossil Fuel</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.FuelAllocationScheduleImpl#getThermalGeneratingUnit <em>Thermal Generating Unit</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.FuelAllocationScheduleImpl#getMinFuelAllocation <em>Min Fuel Allocation</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Generation.Production.impl.FuelAllocationScheduleImpl#getFuelAllocationEndDate <em>Fuel Allocation End Date</em>}</li>
 * </ul>
 *
 * @generated
 */
