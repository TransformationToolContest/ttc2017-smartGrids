 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Wires.PowerTransformer#getFlowgates <em>Flowgates</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.PowerTransformer#getHeatExchanger <em>Heat Exchanger</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.PowerTransformer#getTransformerWindings <em>Transformer Windings</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.PowerTransformer#getMagBaseU <em>Mag Base U</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.PowerTransformer#getMagSatFlux <em>Mag Sat Flux</em>}</li>
 *   <li>{@link CIM.IEC61970.Wires.PowerTransformer#getBmagSat <em>Bmag Sat</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Wires.WiresPackage#getPowerTransformer()
...
public interface PowerTransformer extends Equipment {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.Flowgate#getPowerTransormers <em>Power Transormers</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getPowerTransformer_Flowgates()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.HeatExchanger#getPowerTransformer <em>Power Transformer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getPowerTransformer_HeatExchanger()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.PowerTransformer#getHeatExchanger <em>Heat Exchanger</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CIM.IEC61970.Wires.TransformerWinding}.
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Wires.TransformerWinding#getPowerTransformer <em>Power Transformer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getPowerTransformer_TransformerWindings()
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getPowerTransformer_MagBaseU()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.PowerTransformer#getMagBaseU <em>Mag Base U</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getPowerTransformer_MagSatFlux()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.PowerTransformer#getMagSatFlux <em>Mag Sat Flux</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61970.Wires.WiresPackage#getPowerTransformer_BmagSat()
	 * @model dataType="CIM.IEC61970.Domain.PerCent" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61970.Wires.PowerTransformer#getBmagSat <em>Bmag Sat</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
