...
import gluemodel.substationStandard.LNNodes.LNGroupT.LNGroupTFactory;
...
public class LNGroupTPackageImpl extends EPackageImpl implements LNGroupTPackage {
	 ...
	 * @see gluemodel.substationStandard.LNNodes.LNGroupT.LNGroupTPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EClass getGroupT() {
		if (groupTEClass == null) {
			groupTEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupTPackage.eNS_URI).getEClassifiers().get(0);
		}
		return groupTEClass;
	}
	...
	public EReference getGroupT_EEName() {
        return (EReference)getGroupT().getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getGroupT_EEHealth() {
        return (EAttribute)getGroupT().getEStructuralFeatures().get(1);
	}
	...
	public EReference getGroupT_OpTmh() {
        return (EReference)getGroupT().getEStructuralFeatures().get(2);
	}
	...
	public EReference getGroupT_HzRtg() {
        return (EReference)getGroupT().getEStructuralFeatures().get(3);
	}
	...
	public EReference getGroupT_Rat() {
        return (EReference)getGroupT().getEStructuralFeatures().get(4);
	}
	...
	public EReference getGroupT_Cor() {
        return (EReference)getGroupT().getEStructuralFeatures().get(5);
	}
	...
	public EReference getGroupT_AngCor() {
        return (EReference)getGroupT().getEStructuralFeatures().get(6);
	}
	...
	public EClass getTCTR() {
		if (tctrEClass == null) {
			tctrEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupTPackage.eNS_URI).getEClassifiers().get(1);
		}
		return tctrEClass;
	}
	...
	public EReference getTCTR_Amp() {
        return (EReference)getTCTR().getEStructuralFeatures().get(0);
	}
	...
	public EReference getTCTR_ARtg() {
        return (EReference)getTCTR().getEStructuralFeatures().get(1);
	}
	...
	public EClass getTVTR() {
		if (tvtrEClass == null) {
			tvtrEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(LNGroupTPackage.eNS_URI).getEClassifiers().get(2);
		}
		return tvtrEClass;
	}
	...
	public EReference getTVTR_Vol() {
        return (EReference)getTVTR().getEStructuralFeatures().get(0);
	}
	...
	public EReference getTVTR_FuFail() {
        return (EReference)getTVTR().getEStructuralFeatures().get(1);
	}
	...
	public EReference getTVTR_VRtg() {
        return (EReference)getTVTR().getEStructuralFeatures().get(2);
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("gluemodel.substationStandard.LNNodes.LNGroupT." + eClassifier.getName());
