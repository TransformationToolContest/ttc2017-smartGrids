 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getScheduledEvents <em>Scheduled Events</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getErpOrganisationRoles <em>Erp Organisation Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getCreatedDateTime <em>Created Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getToDocumentRoles <em>To Document Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getAssetRoles <em>Asset Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getErpPersonRoles <em>Erp Person Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getRevisionNumber <em>Revision Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getElectronicAddress <em>Electronic Address</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getNetworkDataSets <em>Network Data Sets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getPowerSystemResourceRoles <em>Power System Resource Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getActivityRecords <em>Activity Records</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getFromDocumentRoles <em>From Document Roles</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getLastModifiedDateTime <em>Last Modified Date Time</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getChangeSets <em>Change Sets</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getDocStatus <em>Doc Status</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getChangeItems <em>Change Items</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getScheduleParameterInfos <em>Schedule Parameter Infos</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61968.Common.impl.DocumentImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
