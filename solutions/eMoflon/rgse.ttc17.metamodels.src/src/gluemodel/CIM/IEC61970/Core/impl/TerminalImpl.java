 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getConnectivityNode <em>Connectivity Node</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getSvPowerFlow <em>Sv Power Flow</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getHasFirst_MutualCoupling <em>Has First Mutual Coupling</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getTerminalConstraints <em>Terminal Constraints</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getRegulatingControl <em>Regulating Control</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#isConnected <em>Connected</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getTieFlow <em>Tie Flow</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getTopologicalNode <em>Topological Node</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getBranchGroupTerminal <em>Branch Group Terminal</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getBushingInfo <em>Bushing Info</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getConductingEquipment <em>Conducting Equipment</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getHasSecond_MutualCoupling <em>Has Second Mutual Coupling</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Core.impl.TerminalImpl#getOperationalLimitSet <em>Operational Limit Set</em>}</li>
 * </ul>
 *
 * @generated
 */
