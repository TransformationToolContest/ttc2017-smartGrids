...
import CIM.IEC61970.Informative.InfERPSupport.ErpCompetency;
import CIM.IEC61970.Informative.InfERPSupport.ErpPerson;
import CIM.IEC61970.Informative.InfERPSupport.ErpPersonnel;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getCallBacks <em>Call Backs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getServiceLocation <em>Service Location</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getDocumentRoles <em>Document Roles</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getSwitchingStepRoles <em>Switching Step Roles</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getLastName <em>Last Name</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getChangeItems <em>Change Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getMName <em>MName</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getSkills <em>Skills</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getElectronicAddress <em>Electronic Address</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getGovernmentID <em>Government ID</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getSpecialNeed <em>Special Need</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getErpOrganisationRoles <em>Erp Organisation Roles</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getLaborItems <em>Labor Items</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getCrafts <em>Crafts</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getMobilePhone <em>Mobile Phone</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getErpCompetency <em>Erp Competency</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getLandPropertyRoles <em>Land Property Roles</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getLandlinePhone <em>Landline Phone</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getMeasurementValues <em>Measurement Values</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getActivityRecords <em>Activity Records</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getCrews <em>Crews</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getAppointments <em>Appointments</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getErpPersonnel <em>Erp Personnel</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getSuffix <em>Suffix</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfERPSupport.impl.ErpPersonImpl#getCustomerData <em>Customer Data</em>}</li>
 * </ul>
 *
 * @generated
 */
