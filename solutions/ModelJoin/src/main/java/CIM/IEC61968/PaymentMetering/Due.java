 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Due#getInterest <em>Interest</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Due#getPrinciple <em>Principle</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Due#getCurrent <em>Current</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Due#getArrears <em>Arrears</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.Due#getCharges <em>Charges</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getDue()
...
public interface Due extends Element {
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getDue_Interest()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Due#getInterest <em>Interest</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getDue_Principle()
	 * @model dataType="CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Due#getPrinciple <em>Principle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getDue_Current()
	 * @model dataType="CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Due#getCurrent <em>Current</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getDue_Arrears()
	 * @model dataType="CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Due#getArrears <em>Arrears</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getDue_Charges()
	 * @model dataType="CIM.IEC61970.Domain.Money" required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.Due#getCharges <em>Charges</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
