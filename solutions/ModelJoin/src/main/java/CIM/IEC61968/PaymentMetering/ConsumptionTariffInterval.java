 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ConsumptionTariffInterval#getTariffProfiles <em>Tariff Profiles</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ConsumptionTariffInterval#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ConsumptionTariffInterval#getCharges <em>Charges</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.ConsumptionTariffInterval#getStartValue <em>Start Value</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getConsumptionTariffInterval()
...
public interface ConsumptionTariffInterval extends Element {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.TariffProfile#getConsumptionTariffIntervals <em>Consumption Tariff Intervals</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getConsumptionTariffInterval_TariffProfiles()
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getConsumptionTariffInterval_SequenceNumber()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.ConsumptionTariffInterval#getSequenceNumber <em>Sequence Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61968.PaymentMetering.Charge#getConsumptionTariffIntervals <em>Consumption Tariff Intervals</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getConsumptionTariffInterval_Charges()
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getConsumptionTariffInterval_StartValue()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.ConsumptionTariffInterval#getStartValue <em>Start Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
