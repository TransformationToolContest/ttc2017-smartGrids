 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#getGraySourcename <em>Gray Sourcename</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#getReliefFactor <em>Relief Factor</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#getOverlapbehaviour <em>Overlapbehaviour</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#getOpacity <em>Opacity</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#getGreenSourceName <em>Green Source Name</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#isBrighnessOnly <em>Brighness Only</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#getBlueSourcename <em>Blue Sourcename</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#getGmlDiagramObject <em>Gml Diagram Object</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfGMLSupport.impl.GmlRasterSymbolImpl#getRedSourcename <em>Red Sourcename</em>}</li>
 * </ul>
 *
 * @generated
 */
