...
import gluemodel.COSEM.COSEMObjects.ElectricityTimeEntries;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getTime_expired_since_last_end_of_billing_period <em>Time expired since last end of billing period</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getLocaltime <em>Localtime</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getLocaldate <em>Localdate</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getWeekday <em>Weekday</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getTimeoflastreset <em>Timeoflastreset</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getDateoflastreset <em>Dateoflastreset</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getOutputpulseduration <em>Outputpulseduration</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getClocksynchronizationwindow <em>Clocksynchronizationwindow</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getClock_synchronization_method <em>Clock synchronization method</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getClock_time_shift_limit <em>Clock time shift limit</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ElectricityTimeEntriesImpl#getBilling_period_reset_lockout_time <em>Billing period reset lockout time</em>}</li>
 * </ul>
 *
 * @generated
 */
