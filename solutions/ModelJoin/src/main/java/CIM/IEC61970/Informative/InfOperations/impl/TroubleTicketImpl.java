...
import CIM.IEC61970.Informative.InfOperations.IncidentRecord;
import CIM.IEC61970.Informative.InfOperations.InfOperationsPackage;
import CIM.IEC61970.Informative.InfOperations.TroubleReportingKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getFirstCallDateTime <em>First Call Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getCallBacks <em>Call Backs</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#isCallBack <em>Call Back</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getIncidentRecord <em>Incident Record</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getEstimatedRestoreDateTime <em>Estimated Restore Date Time</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getReportingKind <em>Reporting Kind</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getCustomerData <em>Customer Data</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#isInformBeforeRestored <em>Inform Before Restored</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getAdvice <em>Advice</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#isInformAfterRestored <em>Inform After Restored</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getHazardCode <em>Hazard Code</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.InfOperations.impl.TroubleTicketImpl#getTroublePeriod <em>Trouble Period</em>}</li>
 * </ul>
 *
 * @generated
 */
