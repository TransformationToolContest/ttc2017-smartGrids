 ...
 * </p>
 * <ul>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getSetMag <em>Set Mag</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getOperTm <em>Oper Tm</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getQ <em>Q</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getT <em>T</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getCtlModel <em>Ctl Model</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getSVC <em>SVC</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getMaxVal <em>Max Val</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getStepSize <em>Step Size</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getD <em>D</em>}</li>
 *   <li>{@link substationStandard.Dataclasses.impl.APCImpl#getDU <em>DU</em>}</li>
 * </ul>
 *
 * @generated
 */
