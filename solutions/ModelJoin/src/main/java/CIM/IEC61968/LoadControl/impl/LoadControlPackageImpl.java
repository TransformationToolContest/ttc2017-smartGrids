...
import CIM.IEC61968.LoadControl.LoadControlFactory;
...
public class LoadControlPackageImpl extends EPackageImpl implements LoadControlPackage {
	 ...
	 * @see CIM.IEC61968.LoadControl.LoadControlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61968.LoadControl." + eClassifier.getName());
