...
import CIM.IEC61970.Contingency.ContingencyFactory;
...
public class ContingencyPackageImpl extends EPackageImpl implements ContingencyPackage {
	 ...
	 * @see CIM.IEC61970.Contingency.ContingencyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("CIM.IEC61970.Contingency." + eClassifier.getName());
