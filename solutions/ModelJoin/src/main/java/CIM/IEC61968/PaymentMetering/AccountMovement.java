 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AccountMovement#getReason <em>Reason</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AccountMovement#getAmount <em>Amount</em>}</li>
 *   <li>{@link CIM.IEC61968.PaymentMetering.AccountMovement#getDateTime <em>Date Time</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountMovement()
...
public interface AccountMovement extends Element {
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountMovement_Reason()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AccountMovement#getReason <em>Reason</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAmount(float)
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountMovement_Amount()
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AccountMovement#getAmount <em>Amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CIM.IEC61968.PaymentMetering.PaymentMeteringPackage#getAccountMovement_DateTime()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CIM.IEC61968.PaymentMetering.AccountMovement#getDateTime <em>Date Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
