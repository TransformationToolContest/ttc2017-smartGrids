 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.impl.ServicePointImpl#getCustomerConsumer <em>Customer Consumer</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.impl.ServicePointImpl#getTransmissionProvider <em>Transmission Provider</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.impl.ServicePointImpl#getHasAPOR_ <em>Has APOR </em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.impl.ServicePointImpl#getGenerationProvider <em>Generation Provider</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.impl.ServicePointImpl#getDeclare_TiePoint <em>Declare Tie Point</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.impl.ServicePointImpl#getHasAPOD_ <em>Has APOD </em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.impl.ServicePointImpl#getEnergyProducts <em>Energy Products</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Reservation.impl.ServicePointImpl#getMemberOf <em>Member Of</em>}</li>
 * </ul>
 *
 * @generated
 */
