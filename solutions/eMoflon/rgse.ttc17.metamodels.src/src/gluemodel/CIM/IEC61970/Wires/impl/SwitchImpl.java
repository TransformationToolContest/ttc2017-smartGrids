 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#isRetained <em>Retained</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#getSwitchOnDate <em>Switch On Date</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#getLoadMgmtFunctions <em>Load Mgmt Functions</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#getConnectDisconnectFunctions <em>Connect Disconnect Functions</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#isNormalOpen <em>Normal Open</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#getSwitchingOperations <em>Switching Operations</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#getSwitchSchedules <em>Switch Schedules</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#getSwitchOnCount <em>Switch On Count</em>}</li>
 *   <li>{@link gluemodel.CIM.IEC61970.Wires.impl.SwitchImpl#getCompositeSwitch <em>Composite Switch</em>}</li>
 * </ul>
 *
 * @generated
 */
