...
import gluemodel.COSEM.COSEMObjects.ActivateNormalMode;
import gluemodel.COSEM.COSEMObjects.ActivateTestMode;
import gluemodel.COSEM.COSEMObjects.Broadcast;
import gluemodel.COSEM.COSEMObjects.COSEMObjectsPackage;
import gluemodel.COSEM.COSEMObjects.DisconnectControl;
import gluemodel.COSEM.COSEMObjects.GlobalMeterReset;
import gluemodel.COSEM.COSEMObjects.ImageActivation;
import gluemodel.COSEM.COSEMObjects.MDIReset;
import gluemodel.COSEM.COSEMObjects.PowerQualityMeasurementManagement;
import gluemodel.COSEM.COSEMObjects.Push;
import gluemodel.COSEM.COSEMObjects.ScriptTable;
import gluemodel.COSEM.COSEMObjects.SetOutputSignal;
import gluemodel.COSEM.COSEMObjects.SwitchOpticalTestOutput;
import gluemodel.COSEM.COSEMObjects.Tariffication;

import gluemodel.COSEM.InterfaceClasses.impl.ScripttableImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getGlobalMeterReset <em>Global Meter Reset</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getMDIReset <em>MDI Reset</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getTariffication <em>Tariffication</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getAcitvateTest <em>Acitvate Test</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getActivateNormal <em>Activate Normal</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getSetOutput <em>Set Output</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getSwitchOptical <em>Switch Optical</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getPowerQuality <em>Power Quality</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getDisconnect <em>Disconnect</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getImage <em>Image</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getPush <em>Push</em>}</li>
 *   <li>{@link gluemodel.COSEM.COSEMObjects.impl.ScriptTableImpl#getBroadcast <em>Broadcast</em>}</li>
 * </ul>
 *
 * @generated
 */
