 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Core.impl.EquipmentImpl#getOperationalLimitSet <em>Operational Limit Set</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.EquipmentImpl#getContingencyEquipment <em>Contingency Equipment</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.EquipmentImpl#isNormaIlyInService <em>Norma Ily In Service</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.EquipmentImpl#getCustomerAgreements <em>Customer Agreements</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.EquipmentImpl#isAggregate <em>Aggregate</em>}</li>
 *   <li>{@link CIM.IEC61970.Core.impl.EquipmentImpl#getEquipmentContainer <em>Equipment Container</em>}</li>
 * </ul>
 *
 * @generated
 */
