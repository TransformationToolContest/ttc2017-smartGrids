 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.Financial.CustomerConsumer#getTieLines <em>Tie Lines</em>}</li>
 *   <li>{@link CIM.IEC61970.Informative.Financial.CustomerConsumer#getServicePoint <em>Service Point</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.Financial.FinancialPackage#getCustomerConsumer()
...
public interface CustomerConsumer extends ErpOrganisation {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.EnergyScheduling.TieLine#getCustomerConsumer <em>Customer Consumer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Financial.FinancialPackage#getCustomerConsumer_TieLines()
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.Reservation.ServicePoint#getCustomerConsumer <em>Customer Consumer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.Financial.FinancialPackage#getCustomerConsumer_ServicePoint()
