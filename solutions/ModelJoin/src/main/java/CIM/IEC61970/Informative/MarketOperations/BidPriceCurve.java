 ...
 * </p>
 * <ul>
 *   <li>{@link CIM.IEC61970.Informative.MarketOperations.BidPriceCurve#getProductBids <em>Product Bids</em>}</li>
 * </ul>
 *
 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getBidPriceCurve()
...
public interface BidPriceCurve extends Curve {
	 ...
	 * It is bidirectional and its opposite is '{@link CIM.IEC61970.Informative.MarketOperations.ProductBid#getBidPriceCurve <em>Bid Price Curve</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CIM.IEC61970.Informative.MarketOperations.MarketOperationsPackage#getBidPriceCurve_ProductBids()
